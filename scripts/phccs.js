...
var require_copy_constructor_properties = __commonJS({
  "node_modules/libram/node_modules/core-js/internals/copy-constructor-properties.js": function(exports, module2) {
    init_kolmafia_polyfill();
    var hasOwn = require_has_own_property(), ownKeys10 = require_own_keys(), getOwnPropertyDescriptorModule = require_object_get_own_property_descriptor(), definePropertyModule = require_object_define_property();
    module2.exports = function(target, source, exceptions) {
      for (var keys = ownKeys10(source), defineProperty = definePropertyModule.f, getOwnPropertyDescriptor = getOwnPropertyDescriptorModule.f, i = 0; i < keys.length; i++) {
        var key = keys[i];
...
function getSaleValue() {
  ...
  return items.map(function(item6) {
    return valueMap.has(item6) || (item6.discardable ? valueMap.set(item6, (0, import_kolmafia3.mallPrice)(item6) > Math.max(2 * (0, import_kolmafia3.autosellPrice)(item6), 100) ? MALL_VALUE_MODIFIER * (0, import_kolmafia3.mallPrice)(item6) : (0, import_kolmafia3.autosellPrice)(item6)) : valueMap.set(item6, (0, import_kolmafia3.mallPrice)(item6) > 100 ? MALL_VALUE_MODIFIER * (0, import_kolmafia3.mallPrice)(item6) : 0)), valueMap.get(item6) || 0;
...
function itemOrItemsBallsMacroName(itemOrItems) {
  ...
  return substringCombatItems.includes(item6) ? (0, import_kolmafia4.toInt)(item6).toString() : item6.name;
}
...
function canEquipItemCount() {
  ...
  }) || (cachedStats = stats, cachedCanEquipItemCount = import_kolmafia6.Item.all().filter(function(item6) {
    return (0, import_kolmafia6.canEquip)(item6);
  ...
  if (outfitName) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
        ...
        (0, import_kolmafia6.equippedItem)(slot) !== item6 && (0, import_kolmafia6.availableAmount)(item6) > 0 && (0, import_kolmafia6.equip)(slot, item6);
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
...
function priceTooOld(item6) {
  return (0, import_kolmafia7.historicalPrice)(item6) === 0 || (0, import_kolmafia7.historicalAge)(item6) >= 7;
}
function historicalPriceOrMax(item6) {
  var historical = (0, import_kolmafia7.historicalPrice)(item6);
  return historical < 0 ? 999999999 : historical;
}
function mallPriceOrMax(item6) {
  var mall = (0, import_kolmafia7.mallPrice)(item6);
...
function inventoryItems() {
  return import_kolmafia7.Item.all().filter(isFuelItem).filter(function(item6) {
    return have(item6) && [100, (0, import_kolmafia7.autosellPrice)(item6)].includes(price(item6, PriceAge.RECENT));
  });
}
...
function getBestFuels() {
  ...
  allFuel.filter(function(item6) {
    return (0, import_kolmafia7.historicalPrice)(item6) === 0;
...
function fillTo(targetUnits) {
  ...
  for (; (0, import_kolmafia7.getFuel)() < targetUnits; ) {
    var _ref = (0, import_kolmafia7.canInteract)() ? getBestFuels() : [$item(_templateObject410 || (_templateObject410 = _taggedTemplateLiteral4(["loaf of soda bread"]))), void 0], _ref2 = _slicedToArray5(_ref, 2), bestFuel = _ref2[0], secondBest = _ref2[1], count = Math.ceil(targetUnits / getAverageAdventures(bestFuel)), ceiling = void 0;
    if (secondBest) {
...
init_kolmafia_polyfill();
var import_kolmafia9 = require("kolmafia"), import_isEqual = __toESM(require_isEqual());
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      if (!Object.values(Skills).includes(skill2))
        return !1;
      (0, import_kolmafia9.cliExecute)("terminal educate ".concat(skill2.name.toLowerCase(), ".edu"));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
var pieces = import_kolmafia10.Monster.get(["Witchess Pawn", "Witchess Knight", "Witchess Bishop", "Witchess Rook", "Witchess Queen", "Witchess King", "Witchess Witch", "Witchess Ox"]);
function fightPiece(piece) {
  if (!pieces.includes(piece))
    throw new Error("That is not a valid piece.");
  if (!(0, import_kolmafia10.visitUrl)("campground.php?action=witchess").includes("whichchoice value=1181"))
    throw new Error("Failed to open Witchess.");
  if (!(0, import_kolmafia10.runChoice)(1).includes("whichchoice=1182"))
    throw new Error("Failed to visit shrink ray.");
  if (!(0, import_kolmafia10.visitUrl)("choice.php?option=1&pwd=".concat((0, import_kolmafia10.myHash)(), "&whichchoice=1182&piece=").concat((0, import_kolmafia10.toInt)(piece)), !1).includes(piece.name))
    throw new Error("Failed to start fight.");
  return (0, import_kolmafia10.runCombat)();
}
...
function currentCostumes() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      matcher && returnValue.set((0, import_kolmafia11.toFamiliar)(matcher[3]), [toModifier(matcher[1]), parseInt(matcher[2])]);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
var _templateObject56, _templateObject217, _templateObject313, _templateObject412, _templateObject57, _templateObject64, _templateObject74, _templateObject84, _templateObject95, _templateObject105, _templateObject115;
...
function tryHead(effect) {
  ...
  return getString("_beachHeadsUsed").split(",").includes(headNumber.toString()) ? !1 : ((0, import_kolmafia14.cliExecute)(effect.default), have(effect));
}
...
var _templateObject58, _templateObject218, _templateObject314;
function _taggedTemplateLiteral10(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var passive = $skill(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral10(["Comprehensive Cartography"]))), skill = $skill(_templateObject218 || (_templateObject218 = _taggedTemplateLiteral10(["Map the Monsters"])));
function have7() {
  return have(passive);
}
function mapMonster(location, monster) {
  if (!have7() || get("_monstersMapped") >= 3 || !(0, import_kolmafia15.canAdventure)(location) || ((0, import_kolmafia15.useSkill)($skill(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral10(["Map the Monsters"])))), !get("mappingMonsters")))
    return !1;
...
var _templateObject59, _templateObject219, _templateObject315, _templateObject413, _templateObject510, _templateObject65, _templateObject75, _templateObject85, _templateObject96, _templateObject106, _templateObject116, _templateObject125, _templateObject135;
...
var Heroes = {
  ...
  Skill: $skill(_templateObject219 || (_templateObject219 = _taggedTemplateLiteral11(["Smooch of the Daywalker"])))
}], [["vampire", "kill"], {
...
function set(hero, mode) {
  return have8() ? currentHero() === hero && currentMode() === mode ? !0 : ((0, import_kolmafia16.cliExecute)("retrocape ".concat(hero, " ").concat(mode)), currentHero() === hero && currentMode() === mode) : !1;
}
...
var _templateObject60, _templateObject220;
...
var buffs = $effects(_templateObject220 || (_templateObject220 = _taggedTemplateLiteral12(["Spectacle Moustache, Toiletbrush Moustache, Barbell Moustache, Grizzly Beard, Surrealist's Moustache, Musician's Musician's Moustache, Gull-Wing Moustache, Space Warlord's Beard, Pointy Wizard Beard, Cowboy Stache, Friendly Chops"])));
function hasBuff() {
...
function buffCycle() {
  var playerclass = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia17.myClass)();
  if ((0, import_kolmafia17.toInt)(playerclass) <= 0)
    return [];
  for (var returnValue = [], id = (0, import_kolmafia17.toInt)(playerclass), seed = id > 6 ? id % 6 + 1 : id, i = 1; i < 12; i++) {
    var index = i * seed % 11;
...
function nextBuff() {
  var currentBuff = (0, import_kolmafia17.toEffect)(get("lastBeardBuff").toFixed(0)), cycle = buffCycle(), index = cycle.indexOf(currentBuff), newIndex = (1 + index) % 11;
...
var _templateObject61, _templateObject221, _templateObject316, _templateObject414, _templateObject511, _templateObject66, _templateObject76, _templateObject86, _templateObject97;
function _taggedTemplateLiteral13(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var item5 = import_kolmafia18.Item.get("autumn-aton");
function available() {
  return (0, import_kolmafia18.availableAmount)(item5) > 0;
}
function have10() {
...
var use = function() {
  return (0, import_kolmafia18.visitUrl)("inv_use.php?pwd&whichitem=10954");
};
...
function sendTo(target) {
  ...
  if (!available())
    return null;
  var pageHtml = use();
  upgrade2 && (0, import_kolmafia18.availableChoiceOptions)()[1] && (0, import_kolmafia18.runChoice)(1);
  var locationsAvailable = checkLocations(pageHtml), location = target instanceof import_kolmafia18.Location ? target : Array.isArray(target) ? target.find(function(l) {
    return locationsAvailable.includes(l);
  }) : target(locationsAvailable);
  return !location || !locationsAvailable.includes(location) ? null : ((0, import_kolmafia18.runChoice)(2, "heythereprogrammer=".concat(location.id)), (0, import_kolmafia18.handlingChoice)() && (0, import_kolmafia18.visitUrl)("main.php"), location);
}
function upgrade() {
  use();
  var canUpgrade = (0, import_kolmafia18.availableChoiceOptions)()[1] !== void 0;
  return canUpgrade && (0, import_kolmafia18.runChoice)(1), (0, import_kolmafia18.visitUrl)("main.php"), canUpgrade;
}
function availableLocations() {
  if (!available())
    return [];
  var pageHtml = use();
  return (0, import_kolmafia18.visitUrl)("main.php"), checkLocations(pageHtml);
}
...
var difficulties = ["low", "mid", "high"], UNIQUES = {
  outdoor: {
    ...
    mid: {
      index: 2,
      item: $item(_templateObject221 || (_templateObject221 = _taggedTemplateLiteral13(["autumn debris shield"])))
    },
    high: {
      index: 6,
...
function availableLocketMonsters() {
  return reminiscesLeft() === 0 ? [] : Object.entries((0, import_kolmafia19.getLocketMonsters)()).filter(function(_ref) {
...
function reminiscesLeft() {
  return have11() ? clamp(3 - parseLocketProperty().length, 0, 3) : 0;
}
...
function reminisce(monster) {
  return !have11() || reminiscesLeft() === 0 || !(0, import_kolmafia19.getLocketMonsters)()[monster.name] ? !1 : ((0, import_kolmafia19.cliExecute)("reminisce ".concat(monster)), (0, import_kolmafia19.runCombat)(), monstersReminisced().includes(monster));
}
function findMonster(criteria) {
  var value = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : function() {
    return 1;
  };
  if (!have11() || reminiscesLeft() === 0)
    return null;
...
init_kolmafia_polyfill();
var _templateObject70, _templateObject225, _templateObject318, _templateObject416, _templateObject513, _templateObject610, _templateObject78;
...
init_kolmafia_polyfill();
var _templateObject71, _templateObject226, _templateObject319, _templateObject417, _templateObject514, _templateObject611, _templateObject79;
...
init_kolmafia_polyfill();
var _templateObject80, _templateObject227, _templateObject320;
...
function expected4() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject227 || (_templateObject227 = _taggedTemplateLiteral18(["BRICKO eye brick"]))), eyeChance], [$item(_templateObject320 || (_templateObject320 = _taggedTemplateLiteral18(["BRICKO brick"]))), 3 - eyeChance]]);
}

// node_modules/libram/dist/resources/2011/Gygaxian.js
init_kolmafia_polyfill();
var _templateObject81, _templateObject228, _templateObject321, _templateObject418, _templateObject515, _templateObject612, _templateObject710;
function _taggedTemplateLiteral19(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill5 = $skill(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral19(["Summon Dice"]))), libramChance3 = 1 / 6, libramExpected3 = /* @__PURE__ */ new Map([[$item(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral19(["d4"]))), libramChance3], [$item(_templateObject321 || (_templateObject321 = _taggedTemplateLiteral19(["d6"]))), libramChance3], [$item(_templateObject418 || (_templateObject418 = _taggedTemplateLiteral19(["d8"]))), libramChance3], [$item(_templateObject515 || (_templateObject515 = _taggedTemplateLiteral19(["d10"]))), libramChance3], [$item(_templateObject612 || (_templateObject612 = _taggedTemplateLiteral19(["d12"]))), libramChance3], [$item(_templateObject710 || (_templateObject710 = _taggedTemplateLiteral19(["d20"]))), libramChance3]]);
function have16() {
...
init_kolmafia_polyfill();
var _templateObject89, _templateObject230, _templateObject324, _templateObject420, _templateObject517, _templateObject614, _templateObject712, _templateObject810;
...
function possibleLibramSummons() {
  ...
  return have12() && results.set(summonSkill, expected()), have13() && results.set(summonSkill2, expected2()), have14() && results.set(summonSkill3, expected3()), have15() && results.set(summonSkill4, expected4()), have16() && results.set(summonSkill5, expected5()), have17() && results.set(summonSkill6, expected6()), have18() && results.set(summonSkill7, expected7()), results;
}
...
var clanIdCache = {}, toPlayerId = function(player) {
  ...
  return _createClass5(Clan2, [{
    ...
    value: function() {
      this._check();
      var logs = (0, import_kolmafia20.visitUrl)("clan_log.php"), lastFax = logs.match(LOG_FAX_PATTERN);
      if (!lastFax)
        return null;
    ...
    value: function() {
      ...
      return (0, import_kolmafia20.xpath)(page, '//select[@name="level"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), match = (0, import_kolmafia20.xpath)(validHtml, "//text()")[0].match(WHITELIST_DEGREE_PATTERN), id = (0, import_kolmafia20.xpath)(validHtml, "//@value")[0];
        if (!match || !id)
          return null;
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item6) {
        var needed = Math.max(0, quantity - (0, import_kolmafia20.availableAmount)(item6));
        if (needed === 0)
          return map.set(item6, 0);
        var foldGroup = getFoldGroup(item6), _iterator = _createForOfIteratorHelper6(foldGroup), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            for (var foldable = _step.value, quantityToFold = Math.min(needed, (0, import_kolmafia20.availableAmount)(foldable)), _i3 = 0; _i3 < quantityToFold; _i3++)
              (0, import_kolmafia20.cliExecute)("fold ".concat(item6.name)), needed--;
        ...
        for (var _i2 = 0, _arr2 = [item6].concat(_toConsumableArray5(foldGroup)); _i2 < _arr2.length; _i2++) {
          var matchingItem = _arr2[_i2], quantityToTake = Math.min(needed, (0, import_kolmafia20.stashAmount)(matchingItem));
          if (quantityToTake !== 0) {
            ...
            if (matchingItem === item6)
              ...
              for (var i = 0; i < quantityToTake; i++)
                (0, import_kolmafia20.cliExecute)("fold ".concat(matchingItem.name)), needed--;
          }
        }
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item6) {
        (0, import_kolmafia20.retrieveItem)(quantity, item6);
        var returned = Math.min(quantity, (0, import_kolmafia20.availableAmount)(item6));
        (0, import_kolmafia20.putStash)(returned, item6), map.set(item6, quantity - returned);
      }), Array.isArray(items) ? countedMapToArray(map) : map;
    }
  }, {
    key: "withStash",
    ...
    value: function(clanIdOrName) {
      ...
      } else if (clanId = clanIdOrName, clanId === (0, import_kolmafia20.getClanId)())
        return Clan2.get();
    ...
    value: function() {
      ...
      return (0, import_kolmafia20.xpath)(page, '//select[@name="whichclan"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), id = Number.parseInt((0, import_kolmafia20.xpath)(validHtml, "//@value")[0]), name = (0, import_kolmafia20.xpath)(validHtml, "//text()")[0];
...
var thralls = /* @__PURE__ */ new Map([[$stat(_templateObject90 || (_templateObject90 = _taggedTemplateLiteral22(["muscle"]))), $thrall(_templateObject231 || (_templateObject231 = _taggedTemplateLiteral22(["Elbow Macaroni"])))], [$stat(_templateObject325 || (_templateObject325 = _taggedTemplateLiteral22(["moxie"]))), $thrall(_templateObject421 || (_templateObject421 = _taggedTemplateLiteral22(["Penne Dreadful"])))]]), statCommunityServicePredictor = function(stat) {
  return function() {
    return 60 - Math.floor(1 / 30 * ((0, import_kolmafia21.myBuffedstat)(stat) - (0, import_kolmafia21.myBasestat)(thralls.get(stat) === (0, import_kolmafia21.myThrall)() && !have($effect(_templateObject518 || (_templateObject518 = _taggedTemplateLiteral22(["Expert Oiliness"])))) ? $stat(_templateObject615 || (_templateObject615 = _taggedTemplateLiteral22(["mysticality"]))) : stat)));
  };
  ...
  return _createClass6(CommunityService2, [{
    ...
    value: function(prepare) {
      ...
      var startTime = Date.now(), startTurns = (0, import_kolmafia21.myTurncount)(), additionalTurns;
      try {
        var _prepare;
      ...
      return turns ? turns > Math.min(maxTurns, (0, import_kolmafia21.myAdventures)()) || !this.do() ? "failed" : (CommunityService2.log[this.property] = {
        predictedTurns: prediction + additionalTurns,
        turnCost: (0, import_kolmafia21.myTurncount)() - startTurns,
    ...
    value: function(name, action) {
      var _action, startTime = Date.now(), startTurns = (0, import_kolmafia21.myTurncount)(), estimatedTurns = (_action = action()) !== null && _action !== void 0 ? _action : 0;
...
_defineProperty8(CommunityService, "HP", new CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia21.myMaxhp)() - (0, import_kolmafia21.myBuffedstat)($stat(_templateObject713 || (_templateObject713 = _taggedTemplateLiteral22(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
...
_defineProperty8(CommunityService, "FamiliarWeight", new CommunityService(5, "Familiar Weight", "Breed More Collies", function() {
  return 60 - Math.floor(((0, import_kolmafia21.familiarWeight)((0, import_kolmafia21.myFamiliar)()) + (0, import_kolmafia21.weightAdjustment)()) / 5);
...
_defineProperty8(CommunityService, "WeaponDamage", new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  var weaponPower = (0, import_kolmafia21.getPower)((0, import_kolmafia21.equippedItem)($slot(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral22(["weapon"]))))), offhandPower = (0, import_kolmafia21.toSlot)((0, import_kolmafia21.equippedItem)($slot(_templateObject126 || (_templateObject126 = _taggedTemplateLiteral22(["off-hand"]))))) === $slot(_templateObject136 || (_templateObject136 = _taggedTemplateLiteral22(["weapon"]))) ? (0, import_kolmafia21.getPower)((0, import_kolmafia21.equippedItem)($slot(_templateObject144 || (_templateObject144 = _taggedTemplateLiteral22(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia21.toSlot)((0, import_kolmafia21.equippedItem)($slot(_templateObject154 || (_templateObject154 = _taggedTemplateLiteral22(["familiar"]))))) === $slot(_templateObject164 || (_templateObject164 = _taggedTemplateLiteral22(["weapon"]))) ? (0, import_kolmafia21.getPower)((0, import_kolmafia21.equippedItem)($slot(_templateObject174 || (_templateObject174 = _taggedTemplateLiteral22(["familiar"]))))) : 0, multiplier = have($effect(_templateObject184 || (_templateObject184 = _taggedTemplateLiteral22(["Bow-Legged Swagger"])))) ? 2 : 1;
...
_defineProperty8(CommunityService, "SpellDamage", new CommunityService(7, "Spell Damage", "Make Sausage", function() {
  var dragonfishDamage = (0, import_kolmafia21.myFamiliar)() === $familiar(_templateObject194 || (_templateObject194 = _taggedTemplateLiteral22(["Magic Dragonfish"]))) ? (0, import_kolmafia21.numericModifier)($familiar(_templateObject204 || (_templateObject204 = _taggedTemplateLiteral22(["Magic Dragonfish"]))), "Spell Damage Percent", (0, import_kolmafia21.familiarWeight)($familiar(_templateObject2110 || (_templateObject2110 = _taggedTemplateLiteral22(["Magic Dragonfish"])))) + (0, import_kolmafia21.weightAdjustment)(), $item.none) : 0;
...
_defineProperty8(CommunityService, "BoozeDrop", new CommunityService(9, "Item Drop", "Make Margaritas", function() {
  var mummingCostume = MummingTrunk_exports.currentCostumes().get((0, import_kolmafia21.myFamiliar)()), mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop" ? mummingCostume[1] : 0, familiarItemDrop = (0, import_kolmafia21.numericModifier)((0, import_kolmafia21.myFamiliar)(), "Item Drop", (0, import_kolmafia21.familiarWeight)((0, import_kolmafia21.myFamiliar)()) + (0, import_kolmafia21.weightAdjustment)(), (0, import_kolmafia21.equippedItem)($slot(_templateObject2210 || (_templateObject2210 = _taggedTemplateLiteral22(["familiar"]))))) + mummingBuff - (0, import_kolmafia21.numericModifier)((0, import_kolmafia21.equippedItem)($slot(_templateObject234 || (_templateObject234 = _taggedTemplateLiteral22(["familiar"])))), "Item Drop"), familiarBoozeDrop = (0, import_kolmafia21.numericModifier)((0, import_kolmafia21.myFamiliar)(), "Booze Drop", (0, import_kolmafia21.familiarWeight)((0, import_kolmafia21.myFamiliar)()) + (0, import_kolmafia21.weightAdjustment)(), (0, import_kolmafia21.equippedItem)($slot(_templateObject244 || (_templateObject244 = _taggedTemplateLiteral22(["familiar"]))))) - (0, import_kolmafia21.numericModifier)((0, import_kolmafia21.equippedItem)($slot(_templateObject254 || (_templateObject254 = _taggedTemplateLiteral22(["familiar"])))), "Booze Drop"), multiplier = (0, import_kolmafia21.haveEquipped)($item(_templateObject264 || (_templateObject264 = _taggedTemplateLiteral22(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1;
...
_defineProperty8(CommunityService, "donate", function() {
  visitCouncil(), (0, import_kolmafia21.visitUrl)("choice.php?whichchoice=1089&option=30");
});
...
function get3(counter) {
  var value = (0, import_kolmafia22.getCounter)(counter);
  return value === -1 ? (0, import_kolmafia22.getCounters)(counter, -1, -1).trim() === "" ? 1 / 0 : -1 : value;
}
function exists(counter) {
  return (0, import_kolmafia22.getCounter)(counter) !== -1 || (0, import_kolmafia22.getCounters)(counter, -1, -1).trim() !== "";
}
function set2(counter, duration) {
  return (0, import_kolmafia22.cliExecute)("counters add ".concat(duration, " ").concat(counter)), get3(counter) !== null;
}
...
function sinceKolmafiaRevision(revision) {
  ...
  var currentRevision = (0, import_kolmafia23.getRevision)();
...
var _templateObject91, _templateObject235, _templateObject326, _templateObject422, _templateObject519, _templateObject616, _templateObject714, _templateObject812, _templateObject910, _templateObject109, _templateObject118, _templateObject127, _templateObject137, _templateObject145, _templateObject155, _templateObject165, _templateObject175, _templateObject185, _templateObject195, _templateObject205, _templateObject2111, _templateObject2211, _templateObject236, _templateObject245, _templateObject255, _templateObject265, _templateObject275, _templateObject283, _templateObject293, _templateObject303;
  ...
  return _createClass8(Outfit2, [{
    ...
    value: function(item6, slot) {
      ...
      switch ((0, import_kolmafia26.toSlot)(item6)) {
        case $slot(_templateObject235 || (_templateObject235 = _taggedTemplateLiteral23(["off-hand"]))):
    ...
    value: function(item6, slot) {
      return ![void 0, $slot(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral23(["off-hand"])))].includes(slot) || (0, import_kolmafia26.toSlot)(item6) !== $slot(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral23(["weapon"]))) || this.equips.has($slot(_templateObject127 || (_templateObject127 = _taggedTemplateLiteral23(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral23(["weapon"]))))) !== 1 || this.equips.has($slot(_templateObject145 || (_templateObject145 = _taggedTemplateLiteral23(["off-hand"])))) || !have($skill(_templateObject155 || (_templateObject155 = _taggedTemplateLiteral23(["Double-Fisted Skull Smashing"])))) || weaponHands(item6) !== 1 || !(0, import_kolmafia26.canEquip)(item6) ? !1 : (this.equips.set($slot(_templateObject165 || (_templateObject165 = _taggedTemplateLiteral23(["off-hand"]))), item6), !0);
    }
  }, {
    key: "getHoldingFamiliar",
    value: function(item6) {
      switch ((0, import_kolmafia26.toSlot)(item6)) {
        case $slot(_templateObject175 || (_templateObject175 = _taggedTemplateLiteral23(["weapon"]))):
          return $familiar(_templateObject185 || (_templateObject185 = _taggedTemplateLiteral23(["Disembodied Hand"])));
        case $slot(_templateObject195 || (_templateObject195 = _taggedTemplateLiteral23(["off-hand"]))):
          return $familiar(_templateObject205 || (_templateObject205 = _taggedTemplateLiteral23(["Left-Hand Man"])));
        default:
          return;
      }
    }
    ...
    value: function(item6, slot) {
      ...
      return familiar === void 0 || !this.equip(familiar) ? !1 : (this.equips.set($slot(_templateObject236 || (_templateObject236 = _taggedTemplateLiteral23(["familiar"]))), item6), !0);
    }
  }, {
    key: "equipItem",
    value: function(item6, slot) {
...
var _templateObject101, _templateObject237, _templateObject327, _templateObject423, _templateObject520, _templateObject617, _templateObject715, _templateObject813, _templateObject911, _templateObject1010, _templateObject119;
...
var _templateObject814, _templateObject912, _templateObject1011, _templateObject1110, _templateObject128, _templateObject138, _templateObject146, _templateObject156, _templateObject166, _templateObject176, _templateObject186, _templateObject196, _templateObject206, _templateObject2112, _templateObject2212, _templateObject238, _templateObject246, _templateObject256, _templateObject266, _templateObject276, _templateObject284, _templateObject294, _templateObject304, _templateObject3110, _templateObject328, _templateObject333, _templateObject343, _templateObject353, _templateObject362, _templateObject372, _templateObject382, _templateObject392, _templateObject402, _templateObject4110, _templateObject424, _templateObject432, _templateObject442, _templateObject452, _templateObject462, _templateObject472, _templateObject482, _templateObject492, _templateObject502, _templateObject5110, _templateObject522, _templateObject532, _templateObject542, _templateObject552, _templateObject562, _templateObject572, _templateObject582, _templateObject592;
...
var SYNTH_PAIRS = [[$item(_templateObject814 || (_templateObject814 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject912 || (_templateObject912 = _taggedTemplateLiteral26(["Crimbo fudge"])))], [$item(_templateObject1011 || (_templateObject1011 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject1110 || (_templateObject1110 = _taggedTemplateLiteral26(["bag of many confections"])))], [$item(_templateObject128 || (_templateObject128 = _taggedTemplateLiteral26(["Crimbo peppermint bark"]))), $item(_templateObject138 || (_templateObject138 = _taggedTemplateLiteral26(["Crimbo candied pecan"])))], [$item(_templateObject146 || (_templateObject146 = _taggedTemplateLiteral26(["Crimbo peppermint bark"]))), $item(_templateObject156 || (_templateObject156 = _taggedTemplateLiteral26(["peppermint sprout"])))], [$item(_templateObject166 || (_templateObject166 = _taggedTemplateLiteral26(["Crimbo candied pecan"]))), $item(_templateObject176 || (_templateObject176 = _taggedTemplateLiteral26(["peppermint crook"])))]];
function synthExp() {
  (0, import_kolmafia29.getCampground)()["Peppermint Pip Packet"] && (0, import_kolmafia29.visitUrl)("campground.php?action=garden"), get("_candySummons") || (0, import_kolmafia29.useSkill)(1, $skill(_templateObject186 || (_templateObject186 = _taggedTemplateLiteral26(["Summon Crimbo Candy"]))));
  var _iterator = _createForOfIteratorHelper11(SYNTH_PAIRS), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var _step$value = _slicedToArray10(_step.value, 2), candy1 = _step$value[0], candy2 = _step$value[1], enough = candy1 === candy2 ? have(candy1, 2) : have(candy1) && (0, import_kolmafia29.retrieveItem)(candy2);
...
function ensureMp(mp) {
  if (!((0, import_kolmafia29.myMp)() > mp)) {
    ...
    for (; have($item(_templateObject196 || (_templateObject196 = _taggedTemplateLiteral26(["magical sausage"])))) || have($item(_templateObject206 || (_templateObject206 = _taggedTemplateLiteral26(["magical sausage casing"])))) && (0, import_kolmafia29.myMp)() < mp && get("_sausagesEaten") < 23; )
    ...
    for (; have($item(_templateObject238 || (_templateObject238 = _taggedTemplateLiteral26(["psychokinetic energy blob"])))) && (0, import_kolmafia29.myMp)() < mp; )
  ...
  if ($skills(_templateObject304 || (_templateObject304 = _taggedTemplateLiteral26(["Summon BRICKOs, Summon Taffy, Summon Love Song, Summon Candy Heart"]))).some(function(skill2) {
    ...
    for (; canCastLibrams(); )
      if (testsDone.includes("Breed More Collies")) {
        ...
        if (have($skill(_templateObject3110 || (_templateObject3110 = _taggedTemplateLiteral26(["Summon Candy Heart"])))) && totalDuration($item(_templateObject328 || (_templateObject328 = _taggedTemplateLiteral26(["green candy heart"])))) <= 0) {
          var _libramPossibilities$, _libramPossibilities$2, probability = (_libramPossibilities$ = (_libramPossibilities$2 = libramPossibilities.get($skill(_templateObject333 || (_templateObject333 = _taggedTemplateLiteral26(["Summon Candy Heart"]))))) === null || _libramPossibilities$2 === void 0 ? void 0 : _libramPossibilities$2.get($item(_templateObject343 || (_templateObject343 = _taggedTemplateLiteral26(["green candy heart"]))))) !== null && _libramPossibilities$ !== void 0 ? _libramPossibilities$ : 0;
          decisionMap.set($skill(_templateObject353 || (_templateObject353 = _taggedTemplateLiteral26(["Summon Candy Heart"]))), 3 * probability);
        }
        if (have($skill(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral26(["Summon Taffy"])))) && totalDuration($item(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral26(["pulled blue taffy"])))) < 50) {
          var _libramPossibilities$3, _libramPossibilities$4, _probability = (_libramPossibilities$3 = (_libramPossibilities$4 = libramPossibilities.get($skill(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral26(["Summon Taffy"]))))) === null || _libramPossibilities$4 === void 0 ? void 0 : _libramPossibilities$4.get($item(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral26(["pulled blue taffy"]))))) !== null && _libramPossibilities$3 !== void 0 ? _libramPossibilities$3 : 0;
          decisionMap.set($skill(_templateObject402 || (_templateObject402 = _taggedTemplateLiteral26(["Summon Taffy"]))), 1 * _probability);
        }
        if (have($skill(_templateObject4110 || (_templateObject4110 = _taggedTemplateLiteral26(["Summon Love Song"])))) && totalDuration($item(_templateObject424 || (_templateObject424 = _taggedTemplateLiteral26(["love song of icy revenge"])))) < 20) {
          var _libramPossibilities$5, _libramPossibilities$6, _probability2 = (_libramPossibilities$5 = (_libramPossibilities$6 = libramPossibilities.get($skill(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral26(["Summon Love Song"]))))) === null || _libramPossibilities$6 === void 0 ? void 0 : _libramPossibilities$6.get($item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral26(["love song of icy revenge"]))))) !== null && _libramPossibilities$5 !== void 0 ? _libramPossibilities$5 : 0, currentWeightValue = clamp(Math.ceil(totalDuration($item(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral26(["love song of icy revenge"])))) / 2), 0, 10), newWeightValue = clamp(Math.ceil((totalDuration($item(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral26(["love song of icy revenge"])))) + 5) / 2), 0, 10);
          decisionMap.set($skill(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral26(["Summon Love Song"]))), _probability2 * (newWeightValue - currentWeightValue));
        }
        if (have($skill(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral26(["Summon BRICKOs"])))) && get("_brickoEyeSummons") < 3 && testsDone.includes("Donate Blood")) {
          var _libramPossibilities$7, _libramPossibilities$8, _probability3 = (_libramPossibilities$7 = (_libramPossibilities$8 = libramPossibilities.get($skill(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral26(["Summon BRICKOs"]))))) === null || _libramPossibilities$8 === void 0 ? void 0 : _libramPossibilities$8.get($item(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral26(["BRICKO eye brick"]))))) !== null && _libramPossibilities$7 !== void 0 ? _libramPossibilities$7 : 0;
...
var _templateObject110, _templateObject239, _templateObject329, _templateObject425, _templateObject521, _templateObject618, _templateObject716, _templateObject815, _templateObject913, _templateObject1012, _templateObject1111, _templateObject129, _templateObject139, _templateObject147, _templateObject157, _templateObject167, _templateObject177, _templateObject187, _templateObject197, _templateObject207, _templateObject2113, _templateObject2213, _templateObject2310;
...
var DEFAULT_UNIFORM = function() {
  return {
    ...
    shirt: $items(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral27(["Jurassic Parka, fresh coat of paint"]))),
    pants: $items(_templateObject329 || (_templateObject329 = _taggedTemplateLiteral27(["designer sweatpants, old sweatpants"]))),
    weapon: get("_juneCleaverFightsLeft") > 0 && get("_juneCleaverEncounters") < 2 ? $item(_templateObject425 || (_templateObject425 = _taggedTemplateLiteral27(["June cleaver"]))) : $item(_templateObject521 || (_templateObject521 = _taggedTemplateLiteral27(["Fourth of May Cosplay Saber"]))),
  ...
  familiar: $familiar(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral27(["Stocking Mimic"]))),
  famequip: $item.none,
  condition: function() {
    return !get("_bagOfCandy");
  }
}, {
  familiar: $familiar(_templateObject139 || (_templateObject139 = _taggedTemplateLiteral27(["Melodramedary"]))),
  famequip: $item(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral27(["dromedary drinking helmet"]))),
  condition: function() {
    return get("camelSpit") < 100 && !have($effect(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral27(["Spit Upon"]))));
  }
}, {
  familiar: $familiar(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral27(["Shorter-Order Cook"]))),
  condition: function() {
    return $familiar(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral27(["Shorter-Order Cook"]))).dropsToday < 1;
  }
}, {
  familiar: $familiar(_templateObject187 || (_templateObject187 = _taggedTemplateLiteral27(["Garbage Fire"]))),
  condition: function() {
    return $familiar(_templateObject197 || (_templateObject197 = _taggedTemplateLiteral27(["Garbage Fire"]))).dropsToday < 1;
  }
}];
function chooseFamiliar(canAttack) {
  ...
  if (pick) {
    var _pick$famequip;
    return {
      famequip: (_pick$famequip = pick.famequip) !== null && _pick$famequip !== void 0 ? _pick$famequip : $item(_templateObject207 || (_templateObject207 = _taggedTemplateLiteral27(["tiny stillsuit"]))),
      familiar: pick.familiar
    };
  }
  return {
    famequip: $item(_templateObject2113 || (_templateObject2113 = _taggedTemplateLiteral27(["tiny stillsuit"]))),
    familiar: $familiar(_templateObject2213 || (_templateObject2213 = _taggedTemplateLiteral27(["Puck Man"])))
  };
}
var DEFAULT_OPTIONS = {
  changes: {},
...
function uniform() {
  ...
  return "familiar" in changes && !("famequip" in changes) && (changes.famequip = $item(_templateObject2310 || (_templateObject2310 = _taggedTemplateLiteral27(["tiny stillsuit"])))), _objectSpread6(_objectSpread6(_objectSpread6({}, DEFAULT_UNIFORM()), chooseFamiliar(canAttack)), changes);
}
  ...
  return {
    ...
    do: function() {
      return Clan.with(get("phccs_elfClan", "Hobopolis Vacation Home"), function() {
        (0, import_kolmafia31.adv1)($location(_templateObject240 || (_templateObject240 = _taggedTemplateLiteral28(["The Slime Tube"]))), -1, "");
      });
    },
    outfit: function() {
      return uniform({
        changes: {
          acc3: $item(_templateObject330 || (_templateObject330 = _taggedTemplateLiteral28(["Kremlin's Greatest Briefcase"]))),
          familiar: $familiar(_templateObject426 || (_templateObject426 = _taggedTemplateLiteral28(["Machine Elf"])))
        }
      });
    },
...
function commonFamiliarWeightBuffs() {
  var buffs5 = $effects(_templateObject1310 || (_templateObject1310 = _taggedTemplateLiteral28(["Empathy, Leash of Linguini, Blood Bond"])));
  return [potionTask($item(_templateObject148 || (_templateObject148 = _taggedTemplateLiteral28(["green candy heart"]))))].concat(_toConsumableArray9(buffs5.map(skillTask)), [restore(buffs5), {
    name: "Witchess",
    completed: function() {
  ...
  }, beachTask($effect(_templateObject158 || (_templateObject158 = _taggedTemplateLiteral28(["Do I Know You From Somewhere?"]))))]);
}
...
function asdonTask(style) {
  ...
  return {
    ...
    do: function() {
      (0, import_kolmafia31.getFuel)() < 37 && ((0, import_kolmafia31.buy)(1, $item(_templateObject168 || (_templateObject168 = _taggedTemplateLiteral28(["all-purpose flower"])))), (0, import_kolmafia31.use)(1, $item(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral28(["all-purpose flower"])))), (0, import_kolmafia31.buy)((0, import_kolmafia31.availableAmount)($item(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral28(["wad of dough"])))), $item(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral28(["soda water"])))), (0, import_kolmafia31.create)((0, import_kolmafia31.availableAmount)($item(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral28(["wad of dough"])))), $item(_templateObject2114 || (_templateObject2114 = _taggedTemplateLiteral28(["loaf of soda bread"])))), (0, import_kolmafia31.cliExecute)("asdonmartin fuel ".concat((0, import_kolmafia31.availableAmount)($item(_templateObject2214 || (_templateObject2214 = _taggedTemplateLiteral28(["loaf of soda bread"])))), " soda bread"))), AsdonMartin_exports.drive(effect);
    }
  };
}
...
function meteorShower() {
  return {
    ...
    do: function() {
      (0, import_kolmafia31.adv1)($location(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral28(["The Dire Warren"]))), -1, ""), (0, import_kolmafia31.handlingChoice)() && (0, import_kolmafia31.runChoice)(-1);
    },
    outfit: function() {
      return uniform({
        changes: {
...
var BoozeDrop = {
  ...
  outfit: function() {
    return have($item(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral29(["wad of used tape"])))) || (0, import_kolmafia32.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject241 || (_templateObject241 = _taggedTemplateLiteral29(["wad of used tape"]))),
      weapon: $items(_templateObject331 || (_templateObject331 = _taggedTemplateLiteral29(["extra-large utility candle, Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject427 || (_templateObject427 = _taggedTemplateLiteral29(["unbreakable umbrella"]))),
  ...
  tasks: [{
    ...
    do: $location(_templateObject1211 || (_templateObject1211 = _taggedTemplateLiteral29(["The Dire Warren"]))),
    outfit: function() {
      return uniform({
        changes: {
          back: $item(_templateObject1311 || (_templateObject1311 = _taggedTemplateLiteral29(["vampyric cloake"]))),
          offhand: $item(_templateObject149 || (_templateObject149 = _taggedTemplateLiteral29(["latte lovers member's mug"])))
        },
        canAttack: !1
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral29(["Become a Bat"])))).skill($skill(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral29(["Throw Latte on Opponent"]))));
    })
  }, songTask($effect(_templateObject179 || (_templateObject179 = _taggedTemplateLiteral29(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject189 || (_templateObject189 = _taggedTemplateLiteral29(["Ode to Booze"])))), {
    name: "Items.enh",
    completed: function() {
      return have($effect(_templateObject199 || (_templateObject199 = _taggedTemplateLiteral29(["items.enh"]))));
    },
    do: function() {
      return SourceTerminal_exports.enhance($effect(_templateObject209 || (_templateObject209 = _taggedTemplateLiteral29(["items.enh"]))));
    }
    ...
    name: "Unlock Beach",
    ready: function() {
      return have($item(_templateObject248 || (_templateObject248 = _taggedTemplateLiteral29(["government cheese"]))));
    },
    completed: function() {
    ...
    completed: function() {
      return have($effect(_templateObject3111 || (_templateObject3111 = _taggedTemplateLiteral29(["I See Everything Thrice!"]))));
    },
    do: function() {
      return (0, import_kolmafia32.create)(1, $item(_templateObject3210 || (_templateObject3210 = _taggedTemplateLiteral29(["government"])))) && (0, import_kolmafia32.use)(1, $item(_templateObject334 || (_templateObject334 = _taggedTemplateLiteral29(["government"]))));
    }
  }, {
    name: "Pray",
    ready: function() {
      return (0, import_kolmafia32.myClass)() === $class(_templateObject344 || (_templateObject344 = _taggedTemplateLiteral29(["Pastamancer"])));
    },
    completed: function() {
  ...
  }].concat(_toConsumableArray10($items(_templateObject354 || (_templateObject354 = _taggedTemplateLiteral29(["Salsa Caliente\u2122 candle, lavender candy heart, bag of grain, emergency glowstick"]))).map(potionTask)), [{
    name: "Steely-Eyed Squint",
    completed: function() {
      return have($effect(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral29(["Steely-Eyed Squint"]))));
    },
    do: function() {
      return (0, import_kolmafia32.useSkill)($skill(_templateObject373 || (_templateObject373 = _taggedTemplateLiteral29(["Steely-Eyed Squint"]))));
    }
  }, {
    name: "Feel Lost",
    completed: function() {
      return have($effect(_templateObject383 || (_templateObject383 = _taggedTemplateLiteral29(["Feeling Lost"]))));
    },
    do: function() {
      return (0, import_kolmafia32.useSkill)($skill(_templateObject393 || (_templateObject393 = _taggedTemplateLiteral29(["Feel Lost"]))));
    }
  }])
...
var _templateObject121, _templateObject249, _templateObject335, _templateObject428, _templateObject525, _templateObject621, _templateObject719, _templateObject818, _templateObject916, _templateObject1015, _templateObject1114, _templateObject1212, _templateObject1312, _templateObject1410;
...
var CoilWire = {
  ...
  tasks: [{
    ...
    do: function() {
      (0, import_kolmafia33.adv1)($location(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral30(["Noob Cave"]))), -1, ""), have($item(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral30(["magical sausage casing"])))) && (0, import_kolmafia33.create)(1, $item(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral30(["magical sausage"])))), (0, import_kolmafia33.eat)(1, $item(_templateObject428 || (_templateObject428 = _taggedTemplateLiteral30(["magical sausage"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
  ...
  outfit: function() {
    return {
      ...
      acc1: $item(_templateObject1212 || (_templateObject1212 = _taggedTemplateLiteral30(["Eight Days a Week Pill Keeper"]))),
      acc2: $item(_templateObject1312 || (_templateObject1312 = _taggedTemplateLiteral30(["Powerful Glove"]))),
      acc3: $item(_templateObject1410 || (_templateObject1410 = _taggedTemplateLiteral30(["Guzzlr tablet"])))
    };
  }
...
var _templateObject130, _templateObject250, _templateObject336, _templateObject429, _templateObject526, _templateObject622;
...
var Drink = {
  ...
  tasks: [{
    ...
    do: function() {
      return (0, import_kolmafia34.use)($item(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral31(["astral six-pack"]))));
    }
  }, songTask($effect(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral31(["Ode to Booze"]))), $effect(_templateObject429 || (_templateObject429 = _taggedTemplateLiteral31(["The Magical Mojomuscular Melody"])))), {
    name: "Drink Pilsners",
    ready: function() {
...
var _templateObject131, _templateObject251, _templateObject337, _templateObject430, _templateObject527, _templateObject623, _templateObject720, _templateObject819, _templateObject917, _templateObject1016, _templateObject1115;
...
var GLOBAL_TASKS = [{
  ...
  do: function() {
    return withProperty("recoveryScript", "", function() {
      (0, import_kolmafia35.adv1)($location(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral32(["Noob Cave"]))), -1, ""), get("lastEncounter") === "Poetic Justice" && (0, import_kolmafia35.useSkill)($skill(_templateObject337 || (_templateObject337 = _taggedTemplateLiteral32(["Tongue of the Walrus"]))));
    });
  },
  outfit: {
  ...
  return _createClass11(CSEngine2, [{
      ...
      try {
        var result = loggingFunction(function() {
          if (_this.run(), _this.csOptions.type === "SERVICE") {
            var outfit2 = new Outfit();
            if (outfit2.equip(_this.csOptions.outfit()))
              outfit2.dress();
            else
              throw new Error("Failed to equip outfit for ".concat(_this.name));
            burnLibrams();
          }
          return _this.turns;
    ...
    value: function() {
      ...
      try {
        ...
        CSEngine2.core === "soft" && (CommunityService.donate(), uneffect($effect(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral33(["Feeling Lost"]))))), CSEngine2.propertyManager.resetAll(), CommunityService.printLog(HIGHLIGHT);
      }
    }
  }]), CSEngine2;
}(Engine);
...
var _templateObject141, _templateObject260, _templateObject338, _templateObject431, _templateObject528, _templateObject624, _templateObject721, _templateObject820, _templateObject918, _templateObject1017, _templateObject1116, _templateObject1213, _templateObject1313, _templateObject1411, _templateObject1510, _templateObject1610, _templateObject1710, _templateObject1810, _templateObject1910, _templateObject2010, _templateObject2116, _templateObject2216, _templateObject2313, _templateObject2410, _templateObject2510, _templateObject269, _templateObject279, _templateObject287, _templateObject296, _templateObject306, _templateObject3112, _templateObject3211, _templateObject339, _templateObject345, _templateObject355, _templateObject364, _templateObject374, _templateObject384, _templateObject394, _templateObject403, _templateObject4111, _templateObject4210, _templateObject433, _templateObject443, _templateObject453, _templateObject463;
...
var FamiliarWeight = {
  ...
  outfit: function() {
    return {
      ...
      weapon: $item(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral34(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject338 || (_templateObject338 = _taggedTemplateLiteral34(["burning paper crane, familiar scrapbook"]))),
      pants: $items(_templateObject431 || (_templateObject431 = _taggedTemplateLiteral34(["repaid diaper, Great Wolf's beastly trousers, designer sweatpants"]))),
  ...
  turnsSpent: 0,
  maxTurns: 30,
  tasks: [].concat(_toConsumableArray12(commonFamiliarWeightBuffs()), [{
    name: "Moveable Feast",
    core: "soft",
    completed: function() {
    ...
    ready: function() {
      return have($item(_templateObject1017 || (_templateObject1017 = _taggedTemplateLiteral34(["moveable feast"]))));
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral34(["moveable feast"]))));
    },
    outfit: {
      familiar: $familiar(_templateObject1213 || (_templateObject1213 = _taggedTemplateLiteral34(["Mini-Trainbot"])))
    }
  }, {
    name: "Get Yule Battery",
    completed: function() {
      return have($item(_templateObject1313 || (_templateObject1313 = _taggedTemplateLiteral34(["overloaded Yule battery"]))));
    },
    do: function() {
      have($item(_templateObject1411 || (_templateObject1411 = _taggedTemplateLiteral34(["box of Familiar Jacks"])))) || (0, import_kolmafia37.create)($item(_templateObject1510 || (_templateObject1510 = _taggedTemplateLiteral34(["box of Familiar Jacks"])))), (0, import_kolmafia37.use)($item(_templateObject1610 || (_templateObject1610 = _taggedTemplateLiteral34(["box of Familiar Jacks"]))));
    },
    outfit: {
      familiar: $familiar(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral34(["Mini-Trainbot"])))
    }
  }, {
    name: "Paper Crane",
    completed: function() {
      return have($item(_templateObject1810 || (_templateObject1810 = _taggedTemplateLiteral34(["burning paper crane"]))));
    },
    do: function() {
      return (0, import_kolmafia37.create)($item(_templateObject1910 || (_templateObject1910 = _taggedTemplateLiteral34(["burning paper crane"]))));
    },
    ready: function() {
      return have($item(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral34(["burning newspaper"]))));
    }
  }, {
    name: "Shorty Fights (Witchess)",
    completed: function() {
      return $familiar(_templateObject2116 || (_templateObject2116 = _taggedTemplateLiteral34(["Shorter-Order Cook"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 11 - get("_shortOrderCookCharge") && 5 > Witchess_exports.fightsDone();
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral34(["Witchess Bishop"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral34(["Shorter-Order Cook"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return $familiar(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral34(["Shorter-Order Cook"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 11 - get("_shortOrderCookCharge") && have($item(_templateObject2510 || (_templateObject2510 = _taggedTemplateLiteral34(["BRICKO eye brick"]))));
    },
    do: function() {
      have($item(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral34(["BRICKO ooze"])))) || (0, import_kolmafia37.create)($item(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.use)($item(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.runCombat)();
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral34(["Shorter-Order Cook"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return $familiar(_templateObject306 || (_templateObject306 = _taggedTemplateLiteral34(["Garbage Fire"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 30 - get("garbageFireProgress") && 5 > Witchess_exports.fightsDone();
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral34(["Witchess Bishop"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral34(["Garbage Fire"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return $familiar(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral34(["Garbage Fire"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 30 - get("garbageFireProgress") && have($item(_templateObject345 || (_templateObject345 = _taggedTemplateLiteral34(["BRICKO eye brick"]))));
    },
    do: function() {
      have($item(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral34(["BRICKO ooze"])))) || (0, import_kolmafia37.create)($item(_templateObject364 || (_templateObject364 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.use)($item(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.runCombat)();
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject384 || (_templateObject384 = _taggedTemplateLiteral34(["Garbage Fire"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    name: "Icy Revenge",
    ready: function() {
      return have($item(_templateObject394 || (_templateObject394 = _taggedTemplateLiteral34(["love song of icy revenge"]))));
    },
    completed: function() {
      return have($effect(_templateObject403 || (_templateObject403 = _taggedTemplateLiteral34(["Cold Hearted"]))), 20);
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject4111 || (_templateObject4111 = _taggedTemplateLiteral34(["love song of icy revenge"]))));
    }
  }, {
    name: "Blue Taffy",
    ready: function() {
      return have($item(_templateObject4210 || (_templateObject4210 = _taggedTemplateLiteral34(["pulled blue taffy"]))));
    },
    completed: function() {
      return have($effect(_templateObject433 || (_templateObject433 = _taggedTemplateLiteral34(["Blue Swayed"]))), 50);
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject443 || (_templateObject443 = _taggedTemplateLiteral34(["pulled blue taffy"]))));
    }
  }, {
    name: "Tune Moon",
    ready: function() {
    ...
    do: function() {
      unequip($item(_templateObject453 || (_templateObject453 = _taggedTemplateLiteral34(["hewn moon-rune spoon"])))), (0, import_kolmafia37.visitUrl)("inv_use.php?whichitem=10254&pwd&doit=96&whichsign=4");
    },
    core: "soft"
  }, meteorShower(), potionTask($item(_templateObject463 || (_templateObject463 = _taggedTemplateLiteral34(["silver face paint"]))))])
...
var buffs2 = $effects(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral35(["Elemental Saucesphere, Astral Shell"]))), HotRes = {
  ...
  outfit: function() {
    return {
      hat: $item(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral35(["Daylight Shavings Helmet"]))),
      shirt: $items(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral35(["Jurassic Parka, denim jacket"]))),
      back: $item(_templateObject434 || (_templateObject434 = _taggedTemplateLiteral35(["unwrapped knock-off retro superhero cape"]))),
      ...
      famequip: $item(_templateObject1214 || (_templateObject1214 = _taggedTemplateLiteral35(["tiny stillsuit"]))),
      modes: {
        parka: "ghostasaurus",
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray13(buffs2.map(skillTask)), [restore(buffs2)], _toConsumableArray13(commonFamiliarWeightBuffs()), [beachTask($effect(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral35(["Hot-Headed"])))), beachTask($effect(_templateObject1412 || (_templateObject1412 = _taggedTemplateLiteral35(["Does It Have a Skull In There??"])))), asdonTask("Safely"), {
    name: "Extinguisher",
    completed: function() {
      return have($effect(_templateObject1511 || (_templateObject1511 = _taggedTemplateLiteral35(["Fireproof Foam Suit"]))));
    },
    ready: function() {
      return get("_saberForceUses") < 5;
    },
    do: function() {
      (0, import_kolmafia38.adv1)($location(_templateObject1611 || (_templateObject1611 = _taggedTemplateLiteral35(["The Dire Warren"]))), -1, ""), (0, import_kolmafia38.handlingChoice)() && (0, import_kolmafia38.runChoice)(-1);
    },
    ...
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar.none,
          famequip: $item.none,
          weapon: $item(_templateObject1711 || (_templateObject1711 = _taggedTemplateLiteral35(["Fourth of May Cosplay Saber"]))),
          offhand: $item(_templateObject1811 || (_templateObject1811 = _taggedTemplateLiteral35(["industrial fire extinguisher"])))
        }
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject1911 || (_templateObject1911 = _taggedTemplateLiteral35(["Fire Extinguisher: Foam Yourself"])))).skill($skill(_templateObject2011 || (_templateObject2011 = _taggedTemplateLiteral35(["Use the Force"]))));
    }),
    post: function() {
    ...
    do: function() {
      ...
      ensureMp(100), (0, import_kolmafia38.useSkill)(1, $skill(_templateObject2411 || (_templateObject2411 = _taggedTemplateLiteral35(["Deep Dark Visions"]))));
    },
    outfit: {
      ...
      acc1: $item(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral35(["your cowboy boots"]))),
      acc2: $item(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral35(["Beach Comb"]))),
      acc3: $item(_templateObject3310 || (_templateObject3310 = _taggedTemplateLiteral35(["Brutal brogues"]))),
      familiar: $familiar(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral35(["Exotic Parrot"]))),
      famequip: $item(_templateObject356 || (_templateObject356 = _taggedTemplateLiteral35(["tiny stillsuit"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["vampire", "hold"]
      }
    ...
    completed: function() {
      return have($item(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral35(["meteorite guard"]))));
    },
    ready: function() {
...
var _templateObject151, _templateObject270, _templateObject341, _templateObject435, _templateObject530, _templateObject626, _templateObject723, _templateObject822, _templateObject920, _templateObject1019, _templateObject1118, _templateObject1215, _templateObject1315, _templateObject1413, _templateObject1512, _templateObject1612, _templateObject1712, _templateObject1812, _templateObject1912, _templateObject2012, _templateObject2118, _templateObject2218, _templateObject2315, _templateObject2412, _templateObject2512, _templateObject2611, _templateObject2711, _templateObject289, _templateObject298, _templateObject308, _templateObject3114, _templateObject3213, _templateObject3311, _templateObject347, _templateObject357, _templateObject366, _templateObject376, _templateObject386, _templateObject395, _templateObject404, _templateObject4112, _templateObject4211, _templateObject436, _templateObject444, _templateObject454, _templateObject464, _templateObject473, _templateObject483, _templateObject493, _templateObject503, _templateObject5111, _templateObject5210, _templateObject533, _templateObject543, _templateObject553, _templateObject563, _templateObject573, _templateObject583, _templateObject593, _templateObject602, _templateObject6110, _templateObject627, _templateObject632, _templateObject642, _templateObject652, _templateObject662, _templateObject672, _templateObject682, _templateObject692, _templateObject702, _templateObject7110, _templateObject724, _templateObject732, _templateObject742, _templateObject752, _templateObject762, _templateObject772, _templateObject782, _templateObject792, _templateObject802, _templateObject8110, _templateObject823, _templateObject832, _templateObject842, _templateObject852, _templateObject862, _templateObject872, _templateObject882, _templateObject892, _templateObject902, _templateObject9110, _templateObject922, _templateObject932, _templateObject942, _templateObject952, _templateObject962, _templateObject972, _templateObject982, _templateObject992, _templateObject1002, _templateObject10110, _templateObject1022, _templateObject1032, _templateObject1042, _templateObject1052, _templateObject1062, _templateObject1072, _templateObject1082, _templateObject1092, _templateObject1102, _templateObject1119, _templateObject1122, _templateObject1132, _templateObject1142, _templateObject1152, _templateObject1162;
...
var levellingComplete = (0, import_kolmafia39.myLevel)() >= 13 && get("_neverendingPartyFreeTurns") >= 10, lovePotionConsidered = !1, foldshirt = function() {
  ...
  return _objectSpread7(_objectSpread7({}, task), {}, {
    outfit: function() {
      return uniform({
        changes: {
          offhand: $item(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral36(["Abracandalabra"])))
        }
      });
    }
  });
  ...
  completed: function() {
    return !have($item(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral36(["psychokinetic energy blob"]))));
  },
  mp: 30,
  do: function() {
  ...
  tasks: [innerElf(), {
    ...
    effects: $effects(_templateObject1215 || (_templateObject1215 = _taggedTemplateLiteral36(["Inscrutable Gaze, Thaumodynamic"]))),
    do: function() {
      return (0, import_kolmafia39.use)(1, $item(_templateObject1315 || (_templateObject1315 = _taggedTemplateLiteral36(["a ten-percent bonus"]))));
    }
  }, {
    name: "Bastille",
    completed: function() {
    ...
    completed: function() {
      return $skill(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral36(["Love Mixology"]))).timescast > 0;
    },
    do: function() {
      return (0, import_kolmafia39.useSkill)(1, $skill(_templateObject1512 || (_templateObject1512 = _taggedTemplateLiteral36(["Love Mixology"]))));
    }
  }, {
    ...
    do: function() {
      return (0, import_kolmafia39.useSkill)($skill(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral36(["Visit your Favorite Bird"]))));
    }
  }, {
    name: "Vaccine",
    completed: function() {
  ...
  }, beachTask($effect(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral36(["You Learned Something Maybe!"])))), beachTask($effect(_templateObject1812 || (_templateObject1812 = _taggedTemplateLiteral36(["We're All Made of Starfish"])))), {
    name: "Smile of Lyle",
    completed: function() {
    ...
    completed: function() {
      return have($effect(_templateObject1912 || (_templateObject1912 = _taggedTemplateLiteral36(["Glittering Eyelashes"]))));
    },
    do: function() {
      var mascara = $item(_templateObject2012 || (_templateObject2012 = _taggedTemplateLiteral36(["glittery mascara"])));
    ...
    do: function() {
      return (0, import_kolmafia39.useSkill)($skill(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral36(["Feel Excitement"]))));
    }
  }, {
    name: "Misc Items",
    completed: function() {
    ...
    do: function() {
      return $items(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral36(["turtle totem, saucepan"]))).forEach(function(i) {
  ...
  }].concat(_toConsumableArray14(CastSkills), _toConsumableArray14(Recovery), [
    {
      ...
      do: function() {
        have($item(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral36(["Dramatic\u2122 range"])))) || (0, import_kolmafia39.buy)(1, $item(_templateObject3311 || (_templateObject3311 = _taggedTemplateLiteral36(["Dramatic\u2122 range"])))), (0, import_kolmafia39.use)(1, $item(_templateObject347 || (_templateObject347 = _taggedTemplateLiteral36(["Dramatic\u2122 range"]))));
      }
    },
    {
      name: "Make & Use Ointment",
      completed: function() {
        return have($effect(_templateObject357 || (_templateObject357 = _taggedTemplateLiteral36(["Mystically Oiled"]))));
      },
      ready: function() {
        return have($item(_templateObject366 || (_templateObject366 = _taggedTemplateLiteral36(["grapefruit"]))));
      },
      do: function() {
        have($item(_templateObject376 || (_templateObject376 = _taggedTemplateLiteral36(["ointment of the occult"])))) || (0, import_kolmafia39.create)(1, $item(_templateObject386 || (_templateObject386 = _taggedTemplateLiteral36(["ointment of the occult"])))), have($item(_templateObject395 || (_templateObject395 = _taggedTemplateLiteral36(["ointment of the occult"])))) && (0, import_kolmafia39.use)(1, $item(_templateObject404 || (_templateObject404 = _taggedTemplateLiteral36(["ointment of the occult"]))));
      }
    },
    {
      name: "Set Snojo",
    ...
    },
    {
      name: "Holiday Yoked",
      completed: function() {
        return have($effect(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral36(["Holiday Yoked"]))));
      },
      do: $location(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral36(["The X-32-F Combat Training Snowman"]))),
      outfit: function() {
        return uniform({
          changes: {
            familiar: $familiar(_templateObject436 || (_templateObject436 = _taggedTemplateLiteral36(["Ghost of Crimbo Carols"]))),
            famequip: $item.none
          }
        });
      },
    ...
    // It happens in globaltasks.ts
    {
      name: "Map Ninja",
      completed: function() {
        return have($item(_templateObject483 || (_templateObject483 = _taggedTemplateLiteral36(["li'l ninja costume"]))));
      },
      do: function() {
        Cartography_exports.mapMonster($location(_templateObject493 || (_templateObject493 = _taggedTemplateLiteral36(["The Haiku Dungeon"]))), $monster(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral36(["amateur ninja"]))));
      },
      combat: new CSStrategy(function() {
    ...
    },
    {
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_("monstername LOV enforcer", Macro2.attack().repeat()).if_("monstername LOV Engineer", Macro2.candyblast().trySkillRepeat($skill(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral36(["Weapon of the Pastalord"]))))).if_("monstername LOV equivocator", Macro2.delevel().easyFight().candyblast().defaultKill());
      }),
      post: function() {
        (0, import_kolmafia39.use)(1, $item(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral36(["LOV Extraterrestrial Chocolate"])))), burnLibrams();
      }
    },
    {
      name: "Snojo",
      ...
      outfit: uniform,
      do: $location(_templateObject732 || (_templateObject732 = _taggedTemplateLiteral36(["The X-32-F Combat Training Snowman"]))),
      combat: new CSStrategy(function() {
    ...
    },
    {
      ...
      completed: function() {
        return $effects(_templateObject742 || (_templateObject742 = _taggedTemplateLiteral36(["Snowballed, Half-Blooded, Half-Drained, Bruised, Relaxed Muscles, Hypnotized, Bad Haircut"]))).every(function(effect) {
          return !have(effect);
        });
      },
      do: function() {
    ...
    },
    {
      ...
      do: function() {
        return withProperties({
          ...
          try {
            (0, import_kolmafia39.useSkill)($skill(_templateObject752 || (_templateObject752 = _taggedTemplateLiteral36(["Evoke Eldritch Horror"])))), (0, import_kolmafia39.runCombat)();
          } catch (e) {
            (0, import_kolmafia39.print)("".concat(e));
          } finally {
            have($effect(_templateObject762 || (_templateObject762 = _taggedTemplateLiteral36(["Beaten Up"])))) && (0, import_kolmafia39.cliExecute)("hottub");
          }
        });
      },
      outfit: uniform,
    ...
    },
    {
      ...
      outfit: function() {
        var _find, gear = (_find = $items(_templateObject772 || (_templateObject772 = _taggedTemplateLiteral36(["God Lobster's Crown, God Lobster's Robe, God Lobster's Rod, God Lobster's Ring, God Lobster's Scepter"]))).find(function(it) {
          return have(it);
        })) !== null && _find !== void 0 ? _find : $item(_templateObject782 || (_templateObject782 = _taggedTemplateLiteral36(["tiny stillsuit"])));
        return uniform({
          changes: {
            familiar: $familiar(_templateObject792 || (_templateObject792 = _taggedTemplateLiteral36(["God Lobster"]))),
            famequip: gear
          }
        });
      },
      choices: _defineProperty15({}, 1310, 3),
    ...
    },
    {
      ...
      outfit: function() {
        return uniform({
          changes: {
            offhand: $item(_templateObject802 || (_templateObject802 = _taggedTemplateLiteral36(["familiar scrapbook"])))
          }
        });
      },
      do: function() {
    ...
    },
    {
      ...
      do: $location(_templateObject8110 || (_templateObject8110 = _taggedTemplateLiteral36(["The Deep Machine Tunnels"]))),
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            shirt: $item(_templateObject823 || (_templateObject823 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            familiar: $familiar(_templateObject832 || (_templateObject832 = _taggedTemplateLiteral36(["Machine Elf"])))
          }
        });
      },
      combat: new CSStrategy()
    },
    {
      name: "Queen",
      completed: function() {
        return have($item(_templateObject842 || (_templateObject842 = _taggedTemplateLiteral36(["very pointy crown"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject852 || (_templateObject852 = _taggedTemplateLiteral36(["Witchess Queen"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject862 || (_templateObject862 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject872 || (_templateObject872 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject882 || (_templateObject882 = _taggedTemplateLiteral36(["familiar scrapbook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
        return Macro2.tryItem($item(_templateObject892 || (_templateObject892 = _taggedTemplateLiteral36(["jam band bootleg"])))).tryItem($item(_templateObject902 || (_templateObject902 = _taggedTemplateLiteral36(["gas can"])))).tryItem($item(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral36(["Time-Spinner"])))).attack().repeat();
      }),
      prepare: function() {
        (0, import_kolmafia39.useSkill)($skill(_templateObject922 || (_templateObject922 = _taggedTemplateLiteral36(["Cannelloni Cocoon"]))));
      }
    },
    {
      name: "King",
      completed: function() {
        return have($item(_templateObject932 || (_templateObject932 = _taggedTemplateLiteral36(["dented scepter"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject942 || (_templateObject942 = _taggedTemplateLiteral36(["Witchess King"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject952 || (_templateObject952 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject962 || (_templateObject962 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject972 || (_templateObject972 = _taggedTemplateLiteral36(["familiar scrapbook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
      ...
      prepare: function() {
        (0, import_kolmafia39.useSkill)($skill(_templateObject982 || (_templateObject982 = _taggedTemplateLiteral36(["Cannelloni Cocoon"]))));
      }
    },
    {
      name: "NEP Quest",
    ...
    },
    {
      ...
      do: $location(_templateObject992 || (_templateObject992 = _taggedTemplateLiteral36(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var enoughSausages = get("_sausageFights") > 4, changes = _objectSpread7({
          shirt: $items(_templateObject1002 || (_templateObject1002 = _taggedTemplateLiteral36(["makeshift garbage shirt"])))
        }, enoughSausages ? {} : {
          offhand: $item(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral36(["Kramco Sausage-o-Matic\u2122"])))
        });
        return uniform({
          changes: changes
        });
      ...
      combat: new CSStrategy(function() {
        return Macro2.delevel().if_($effect(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral36(["Inner Elf"]))), Macro2.trySkill($skill(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral36(["Feel Pride"]))))).trySkill($skill(_templateObject1042 || (_templateObject1042 = _taggedTemplateLiteral36(["Bowl Sideways"])))).defaultKill();
      })
    },
    {
      name: "Freekill NEP",
      completed: function() {
        return get("_shatteringPunchUsed") >= 3 && get("_gingerbreadMobHitUsed") && have($effect(_templateObject1052 || (_templateObject1052 = _taggedTemplateLiteral36(["Everything Looks Yellow"])))) && get("_chestXRayUsed") >= 3;
      },
      do: $location(_templateObject1062 || (_templateObject1062 = _taggedTemplateLiteral36(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var killSource = have($effect(_templateObject1072 || (_templateObject1072 = _taggedTemplateLiteral36(["Everything Looks Yellow"])))) ? get("_chestXRayUsed") < 3 ? {
          acc3: $item(_templateObject1092 || (_templateObject1092 = _taggedTemplateLiteral36(["Lil' Doctor\u2122 bag"])))
        } : {} : {
          shirt: $item(_templateObject1082 || (_templateObject1082 = _taggedTemplateLiteral36(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
        }, enoughSausages = get("_sausageFights") > 4, changes = _objectSpread7(_objectSpread7({
          shirt: $items(_templateObject1102 || (_templateObject1102 = _taggedTemplateLiteral36(["makeshift garbage shirt"])))
        }, killSource), enoughSausages ? {} : {
          offhand: $item(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral36(["Kramco Sausage-o-Matic\u2122"])))
        });
        return uniform({
          changes: changes
        });
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral36(["sausage goblin"]))), Macro2.defaultKill()).trySkill($skill(_templateObject1132 || (_templateObject1132 = _taggedTemplateLiteral36(["Spit jurassic acid"])))).trySkill($skill(_templateObject1142 || (_templateObject1142 = _taggedTemplateLiteral36(["Chest X-Ray"])))).trySkill($skill(_templateObject1152 || (_templateObject1152 = _taggedTemplateLiteral36(["Shattering Punch"])))).trySkill($skill(_templateObject1162 || (_templateObject1162 = _taggedTemplateLiteral36(["Gingerbread Mob Hit"])))).abort();
      })
    }
  ])
}, level_default = Level;
...
var Noncombat = {
  ...
  outfit: function() {
    return {
      ...
      back: $item(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral37(["protonic accelerator pack"]))),
      weapon: $item(_templateObject348 || (_templateObject348 = _taggedTemplateLiteral37(["Fourth of May Cosplay Saber"]))),
      shirt: $item(_templateObject437 || (_templateObject437 = _taggedTemplateLiteral37(["Jurassic Parka"]))),
  ...
  tasks: [{
    ...
    completed: function() {
      return have($effect(_templateObject1216 || (_templateObject1216 = _taggedTemplateLiteral37(["Invisible Avatar"]))));
    },
    do: function() {
      return (0, import_kolmafia40.useSkill)($skill(_templateObject1316 || (_templateObject1316 = _taggedTemplateLiteral37(["CHEAT CODE: Invisible Avatar"]))));
    },
    outfit: {
      acc3: $item(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral37(["Powerful Glove"])))
    }
  }, skillTask($effect(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral37(["Blessing of the Bird"])))), {
    name: "Favourite Bird",
    completed: function() {
      return get("_favoriteBirdVisited");
    },
    ...
    do: function() {
      return (0, import_kolmafia40.useSkill)($skill(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral37(["Visit your Favorite Bird"]))));
    }
  }, songTask($effect(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral37(["The Sonata of Sneakiness"]))), $effect(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral37(["Fat Leon's Phat Loot Lyric"])))), restore($effects(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral37(["Smooth Movements, The Sonata of Sneakiness"])))), {
    name: "Swim Sprints",
    completed: function() {
...
var PULLS = [$items(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral38(["repaid diaper, Great Wolf's beastly trousers"]))), $items(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral38(["meteorite necklace, meteorite ring, meteorite fragment, meteorite earring"]))), $items(_templateObject349 || (_templateObject349 = _taggedTemplateLiteral38(["Stick-Knife of Loathing"]))), $items(_templateObject438 || (_templateObject438 = _taggedTemplateLiteral38(["moveable feast"])))], codpieceAttempted = !1, MARKET_QUESTS = [{
  ...
  tasks: [{
    ...
    do: function() {
      (0, import_kolmafia41.cliExecute)("cheat forest; cheat island; cheat 1952"), (0, import_kolmafia41.autosell)(1, $item(_templateObject1121 || (_templateObject1121 = _taggedTemplateLiteral38(["1952 Mickey Mantle card"])))), (0, import_kolmafia41.useSkill)(1, $skill(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral38(["Ancestral Recall"]))));
    }
  }, {
    name: "Juice Bar",
    completed: function() {
    ...
    do: function() {
      (0, import_kolmafia41.visitUrl)("place.php?whichplace=chateau&action=chateau_desk2"), (0, import_kolmafia41.autosell)(1, $item(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral38(["gremlin juice"]))));
    }
  }, {
    name: "Vote!",
    completed: function() {
      return have($item(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral38(['"I Voted!" sticker']))));
    },
    do: function() {
    ...
    completed: function() {
      return SourceTerminal_exports.getSkills().every(function(skill2) {
        return $skills(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral38(["Extract, Portscan"]))).includes(skill2);
      }) && !!SourceTerminal_exports.getSkills().length;
    },
    do: function() {
      return SourceTerminal_exports.educate([$skill(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral38(["Extract"]))), $skill(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral38(["Portscan"])))]);
    }
  }, {
    name: "Change Clan",
    completed: function() {
    ...
    name: "Toot",
    completed: function() {
      return have($item(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral38(["big rock"]))));
    },
    do: function() {
      (0, import_kolmafia41.visitUrl)("tutorial.php?action=toot"), tryUse(1, $item(_templateObject1914 || (_templateObject1914 = _taggedTemplateLiteral38(["letter from King Ralph XI"])))), tryUse(1, $item(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral38(["pork elf goodies sack"])))), (0, import_kolmafia41.autosell)(5, $item(_templateObject2119 || (_templateObject2119 = _taggedTemplateLiteral38(["baconstone"])))), (0, import_kolmafia41.autosell)(5, $item(_templateObject2219 || (_templateObject2219 = _taggedTemplateLiteral38(["hamethyst"]))));
    }
  }, {
    name: "Accordion",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia41.buy)(1, $item(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral38(["toy accordion"]))));
    }
  }, {
    ...
    ready: function() {
      return have($skill(_templateObject3115 || (_templateObject3115 = _taggedTemplateLiteral38(["Summon Alice's Army Cards"]))));
    },
    do: function() {
      (0, import_kolmafia41.useSkill)(1, $skill(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral38(["Summon Alice's Army Cards"])))), !have($item(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral38(["tobiko marble soda"])))) && !CommunityService.SpellDamage.isDone() && (0, import_kolmafia41.buy)($coinmaster(_templateObject3410 || (_templateObject3410 = _taggedTemplateLiteral38(["Game Shoppe Snacks"]))), 1, $item(_templateObject358 || (_templateObject358 = _taggedTemplateLiteral38(["tobiko marble soda"]))));
    }
  }, {
    name: "Drinking Helmet",
    completed: function() {
      return have($item(_templateObject367 || (_templateObject367 = _taggedTemplateLiteral38(["dromedary drinking helmet"]))));
    },
    do: function() {
      (0, import_kolmafia41.useFamiliar)($familiar(_templateObject377 || (_templateObject377 = _taggedTemplateLiteral38(["Melodramedary"])))), have($item(_templateObject387 || (_templateObject387 = _taggedTemplateLiteral38(["box of Familiar Jacks"])))) || (0, import_kolmafia41.create)(1, $item(_templateObject396 || (_templateObject396 = _taggedTemplateLiteral38(["box of Familiar Jacks"])))), (0, import_kolmafia41.use)(1, $item(_templateObject405 || (_templateObject405 = _taggedTemplateLiteral38(["box of Familiar Jacks"]))));
    }
  }, {
    name: "Mummery",
    completed: function() {
    ...
    do: function() {
      (0, import_kolmafia41.useFamiliar)($familiar(_templateObject4113 || (_templateObject4113 = _taggedTemplateLiteral38(["Melodramedary"])))), (0, import_kolmafia41.cliExecute)("mummery myst");
    }
  }, {
    name: "Shortsuit",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia41.equip)($familiar(_templateObject439 || (_templateObject439 = _taggedTemplateLiteral38(["Shorter-Order Cook"]))), $item(_templateObject445 || (_templateObject445 = _taggedTemplateLiteral38(["tiny stillsuit"]))));
    }
  }, {
    name: "Horsery",
    completed: function() {
    ...
    name: "Cowboy Boots",
    completed: function() {
      return have($item(_templateObject455 || (_templateObject455 = _taggedTemplateLiteral38(["your cowboy boots"]))));
    },
    do: function() {
    ...
    completed: function() {
      return have($item(_templateObject465 || (_templateObject465 = _taggedTemplateLiteral38(["gold detective badge"]))));
    },
    do: function() {
    ...
    name: "Codpiece",
    completed: function() {
      return have($item(_templateObject474 || (_templateObject474 = _taggedTemplateLiteral38(["codpiece"])))) || codpieceAttempted;
    },
    do: function() {
      Clan.with("Alliance From Heck", function() {
    ...
    do: function() {
      return (0, import_kolmafia41.use)($item(_templateObject484 || (_templateObject484 = _taggedTemplateLiteral38(["Bird-a-Day calendar"]))));
    }
  }])
...
var _templateObject170, _templateObject281, _templateObject350, _templateObject440, _templateObject535, _templateObject630, _templateObject727, _templateObject826, _templateObject924, _templateObject1023, _templateObject1123, _templateObject1218, _templateObject1318, _templateObject1416, _templateObject1515, _templateObject1615, _templateObject1715, _templateObject1815, _templateObject1915, _templateObject2014, _templateObject2120, _templateObject2220, _templateObject2317, _templateObject2414, _templateObject2514, _templateObject2613, _templateObject2713, _templateObject2811, _templateObject2910, _templateObject3010, _templateObject3116, _templateObject3215, _templateObject3313, _templateObject3411, _templateObject359, _templateObject368, _templateObject378, _templateObject388;
...
var buffs3 = $effects(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral39(["Carol of the Hells, Arched Eyebrow of the Archmage, Song of Sauce"]))), chefstaves = $items(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral39(["Staff of the Roaring Hearth, Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist, Staff of the Roaring Hearth"]))), Spell = {
  name: "Spell Damage",
  type: "SERVICE",
  test: CommunityService.SpellDamage,
  outfit: function() {
    return _objectSpread8({
      hat: $items(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral39(["astral chapeau, Hollandaise helmet"]))),
      weapon: CSEngine.core === "soft" ? chefstaves : $item(_templateObject440 || (_templateObject440 = _taggedTemplateLiteral39(["weeping willow wand"]))),
      ...
      familiar: $familiar(_templateObject1218 || (_templateObject1218 = _taggedTemplateLiteral39(["Left-Hand Man"]))),
      equipment: $item(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral39(["astral statuette"])))
    });
  },
  turnsSpent: 1,
  maxTurns: 30,
  tasks: [skillTask($skill(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral39(["Simmer"])))), potionTask($item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral39(["tobiko marble soda"])))), songTask($effect(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral39(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral39(["The Sonata of Sneakiness"]))))].concat(_toConsumableArray17(buffs3.map(skillTask)), [restore(buffs3), beachTask($effect(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral39(["We're All Made of Starfish"])))), potionTask($item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral39(["LOV Elixir #6"])))), {
    name: "Cargopocket",
    completed: function() {
      return get("_cargoPocketEmptied");
    },
    ready: function() {
      return $items(_templateObject2014 || (_templateObject2014 = _taggedTemplateLiteral39(["sizzling desk bell, frost-rimed desk bell, uncanny desk bell, nasty desk bell, greasy desk bell"]))).every(function(item6) {
  ...
  }, potionTask($item(_templateObject2120 || (_templateObject2120 = _taggedTemplateLiteral39(["Yeg's Motel hand soap"])))), {
    name: "Briefcase",
    core: "hard",
    completed: function() {
      return (0, import_kolmafia42.numericModifier)($item(_templateObject2220 || (_templateObject2220 = _taggedTemplateLiteral39(["Kremlin's Greatest Briefcase"]))), "Spell Damage Percent") > 0;
    },
    do: function() {
    ...
    name: "Mariachi Hat",
    completed: function() {
      return have($item(_templateObject2317 || (_templateObject2317 = _taggedTemplateLiteral39(["mariachi hat"]))));
    },
    do: function() {
      return (0, import_kolmafia42.retrieveItem)($item(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral39(["mariachi hat"]))));
    }
  }, {
    name: "Tea Party",
    completed: function() {
    ...
    prepare: function() {
      (0, import_kolmafia42.visitUrl)("clan_viplounge.php?action=lookingglass&whichfloor=2"), (0, import_kolmafia42.use)($item(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral39(['"DRINK ME" potion']))));
    }
  }, skillTask($skill(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral39(["Spirit of Cayenne"])))), potionTask($item(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral39(["flask of baconstone juice"])))), {
    name: "Saucefingers",
    ready: function() {
      return (0, import_kolmafia42.myLevel)() >= 15 && have($familiar(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral39(["Mini-Adventurer"]))));
    },
    completed: function() {
      return have($effect(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral39(["Saucefingers"]))));
    },
    do: $location(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral39(["The Dire Warren"]))),
    prepare: function() {
      return horsery() === "pale" && horse("dark");
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject3116 || (_templateObject3116 = _taggedTemplateLiteral39(["Mini-Adventurer"])))
        }
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject3215 || (_templateObject3215 = _taggedTemplateLiteral39(["Asdon Martin: Spring-Loaded Front Bumper"])))).skill($skill(_templateObject3313 || (_templateObject3313 = _taggedTemplateLiteral39(["Feel Hatred"]))));
    }),
    choices: _defineProperty16({}, 768, 4)
  }, innerElf(), meteorShower(), {
    name: "Meteorite Necklace",
    core: "soft",
    completed: function() {
      return have($item(_templateObject3411 || (_templateObject3411 = _taggedTemplateLiteral39(["meteorite necklace"]))));
    },
    ready: function() {
      return (0, import_kolmafia42.canadiaAvailable)();
    },
    do: function() {
      var meteor = $items(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral39(["meteorite ring, meteorite fragment, meteorite earring"]))).find(function(item6) {
        return have(item6);
      });
      meteor && (unequip(meteor), (0, import_kolmafia42.retrieveItem)(1, $item(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral39(["tenderizing hammer"])))), (0, import_kolmafia42.retrieveItem)(1, $item(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral39(["jewelry-making pliers"])))), (0, import_kolmafia42.cliExecute)("smash ".concat(meteor)), (0, import_kolmafia42.cliExecute)("make ".concat($item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral39(["meteorite necklace"]))))));
    }
  }, {
    name: "Pull Staff",
    completed: function() {
...
var _templateObject171, _templateObject290, _templateObject351, _templateObject441, _templateObject536, _templateObject631, _templateObject728, _templateObject827, _templateObject925, _templateObject1024, _templateObject1124, _templateObject1219, _templateObject1319, _templateObject1417, _templateObject1516, _templateObject1616, _templateObject1716, _templateObject1816, _templateObject1916, _templateObject2015, _templateObject2121, _templateObject2221, _templateObject2318, _templateObject2415, _templateObject2515, _templateObject2614, _templateObject2714, _templateObject2812, _templateObject2911, _templateObject3011, _templateObject3117, _templateObject3216, _templateObject3314, _templateObject3412, _templateObject3510, _templateObject369, _templateObject379, _templateObject389, _templateObject397, _templateObject406, _templateObject4114, _templateObject4213, _templateObject4310, _templateObject446, _templateObject456, _templateObject466, _templateObject475, _templateObject485, _templateObject494, _templateObject504, _templateObject5112, _templateObject5211, _templateObject537, _templateObject544, _templateObject554, _templateObject564, _templateObject574, _templateObject584, _templateObject594;
...
var SKILL_BUFFS = {
  ...
  MYSTICALITY: $effects(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral40(["Feeling Excited, Big, Song of Bravado"]))),
  MOXIE: $effects(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral40(["Feeling Excited, Big, Song of Bravado, Blessing of the Bird, Quiet Desperation, Disco Fever, Blubbered Up, Mariachi Mood, Disco State of Mind"]))),
  HP: $effects(_templateObject441 || (_templateObject441 = _taggedTemplateLiteral40(["Feeling Excited, Big, Song of Starch, Rage of the Reindeer, Quiet Determination, Disdain of the War Snapper"])))
};
...
var Muscle = {
  ...
  outfit: function() {
    return have($item(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      ...
      acc1: $item(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral40(["Brutal brogues"]))),
      acc2: CSEngine.core === "soft" ? $item(_templateObject1319 || (_templateObject1319 = _taggedTemplateLiteral40(["meteorite necklace"]))) : $item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral40(["Retrospecs"]))),
      acc3: $item(_templateObject1516 || (_templateObject1516 = _taggedTemplateLiteral40(["Kremlin's Greatest Briefcase"]))),
      familiar: $familiar(_templateObject1616 || (_templateObject1616 = _taggedTemplateLiteral40(["Left-Hand Man"]))),
      modes: {
        retrocape: ["vampire", RetroCape_exports.currentMode()],
        parka: "dilophosaur",
        umbrella: "broken"
      },
      famequip: $item(_templateObject1716 || (_templateObject1716 = _taggedTemplateLiteral40(["unbreakable umbrella"])))
    };
  },
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MUSCLE")), [potionTask($item(_templateObject1816 || (_templateObject1816 = _taggedTemplateLiteral40(["LOV Elixir #3"])))), thrallTask($thrall(_templateObject1916 || (_templateObject1916 = _taggedTemplateLiteral40(["Elbow Macaroni"]))))])
}, Mysticality = {
  name: "Mysticality",
  type: "SERVICE",
  test: CommunityService.Mysticality,
  outfit: function() {
    return have($item(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject2121 || (_templateObject2121 = _taggedTemplateLiteral40(["wad of used tape"]))),
      weapon: $item(_templateObject2221 || (_templateObject2221 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject2318 || (_templateObject2318 = _taggedTemplateLiteral40(["astral statuette, industrial fire extinguisher"]))),
      back: $item(_templateObject2415 || (_templateObject2415 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      shirt: $items(_templateObject2515 || (_templateObject2515 = _taggedTemplateLiteral40(["denim jacket, shoe ad T-shirt, fresh coat of paint"]))),
      pants: $item(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral40(["designer sweatpants"]))),
      acc1: $item(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral40(["your cowboy boots"]))),
      acc2: $item(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral40(["codpiece"]))),
      acc3: $item(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral40(["battle broom"]))),
      famequip: $items(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral40(["Abracandalabra"]))),
      familiar: $familiar(_templateObject3117 || (_templateObject3117 = _taggedTemplateLiteral40(["Left-Hand Man"]))),
      modes: {
        retrocape: ["vampire", RetroCape_exports.currentMode()]
      }
    };
  ...
  outfit: function() {
    return {
      hat: $item(_templateObject3216 || (_templateObject3216 = _taggedTemplateLiteral40(["very pointy crown"]))),
      shirt: $item(_templateObject3314 || (_templateObject3314 = _taggedTemplateLiteral40(["Jurassic Parka"]))),
      back: $item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      weapon: $item(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject369 || (_templateObject369 = _taggedTemplateLiteral40(["unbreakable umbrella"]))),
      pants: $item(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral40(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject389 || (_templateObject389 = _taggedTemplateLiteral40(["Beach Comb"]))),
      acc2: $item(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral40(['"I Voted!" sticker']))),
      acc3: $item(_templateObject406 || (_templateObject406 = _taggedTemplateLiteral40(["Retrospecs"]))),
      famequip: $item(_templateObject4114 || (_templateObject4114 = _taggedTemplateLiteral40(["miniature crystal ball"]))),
      modes: {
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MOXIE")), _toConsumableArray18($items(_templateObject4213 || (_templateObject4213 = _taggedTemplateLiteral40(["runproof mascara, confiscated love note, dollop of barbecue sauce"]))).map(potionTask)), [{
    name: "Rhinestones",
    completed: function() {
      return !have($item(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral40(["rhinestone"]))));
    },
    do: function() {
      return (0, import_kolmafia43.use)((0, import_kolmafia43.itemAmount)($item(_templateObject446 || (_templateObject446 = _taggedTemplateLiteral40(["rhinestone"])))), $item(_templateObject456 || (_templateObject456 = _taggedTemplateLiteral40(["rhinestone"]))));
    }
  }, thrallTask($thrall(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral40(["Penne Dreadful"]))))])
}, Hitpoints = {
  name: "Hitpoints",
  type: "SERVICE",
  ...
  maxTurns: 1,
  outfit: function() {
    return have($item(_templateObject475 || (_templateObject475 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject485 || (_templateObject485 = _taggedTemplateLiteral40(["wad of used tape"]))),
      weapon: $item(_templateObject494 || (_templateObject494 = _taggedTemplateLiteral40(["dented scepter"]))),
      offhand: $item(_templateObject504 || (_templateObject504 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      shirt: $items(_templateObject5112 || (_templateObject5112 = _taggedTemplateLiteral40(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
      back: $item(_templateObject5211 || (_templateObject5211 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      pants: $item(_templateObject537 || (_templateObject537 = _taggedTemplateLiteral40(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject544 || (_templateObject544 = _taggedTemplateLiteral40(["Brutal brogues"]))),
      acc2: $item(_templateObject554 || (_templateObject554 = _taggedTemplateLiteral40(["Retrospecs"]))),
      acc3: $item(_templateObject564 || (_templateObject564 = _taggedTemplateLiteral40(["Kremlin's Greatest Briefcase"]))),
      famequip: $item(_templateObject574 || (_templateObject574 = _taggedTemplateLiteral40(["miniature crystal ball"]))),
      modes: {
        retrocape: ["vampire", RetroCape_exports.currentMode()],
        parka: "kachungasaur"
      }
  ...
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("HP")), [potionTask($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral40(["LOV Elixir #3"])))), thrallTask($thrall(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral40(["Elbow Macaroni"]))))])
};

// src/weapon.ts
init_kolmafia_polyfill();
var import_kolmafia44 = require("kolmafia");
var _templateObject180, _templateObject291, _templateObject360, _templateObject447, _templateObject538, _templateObject633, _templateObject729, _templateObject828, _templateObject926, _templateObject1025, _templateObject1125, _templateObject1220, _templateObject1320, _templateObject1418, _templateObject1517, _templateObject1617, _templateObject1717, _templateObject1817, _templateObject1917, _templateObject2016, _templateObject2122, _templateObject2222, _templateObject2319, _templateObject2416, _templateObject2516, _templateObject2615, _templateObject2715, _templateObject2813, _templateObject2912, _templateObject3012, _templateObject3118, _templateObject3217, _templateObject3315, _templateObject3413, _templateObject3511, _templateObject3610, _templateObject3710, _templateObject3810, _templateObject398;
...
var buffs4 = $effects(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral41(["Carol of the Bulls, Song of the North, Rage of the Reindeer, Scowl of the Auk, Disdain of the War Snapper, Tenacity of the Snapper, Blessing of the Bird"]))), meteors, Weapon = {
  ...
  outfit: function() {
    return have($item(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral41(["broken champagne bottle"])))) || (0, import_kolmafia44.cliExecute)("fold broken champagne bottle"), _objectSpread9({
      hat: $items(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral41(["seal-skull helmet, Iunion Crown"]))),
      weapon: $item(_templateObject447 || (_templateObject447 = _taggedTemplateLiteral41(["broken champagne bottle"]))),
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray19(buffs4.map(skillTask)), [restore(buffs4), skillTask($effect(_templateObject1125 || (_templateObject1125 = _taggedTemplateLiteral41(["Frenzied, Bloody"])))), potionTask($item(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral41(["LOV Elixir #3"])))), potionTask($item(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral41(["vial of hamethyst juice"])))), beachTask($effect(_templateObject1418 || (_templateObject1418 = _taggedTemplateLiteral41(["Lack of Body-Building"])))), songTask($effect(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral41(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject1617 || (_templateObject1617 = _taggedTemplateLiteral41(["The Sonata of Sneakiness"])))), {
    name: "Play Pool",
    completed: function() {
      return have($effect(_templateObject1717 || (_templateObject1717 = _taggedTemplateLiteral41(["Billiards Belligerence"]))));
    },
    do: function() {
    ...
    completed: function() {
      return have($effect(_templateObject1817 || (_templateObject1817 = _taggedTemplateLiteral41(["Do You Crush What I Crush?"]))));
    },
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral41(["Asdon Martin: Spring-Loaded Front Bumper"])))).trySkill($skill(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral41(["Feel Hatred"]))));
    })
  }, _objectSpread9(_objectSpread9({}, innerElf()), {}, {
    core: "hard"
  }), {
    name: "Spit Ungulith",
    completed: function() {
      return have($effect(_templateObject2319 || (_templateObject2319 = _taggedTemplateLiteral41(["Spit Upon"]))));
    },
    ready: function() {
      return get("camelSpit") >= 100;
    },
    do: function() {
      meteors = get("_meteorShowerUses"), CombatLoversLocket_exports.reminisce($monster(_templateObject2416 || (_templateObject2416 = _taggedTemplateLiteral41(["ungulith"])))), (0, import_kolmafia44.handlingChoice)() && (0, import_kolmafia44.runChoice)(-1);
    },
    choices: _defineProperty17({}, 1387, 3),
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject2516 || (_templateObject2516 = _taggedTemplateLiteral41(["Melodramedary"]))),
          weapon: $item(_templateObject2615 || (_templateObject2615 = _taggedTemplateLiteral41(["Fourth of May Cosplay Saber"])))
        }
      });
    },
    post: function() {
      have($effect(_templateObject2715 || (_templateObject2715 = _taggedTemplateLiteral41(["Spit Upon"])))) && _set("camelSpit", 0), meteors && have($effect(_templateObject2813 || (_templateObject2813 = _taggedTemplateLiteral41(["Meteor Showered"])))) && _set("_meteorShowerUses", meteors + 1);
      var ungId = $monster(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral41(["ungulith"]))).id.toFixed(0), locketIdStrings = get("_locketMonstersFought").split(",").map(function(x) {
        return x.trim();
      }).filter(function(x) {
        return x.length > 0;
      });
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject3012 || (_templateObject3012 = _taggedTemplateLiteral41(["%fn, spit on me!"])))).trySkill($skill(_templateObject3118 || (_templateObject3118 = _taggedTemplateLiteral41(["Meteor Shower"])))).skill($skill(_templateObject3217 || (_templateObject3217 = _taggedTemplateLiteral41(["Use the Force"]))));
    })
  }, {
    name: "Meteorite Ring",
    core: "soft",
    completed: function() {
      return have($item(_templateObject3315 || (_templateObject3315 = _taggedTemplateLiteral41(["meteorite ring"]))));
    },
    ready: function() {
      return (0, import_kolmafia44.canadiaAvailable)();
    },
    do: function() {
      var meteor = $items(_templateObject3413 || (_templateObject3413 = _taggedTemplateLiteral41(["meteorite necklace, meteorite fragment, meteorite earring"]))).find(function(item6) {
        return have(item6);
      });
      meteor && (unequip(meteor), (0, import_kolmafia44.retrieveItem)(1, $item(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral41(["tenderizing hammer"])))), (0, import_kolmafia44.retrieveItem)(1, $item(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral41(["jewelry-making pliers"])))), (0, import_kolmafia44.cliExecute)("smash ".concat(meteor)), (0, import_kolmafia44.cliExecute)("make ".concat($item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral41(["meteorite ring"]))))));
    }
  }, potionTask($item(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral41(["corrupted marrow"])))), {
    name: "Swagger",
    completed: function() {
      return get("_bowleggedSwaggerUsed");
    },
    do: function() {
      return (0, import_kolmafia44.useSkill)($skill(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral41(["Bow-Legged Swagger"]))));
    }
  }])
