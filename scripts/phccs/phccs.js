...
function NEP() {
  ...
  uniform(template_string_$item(level_templateObject118 || (level_templateObject118 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))), template_string_$item(level_templateObject119 || (level_templateObject119 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
  useDefaultFamiliar();
  advMacroAA($location(level_templateObject120 || (level_templateObject120 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.delevel().if_($effect(level_templateObject121 || (level_templateObject121 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill($skill(level_templateObject122 || (level_templateObject122 = level_taggedTemplateLiteral(["Feel Pride"]))))).defaultKill(), () => {
    return property_get("_neverendingPartyFreeTurns") < 10;
  }, () => {
    useDefaultFamiliar();
    heal();

    if (property_get("_sausageFights") > 4 && (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(level_templateObject123 || (level_templateObject123 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject124 || (level_templateObject124 = level_taggedTemplateLiteral(["off-hand"]))), template_string_$item(level_templateObject125 || (level_templateObject125 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    }
  ...
  advMacroAA($location(level_templateObject127 || (level_templateObject127 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject128 || (level_templateObject128 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill($skill(level_templateObject129 || (level_templateObject129 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill($skill(level_templateObject130 || (level_templateObject130 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill($skill(level_templateObject131 || (level_templateObject131 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill($skill(level_templateObject132 || (level_templateObject132 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill().repeat()), () => {
    return property_get("_shatteringPunchUsed") < 3 && !property_get("_gingerbreadMobHitUsed");
  }, () => {
    heal();
    useDefaultFamiliar();

    if (property_get("_sausageFights") > 4 && (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(level_templateObject133 || (level_templateObject133 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject134 || (level_templateObject134 = level_taggedTemplateLiteral(["off-hand"]))), template_string_$item(level_templateObject135 || (level_templateObject135 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    }
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject137 || (level_templateObject137 = level_taggedTemplateLiteral(["acc3"]))), template_string_$item(level_templateObject138 || (level_templateObject138 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  advMacroAA($location(level_templateObject139 || (level_templateObject139 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject140 || (level_templateObject140 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill($skill(level_templateObject141 || (level_templateObject141 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill($skill(level_templateObject142 || (level_templateObject142 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill($skill(level_templateObject143 || (level_templateObject143 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill($skill(level_templateObject144 || (level_templateObject144 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill().repeat()), () => {
    ...
    if (property_get("_sausageFights") > 4 && (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(level_templateObject145 || (level_templateObject145 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject146 || (level_templateObject146 = level_taggedTemplateLiteral(["off-hand"]))), template_string_$item(level_templateObject147 || (level_templateObject147 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    }
