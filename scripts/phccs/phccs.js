...
function isSong(skillOrEffect) {
  if (skillOrEffect instanceof import_kolmafia5.Effect && skillOrEffect.attributes.includes("song"))
    return !0;
  var skill2 = skillOrEffect instanceof import_kolmafia5.Effect ? (0, import_kolmafia5.toSkill)(skillOrEffect) : skillOrEffect;
...
function itemOrItemsBallsMacroName(itemOrItems) {
  ...
  return substringCombatItems.includes(item6) ? (0, import_kolmafia6.toInt)(item6).toString() : item6.name;
}
...
function skillBallsMacroName(skillOrName) {
  ...
  return skill2.name.match(/^[A-Za-z ]+$/) && !substringCombatSkills.includes(skill2) ? skill2.name : (0, import_kolmafia6.toInt)(skill2);
}
...
function set(counter, duration) {
  return (0, import_kolmafia14.cliExecute)("counters add ".concat(duration, " ").concat(counter)), get3(counter) !== null;
}
...
function setSong(newSong) {
  if (song() !== newSong) {
    ...
    return (0, import_kolmafia15.cliExecute)("boombox ".concat(newSong ? keywords[newSong] : "none")), !0;
  } else
    return !1;
}
...
function tideLevel() {
  var day = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia16.gamedayToInt)(), dayOfMonth = 1 + day % 8;
  ...
  if (!(!have7() || !tiles.length)) {
    for (var _i = 0, _tiles = tiles; _i < _tiles.length; _i++) {
      ...
      if (canComb(tile)) {
        ...
        (0, import_kolmafia16.cliExecute)("beach wander ".concat(minute)), (0, import_kolmafia16.cliExecute)("beach comb ".concat(row, " ").concat(column));
      }
    }
    (0, import_kolmafia16.handlingChoice)() && (0, import_kolmafia16.runChoice)(5);
  }
}
function headAvailable(target) {
  var effect = target instanceof import_kolmafia16.Effect ? target : head[target], headNumber = 1 + headBuffs.indexOf(effect);
...
function tryHead(target) {
  var effect = target instanceof import_kolmafia16.Effect ? target : head[target];
  return !headBuffs.includes(effect) || !headAvailable(target) ? !1 : ((0, import_kolmafia16.cliExecute)(effect.default), have(effect));
}
...
function mapMonster(location, monster) {
  if (!have8() || get("_monstersMapped") >= 3 || !(0, import_kolmafia17.canAdventure)(location) || ((0, import_kolmafia17.useSkill)($skill(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral10(["Map the Monsters"])))), !get("mappingMonsters")))
    return !1;
  for (var turns = (0, import_kolmafia17.myTurncount)(); (0, import_kolmafia17.currentRound)() < 1; ) {
    if ((0, import_kolmafia17.myTurncount)() > turns)
      throw new Error("Map the Monsters unsuccessful?");
    if ((0, import_kolmafia17.visitUrl)((0, import_kolmafia17.toUrl)(location)), (0, import_kolmafia17.handlingChoice)() && (0, import_kolmafia17.lastChoice)() === 1435)
      return (0, import_kolmafia17.runChoice)(1, "heyscriptswhatsupwinkwink=".concat(monster.id)), !0;
    (0, import_kolmafia17.runChoice)(-1, !1);
  }
  return !1;
}
...
function set2(hero, mode) {
  return have9() ? currentHero() === hero && currentMode() === mode ? !0 : ((0, import_kolmafia18.cliExecute)("retrocape ".concat(hero, " ").concat(mode)), currentHero() === hero && currentMode() === mode) : !1;
}
...
function tuneToSkill(skill2) {
  ...
  return !setting || !have9() ? !1 : (set2.apply(void 0, _toConsumableArray4(setting)), [currentHero(), currentMode()].every(function(element, index) {
...
function buffCycle() {
  var playerclass = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia19.myClass)();
  if ((0, import_kolmafia19.toInt)(playerclass) <= 0)
    return [];
  for (var returnValue = [], id = (0, import_kolmafia19.toInt)(playerclass), seed = id > 6 ? id % 6 + 1 : id, i = 1; i < 12; i++) {
    var index = i * seed % 11;
...
function nextBuff() {
  var currentBuff = (0, import_kolmafia19.toEffect)(get("lastBeardBuff").toFixed(0)), cycle = buffCycle(), index = cycle.indexOf(currentBuff), newIndex = (1 + index) % 11;
...
var item5 = import_kolmafia20.Item.get("autumn-aton");
function available() {
  return (0, import_kolmafia20.availableAmount)(item5) > 0;
}
function have11() {
  return get("hasAutumnaton") || available();
}
function checkLocations(html) {
  return (0, import_kolmafia20.xpath)(html, '//select[@name="heythereprogrammer"]//option[position()>1]/text()').map(function(name) {
    return (0, import_kolmafia20.toLocation)(name);
  });
}
var use = function() {
  return (0, import_kolmafia20.visitUrl)("inv_use.php?pwd&whichitem=10954");
};
...
function sendTo(target) {
  ...
  if (!available())
    return null;
  var pageHtml = use();
  upgrade2 && (0, import_kolmafia20.availableChoiceOptions)()[1] && (0, import_kolmafia20.runChoice)(1);
  var locationsAvailable = checkLocations(pageHtml), location = target instanceof import_kolmafia20.Location ? target : Array.isArray(target) ? target.find(function(l) {
    return locationsAvailable.includes(l);
  }) : target(locationsAvailable);
  return !location || !locationsAvailable.includes(location) ? null : ((0, import_kolmafia20.handlingChoice)() || use(), (0, import_kolmafia20.runChoice)(2, "heythereprogrammer=".concat(location.id)), (0, import_kolmafia20.handlingChoice)() && (0, import_kolmafia20.visitUrl)("main.php"), location);
}
function upgrade() {
  use();
  var canUpgrade = (0, import_kolmafia20.availableChoiceOptions)()[1] !== void 0;
  return canUpgrade && (0, import_kolmafia20.runChoice)(1), (0, import_kolmafia20.visitUrl)("main.php"), canUpgrade;
}
function availableLocations() {
  if (!available())
    return [];
  var pageHtml = use();
  return (0, import_kolmafia20.visitUrl)("main.php"), checkLocations(pageHtml);
}
...
function turnsLeft() {
  return get("autumnatonQuestTurn") - (0, import_kolmafia20.totalTurnsPlayed)();
}
function legs() {
...
function availableLocketMonsters() {
  return reminiscesLeft() === 0 ? [] : Object.entries((0, import_kolmafia21.getLocketMonsters)()).filter(function(_ref) {
    var _ref2 = _slicedToArray6(_ref, 2), unused = _ref2[1];
    return unused;
  }).map(function(_ref3) {
    var _ref4 = _slicedToArray6(_ref3, 1), name = _ref4[0];
    return (0, import_kolmafia21.toMonster)(name);
  });
}
function unlockedLocketMonsters() {
  return Object.entries((0, import_kolmafia21.getLocketMonsters)()).map(function(_ref5) {
...
function monstersReminisced() {
  return parseLocketProperty().map(function(id) {
    return (0, import_kolmafia21.toMonster)(id);
  });
}
function reminisce(monster) {
  return !have12() || reminiscesLeft() === 0 || !(0, import_kolmafia21.getLocketMonsters)()[monster.name] ? !1 : ((0, import_kolmafia21.cliExecute)("reminisce ".concat(monster)), (0, import_kolmafia21.runCombat)(), monstersReminisced().includes(monster));
}
...
var clanIdCache = {}, toPlayerId = function(player) {
  return typeof player == "string" ? (0, import_kolmafia22.getPlayerId)(player) : player;
  ...
  return _createClass7(Clan2, [{
    key: "_check",
    value: function() {
      if (this.id !== (0, import_kolmafia22.getClanId)())
    ...
    key: "check",
    value: function() {
      return (0, import_kolmafia22.visitUrl)("clan_hall.php").includes("<b>".concat(this.name, "</b>"));
    }
  }, {
    key: "getCurrentFax",
    value: function() {
      this._check();
      var logs = (0, import_kolmafia22.visitUrl)("clan_log.php"), lastFax = logs.match(LOG_FAX_PATTERN);
      if (!lastFax)
        return null;
      var _lastFax = _slicedToArray8(lastFax, 4), monsterName = _lastFax[3];
      return monsterName ? import_kolmafia22.Monster.get(monsterName) : null;
    }
  }, {
    key: "getRanks",
    value: function() {
      this._check();
      var page = (0, import_kolmafia22.visitUrl)("clan_whitelist.php");
      return (0, import_kolmafia22.xpath)(page, '//select[@name="level"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), match = (0, import_kolmafia22.xpath)(validHtml, "//text()")[0].match(WHITELIST_DEGREE_PATTERN), id = (0, import_kolmafia22.xpath)(validHtml, "//@value")[0];
        if (!match || !id)
          return null;
    ...
    value: function(player, rankName) {
      ...
      if (!rank)
        return !1;
      var result = (0, import_kolmafia22.visitUrl)("clan_whitelist.php?action=add&pwd&addwho=".concat(playerId, "&level=").concat(rank.id, "&title=").concat(title));
    ...
    value: function(player) {
      this._check();
      var playerId = toPlayerId(player), result = (0, import_kolmafia22.visitUrl)("clan_whitelist.php?action=updatewl&pwd&who=".concat(playerId, "&remove=Remove"));
    ...
    value: function() {
      this._check();
      var page = (0, import_kolmafia22.visitUrl)("clan_stash.php"), _ref = page.match(/Your <b>Clan Coffer<\/b> contains ([\d,]+) Meat./) || ["0", "0"], _ref2 = _slicedToArray8(_ref, 2), meat = _ref2[1];
    ...
    value: function(amount) {
      this._check();
      var result = (0, import_kolmafia22.visitUrl)("clan_stash.php?pwd&action=contribute&howmuch=".concat(amount));
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item6) {
        var needed = Math.max(0, quantity - (0, import_kolmafia22.availableAmount)(item6));
        if (needed === 0)
          return map.set(item6, 0);
        var foldGroup = getFoldGroup(item6), _iterator = _createForOfIteratorHelper6(foldGroup), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            for (var foldable = _step.value, quantityToFold = Math.min(needed, (0, import_kolmafia22.availableAmount)(foldable)), _i3 = 0; _i3 < quantityToFold; _i3++)
              (0, import_kolmafia22.cliExecute)("fold ".concat(item6.name)), needed--;
        ...
        (0, import_kolmafia22.refreshStash)();
        for (var _i2 = 0, _arr2 = [item6].concat(_toConsumableArray5(foldGroup)); _i2 < _arr2.length; _i2++) {
          var matchingItem = _arr2[_i2], quantityToTake = Math.min(needed, (0, import_kolmafia22.stashAmount)(matchingItem));
          if (quantityToTake !== 0) {
            if (!(0, import_kolmafia22.takeStash)(quantityToTake, matchingItem))
              return;
            if (matchingItem === item6)
              needed -= quantityToTake;
            else
              for (var i = 0; i < quantityToTake; i++)
                (0, import_kolmafia22.cliExecute)("fold ".concat(matchingItem.name)), needed--;
          }
        }
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item6) {
        (0, import_kolmafia22.retrieveItem)(quantity, item6);
        var returned = Math.min(quantity, (0, import_kolmafia22.availableAmount)(item6));
        (0, import_kolmafia22.putStash)(returned, item6), map.set(item6, quantity - returned);
      }), Array.isArray(items) ? countedMapToArray(map) : map;
    }
  }, {
    key: "withStash",
    ...
    key: "_join",
    value: function(id) {
      var result = (0, import_kolmafia22.visitUrl)("showclan.php?recruiter=1&whichclan=".concat(id, "&pwd&whichclan=").concat(id, "&action=joinclan&apply=Apply+to+this+Clan&confirm=on"));
    ...
    value: function(clanIdOrName) {
      ...
      if (typeof clanIdOrName == "string") {
        ...
        if (clanName === (0, import_kolmafia22.getClanName)().toLowerCase())
          return Clan2.get();
      ...
      } else if (clanId = clanIdOrName, clanId === (0, import_kolmafia22.getClanId)())
        return Clan2.get();
    ...
    key: "get",
    value: function() {
      return new Clan2((0, import_kolmafia22.getClanId)(), (0, import_kolmafia22.getClanName)());
    }
  }, {
    key: "getWhitelisted",
    value: function() {
      var page = (0, import_kolmafia22.visitUrl)("clan_signup.php");
      return (0, import_kolmafia22.xpath)(page, '//select[@name="whichclan"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), id = Number.parseInt((0, import_kolmafia22.xpath)(validHtml, "//@value")[0]), name = (0, import_kolmafia22.xpath)(validHtml, "//text()")[0];
...
var thralls = /* @__PURE__ */ new Map([[$stat(_templateObject90 || (_templateObject90 = _taggedTemplateLiteral22(["muscle"]))), $thrall(_templateObject234 || (_templateObject234 = _taggedTemplateLiteral22(["Elbow Macaroni"])))], [$stat(_templateObject325 || (_templateObject325 = _taggedTemplateLiteral22(["moxie"]))), $thrall(_templateObject421 || (_templateObject421 = _taggedTemplateLiteral22(["Penne Dreadful"])))]]), statCommunityServicePredictor = function(stat) {
  return function() {
    return 60 - Math.floor(1 / 30 * ((0, import_kolmafia23.myBuffedstat)(stat) - (0, import_kolmafia23.myBasestat)(thralls.get(stat) === (0, import_kolmafia23.myThrall)() && !have($effect(_templateObject518 || (_templateObject518 = _taggedTemplateLiteral22(["Expert Oiliness"])))) ? $stat(_templateObject615 || (_templateObject615 = _taggedTemplateLiteral22(["mysticality"]))) : stat)));
  };
}, visitCouncil = function() {
  return (0, import_kolmafia23.visitUrl)("council.php");
}, baseWeight = function() {
  return have($effect(_templateObject713 || (_templateObject713 = _taggedTemplateLiteral22(["Fidoxene"])))) ? 20 : (0, import_kolmafia23.familiarWeight)((0, import_kolmafia23.myFamiliar)());
  ...
  return _createClass8(CommunityService2, [{
    ...
    value: function() {
      ...
      var councilText = (0, import_kolmafia23.runChoice)(this.choice);
    ...
    value: function(prepare) {
      ...
      var startTime = Date.now(), startTurns = (0, import_kolmafia23.myTurncount)(), additionalTurns;
      try {
        var _prepare;
        additionalTurns = (_prepare = prepare()) !== null && _prepare !== void 0 ? _prepare : 0;
      } catch (e) {
        return (0, import_kolmafia23.print)("".concat(e), "red"), "failed";
      }
      var prediction = this.predictor(), council = visitCouncil(), turns = this._actualCost(council);
      return turns ? turns > Math.min(maxTurns, (0, import_kolmafia23.myAdventures)()) || !this.do() ? "failed" : (CommunityService2.log[this.property] = {
        predictedTurns: prediction + additionalTurns,
        turnCost: (0, import_kolmafia23.myTurncount)() - startTurns,
    ...
    value: function(name, action) {
      var _action, startTime = Date.now(), startTurns = (0, import_kolmafia23.myTurncount)(), estimatedTurns = (_action = action()) !== null && _action !== void 0 ? _action : 0;
    ...
    value: function() {
      for (var colour = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "blue", logEntries = Object.entries(CommunityService2.log), _i = 0, _logEntries = logEntries; _i < _logEntries.length; _i++) {
        ...
        type === "test" ? ((0, import_kolmafia23.print)("We predicted the ".concat(testName, " test would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia23.print)("".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour)) : (predictedTurns === 0 && turnCost === 0 || (0, import_kolmafia23.print)("We predicted the task ".concat(testName, " would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia23.print)("The task ".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour));
      }
      var totalTime = sum(logEntries, function(_ref) {
        var _ref2 = _slicedToArray9(_ref, 2), testEntry2 = _ref2[1];
        return testEntry2.seconds;
      });
      (0, import_kolmafia23.print)("All together, you have spent ".concat(totalTime.toFixed(1), " seconds during this Community Service run"), colour);
    }
  }]), CommunityService2;
}();
...
_defineProperty8(CommunityService, "HP", new CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia23.myMaxhp)() - (0, import_kolmafia23.myBuffedstat)($stat(_templateObject811 || (_templateObject811 = _taggedTemplateLiteral22(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
_defineProperty8(CommunityService, "Muscle", new CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(_templateObject99 || (_templateObject99 = _taggedTemplateLiteral22(["Muscle"])))), new Requirement(["Muscle"], {})));
_defineProperty8(CommunityService, "Mysticality", new CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral22(["Mysticality"])))), new Requirement(["Mysticality"], {})));
_defineProperty8(CommunityService, "Moxie", new CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral22(["Moxie"])))), new Requirement(["Moxie"], {})));
_defineProperty8(CommunityService, "FamiliarWeight", new CommunityService(5, "Familiar Weight", "Breed More Collies", function() {
  return 60 - Math.floor((baseWeight() + (0, import_kolmafia23.weightAdjustment)()) / 5);
...
_defineProperty8(CommunityService, "WeaponDamage", new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  var weaponPower = (0, import_kolmafia23.getPower)((0, import_kolmafia23.equippedItem)($slot(_templateObject127 || (_templateObject127 = _taggedTemplateLiteral22(["weapon"]))))), offhandPower = (0, import_kolmafia23.toSlot)((0, import_kolmafia23.equippedItem)($slot(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral22(["off-hand"]))))) === $slot(_templateObject145 || (_templateObject145 = _taggedTemplateLiteral22(["weapon"]))) ? (0, import_kolmafia23.getPower)((0, import_kolmafia23.equippedItem)($slot(_templateObject155 || (_templateObject155 = _taggedTemplateLiteral22(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia23.toSlot)((0, import_kolmafia23.equippedItem)($slot(_templateObject165 || (_templateObject165 = _taggedTemplateLiteral22(["familiar"]))))) === $slot(_templateObject175 || (_templateObject175 = _taggedTemplateLiteral22(["weapon"]))) ? (0, import_kolmafia23.getPower)((0, import_kolmafia23.equippedItem)($slot(_templateObject185 || (_templateObject185 = _taggedTemplateLiteral22(["familiar"]))))) : 0, multiplier = have($effect(_templateObject195 || (_templateObject195 = _taggedTemplateLiteral22(["Bow-Legged Swagger"])))) ? 2 : 1;
...
_defineProperty8(CommunityService, "SpellDamage", new CommunityService(7, "Spell Damage", "Make Sausage", function() {
  var dragonfishDamage = (0, import_kolmafia23.myFamiliar)() === $familiar(_templateObject205 || (_templateObject205 = _taggedTemplateLiteral22(["Magic Dragonfish"]))) ? (0, import_kolmafia23.numericModifier)($familiar(_templateObject2110 || (_templateObject2110 = _taggedTemplateLiteral22(["Magic Dragonfish"]))), "Spell Damage Percent", baseWeight() + (0, import_kolmafia23.weightAdjustment)(), $item.none) : 0;
...
_defineProperty8(CommunityService, "BoozeDrop", new CommunityService(9, "Item Drop", "Make Margaritas", function() {
  var mummingCostume = MummingTrunk_exports.currentCostumes().get((0, import_kolmafia23.myFamiliar)()), mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop" ? mummingCostume[1] : 0, familiarItemDrop = (0, import_kolmafia23.numericModifier)((0, import_kolmafia23.myFamiliar)(), "Item Drop", baseWeight() + (0, import_kolmafia23.weightAdjustment)(), (0, import_kolmafia23.equippedItem)($slot(_templateObject2210 || (_templateObject2210 = _taggedTemplateLiteral22(["familiar"]))))) + mummingBuff - (0, import_kolmafia23.numericModifier)((0, import_kolmafia23.equippedItem)($slot(_templateObject235 || (_templateObject235 = _taggedTemplateLiteral22(["familiar"])))), "Item Drop"), familiarBoozeDrop = (0, import_kolmafia23.numericModifier)((0, import_kolmafia23.myFamiliar)(), "Booze Drop", baseWeight() + (0, import_kolmafia23.weightAdjustment)(), (0, import_kolmafia23.equippedItem)($slot(_templateObject244 || (_templateObject244 = _taggedTemplateLiteral22(["familiar"]))))) - (0, import_kolmafia23.numericModifier)((0, import_kolmafia23.equippedItem)($slot(_templateObject254 || (_templateObject254 = _taggedTemplateLiteral22(["familiar"])))), "Booze Drop"), multiplier = (0, import_kolmafia23.haveEquipped)($item(_templateObject264 || (_templateObject264 = _taggedTemplateLiteral22(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1;
  return 60 - Math.floor(multiplier * (get2("Item Drop") - familiarItemDrop - (0, import_kolmafia23.numericModifier)((0, import_kolmafia23.myThrall)(), "Item Drop")) / 30 + 1e-3) - Math.floor((get2("Booze Drop") - familiarBoozeDrop) / 15 + 1e-3);
...
_defineProperty8(CommunityService, "donate", function() {
  visitCouncil(), (0, import_kolmafia23.visitUrl)("choice.php?whichchoice=1089&option=30");
});
...
function undelay2(delayedObject) {
  return typeof delayedObject == "function" ? delayedObject() : delayedObject;
}
...
var CombatStrategy = /* @__PURE__ */ function() {
  ...
  return _createClass10(CombatResources2, [{
    ...
    value: function(action) {
      ...
      if (resource !== void 0)
        return resource.do instanceof import_kolmafia25.Item ? new Macro().item(resource.do) : resource.do instanceof import_kolmafia25.Skill ? new Macro().skill(resource.do) : undelay2(resource.do);
    }
  }]), CombatResources2;
}();
...
var weaponHands = function(i) {
  ...
  return _createClass11(Outfit2, [{
    ...
    value: function(item6, value) {
      var can = this.canEquip(item6);
      return can && this.bonuses.set(item6, value), can;
    }
  }, {
    key: "addBonus",
    value: function(item6, value) {
    ...
    value: function(item6, slot) {
      ...
      return familiar2 === void 0 || !this.equip(familiar2) ? !1 : (this.equips.set($slot(_templateObject237 || (_templateObject237 = _taggedTemplateLiteral23(["familiar"]))), item6), !0);
    }
  }, {
    key: "equipItem",
    value: function(item6, slot) {
    ...
    value: function(familiar2) {
      ...
      return item6 !== void 0 && item6 !== $item.none && !(0, import_kolmafia26.canEquip)(familiar2, item6) ? !1 : (this.familiar = familiar2, !0);
    }
  }, {
    key: "equipSpec",
    value: function(spec) {
      ...
      if (spec.modes && (this.setModes(spec.modes) || (succeeded = !1)), spec.riders && (spec.riders["buddy-bjorn"] && !this.bjornify(spec.riders["buddy-bjorn"]) && (succeeded = !1), spec.riders["crown-of-thrones"] && !this.enthrone(spec.riders["crown-of-thrones"]) && (succeeded = !1)), spec.bonuses) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            ...
            succeeded && (succeeded = value + this.getBonus(item6) === this.addBonus(item6, value));
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
    ...
    value: function(refreshed) {
      ...
      var targetEquipment = Array.from(this.equips.values()), usedSlots = /* @__PURE__ */ new Set(), nonaccessorySlots = $slots(_templateObject353 || (_templateObject353 = _taggedTemplateLiteral23(["weapon, off-hand, hat, back, shirt, pants, familiar"]))), bjorn = this.riders.get($slot(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral23(["buddy-bjorn"]))));
      bjorn && (this.equips.get($slot(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral23(["back"])))) === $item(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral23(["Buddy Bjorn"]))) || this.getBonus($item(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral23(["Buddy Bjorn"]))))) && (usedSlots.add($slot(_templateObject402 || (_templateObject402 = _taggedTemplateLiteral23(["buddy-bjorn"])))), usedSlots.add($slot(_templateObject4110 || (_templateObject4110 = _taggedTemplateLiteral23(["crown-of-thrones"])))));
      var crown = this.riders.get($slot(_templateObject423 || (_templateObject423 = _taggedTemplateLiteral23(["crown-of-thrones"]))));
      crown && (this.equips.get($slot(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral23(["hat"])))) === $item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral23(["Crown of Thrones"]))) || this.getBonus($item(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral23(["Crown of Thrones"]))))) && (usedSlots.add($slot(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral23(["buddy-bjorn"])))), usedSlots.add($slot(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral23(["crown-of-thrones"])))));
      ...
      var accessorySlots = $slots(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral23(["acc1, acc2, acc3"]))), accessoryEquips = accessorySlots.map(function(slot2) {
      ...
      if (this.modifier.length > 0) {
        ...
        if (refreshed && allRequirements.push(FORCE_REFRESH_REQUIREMENT), !Requirement.merge(allRequirements).maximize()) {
          ...
          (0, import_kolmafia26.cliExecute)("refresh inventory"), this._dress(!0);
          return;
        }
        (0, import_kolmafia26.logprint)("Maximize: ".concat(this.modifier));
      }
      if (applyModes(modes), bjorn && ((0, import_kolmafia26.myEnthronedFamiliar)() === bjorn && (0, import_kolmafia26.enthroneFamiliar)($familiar.none), (0, import_kolmafia26.myBjornedFamiliar)() !== bjorn && (0, import_kolmafia26.bjornifyFamiliar)(bjorn)), crown && ((0, import_kolmafia26.myBjornedFamiliar)() === crown && (0, import_kolmafia26.bjornifyFamiliar)($familiar.none), (0, import_kolmafia26.myEnthronedFamiliar)() !== crown && (0, import_kolmafia26.enthroneFamiliar)(crown)), this.familiar !== void 0 && (0, import_kolmafia26.myFamiliar)() !== this.familiar)
      ...
      for (var _i4 = 0, _arr2 = [[$slot(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral23(["buddy-bjorn"]))), import_kolmafia26.myBjornedFamiliar], [$slot(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral23(["crown-of-thrones"]))), import_kolmafia26.myEnthronedFamiliar]]; _i4 < _arr2.length; _i4++) {
    ...
    value: function() {
      for (var _a, result = {
        ...
        result[slotName] = this.equips.get((_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject5110 || (_templateObject5110 = _taggedTemplateLiteral23(["familiar"])))], ["offhand", $slot(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral23(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia26.toSlot)(slotName));
      }
      var riders = {}, buddyRider = this.riders.get($slot(_templateObject532 || (_templateObject532 = _taggedTemplateLiteral23(["buddy-bjorn"]))));
      buddyRider !== void 0 && (riders["buddy-bjorn"] = buddyRider);
      var throneRider = this.riders.get($slot(_templateObject542 || (_templateObject542 = _taggedTemplateLiteral23(["crown-of-thrones"]))));
    ...
    key: "current",
    value: function() {
      var _a, outfit2 = new Outfit2(), familiar2 = (0, import_kolmafia26.myFamiliar)();
      ...
      for (var _i6 = 0, _outfitSlots3 = outfitSlots; _i6 < _outfitSlots3.length; _i6++) {
        var slotName = _outfitSlots3[_i6], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject552 || (_templateObject552 = _taggedTemplateLiteral23(["familiar"])))], ["offhand", $slot(_templateObject562 || (_templateObject562 = _taggedTemplateLiteral23(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia26.toSlot)(slotName), item6 = (0, import_kolmafia26.equippedItem)(slot);
        if (!outfit2.equip(item6, slot))
          throw "Failed to create outfit from current state (expected: ".concat(slot, " ").concat(item6, ")");
      }
      return (0, import_kolmafia26.haveEquipped)($item(_templateObject572 || (_templateObject572 = _taggedTemplateLiteral23(["Crown of Thrones"])))) && outfit2.riders.set($slot(_templateObject582 || (_templateObject582 = _taggedTemplateLiteral23(["crown-of-thrones"]))), (0, import_kolmafia26.myEnthronedFamiliar)()), (0, import_kolmafia26.haveEquipped)($item(_templateObject592 || (_templateObject592 = _taggedTemplateLiteral23(["Buddy Bjorn"])))) && outfit2.riders.set($slot(_templateObject602 || (_templateObject602 = _taggedTemplateLiteral23(["buddy-bjorn"]))), (0, import_kolmafia26.myBjornedFamiliar)()), outfit2.setModes(getCurrentModes2()), outfit2;
    }
  }, {
    key: "from",
    value: function(spec) {
...
var grimoireCCS = "grimoire_macro", Engine = /* @__PURE__ */ function() {
  ...
  return _createClass12(Engine2, [{
    ...
    key: "acquireItems",
    value: function(task) {
      var _a, acquire = undelay2(task.acquire), _iterator4 = _createForOfIteratorHelper9(acquire || []), _step4;
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
    ...
    key: "acquireEffects",
    value: function(task) {
      var _a, effects = (_a = undelay2(task.effects)) !== null && _a !== void 0 ? _a : [], songs = effects.filter(function(effect2) {
    ...
    value: function(task, manager) {
      ...
      for (var choice_id_str in task.choices) {
        ...
        choices[choice_id] = undelay2(choice);
      }
...
var _templateObject101, _templateObject238, _templateObject328, _templateObject424, _templateObject520, _templateObject617, _templateObject715, _templateObject813, _templateObject911, _templateObject1010, _templateObject119, _templateObject129, _templateObject139, _templateObject147, _templateObject157, _templateObject167;
...
var CSStrategy = /* @__PURE__ */ function(_CombatStrategy) {
  ...
  return _createClass13(Macro3, [{
    key: "tryBowl",
    value: function() {
      return this.if_("!hascombatitem cosmic bowling ball", Macro3.item($item(_templateObject328 || (_templateObject328 = _taggedTemplateLiteral25(["Time-Spinner"])))).if_($item(_templateObject424 || (_templateObject424 = _taggedTemplateLiteral25(["cosmic bowling ball"]))), Macro3.item([$item(_templateObject520 || (_templateObject520 = _taggedTemplateLiteral25(["Time-Spinner"]))), $item(_templateObject617 || (_templateObject617 = _taggedTemplateLiteral25(["cosmic bowling ball"])))])));
    }
  }, {
    key: "delevel",
    value: function() {
      var hard = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1;
      return this.trySkill($skill(_templateObject715 || (_templateObject715 = _taggedTemplateLiteral25(["Curse of Weaksauce"])))).trySkill($skill(_templateObject813 || (_templateObject813 = _taggedTemplateLiteral25(["Micrometeorite"])))).externalIf(hard, Macro3.tryBowl(), Macro3.item($item(_templateObject911 || (_templateObject911 = _taggedTemplateLiteral25(["Time-Spinner"]))))).trySkill($skill(_templateObject1010 || (_templateObject1010 = _taggedTemplateLiteral25(["Summon Love Gnats"]))));
    }
  }, {
    key: "candyblast",
    value: function() {
      return this.externalIf(have($skill(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral25(["Candyblast"])))), Macro3.while_('!match "Hey, some of it is even intact afterwards!"', Macro3.trySkill($skill(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral25(["Candyblast"]))))));
    }
  }, {
    key: "easyFight",
    value: function() {
      return this.trySkill($skill(_templateObject139 || (_templateObject139 = _taggedTemplateLiteral25(["Extract"])))).trySkill($skill(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral25(["Sing Along"]))));
    }
  }, {
    key: "defaultKill",
    value: function() {
      return this.delevel().easyFight().externalIf((0, import_kolmafia28.myClass)() === $class(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral25(["Sauceror"]))), Macro3.skill($skill(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral25(["Saucegeyser"])))).repeat(), Macro3.attack().repeat());
    }
  }], [{
    key: "tryBowl",
    value: function() {
...
var SYNTH_PAIRS = byStat({
  Mysticality: [[$item(_templateObject814 || (_templateObject814 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject912 || (_templateObject912 = _taggedTemplateLiteral26(["Crimbo fudge"])))], [$item(_templateObject1011 || (_templateObject1011 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject1110 || (_templateObject1110 = _taggedTemplateLiteral26(["bag of many confections"])))], [$item(_templateObject1210 || (_templateObject1210 = _taggedTemplateLiteral26(["Crimbo peppermint bark"]))), $item(_templateObject1310 || (_templateObject1310 = _taggedTemplateLiteral26(["Crimbo candied pecan"])))], [$item(_templateObject148 || (_templateObject148 = _taggedTemplateLiteral26(["Crimbo peppermint bark"]))), $item(_templateObject158 || (_templateObject158 = _taggedTemplateLiteral26(["peppermint sprout"])))], [$item(_templateObject168 || (_templateObject168 = _taggedTemplateLiteral26(["Crimbo candied pecan"]))), $item(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral26(["peppermint crook"])))]],
  Muscle: [[$item(_templateObject187 || (_templateObject187 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject197 || (_templateObject197 = _taggedTemplateLiteral26(["Crimbo peppermint bark"])))], [$item(_templateObject207 || (_templateObject207 = _taggedTemplateLiteral26(["bag of many confections"]))), $item(_templateObject2112 || (_templateObject2112 = _taggedTemplateLiteral26(["Crimbo peppermint bark"])))], [$item(_templateObject2212 || (_templateObject2212 = _taggedTemplateLiteral26(["Crimbo candied pecan"]))), $item(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral26(["peppermint patty"])))], [$item(_templateObject246 || (_templateObject246 = _taggedTemplateLiteral26(["peppermint sprout"]))), $item(_templateObject256 || (_templateObject256 = _taggedTemplateLiteral26(["peppermint patty"])))]],
  Moxie: [[$item(_templateObject266 || (_templateObject266 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject276 || (_templateObject276 = _taggedTemplateLiteral26(["Crimbo candied pecan"])))], [$item(_templateObject284 || (_templateObject284 = _taggedTemplateLiteral26(["Crimbo fudge"]))), $item(_templateObject294 || (_templateObject294 = _taggedTemplateLiteral26(["peppermint sprout"])))], [$item(_templateObject304 || (_templateObject304 = _taggedTemplateLiteral26(["bag of many confections"]))), $item(_templateObject3111 || (_templateObject3111 = _taggedTemplateLiteral26(["Crimbo candied pecan"])))], [$item(_templateObject329 || (_templateObject329 = _taggedTemplateLiteral26(["bag of many confections"]))), $item(_templateObject334 || (_templateObject334 = _taggedTemplateLiteral26(["peppermint sprout"])))], [$item(_templateObject344 || (_templateObject344 = _taggedTemplateLiteral26(["Crimbo peppermint bark"]))), $item(_templateObject354 || (_templateObject354 = _taggedTemplateLiteral26(["peppermint twist"])))]]
});
function synthExp() {
  (0, import_kolmafia29.getCampground)()["Peppermint Pip Packet"] && (0, import_kolmafia29.visitUrl)("campground.php?action=garden"), get("_candySummons") || (0, import_kolmafia29.useSkill)(1, $skill(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral26(["Summon Crimbo Candy"]))));
...
var SYNTH_EFFECT = byStat({
  Mysticality: $effect(_templateObject373 || (_templateObject373 = _taggedTemplateLiteral26(["Synthesis: Learning"]))),
  Moxie: $effect(_templateObject383 || (_templateObject383 = _taggedTemplateLiteral26(["Synthesis: Style"]))),
  Muscle: $effect(_templateObject393 || (_templateObject393 = _taggedTemplateLiteral26(["Synthesis: Movement"])))
});
...
function ensureMp(mp) {
  if (!((0, import_kolmafia29.myMp)() > mp)) {
    ...
    for (; have($item(_templateObject403 || (_templateObject403 = _taggedTemplateLiteral26(["magical sausage"])))) || have($item(_templateObject4111 || (_templateObject4111 = _taggedTemplateLiteral26(["magical sausage casing"])))) && (0, import_kolmafia29.myMp)() < mp && get("_sausagesEaten") < 23; )
      (0, import_kolmafia29.retrieveItem)($item(_templateObject425 || (_templateObject425 = _taggedTemplateLiteral26(["magical sausage"])))), (0, import_kolmafia29.eat)($item(_templateObject433 || (_templateObject433 = _taggedTemplateLiteral26(["magical sausage"]))));
    for (; have($item(_templateObject443 || (_templateObject443 = _taggedTemplateLiteral26(["psychokinetic energy blob"])))) && (0, import_kolmafia29.myMp)() < mp; )
      (0, import_kolmafia29.use)($item(_templateObject453 || (_templateObject453 = _taggedTemplateLiteral26(["psychokinetic energy blob"]))));
    (0, import_kolmafia29.myMp)() < mp && (0, import_kolmafia29.restoreMp)(mp);
  }
}
var maximizeFamiliar = have($familiar(_templateObject463 || (_templateObject463 = _taggedTemplateLiteral26(["Disembodied Hand"])))) ? $familiar(_templateObject473 || (_templateObject473 = _taggedTemplateLiteral26(["Disembodied Hand"]))) : $familiar(_templateObject483 || (_templateObject483 = _taggedTemplateLiteral26(["Left-Hand Man"])));
...
var availableFights = function() {
  return clamp(5 - Witchess_exports.fightsDone(), 0, 5) + clamp((0, import_kolmafia29.availableAmount)($item(_templateObject493 || (_templateObject493 = _taggedTemplateLiteral26(["BRICKO eye brick"])))), 0, 10 - get("_brickoFights"));
}, potentialFights = function() {
  return clamp(5 - Witchess_exports.fightsDone(), 0, 5) + clamp((0, import_kolmafia29.availableAmount)($item(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral26(["BRICKO eye brick"])))), 0, 10 - get("_brickoFights")) + clamp(3 - get("_brickoEyeSummons"), 0, 10 - get("_brickoFights"));
};
...
function burnLibrams() {
  ...
  if (!!$skills(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral26(["Summon BRICKOs, Summon Taffy, Summon Love Song, Summon Candy Heart"]))).some(function(skill2) {
    return have(skill2);
  }))
    for (; canCastLibrams(); )
      if (testsDone.includes("Breed More Collies")) {
        ...
        if (have($skill(_templateObject523 || (_templateObject523 = _taggedTemplateLiteral26(["Summon Candy Heart"])))) && totalDuration($item(_templateObject533 || (_templateObject533 = _taggedTemplateLiteral26(["green candy heart"])))) <= 0) {
          var _libramPossibilities$, _libramPossibilities$2, probability = (_libramPossibilities$ = (_libramPossibilities$2 = libramPossibilities.get($skill(_templateObject543 || (_templateObject543 = _taggedTemplateLiteral26(["Summon Candy Heart"]))))) === null || _libramPossibilities$2 === void 0 ? void 0 : _libramPossibilities$2.get($item(_templateObject553 || (_templateObject553 = _taggedTemplateLiteral26(["green candy heart"]))))) !== null && _libramPossibilities$ !== void 0 ? _libramPossibilities$ : 0;
          decisionMap.set($skill(_templateObject563 || (_templateObject563 = _taggedTemplateLiteral26(["Summon Candy Heart"]))), 3 * probability);
        }
        if (have($skill(_templateObject573 || (_templateObject573 = _taggedTemplateLiteral26(["Summon Taffy"])))) && totalDuration($item(_templateObject583 || (_templateObject583 = _taggedTemplateLiteral26(["pulled blue taffy"])))) < 50) {
          var _libramPossibilities$3, _libramPossibilities$4, _probability = (_libramPossibilities$3 = (_libramPossibilities$4 = libramPossibilities.get($skill(_templateObject593 || (_templateObject593 = _taggedTemplateLiteral26(["Summon Taffy"]))))) === null || _libramPossibilities$4 === void 0 ? void 0 : _libramPossibilities$4.get($item(_templateObject603 || (_templateObject603 = _taggedTemplateLiteral26(["pulled blue taffy"]))))) !== null && _libramPossibilities$3 !== void 0 ? _libramPossibilities$3 : 0;
          decisionMap.set($skill(_templateObject618 || (_templateObject618 = _taggedTemplateLiteral26(["Summon Taffy"]))), 1 * _probability);
        }
        if (have($skill(_templateObject622 || (_templateObject622 = _taggedTemplateLiteral26(["Summon Love Song"])))) && totalDuration($item(_templateObject632 || (_templateObject632 = _taggedTemplateLiteral26(["love song of icy revenge"])))) < 20) {
          var _libramPossibilities$5, _libramPossibilities$6, _probability2 = (_libramPossibilities$5 = (_libramPossibilities$6 = libramPossibilities.get($skill(_templateObject642 || (_templateObject642 = _taggedTemplateLiteral26(["Summon Love Song"]))))) === null || _libramPossibilities$6 === void 0 ? void 0 : _libramPossibilities$6.get($item(_templateObject652 || (_templateObject652 = _taggedTemplateLiteral26(["love song of icy revenge"]))))) !== null && _libramPossibilities$5 !== void 0 ? _libramPossibilities$5 : 0, currentWeightValue = clamp(Math.ceil(totalDuration($item(_templateObject662 || (_templateObject662 = _taggedTemplateLiteral26(["love song of icy revenge"])))) / 2), 0, 10), newWeightValue = clamp(Math.ceil((totalDuration($item(_templateObject672 || (_templateObject672 = _taggedTemplateLiteral26(["love song of icy revenge"])))) + 5) / 2), 0, 10);
          decisionMap.set($skill(_templateObject682 || (_templateObject682 = _taggedTemplateLiteral26(["Summon Love Song"]))), _probability2 * (newWeightValue - currentWeightValue));
        }
        if (have($skill(_templateObject692 || (_templateObject692 = _taggedTemplateLiteral26(["Summon BRICKOs"])))) && get("_brickoEyeSummons") < 3 && testsDone.includes("Donate Blood")) {
          var _libramPossibilities$7, _libramPossibilities$8, _probability3 = (_libramPossibilities$7 = (_libramPossibilities$8 = libramPossibilities.get($skill(_templateObject702 || (_templateObject702 = _taggedTemplateLiteral26(["Summon BRICKOs"]))))) === null || _libramPossibilities$8 === void 0 ? void 0 : _libramPossibilities$8.get($item(_templateObject716 || (_templateObject716 = _taggedTemplateLiteral26(["BRICKO eye brick"]))))) !== null && _libramPossibilities$7 !== void 0 ? _libramPossibilities$7 : 0;
          if (have($familiar(_templateObject722 || (_templateObject722 = _taggedTemplateLiteral26(["Shorter-Order Cook"])))) && totalDuration($item(_templateObject732 || (_templateObject732 = _taggedTemplateLiteral26(["short stack of pancakes"])))) === 0 && availableFights() < 11 - get("_shortOrderCookCharge") && potentialFights() >= 11 - get("_shortOrderCookCharge") && decisionMap.set($skill(_templateObject742 || (_templateObject742 = _taggedTemplateLiteral26(["Summon BRICKOs"]))), _probability3 * 11 / (11 - get("_shortOrderCookCharge") - availableFights())), have($familiar(_templateObject752 || (_templateObject752 = _taggedTemplateLiteral26(["Garbage Fire"])))) && !have($item(_templateObject762 || (_templateObject762 = _taggedTemplateLiteral26(["burning paper crane"])))) && !have($item(_templateObject772 || (_templateObject772 = _taggedTemplateLiteral26(["burning newspaper"])))) && availableFights() < 30 - get("garbageFireProgress") && potentialFights() >= 30 - get("garbageFireProgress")) {
            var _decisionMap$get, value = 5 / (30 - get("garbageFireProgress") - availableFights()) * _probability3, otherBrickoValue = (_decisionMap$get = decisionMap.get($skill(_templateObject782 || (_templateObject782 = _taggedTemplateLiteral26(["Summon BRICKOs"]))))) !== null && _decisionMap$get !== void 0 ? _decisionMap$get : 0;
            value > otherBrickoValue && decisionMap.set($skill(_templateObject792 || (_templateObject792 = _taggedTemplateLiteral26(["Summon BRICKOs"]))), value);
          }
        }
...
function unequip(item6) {
  for (; (0, import_kolmafia29.equippedAmount)(item6) > 0; ) {
    ...
    if (!slot)
      return;
    (0, import_kolmafia29.equip)(slot, $item(_templateObject802 || (_templateObject802 = _taggedTemplateLiteral26(["none"]))));
  }
}
...
var _templateObject110, _templateObject240, _templateObject330, _templateObject426, _templateObject521, _templateObject619, _templateObject717, _templateObject815, _templateObject913, _templateObject1012, _templateObject1111, _templateObject1211, _templateObject1311, _templateObject149, _templateObject159, _templateObject169, _templateObject178, _templateObject188, _templateObject198, _templateObject208, _templateObject2113, _templateObject2213, _templateObject2310, _templateObject247, _templateObject257, _templateObject267, _templateObject277, _templateObject285, _templateObject295, _templateObject305, _templateObject3112, _templateObject3210;
...
var UNCHANGING_OUTFIT = {
  shirt: $items(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral27(["LOV Eardigan, Jurassic Parka, fresh coat of paint"]))),
  pants: $items(_templateObject240 || (_templateObject240 = _taggedTemplateLiteral27(["designer sweatpants, old sweatpants"]))),
  offhand: $item(_templateObject330 || (_templateObject330 = _taggedTemplateLiteral27(["unbreakable umbrella"]))),
  acc1: byStat({
    Mysticality: $items(_templateObject426 || (_templateObject426 = _taggedTemplateLiteral27(["meteorite necklace, your cowboy boots"]))),
    default: $item(_templateObject521 || (_templateObject521 = _taggedTemplateLiteral27(["Powerful Glove"])))
  }),
  acc2: byStat({
    Mysticality: $item(_templateObject619 || (_templateObject619 = _taggedTemplateLiteral27(["codpiece"]))),
    Moxie: $items(_templateObject717 || (_templateObject717 = _taggedTemplateLiteral27(["LOV Earrings, Beach Comb"]))),
    Muscle: $items(_templateObject815 || (_templateObject815 = _taggedTemplateLiteral27(["Brutal brogues, Retrospecs"])))
  }),
  acc3: byStat({
    Mysticality: $items(_templateObject913 || (_templateObject913 = _taggedTemplateLiteral27(["battle broom, Powerful Glove"]))),
    default: $item(_templateObject1012 || (_templateObject1012 = _taggedTemplateLiteral27(["your cowboy boots"])))
  }),
  modes: {
    retrocape: [byStat({
      Muscle: "vampire",
  ...
  return _objectSpread6(_objectSpread6({}, UNCHANGING_OUTFIT), {}, {
    hat: DaylightShavings_exports.buffAvailable() ? DaylightShavings_exports.helmet : byStat({
      Moxie: $items(_templateObject1111 || (_templateObject1111 = _taggedTemplateLiteral27(["very pointy crown, Iunion Crown"]))),
      Mysticality: $items(_templateObject1211 || (_templateObject1211 = _taggedTemplateLiteral27(["astral chapeau, Iunion Crown"]))),
      Muscle: $item(_templateObject1311 || (_templateObject1311 = _taggedTemplateLiteral27(["Iunion Crown"])))
    }),
    weapon: get("_juneCleaverFightsLeft") > 0 && get("_juneCleaverEncounters") < 2 ? $item(_templateObject149 || (_templateObject149 = _taggedTemplateLiteral27(["June cleaver"]))) : byStat({
      Muscle: $items(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral27(["dented scepter, Fourth of May Cosplay Saber"]))),
      default: $item(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral27(["Fourth of May Cosplay Saber"])))
    }),
    back: get("questPAGhost") === "unstarted" && get("nextParanormalActivity") <= (0, import_kolmafia30.totalTurnsPlayed)() ? $item(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral27(["protonic accelerator pack"]))) : $items(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral27(["LOV Epaulettes, unwrapped knock-off retro superhero cape"])))
  });
}, FAMILIAR_PICKS = [{
  familiar: $familiar(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral27(["Stocking Mimic"]))),
  famequip: $item.none,
  condition: function() {
    return !get("_bagOfCandy");
  }
}, {
  familiar: $familiar(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral27(["Melodramedary"]))),
  famequip: $item(_templateObject2113 || (_templateObject2113 = _taggedTemplateLiteral27(["dromedary drinking helmet"]))),
  condition: function() {
    return get("camelSpit") < 100 && !have($effect(_templateObject2213 || (_templateObject2213 = _taggedTemplateLiteral27(["Spit Upon"]))));
  }
}, {
  familiar: $familiar(_templateObject2310 || (_templateObject2310 = _taggedTemplateLiteral27(["Shorter-Order Cook"]))),
  condition: function() {
    return ![$effect(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral27(["Shortly Stacked"]))), $item(_templateObject257 || (_templateObject257 = _taggedTemplateLiteral27(["short stack of pancakes"])))].some(function(x) {
      return have(x);
    }) && !CommunityService.FamiliarWeight.isDone();
  }
}, {
  familiar: $familiar(_templateObject267 || (_templateObject267 = _taggedTemplateLiteral27(["Garbage Fire"]))),
  condition: function() {
    return $familiar(_templateObject277 || (_templateObject277 = _taggedTemplateLiteral27(["Garbage Fire"]))).dropsToday < 1;
  }
}];
...
function chooseFamiliar(canAttack) {
  ...
  if (pick) {
    var _pick$famequip;
    return {
      famequip: (_pick$famequip = pick.famequip) !== null && _pick$famequip !== void 0 ? _pick$famequip : $item(_templateObject285 || (_templateObject285 = _taggedTemplateLiteral27(["tiny stillsuit"]))),
      familiar: pick.familiar
    };
  }
  return {
    famequip: $item(_templateObject295 || (_templateObject295 = _taggedTemplateLiteral27(["tiny stillsuit"]))),
    familiar: (_findFirstFamiliar = findFirstFamiliar($familiars(_templateObject305 || (_templateObject305 = _taggedTemplateLiteral27(["Puck Man, Ms. Puck Man"]))))) !== null && _findFirstFamiliar !== void 0 ? _findFirstFamiliar : $familiar(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral27(["Blood-Faced Volleyball"])))
  };
}
var DEFAULT_OPTIONS = {
  changes: {},
...
function innerElf() {
  return {
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject524 || (_templateObject524 = _taggedTemplateLiteral28(["KGB tranquilizer dart"])))).trySkill($skill(_templateObject620 || (_templateObject620 = _taggedTemplateLiteral28(["Snokebomb"]))));
    })
  };
}
...
function restore(effects) {
  return {
    ...
    do: function() {
      !have($item(_templateObject718 || (_templateObject718 = _taggedTemplateLiteral28(["magical sausage"])))) && have($item(_templateObject816 || (_templateObject816 = _taggedTemplateLiteral28(["magical sausage casing"])))) && (0, import_kolmafia31.create)(1, $item(_templateObject914 || (_templateObject914 = _taggedTemplateLiteral28(["magical sausage"])))), have($item(_templateObject1013 || (_templateObject1013 = _taggedTemplateLiteral28(["magical sausage"])))) ? (0, import_kolmafia31.eat)(1, $item(_templateObject1112 || (_templateObject1112 = _taggedTemplateLiteral28(["magical sausage"])))) : (0, import_kolmafia31.use)(1, $item(_templateObject1212 || (_templateObject1212 = _taggedTemplateLiteral28(["psychokinetic energy blob"]))));
    }
  };
}
...
function commonFamiliarWeightBuffs() {
  var buffs5 = $effects(_templateObject1312 || (_templateObject1312 = _taggedTemplateLiteral28(["Empathy, Leash of Linguini, Blood Bond"])));
  return [potionTask($item(_templateObject1410 || (_templateObject1410 = _taggedTemplateLiteral28(["green candy heart"]))))].concat(_toConsumableArray9(restoreBuffTasks(buffs5)), [{
    name: "Witchess",
    completed: function() {
  ...
  }, beachTask($effect(_templateObject1510 || (_templateObject1510 = _taggedTemplateLiteral28(["Do I Know You From Somewhere?"]))))]);
}
...
function meteorShower() {
  ...
  return {
    ...
    prepare: function() {
      horsery() === "pale" && horse("dark"), SourceTerminal_exports.educate([$skill(_templateObject248 || (_templateObject248 = _taggedTemplateLiteral28(["Turbo"]))), $skill(_templateObject258 || (_templateObject258 = _taggedTemplateLiteral28(["Extract"])))]);
    },
    do: function() {
      (0, import_kolmafia31.adv1)($location(_templateObject268 || (_templateObject268 = _taggedTemplateLiteral28(["The Neverending Party"]))), -1, ""), (0, import_kolmafia31.handlingChoice)() && (0, import_kolmafia31.runChoice)(-1);
    },
    outfit: function() {
      return uniform({
        changes: {
          ...
          famequip: $item.none,
          weapon: $item(_templateObject278 || (_templateObject278 = _taggedTemplateLiteral28(["Fourth of May Cosplay Saber"])))
        }
      });
    },
    choices: (_choices2 = {}, _defineProperty12(_choices2, 1387, 3), _defineProperty12(_choices2, 1324, 5), _choices2),
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject286 || (_templateObject286 = _taggedTemplateLiteral28(["Turbo"])))).skill($skill(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral28(["Meteor Shower"])))).skill($skill(_templateObject306 || (_templateObject306 = _taggedTemplateLiteral28(["Use the Force"]))));
    }),
    post: function() {
      have($effect(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral28(["Meteor Showered"])))) && showers++, _set("_meteorShowerUses", showers), SourceTerminal_exports.educate([$skill(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral28(["Extract"]))), $skill(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral28(["Portscan"])))]);
    }
  };
}
function birdTask(modifier) {
  ...
  return {
    name: "Regular Bird",
    completed: function() {
      return have($effect(_templateObject345 || (_templateObject345 = _taggedTemplateLiteral28(["Blessing of the Bird"]))));
    },
    ready: function() {
      return currentBirdHas(modifier, positive) && get("_birdsSoughtToday") < 6;
    },
    do: function() {
      return (0, import_kolmafia31.useSkill)($skill(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral28(["Seek out a Bird"]))));
    }
  };
}
function favouriteBirdTask(modifier) {
  ...
  return {
    ...
    do: function() {
      return (0, import_kolmafia31.useSkill)($skill(_templateObject364 || (_templateObject364 = _taggedTemplateLiteral28(["Visit your Favorite Bird"]))));
    }
  };
}
function deckTask(card) {
  return {
    ...
    completed: function() {
      return get("_deckCardsSeen").toLowerCase().split("|").includes(card.toLowerCase());
    },
    ready: function() {
      return have($item(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral28(["Deck of Every Card"])))) && get("_deckCardsDrawn") <= 10;
    },
    do: function() {
      return (0, import_kolmafia31.cliExecute)("cheat ".concat(card.toLowerCase()));
    }
  };
}
...
var _templateObject120, _templateObject249, _templateObject336, _templateObject428, _templateObject525, _templateObject621, _templateObject719, _templateObject817, _templateObject915, _templateObject1014, _templateObject1113, _templateObject1213, _templateObject1313;
...
var GLOBAL_TASKS = [{
  name: "Beaten Up!",
  completed: function() {
    return !have($effect(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral29(["Beaten Up"]))));
  },
  ready: function() {
    return get("lastEncounter") !== "Poetic Justice";
  },
  do: function() {
    return (0, import_kolmafia32.abort)("Beaten up!");
  }
}, {
  ...
  ready: function() {
    return (0, import_kolmafia32.myInebriety)() > 0 && get("sweat") >= 25;
  },
  do: function() {
    return (0, import_kolmafia32.useSkill)($skill(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral29(["Sweat Out Some Booze"]))));
  },
  outfit: {
    pants: $item(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral29(["designer sweatpants"])))
  }
}, {
  name: "Numberology",
  ready: function() {
    return Object.values((0, import_kolmafia32.reverseNumberology)()).includes(69) && get("skillLevel144") <= 3;
  },
  completed: function() {
    return get("_universeCalculated") >= get("skillLevel144");
  },
  do: function() {
    return (0, import_kolmafia32.cliExecute)("numberology 69");
  }
}, {
  name: "June Cleaver",
  completed: function() {
  ...
  do: function() {
    return withProperty("recoveryScript", "", function() {
      (0, import_kolmafia32.adv1)($location(_templateObject428 || (_templateObject428 = _taggedTemplateLiteral29(["Noob Cave"]))), -1, ""), get("lastEncounter") === "Poetic Justice" && (0, import_kolmafia32.useSkill)($skill(_templateObject525 || (_templateObject525 = _taggedTemplateLiteral29(["Tongue of the Walrus"]))));
    });
  },
  outfit: {
    weapon: $item(_templateObject621 || (_templateObject621 = _taggedTemplateLiteral29(["June cleaver"])))
  }
}, {
  name: "Ghost",
  completed: function() {
  ...
  ready: function() {
    return have($item(_templateObject719 || (_templateObject719 = _taggedTemplateLiteral29(["protonic accelerator pack"])))) && get("questPAGhost") !== "unstarted" && !!get("ghostLocation") && !have($effect(_templateObject817 || (_templateObject817 = _taggedTemplateLiteral29(["Meteor Showered"]))));
  },
  do: function() {
    var location = get("ghostLocation");
    if (location)
      (0, import_kolmafia32.adv1)(location, 0, "");
    else
      throw "Could not determine Proton Ghost location!";
  },
  combat: new CSStrategy(function() {
    return Macro2.delevel().easyFight().trySkill($skill(_templateObject915 || (_templateObject915 = _taggedTemplateLiteral29(["Shoot Ghost"])))).trySkill($skill(_templateObject1014 || (_templateObject1014 = _taggedTemplateLiteral29(["Shoot Ghost"])))).trySkill($skill(_templateObject1113 || (_templateObject1113 = _taggedTemplateLiteral29(["Shoot Ghost"])))).trySkill($skill(_templateObject1213 || (_templateObject1213 = _taggedTemplateLiteral29(["Trap Ghost"]))));
  }),
  outfit: function() {
    return uniform({
      changes: {
        back: $item(_templateObject1313 || (_templateObject1313 = _taggedTemplateLiteral29(["protonic accelerator pack"])))
      }
    });
  }
}], GLOBAL_QUEST = {
...
var HIGHLIGHT = (0, import_kolmafia33.isDarkMode)() ? "yellow" : "blue", CSEngine = /* @__PURE__ */ function(_Engine) {
  ...
  return _createClass14(CSEngine2, [{
    key: "destruct",
    value: function() {
      (0, import_kolmafia33.setAutoAttack)(0);
    }
  }, {
    key: "available",
    value: function(task) {
      return _get2(_getPrototypeOf6(CSEngine2.prototype), "available", this).call(this, task) && (!task.core || task.core === CSEngine2.core) && (!task.class || task.class.includes((0, import_kolmafia33.myClass)()));
    }
  }, {
    key: "initPropertiesManager",
    value: function() {
    ...
    value: function() {
      CSEngine2.propertyManager.set({
        ...
        1474: 1,
        1475: 1
      }), (0, import_kolmafia33.readCcs)("grimoire_macro") || (0, import_kolmafia33.writeCcs)("[ default ]\nabort", "grimoire_macro");
    }
  }, {
    key: "runTests",
    value: function() {
      (0, import_kolmafia33.myPath)() !== $path(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral30(["Community Service"]))) && (0, import_kolmafia33.abort)(), (0, import_kolmafia33.visitUrl)("council.php"), CSEngine2.initiate();
      try {
        ...
        CSEngine2.propertyManager.resetAll(), CommunityService.printLog(HIGHLIGHT), CSEngine2.core === "soft" && (CommunityService.donate(), (0, import_kolmafia33.cliExecute)("refresh all"), (0, import_kolmafia33.cliExecute)(get("kingLiberatedScript")), uneffect($effect(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral30(["Feeling Lost"]))))), get("_cloudTalkSmoker") && (0, import_kolmafia33.print)("".concat(get("_cloudTalkSmoker").slice(10), " has a message for you: ").concat(get("_cloudTalkMessage"))), ["food", "booze"].includes(get("_questPartyFairQuest")) && (0, import_kolmafia33.print)("Talk to Gerald/ine!");
      }
    }
  }]), CSEngine2;
}(Engine);
_defineProperty13(CSEngine, "propertyManager", new PropertiesManager());
_defineProperty13(CSEngine, "core_", (0, import_kolmafia33.inHardcore)() ? "hard" : "soft");

// src/boozedrop.ts
var import_kolmafia34 = require("kolmafia");
var _templateObject130, _templateObject251, _templateObject337, _templateObject429, _templateObject526, _templateObject623, _templateObject720, _templateObject818, _templateObject916, _templateObject1015, _templateObject1114, _templateObject1214, _templateObject1314, _templateObject1411, _templateObject1511, _templateObject1611, _templateObject1710, _templateObject1810, _templateObject1910, _templateObject2010, _templateObject2115, _templateObject2215, _templateObject2312, _templateObject2410, _templateObject259, _templateObject269, _templateObject279, _templateObject287, _templateObject297, _templateObject307, _templateObject3114, _templateObject3212, _templateObject338, _templateObject346, _templateObject356, _templateObject365, _templateObject375, _templateObject384, _templateObject394;
...
var BoozeDrop = {
  ...
  outfit: function() {
    return have($item(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral31(["wad of used tape"])))) || (0, import_kolmafia34.cliExecute)("fold wad of used tape"), _objectSpread7(_objectSpread7({
      hat: $item(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral31(["wad of used tape"]))),
      weapon: $items(_templateObject337 || (_templateObject337 = _taggedTemplateLiteral31(["extra-large utility candle, Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject429 || (_templateObject429 = _taggedTemplateLiteral31(["unbreakable umbrella"])))
    }, have($familiar(_templateObject526 || (_templateObject526 = _taggedTemplateLiteral31(["Comma Chameleon"])))) && CSEngine.core === "soft" ? {
      back: $item(_templateObject623 || (_templateObject623 = _taggedTemplateLiteral31(["Buddy Bjorn"]))),
      riders: {
        "buddy-bjorn": $familiar(_templateObject720 || (_templateObject720 = _taggedTemplateLiteral31(["Party Mouse"])))
      }
    } : {
      back: $item(_templateObject818 || (_templateObject818 = _taggedTemplateLiteral31(["protonic accelerator pack"])))
    }), {}, {
      acc1: $item(_templateObject916 || (_templateObject916 = _taggedTemplateLiteral31(["Guzzlr tablet"]))),
      acc2: $item(_templateObject1015 || (_templateObject1015 = _taggedTemplateLiteral31(["Cincho de Mayo"]))),
      acc3: $items(_templateObject1114 || (_templateObject1114 = _taggedTemplateLiteral31(["barrel hoop earring, gold detective badge, government-issued night-vision goggles, combat lover's locket"]))),
      famequip: $item(_templateObject1214 || (_templateObject1214 = _taggedTemplateLiteral31(["li'l ninja costume"]))),
      familiar: $familiar(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral31(["Trick-or-Treating Tot"]))),
      modes: {
  ...
  tasks: [{
    name: "Batform",
    completed: function() {
      return have($effect(_templateObject1411 || (_templateObject1411 = _taggedTemplateLiteral31(["Bat-Adjacent Form"]))));
    },
    do: $location(_templateObject1511 || (_templateObject1511 = _taggedTemplateLiteral31(["The Dire Warren"]))),
    outfit: function() {
      return uniform({
        changes: {
          back: $item(_templateObject1611 || (_templateObject1611 = _taggedTemplateLiteral31(["vampyric cloake"]))),
          offhand: $item(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral31(["latte lovers member's mug"])))
        },
        canAttack: !1
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject1810 || (_templateObject1810 = _taggedTemplateLiteral31(["Become a Bat"])))).skill($skill(_templateObject1910 || (_templateObject1910 = _taggedTemplateLiteral31(["Throw Latte on Opponent"]))));
    })
  }, _objectSpread7(_objectSpread7({}, deckTask("X - The Wheel of Fortune")), {}, {
    class: $classes(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral31(["Sauceror, Turtle Tamer"]))),
    core: "hard"
  }), songTask($effect(_templateObject2115 || (_templateObject2115 = _taggedTemplateLiteral31(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral31(["Ode to Booze"])))), {
    name: "Items.enh",
    completed: function() {
      return have($effect(_templateObject2312 || (_templateObject2312 = _taggedTemplateLiteral31(["items.enh"]))));
    },
    do: function() {
      return SourceTerminal_exports.enhance($effect(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral31(["items.enh"]))));
    }
  }, skillTask($skill(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral31(["The Spirit of Taking"])))), skillTask($skill(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral31(["Singer's Faithful Ocelot"])))), {
    name: "Play Pool",
    completed: function() {
      return have($effect(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral31(["Hustlin'"]))));
    },
    do: function() {
      return (0, import_kolmafia34.cliExecute)("pool 3");
    }
  }, asdonTask("Observantly"), {
    name: "Get Anticheese",
    ready: function() {
      return (0, import_kolmafia34.canAdventure)($location(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral31(["South of the Border"]))));
    },
    completed: function() {
      return get("lastAnticheeseDay") > 0;
    },
    do: function() {
      return (0, import_kolmafia34.visitUrl)("place.php?whichplace=desertbeach&action=db_nukehouse");
    }
  }, {
    name: "Government",
    ready: function() {
      return have($item(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral31(["anticheese"])))) && have($item(_templateObject307 || (_templateObject307 = _taggedTemplateLiteral31(["government cheese"]))));
    },
    completed: function() {
      return have($effect(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral31(["I See Everything Thrice!"]))));
    },
    do: function() {
      return (0, import_kolmafia34.create)(1, $item(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral31(["government"])))) && (0, import_kolmafia34.use)(1, $item(_templateObject338 || (_templateObject338 = _taggedTemplateLiteral31(["government"]))));
    }
  }, {
    name: "Pray",
    class: $classes(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral31(["Pastamancer"]))),
    completed: function() {
      return get("_barrelPrayer");
    },
    do: function() {
      return (0, import_kolmafia34.cliExecute)("barrelprayer buff");
    }
  }].concat(_toConsumableArray11($items(_templateObject356 || (_templateObject356 = _taggedTemplateLiteral31(["Salsa Caliente\u2122 candle, lavender candy heart, bag of grain, emergency glowstick"]))).map(potionTask)), [{
    name: "Steely-Eyed Squint",
    completed: function() {
      return have($effect(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral31(["Steely-Eyed Squint"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject375 || (_templateObject375 = _taggedTemplateLiteral31(["Steely-Eyed Squint"]))));
    }
  }, {
    name: "Feel Lost",
    completed: function() {
      return have($effect(_templateObject384 || (_templateObject384 = _taggedTemplateLiteral31(["Feeling Lost"]))));
    },
    do: function() {
      return (0, import_kolmafia34.useSkill)($skill(_templateObject394 || (_templateObject394 = _taggedTemplateLiteral31(["Feel Lost"]))));
    }
  }])
...
var _templateObject131, _templateObject260, _templateObject339, _templateObject430, _templateObject527, _templateObject624, _templateObject721, _templateObject819, _templateObject917, _templateObject1016, _templateObject1115, _templateObject1215, _templateObject1315, _templateObject1412, _templateObject1512, _templateObject1612, _templateObject1711, _templateObject1811, _templateObject1911, _templateObject2011, _templateObject2116, _templateObject2216, _templateObject2313, _templateObject2411, _templateObject2510, _templateObject2610, _templateObject2710, _templateObject288, _templateObject298;
...
var CoilWire = {
  ...
  tasks: [{
    ...
    do: function() {
      (0, import_kolmafia35.adv1)(byStat({
        Mysticality: $location(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral32(["The Haunted Pantry"]))),
        Moxie: $location(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral32(["The Sleazy Back Alley"]))),
        Muscle: $location(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral32(["The Outskirts of Cobb's Knob"])))
      }), -1, ""), have($item(_templateObject430 || (_templateObject430 = _taggedTemplateLiteral32(["magical sausage casing"])))) && (0, import_kolmafia35.create)(1, $item(_templateObject527 || (_templateObject527 = _taggedTemplateLiteral32(["magical sausage"])))), (0, import_kolmafia35.eat)(1, $item(_templateObject624 || (_templateObject624 = _taggedTemplateLiteral32(["magical sausage"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
    ...
    outfit: function() {
      return uniform({
        canAttack: !1,
        changes: {
          shirt: $item(_templateObject1412 || (_templateObject1412 = _taggedTemplateLiteral32(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
        }
  ...
  outfit: function() {
    return {
      ...
      pants: $item(_templateObject2411 || (_templateObject2411 = _taggedTemplateLiteral32(["Cargo Cultist Shorts"]))),
...
var _templateObject140, _templateObject261, _templateObject340, _templateObject431, _templateObject528, _templateObject625, _templateObject723;
function _taggedTemplateLiteral33(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var totalInebriety = function() {
  return (0, import_kolmafia36.myInebriety)() + get("_sweatOutSomeBoozeUsed");
}, Drink = {
  name: "Drink Pilsners",
  type: "MISC",
  completed: function() {
  ...
  tasks: [{
    name: "Open Pilsners",
    completed: function() {
      return !have($item(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral33(["astral six-pack"]))));
    },
    do: function() {
      return (0, import_kolmafia36.use)($item(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral33(["astral six-pack"]))));
    }
  }, songTask($effect(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral33(["Ode to Booze"]))), $effect(_templateObject431 || (_templateObject431 = _taggedTemplateLiteral33(["The Magical Mojomuscular Melody"])))), {
    name: "Drink Pilsners",
    ready: function() {
      return have($item(_templateObject528 || (_templateObject528 = _taggedTemplateLiteral33(["astral pilsner"]))));
    },
    completed: function() {
      return totalInebriety() >= 5;
    },
    do: function() {
      return (0, import_kolmafia36.drink)($item(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral33(["astral pilsner"]))), clamp((0, import_kolmafia36.itemAmount)($item(_templateObject723 || (_templateObject723 = _taggedTemplateLiteral33(["astral pilsner"])))), 0, 5 - totalInebriety()));
    }
  }]
...
var _templateObject141, _templateObject270, _templateObject341, _templateObject434, _templateObject529, _templateObject626, _templateObject724, _templateObject820, _templateObject918, _templateObject1017, _templateObject1116, _templateObject1216, _templateObject1316, _templateObject1413, _templateObject1513, _templateObject1613, _templateObject1712, _templateObject1812, _templateObject1912, _templateObject2012, _templateObject2117, _templateObject2217, _templateObject2314, _templateObject2412, _templateObject2511, _templateObject2611, _templateObject2711, _templateObject289, _templateObject299, _templateObject308, _templateObject3115, _templateObject3213, _templateObject3310, _templateObject347, _templateObject357, _templateObject366, _templateObject376, _templateObject385, _templateObject395, _templateObject404, _templateObject4112, _templateObject4210, _templateObject435, _templateObject444, _templateObject454, _templateObject464, _templateObject474, _templateObject484, _templateObject494, _templateObject504, _templateObject5112, _templateObject5210, _templateObject534, _templateObject544, _templateObject554, _templateObject564, _templateObject574, _templateObject584, _templateObject594, _templateObject604, _templateObject6110, _templateObject627;
...
var familiar = have($familiar(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral34(["Comma Chameleon"])))) ? $familiar(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral34(["Comma Chameleon"]))) : $familiar(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral34(["Mini-Trainbot"]))), FamiliarWeight = {
  name: "Familiar Weight",
  type: "SERVICE",
  test: CommunityService.FamiliarWeight,
  outfit: function() {
    return _objectSpread8({
      hat: $item(_templateObject434 || (_templateObject434 = _taggedTemplateLiteral34(["Daylight Shavings Helmet"]))),
      weapon: $item(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral34(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject626 || (_templateObject626 = _taggedTemplateLiteral34(["burning paper crane, familiar scrapbook"]))),
      pants: $items(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral34(["repaid diaper, Great Wolf's beastly trousers, designer sweatpants"]))),
  ...
  turnsSpent: 0,
  maxTurns: 30,
  tasks: [].concat(_toConsumableArray12(commonFamiliarWeightBuffs()), [potionTask($item(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral34(["short stack of pancakes"])))), {
    name: "Moveable Feast",
    core: "soft",
    completed: function() {
    ...
    ready: function() {
      return have($item(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral34(["moveable feast"])))) && familiar === $familiar(_templateObject1712 || (_templateObject1712 = _taggedTemplateLiteral34(["Mini-Trainbot"])));
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject1812 || (_templateObject1812 = _taggedTemplateLiteral34(["moveable feast"]))));
    },
    outfit: {
      familiar: familiar
    }
    ...
    completed: function() {
      return have($item(_templateObject1912 || (_templateObject1912 = _taggedTemplateLiteral34(["overloaded Yule battery"])))) || have($item(_templateObject2012 || (_templateObject2012 = _taggedTemplateLiteral34(["homemade robot gear"])))) || get("commaFamiliar") === $familiar(_templateObject2117 || (_templateObject2117 = _taggedTemplateLiteral34(["Homemade Robot"])));
    },
    do: function() {
      have($item(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral34(["box of Familiar Jacks"])))) || (0, import_kolmafia37.create)($item(_templateObject2314 || (_templateObject2314 = _taggedTemplateLiteral34(["box of Familiar Jacks"])))), (0, import_kolmafia37.use)($item(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral34(["box of Familiar Jacks"]))));
    },
    outfit: {
      familiar: have($familiar(_templateObject2511 || (_templateObject2511 = _taggedTemplateLiteral34(["Comma Chameleon"])))) ? $familiar(_templateObject2611 || (_templateObject2611 = _taggedTemplateLiteral34(["Homemade Robot"]))) : $familiar(_templateObject2711 || (_templateObject2711 = _taggedTemplateLiteral34(["Mini-Trainbot"])))
    }
  }, {
    name: "Feed Chameleon",
    completed: function() {
      return get("commaFamiliar") === $familiar(_templateObject289 || (_templateObject289 = _taggedTemplateLiteral34(["Homemade Robot"])));
    },
    ready: function() {
    ...
    name: "Paper Crane",
    completed: function() {
      return have($item(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral34(["burning paper crane"]))));
    },
    do: function() {
      return (0, import_kolmafia37.create)($item(_templateObject3310 || (_templateObject3310 = _taggedTemplateLiteral34(["burning paper crane"]))));
    },
    ready: function() {
      return have($item(_templateObject347 || (_templateObject347 = _taggedTemplateLiteral34(["burning newspaper"]))));
    }
  }, {
    name: "Shorty Fights (Witchess)",
    completed: function() {
      return [$effect(_templateObject357 || (_templateObject357 = _taggedTemplateLiteral34(["Shortly Stacked"]))), $item(_templateObject366 || (_templateObject366 = _taggedTemplateLiteral34(["short stack of pancakes"])))].some(function(x) {
        return have(x);
      });
    },
    ready: function() {
    ...
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject376 || (_templateObject376 = _taggedTemplateLiteral34(["Witchess Bishop"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject385 || (_templateObject385 = _taggedTemplateLiteral34(["Shorter-Order Cook"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return [$effect(_templateObject395 || (_templateObject395 = _taggedTemplateLiteral34(["Shortly Stacked"]))), $item(_templateObject404 || (_templateObject404 = _taggedTemplateLiteral34(["short stack of pancakes"])))].some(function(x) {
        return have(x);
      });
    },
    ready: function() {
      return availableFights() >= 11 - get("_shortOrderCookCharge") && have($item(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral34(["BRICKO eye brick"]))));
    },
    do: function() {
      have($item(_templateObject4210 || (_templateObject4210 = _taggedTemplateLiteral34(["BRICKO ooze"])))) || (0, import_kolmafia37.create)($item(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.use)($item(_templateObject444 || (_templateObject444 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.runCombat)();
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject454 || (_templateObject454 = _taggedTemplateLiteral34(["Shorter-Order Cook"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return $familiar(_templateObject464 || (_templateObject464 = _taggedTemplateLiteral34(["Garbage Fire"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 30 - get("garbageFireProgress") && 5 > Witchess_exports.fightsDone();
    },
    do: function() {
      return Witchess_exports.fightPiece($monster(_templateObject474 || (_templateObject474 = _taggedTemplateLiteral34(["Witchess Bishop"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject484 || (_templateObject484 = _taggedTemplateLiteral34(["Garbage Fire"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    completed: function() {
      return $familiar(_templateObject494 || (_templateObject494 = _taggedTemplateLiteral34(["Garbage Fire"]))).dropsToday > 0;
    },
    ready: function() {
      return availableFights() >= 30 - get("garbageFireProgress") && have($item(_templateObject504 || (_templateObject504 = _taggedTemplateLiteral34(["BRICKO eye brick"]))));
    },
    do: function() {
      have($item(_templateObject5112 || (_templateObject5112 = _taggedTemplateLiteral34(["BRICKO ooze"])))) || (0, import_kolmafia37.create)($item(_templateObject5210 || (_templateObject5210 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.use)($item(_templateObject534 || (_templateObject534 = _taggedTemplateLiteral34(["BRICKO ooze"])))), (0, import_kolmafia37.runCombat)();
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject544 || (_templateObject544 = _taggedTemplateLiteral34(["Garbage Fire"])))
        }
      });
    },
    combat: new CSStrategy(function() {
    ...
    name: "Icy Revenge",
    ready: function() {
      return have($item(_templateObject554 || (_templateObject554 = _taggedTemplateLiteral34(["love song of icy revenge"]))));
    },
    completed: function() {
      return have($effect(_templateObject564 || (_templateObject564 = _taggedTemplateLiteral34(["Cold Hearted"]))), 20);
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject574 || (_templateObject574 = _taggedTemplateLiteral34(["love song of icy revenge"]))));
    }
  }, {
    name: "Blue Taffy",
    ready: function() {
      return have($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral34(["pulled blue taffy"]))));
    },
    completed: function() {
      return have($effect(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral34(["Blue Swayed"]))), 50);
    },
    do: function() {
      return (0, import_kolmafia37.use)($item(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral34(["pulled blue taffy"]))));
    }
  }, {
    name: "Tune Moon",
    ready: function() {
    ...
    do: function() {
      unequip($item(_templateObject6110 || (_templateObject6110 = _taggedTemplateLiteral34(["hewn moon-rune spoon"])))), (0, import_kolmafia37.visitUrl)("inv_use.php?whichitem=10254&pwd&doit=96&whichsign=4");
    },
    core: "soft"
  }, potionTask($item(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral34(["silver face paint"])))), meteorShower()])
}, familiarweight_default = FamiliarWeight;

// src/hotres.ts
var import_kolmafia38 = require("kolmafia");
var _templateObject150, _templateObject271, _templateObject348, _templateObject436, _templateObject530, _templateObject628, _templateObject725, _templateObject821, _templateObject919, _templateObject1018, _templateObject1117, _templateObject1217, _templateObject1317, _templateObject1414, _templateObject1514, _templateObject1614, _templateObject1713, _templateObject1813, _templateObject1913, _templateObject2013, _templateObject2118, _templateObject2218, _templateObject2315, _templateObject2413, _templateObject2512, _templateObject2612, _templateObject2712, _templateObject2810, _templateObject2910, _templateObject309, _templateObject3116, _templateObject3214, _templateObject3311, _templateObject349, _templateObject358, _templateObject367, _templateObject377, _templateObject386;
...
var buffs2 = $effects(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral35(["Elemental Saucesphere, Astral Shell"]))), HotRes = {
  ...
  outfit: function() {
    return {
      hat: $item(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral35(["Daylight Shavings Helmet"]))),
      shirt: $items(_templateObject348 || (_templateObject348 = _taggedTemplateLiteral35(["Jurassic Parka, denim jacket"]))),
      back: $item(_templateObject436 || (_templateObject436 = _taggedTemplateLiteral35(["unwrapped knock-off retro superhero cape"]))),
      weapon: $item(_templateObject530 || (_templateObject530 = _taggedTemplateLiteral35(["industrial fire extinguisher"]))),
      offhand: $item(_templateObject628 || (_templateObject628 = _taggedTemplateLiteral35(["meteorite guard"]))),
      pants: $item(_templateObject725 || (_templateObject725 = _taggedTemplateLiteral35(["designer sweatpants"]))),
      ...
      famequip: $item(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral35(["tiny stillsuit"]))),
      modes: {
        parka: "pterodactyl",
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray13(restoreBuffTasks(buffs2)), _toConsumableArray13(commonFamiliarWeightBuffs()), [_objectSpread9(_objectSpread9({}, beachTask($effect(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral35(["Hot-Headed"]))))), {}, {
    core: "hard"
  }), beachTask($effect(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral35(["Does It Have a Skull In There??"])))), asdonTask("Safely"), {
    name: "Extinguisher",
    completed: function() {
      return have($effect(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral35(["Fireproof Foam Suit"]))));
    },
    ready: function() {
      return get("_saberForceUses") < 5;
    },
    do: function() {
      (0, import_kolmafia38.adv1)($location(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral35(["The Dire Warren"]))), -1, ""), (0, import_kolmafia38.handlingChoice)() && (0, import_kolmafia38.runChoice)(-1);
    },
    ...
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar.none,
          famequip: $item.none,
          weapon: $item(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral35(["Fourth of May Cosplay Saber"]))),
          offhand: $item(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral35(["industrial fire extinguisher"])))
        }
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral35(["Fire Extinguisher: Foam Yourself"])))).skill($skill(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral35(["Use the Force"]))));
    }),
    post: function() {
      return (0, import_kolmafia38.visitUrl)("desc_item.php?whichitem=".concat($item(_templateObject2118 || (_templateObject2118 = _taggedTemplateLiteral35(["industrial fire extinguisher"]))).descid));
    }
  }, {
    core: "hard",
    name: "Pale Horse",
    ...
    completed: function() {
      return have($effect(_templateObject2218 || (_templateObject2218 = _taggedTemplateLiteral35(["Visions of the Deep Dark Deeps"]))), 20);
    },
    do: function() {
      for (; (0, import_kolmafia38.myHp)() < (0, import_kolmafia38.myMaxhp)(); )
        ensureMp(20), (0, import_kolmafia38.useSkill)(1, $skill(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral35(["Cannelloni Cocoon"]))));
      ensureMp(100), (0, import_kolmafia38.useSkill)(1, $skill(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral35(["Deep Dark Visions"]))));
    },
    outfit: {
      hat: $item(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral35(["Daylight Shavings Helmet"]))),
      shirt: $items(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral35(["Jurassic Parka, denim jacket"]))),
      back: $item(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral35(["unwrapped knock-off retro superhero cape"]))),
      weapon: $item(_templateObject2810 || (_templateObject2810 = _taggedTemplateLiteral35(["industrial fire extinguisher"]))),
      offhand: $item(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral35(["Fourth of May Cosplay Saber"]))),
      pants: $item(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral35(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject3116 || (_templateObject3116 = _taggedTemplateLiteral35(["your cowboy boots"]))),
      acc2: $item(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral35(["Beach Comb"]))),
      acc3: $item(_templateObject3311 || (_templateObject3311 = _taggedTemplateLiteral35(["Brutal brogues"]))),
      familiar: $familiar(_templateObject349 || (_templateObject349 = _taggedTemplateLiteral35(["Exotic Parrot"]))),
      famequip: $item(_templateObject358 || (_templateObject358 = _taggedTemplateLiteral35(["tiny stillsuit"]))),
      modes: {
        parka: "ghostasaurus",
        retrocape: ["vampire", "hold"]
      }
    ...
    completed: function() {
      return have($item(_templateObject367 || (_templateObject367 = _taggedTemplateLiteral35(["meteorite guard"]))));
    },
    ready: function() {
      return have($item(_templateObject377 || (_templateObject377 = _taggedTemplateLiteral35(["metal meteoroid"]))));
    },
    do: function() {
...
var levellingComplete = (0, import_kolmafia39.myLevel)() >= 13 && get("_neverendingPartyFreeTurns") >= 10, lovePotionConsidered = !1, foldshirt = function() {
  ...
  return _objectSpread10(_objectSpread10({}, task), {}, {
    outfit: function() {
      return uniform({
        changes: {
          offhand: $item(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral36(["Abracandalabra"])))
        }
      });
    }
  });
}), generalStoreItem = byStat({
  Muscle: $item(_templateObject437 || (_templateObject437 = _taggedTemplateLiteral36(["Ben-Gal\u2122 Balm"]))),
  Mysticality: $item(_templateObject531 || (_templateObject531 = _taggedTemplateLiteral36(["glittery mascara"]))),
  Moxie: $item(_templateObject629 || (_templateObject629 = _taggedTemplateLiteral36(["hair spray"])))
}), _byStat = byStat({
  Mysticality: {
    sauceFruit: $item(_templateObject726 || (_templateObject726 = _taggedTemplateLiteral36(["grapefruit"]))),
    saucePotion: $item(_templateObject822 || (_templateObject822 = _taggedTemplateLiteral36(["ointment of the occult"]))),
    sauceEffect: $effect(_templateObject920 || (_templateObject920 = _taggedTemplateLiteral36(["Mystically Oiled"])))
  },
  Muscle: {
    sauceFruit: $item(_templateObject1019 || (_templateObject1019 = _taggedTemplateLiteral36(["lemon"]))),
    saucePotion: $item(_templateObject1118 || (_templateObject1118 = _taggedTemplateLiteral36(["philter of phorce"]))),
    sauceEffect: $effect(_templateObject1218 || (_templateObject1218 = _taggedTemplateLiteral36(["Phorcefullness"])))
  },
  Moxie: {
    sauceFruit: $item(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral36(["olive"]))),
    saucePotion: $item(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral36(["serum of sarcasm"]))),
    sauceEffect: $effect(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral36(["Superhuman Sarcasm"])))
  }
}), saucePotion = _byStat.saucePotion, sauceFruit = _byStat.sauceFruit, sauceEffect = _byStat.sauceEffect, lovePotion = $item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral36(["Love Potion #XYZ"]))), loveEffect = $effect(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral36(["Tainted Love Potion"]))), Level = {
  type: "MISC",
  name: "Level",
  completed: function() {
  ...
  tasks: [innerElf(), {
    ...
    do: function() {
      return (0, import_kolmafia39.cliExecute)("shower ".concat((0, import_kolmafia39.myPrimestat)()));
    }
  }, {
    name: "Ten-Percent Bonus",
    completed: function() {
      return !have($item(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral36(["a ten-percent bonus"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          offhand: $item(_templateObject1914 || (_templateObject1914 = _taggedTemplateLiteral36(["familiar scrapbook"])))
        }
      });
    },
    effects: byStat({
      Mysticality: $effects(_templateObject2014 || (_templateObject2014 = _taggedTemplateLiteral36(["Inscrutable Gaze"]))),
      default: []
    }),
    do: function() {
      return (0, import_kolmafia39.use)(1, $item(_templateObject2119 || (_templateObject2119 = _taggedTemplateLiteral36(["a ten-percent bonus"]))));
    }
  }, {
    name: "Bastille",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia39.cliExecute)("bastille ".concat((0, import_kolmafia39.myPrimestat)(), " brutalist"));
    }
  }, {
    name: "Get Love Potion",
    completed: function() {
      return $skill(_templateObject2219 || (_templateObject2219 = _taggedTemplateLiteral36(["Love Mixology"]))).timescast > 0;
    },
    do: function() {
      return (0, import_kolmafia39.useSkill)(1, $skill(_templateObject2316 || (_templateObject2316 = _taggedTemplateLiteral36(["Love Mixology"]))));
    }
  }, {
    ...
    do: function() {
      (0, import_kolmafia39.visitUrl)("desc_effect.php?whicheffect=".concat(loveEffect.descid)), lovePotionConsidered = !0, (0, import_kolmafia39.numericModifier)(loveEffect, (0, import_kolmafia39.myPrimestat)().toString()) > 10 && import_kolmafia39.Stat.all().every(function(stat) {
        return (0, import_kolmafia39.numericModifier)(loveEffect, stat.toString()) > -30;
      }) && (0, import_kolmafia39.numericModifier)(loveEffect, "Maximum HP Percent") > -1e-3 && (0, import_kolmafia39.use)(1, lovePotion);
    }
  }, favouriteBirdTask("".concat((0, import_kolmafia39.myPrimestat)().toString(), " Percent")), {
    name: "Vaccine",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia39.cliExecute)("daycare ".concat((0, import_kolmafia39.myPrimestat)().toString().toLowerCase()));
    }
  }, beachTask($effect(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral36(["You Learned Something Maybe!"])))), beachTask($effect(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral36(["We're All Made of Starfish"])))), {
    name: "Smile of Lyle",
    completed: function() {
    ...
    completed: function() {
      return have(generalStoreItem) || have((0, import_kolmafia39.effectModifier)(generalStoreItem, "Effect"));
    },
    do: function() {
      return (0, import_kolmafia39.buy)(1, generalStoreItem);
    }
  }, potionTask(generalStoreItem), {
    name: "Triple-Sized",
    completed: function() {
      return have($effect(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral36(["Triple-Sized"]))));
    },
    do: function() {
      return (0, import_kolmafia39.useSkill)($skill(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral36(["CHEAT CODE: Triple Size"]))), 1);
    },
    outfit: {
      acc3: $item(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral36(["Powerful Glove"])))
    }
  }, {
    name: "Feel Excited",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia39.useSkill)($skill(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral36(["Feel Excitement"]))));
    }
  }].concat(_toConsumableArray14($items(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral36(["votive of confidence, natural magick candle, MayDay\u2122 supply package, Napalm In The Morning\u2122 candle"]))).map(potionTask)), [{
    name: "Acquire Blue Rocket",
    completed: function() {
      return have($effect(_templateObject3117 || (_templateObject3117 = _taggedTemplateLiteral36(["Glowing Blue"])))) || have($item(_templateObject3215 || (_templateObject3215 = _taggedTemplateLiteral36(["blue rocket"]))));
    },
    do: function() {
      (0, import_kolmafia39.visitUrl)("clan_viplounge.php?action=fwshop&whichfloor=2"), (0, import_kolmafia39.buy)(1, $item(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral36(["blue rocket"]))));
    }
  }, {
    name: "Acquire Casting Items",
    completed: function() {
      return $items(_templateObject3410 || (_templateObject3410 = _taggedTemplateLiteral36(["turtle totem, saucepan"]))).every(function(i) {
        return have(i);
      });
    },
    do: function() {
      return $items(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral36(["turtle totem, saucepan"]))).forEach(function(i) {
    ...
    completed: function() {
      return !have($item(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral36(["psychokinetic energy blob"])))) || CastSkills.every(function(_ref) {
        var completed = _ref.completed;
        return completed();
      });
    },
    do: function() {
      (0, import_kolmafia39.use)($item(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral36(["psychokinetic energy blob"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          offhand: $item(_templateObject387 || (_templateObject387 = _taggedTemplateLiteral36(["Abracandalabra"])))
        }
      });
    },
    ready: function() {
      return (0, import_kolmafia39.myMp)() + 30 < (0, import_kolmafia39.myMaxmp)();
    }
  }], _toConsumableArray14(restoreBuffTasks(byStat({
    Mysticality: $effects(_templateObject396 || (_templateObject396 = _taggedTemplateLiteral36(["Inscrutable Gaze"]))),
    Moxie: $effects(_templateObject405 || (_templateObject405 = _taggedTemplateLiteral36(["Quiet Desperation"]))),
    Muscle: $effects(_templateObject4113 || (_templateObject4113 = _taggedTemplateLiteral36(["Quiet Determination"])))
  }))), [
    {
      name: "Get Range",
      completed: function() {
      ...
      do: function() {
        have($item(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral36(["Dramatic\u2122 range"])))) || (0, import_kolmafia39.buy)(1, $item(_templateObject438 || (_templateObject438 = _taggedTemplateLiteral36(["Dramatic\u2122 range"])))), (0, import_kolmafia39.use)(1, $item(_templateObject445 || (_templateObject445 = _taggedTemplateLiteral36(["Dramatic\u2122 range"]))));
      }
    },
    {
      ...
      do: function() {
        have(saucePotion) || (0, import_kolmafia39.create)(1, saucePotion), have(saucePotion) && (0, import_kolmafia39.use)(1, saucePotion);
      }
    },
    {
      name: "Set Snojo",
    ...
    },
    {
      ...
      core: "hard",
      completed: function() {
        return have($effect(_templateObject455 || (_templateObject455 = _taggedTemplateLiteral36(["Holiday Yoked"]))));
      },
      ready: function() {
        return have($item(_templateObject465 || (_templateObject465 = _taggedTemplateLiteral36(["green mana"])))) && get("_snojoFreeFights") < 10;
      },
      do: $location(_templateObject475 || (_templateObject475 = _taggedTemplateLiteral36(["The X-32-F Combat Training Snowman"]))),
      outfit: function() {
        return uniform({
          changes: {
            familiar: $familiar(_templateObject485 || (_templateObject485 = _taggedTemplateLiteral36(["Ghost of Crimbo Carols"]))),
            famequip: $item.none
          }
        });
      },
      combat: new CSStrategy(function() {
        return Macro2.externalIf(!have($effect(_templateObject495 || (_templateObject495 = _taggedTemplateLiteral36(["Cosmic Ball in the Air"])))), Macro2.skill($skill(_templateObject505 || (_templateObject505 = _taggedTemplateLiteral36(["Bowl Straight Up"]))))).delevel().tryItem($item(_templateObject5113 || (_templateObject5113 = _taggedTemplateLiteral36(["blue rocket"])))).trySkill($skill(_templateObject5211 || (_templateObject5211 = _taggedTemplateLiteral36(["Giant Growth"])))).defaultKill();
      })
    },
    {
      ...
      core: "soft",
      completed: function() {
        return have($effect(_templateObject535 || (_templateObject535 = _taggedTemplateLiteral36(["Giant Growth"]))));
      },
      ready: function() {
        return have($item(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral36(["green mana"])))) && get("_snojoFreeFights") < 10;
      },
      do: $location(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral36(["The X-32-F Combat Training Snowman"]))),
      outfit: uniform,
      combat: new CSStrategy(function() {
        return Macro2.externalIf(!have($effect(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral36(["Cosmic Ball in the Air"])))), Macro2.skill($skill(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral36(["Bowl Straight Up"]))))).delevel().tryItem($item(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral36(["blue rocket"])))).trySkill($skill(_templateObject595 || (_templateObject595 = _taggedTemplateLiteral36(["Giant Growth"])))).defaultKill();
      })
    },
    {
      name: "Map Ninja",
      completed: function() {
        return have($item(_templateObject605 || (_templateObject605 = _taggedTemplateLiteral36(["li'l ninja costume"]))));
      },
      do: function() {
        Cartography_exports.mapMonster($location(_templateObject6111 || (_templateObject6111 = _taggedTemplateLiteral36(["The Haiku Dungeon"]))), $monster(_templateObject6210 || (_templateObject6210 = _taggedTemplateLiteral36(["amateur ninja"]))));
      },
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject633 || (_templateObject633 = _taggedTemplateLiteral36(["amateur ninja"]))), Macro2.skill($skill(_templateObject643 || (_templateObject643 = _taggedTemplateLiteral36(["Chest X-Ray"]))))).abort();
      }),
      outfit: function() {
        return uniform({
          canAttack: !1,
          changes: {
            acc3: $item(_templateObject653 || (_templateObject653 = _taggedTemplateLiteral36(["Lil' Doctor\u2122 bag"])))
          }
        });
      }
    },
    {
      name: "Witch",
      completed: function() {
        return have($item(_templateObject663 || (_templateObject663 = _taggedTemplateLiteral36(["battle broom"]))));
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject673 || (_templateObject673 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject683 || (_templateObject683 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject693 || (_templateObject693 = _taggedTemplateLiteral36(["familiar scrapbook"])))
          }
        });
      },
      prepare: function() {
        (0, import_kolmafia39.useSkill)($skill(_templateObject703 || (_templateObject703 = _taggedTemplateLiteral36(["Cannelloni Cocoon"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral36(["Witchess Witch"]))));
      },
      combat: new CSStrategy(function() {
    ...
    },
    {
      name: "King",
      completed: function() {
        return have($item(_templateObject727 || (_templateObject727 = _taggedTemplateLiteral36(["dented scepter"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject733 || (_templateObject733 = _taggedTemplateLiteral36(["Witchess King"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject743 || (_templateObject743 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject753 || (_templateObject753 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject763 || (_templateObject763 = _taggedTemplateLiteral36(["familiar scrapbook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
      ...
      prepare: function() {
        (0, import_kolmafia39.useSkill)($skill(_templateObject773 || (_templateObject773 = _taggedTemplateLiteral36(["Cannelloni Cocoon"]))));
      }
    },
    {
      name: "Queen",
      completed: function() {
        return have($item(_templateObject783 || (_templateObject783 = _taggedTemplateLiteral36(["very pointy crown"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject793 || (_templateObject793 = _taggedTemplateLiteral36(["Witchess Queen"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: byStat({
              Muscle: $item(_templateObject803 || (_templateObject803 = _taggedTemplateLiteral36(["June cleaver"]))),
              default: $item(_templateObject8110 || (_templateObject8110 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"])))
            }),
            shirt: $item(_templateObject823 || (_templateObject823 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject832 || (_templateObject832 = _taggedTemplateLiteral36(["familiar scrapbook"]))),
            familiar: $familiar(_templateObject842 || (_templateObject842 = _taggedTemplateLiteral36(["Shorter-Order Cook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
      ...
      prepare: function() {
        (0, import_kolmafia39.useSkill)($skill(_templateObject852 || (_templateObject852 = _taggedTemplateLiteral36(["Cannelloni Cocoon"])))), have($effect(_templateObject862 || (_templateObject862 = _taggedTemplateLiteral36(["Psalm of Pointiness"])))) || (0, import_kolmafia39.useSkill)($skill(_templateObject872 || (_templateObject872 = _taggedTemplateLiteral36(["The Psalm of Pointiness"]))));
      },
      post: function() {
        return uneffect($effect(_templateObject882 || (_templateObject882 = _taggedTemplateLiteral36(["Psalm of Pointiness"]))));
      }
    },
    {
      ...
      do: $location(_templateObject892 || (_templateObject892 = _taggedTemplateLiteral36(["An Unusually Quiet Barroom Brawl"]))),
      outfit: function() {
        return uniform();
      },
      combat: new CSStrategy(function() {
        return Macro2.skill($skill(_templateObject902 || (_templateObject902 = _taggedTemplateLiteral36(["Portscan"])))).defaultKill();
      })
    },
    {
      ...
      completed: function() {
        return have($item(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral36(["government cheese"]))));
      },
      do: $location(_templateObject922 || (_templateObject922 = _taggedTemplateLiteral36(["An Unusually Quiet Barroom Brawl"]))),
      outfit: function() {
        return uniform({
          changes: {
            back: $item(_templateObject932 || (_templateObject932 = _taggedTemplateLiteral36(["vampyric cloake"]))),
            acc3: $item(_templateObject942 || (_templateObject942 = _taggedTemplateLiteral36(["Lil' Doctor\u2122 bag"])))
          }
        });
      },
      combat: new CSStrategy(function() {
        return Macro2.skill($skill(_templateObject952 || (_templateObject952 = _taggedTemplateLiteral36(["Become a Bat"])))).skill($skill(_templateObject962 || (_templateObject962 = _taggedTemplateLiteral36(["Otoscope"])))).attack().repeat();
      })
    },
    {
      name: "LOV",
      ...
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject972 || (_templateObject972 = _taggedTemplateLiteral36(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject982 || (_templateObject982 = _taggedTemplateLiteral36(["makeshift garbage shirt"])))
          },
          canAttack: !1
        });
      },
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject992 || (_templateObject992 = _taggedTemplateLiteral36(["LOV Enforcer"]))), Macro2.attack().repeat()).if_($monster(_templateObject1002 || (_templateObject1002 = _taggedTemplateLiteral36(["LOV Engineer"]))), Macro2.candyblast().trySkillRepeat($skill(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral36(["Weapon of the Pastalord"]))))).if_($monster(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral36(["LOV Equivocator"]))), Macro2.delevel().easyFight().candyblast().defaultKill());
      }),
      post: function() {
        (0, import_kolmafia39.use)(1, $item(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral36(["LOV Extraterrestrial Chocolate"])))), burnLibrams();
      }
    },
    {
      name: "Snojo",
      ...
      outfit: uniform,
      do: $location(_templateObject1042 || (_templateObject1042 = _taggedTemplateLiteral36(["The X-32-F Combat Training Snowman"]))),
      combat: new CSStrategy(function() {
    ...
    },
    {
      ...
      completed: function() {
        return $effects(_templateObject1052 || (_templateObject1052 = _taggedTemplateLiteral36(["Snowballed, Half-Blooded, Half-Drained, Bruised, Relaxed Muscles, Hypnotized, Bad Haircut"]))).every(function(effect) {
          return !have(effect);
        });
      },
      do: function() {
    ...
    },
    {
      ...
      do: function() {
        return withProperties({
          ...
          try {
            (0, import_kolmafia39.useSkill)($skill(_templateObject1062 || (_templateObject1062 = _taggedTemplateLiteral36(["Evoke Eldritch Horror"])))), (0, import_kolmafia39.runCombat)();
          } catch (e) {
            (0, import_kolmafia39.print)("".concat(e));
          } finally {
            (have($effect(_templateObject1072 || (_templateObject1072 = _taggedTemplateLiteral36(["Beaten Up"])))) || (0, import_kolmafia39.myHp)() === 0 || !get("_lastCombatWon")) && (0, import_kolmafia39.cliExecute)("hottub");
          }
        });
      },
      outfit: uniform,
    ...
    },
    {
      ...
      outfit: function() {
        var _find, gear = (_find = $items(_templateObject1082 || (_templateObject1082 = _taggedTemplateLiteral36(["God Lobster's Crown, God Lobster's Robe, God Lobster's Rod, God Lobster's Ring, God Lobster's Scepter"]))).find(function(it) {
          return have(it);
        })) !== null && _find !== void 0 ? _find : $item(_templateObject1092 || (_templateObject1092 = _taggedTemplateLiteral36(["tiny stillsuit"])));
        return uniform({
          changes: {
            familiar: $familiar(_templateObject1102 || (_templateObject1102 = _taggedTemplateLiteral36(["God Lobster"]))),
            famequip: gear
          }
        });
      },
    ...
    },
    {
      ...
      do: $location(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral36(["The Deep Machine Tunnels"]))),
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            shirt: $item(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral36(["makeshift garbage shirt"]))),
            familiar: $familiar(_templateObject1132 || (_templateObject1132 = _taggedTemplateLiteral36(["Machine Elf"])))
          }
        });
      },
      combat: new CSStrategy()
    ...
    },
    {
      ...
      do: $location(_templateObject1142 || (_templateObject1142 = _taggedTemplateLiteral36(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var enoughSausages = get("_sausageFights") > 4, changes = _objectSpread10({
          shirt: $items(_templateObject1152 || (_templateObject1152 = _taggedTemplateLiteral36(["makeshift garbage shirt"])))
        }, enoughSausages ? {} : {
          offhand: $item(_templateObject1162 || (_templateObject1162 = _taggedTemplateLiteral36(["Kramco Sausage-o-Matic\u2122"])))
        });
        return uniform({
          changes: changes
        });
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($effect(_templateObject1172 || (_templateObject1172 = _taggedTemplateLiteral36(["Inner Elf"]))), Macro2.if_("!hascombatitem ".concat($item(_templateObject1182 || (_templateObject1182 = _taggedTemplateLiteral36(["cosmic bowling ball"])))), Macro2.trySkill($skill(_templateObject1192 || (_templateObject1192 = _taggedTemplateLiteral36(["Feel Pride"])))))).trySkill($skill(_templateObject1202 || (_templateObject1202 = _taggedTemplateLiteral36(["Bowl Sideways"])))).delevel().defaultKill();
      }),
    ...
    },
    {
      name: "Freekill NEP",
      completed: function() {
        return get("_shatteringPunchUsed") >= 3 && get("_gingerbreadMobHitUsed") && have($effect(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral36(["Everything Looks Yellow"])))) && get("_chestXRayUsed") >= 3;
      },
      do: $location(_templateObject1222 || (_templateObject1222 = _taggedTemplateLiteral36(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var killSource = have($effect(_templateObject1232 || (_templateObject1232 = _taggedTemplateLiteral36(["Everything Looks Yellow"])))) ? get("_chestXRayUsed") < 3 ? {
          acc3: $item(_templateObject1252 || (_templateObject1252 = _taggedTemplateLiteral36(["Lil' Doctor\u2122 bag"])))
        } : {} : {
          shirt: $item(_templateObject1242 || (_templateObject1242 = _taggedTemplateLiteral36(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
        }, enoughSausages = get("_sausageFights") > 4, changes = _objectSpread10(_objectSpread10({
          shirt: $items(_templateObject1262 || (_templateObject1262 = _taggedTemplateLiteral36(["makeshift garbage shirt"])))
        }, killSource), enoughSausages ? {} : {
          offhand: $item(_templateObject1272 || (_templateObject1272 = _taggedTemplateLiteral36(["Kramco Sausage-o-Matic\u2122"])))
        });
        return uniform({
          changes: changes
        });
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject1282 || (_templateObject1282 = _taggedTemplateLiteral36(["sausage goblin"]))), Macro2.defaultKill()).trySkill($skill(_templateObject1292 || (_templateObject1292 = _taggedTemplateLiteral36(["Bowl Sideways"])))).trySkill($skill(_templateObject1302 || (_templateObject1302 = _taggedTemplateLiteral36(["Spit jurassic acid"])))).trySkill($skill(_templateObject1319 || (_templateObject1319 = _taggedTemplateLiteral36(["Chest X-Ray"])))).trySkill($skill(_templateObject1322 || (_templateObject1322 = _taggedTemplateLiteral36(["Shattering Punch"])))).trySkill($skill(_templateObject1332 || (_templateObject1332 = _taggedTemplateLiteral36(["Gingerbread Mob Hit"])))).abort();
      }),
      choices: _defineProperty17({}, 1324, 5)
    }
  ])
...
var _templateObject160, _templateObject281, _templateObject351, _templateObject439, _templateObject536, _templateObject630, _templateObject728, _templateObject824, _templateObject921, _templateObject1020, _templateObject1120, _templateObject1220, _templateObject1320, _templateObject1416, _templateObject1516, _templateObject1616, _templateObject1715, _templateObject1815, _templateObject1915;
...
var Noncombat = {
  ...
  outfit: function() {
    return {
      ...
      back: $item(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral37(["protonic accelerator pack"]))),
      weapon: $item(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral37(["Fourth of May Cosplay Saber"]))),
      shirt: $item(_templateObject439 || (_templateObject439 = _taggedTemplateLiteral37(["Jurassic Parka"]))),
      offhand: $item(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral37(["unbreakable umbrella"]))),
      acc1: $item(_templateObject630 || (_templateObject630 = _taggedTemplateLiteral37(["hewn moon-rune spoon"]))),
      acc2: $item(_templateObject728 || (_templateObject728 = _taggedTemplateLiteral37(["codpiece"]))),
  ...
  tasks: [{
    ...
    completed: function() {
      return have($effect(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral37(["Invisible Avatar"]))));
    },
    do: function() {
      return (0, import_kolmafia40.useSkill)($skill(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral37(["CHEAT CODE: Invisible Avatar"]))));
    },
    outfit: {
      acc3: $item(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral37(["Powerful Glove"])))
    }
  }, birdTask("Combat Rate", !1), favouriteBirdTask("Combat Rate", !1), songTask($effect(_templateObject1516 || (_templateObject1516 = _taggedTemplateLiteral37(["The Sonata of Sneakiness"]))), $effect(_templateObject1616 || (_templateObject1616 = _taggedTemplateLiteral37(["Fat Leon's Phat Loot Lyric"])))), restore($effects(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral37(["Smooth Movements, The Sonata of Sneakiness"])))), {
    name: "Swim Sprints",
    completed: function() {
    ...
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral37(["God Lobster"]))),
          famequip: $item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral37(["God Lobster's Ring"])))
        }
      });
    },
...
var _templateObject161, _templateObject290, _templateObject360, _templateObject440, _templateObject537, _templateObject631, _templateObject729, _templateObject825, _templateObject923, _templateObject1021, _templateObject1121, _templateObject1221, _templateObject1321, _templateObject1417, _templateObject1517, _templateObject1617, _templateObject1716, _templateObject1816, _templateObject1916, _templateObject2015, _templateObject2120, _templateObject2220, _templateObject2317, _templateObject2415, _templateObject2514, _templateObject2614, _templateObject2714, _templateObject2812, _templateObject2912, _templateObject3011, _templateObject3118, _templateObject3216, _templateObject3313, _templateObject3411, _templateObject3510, _templateObject369, _templateObject379, _templateObject388, _templateObject397, _templateObject406, _templateObject4114, _templateObject4212, _templateObject4310, _templateObject446, _templateObject456, _templateObject466, _templateObject476, _templateObject486, _templateObject496, _templateObject506, _templateObject5114, _templateObject5212, _templateObject538, _templateObject546, _templateObject556, _templateObject566, _templateObject576, _templateObject586, _templateObject596, _templateObject606, _templateObject6112, _templateObject6211, _templateObject634, _templateObject644, _templateObject654, _templateObject664;
...
var PULLS = [$items(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral38(["repaid diaper, Great Wolf's beastly trousers"]))), $items(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral38(["meteorite necklace"]))), $items(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral38(["Stick-Knife of Loathing"]))), have($familiar(_templateObject440 || (_templateObject440 = _taggedTemplateLiteral38(["Comma Chameleon"])))) ? $items(_templateObject537 || (_templateObject537 = _taggedTemplateLiteral38(["Buddy Bjorn"]))) : $items(_templateObject631 || (_templateObject631 = _taggedTemplateLiteral38(["moveable feast"])))], codpieceAttempted = !1, MARKET_QUESTS = [{
  ...
  tasks: [{
    name: "Set Workshed",
    completed: function() {
      return (0, import_kolmafia41.getWorkshed)() === $item(_templateObject729 || (_templateObject729 = _taggedTemplateLiteral38(["Asdon Martin keyfob"])));
    },
    do: function() {
      return (0, import_kolmafia41.use)($item(_templateObject825 || (_templateObject825 = _taggedTemplateLiteral38(["Asdon Martin keyfob"]))));
    }
    ...
    ready: function() {
      return have($item(_templateObject923 || (_templateObject923 = _taggedTemplateLiteral38(["S.I.T. Course Completion Certificate"]))));
    },
    completed: function() {
      return get("_sitCourseCompleted") || have($skill(_templateObject1021 || (_templateObject1021 = _taggedTemplateLiteral38(["Insectologist"]))));
    },
    do: function() {
      return (0, import_kolmafia41.use)($item(_templateObject1121 || (_templateObject1121 = _taggedTemplateLiteral38(["S.I.T. Course Completion Certificate"]))));
    },
    choices: {
      1494: 2
    }
    ...
    do: function() {
      return AutumnAton_exports.sendTo($location(_templateObject1221 || (_templateObject1221 = _taggedTemplateLiteral38(["The Sleazy Back Alley"]))));
    }
  }, {
    name: "Borrow Time",
    completed: function() {
    ...
    do: function() {
      have($item(_templateObject1321 || (_templateObject1321 = _taggedTemplateLiteral38(["borrowed time"])))) || (0, import_kolmafia41.create)(1, $item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral38(["borrowed time"])))), (0, import_kolmafia41.use)(1, $item(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral38(["borrowed time"]))));
    }
  }, deckTask("Forest"), deckTask("Island"), {
    name: "Ancestral Recall",
    completed: function() {
      return !have($item(_templateObject1617 || (_templateObject1617 = _taggedTemplateLiteral38(["blue mana"]))));
    },
    do: function() {
      return (0, import_kolmafia41.useSkill)($skill(_templateObject1716 || (_templateObject1716 = _taggedTemplateLiteral38(["Ancestral Recall"]))));
    }
  }, _objectSpread11(_objectSpread11({}, deckTask("1952 Mickey Mantle")), {}, {
    class: $classes(_templateObject1816 || (_templateObject1816 = _taggedTemplateLiteral38(["Pastamancer, Seal Clubber, Disco Bandit, Accordion Thief"])))
  }), {
    name: "Sell Mickey Mantle",
    completed: function() {
      return !have($item(_templateObject1916 || (_templateObject1916 = _taggedTemplateLiteral38(["1952 Mickey Mantle card"]))));
    },
    do: function() {
      return (0, import_kolmafia41.autosell)(1, $item(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral38(["1952 Mickey Mantle card"]))));
    }
  }, {
    name: "Sell Space Blanket",
    completed: function() {
      return $items(_templateObject2120 || (_templateObject2120 = _taggedTemplateLiteral38(["space blanket, MayDay\u2122 supply package"]))).every(function(i) {
        return !have(i);
      });
    },
    do: function() {
      have($item(_templateObject2220 || (_templateObject2220 = _taggedTemplateLiteral38(["MayDay\u2122 supply package"])))) && (0, import_kolmafia41.use)($item(_templateObject2317 || (_templateObject2317 = _taggedTemplateLiteral38(["MayDay\u2122 supply package"])))), (0, import_kolmafia41.autosell)(1, $item(_templateObject2415 || (_templateObject2415 = _taggedTemplateLiteral38(["space blanket"]))));
    },
    class: $classes(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral38(["Turtle Tamer, Sauceror"])))
  }, {
    name: "Barrel Hoop Earring",
    completed: function() {
      return get("_barrelPrayer");
    },
    class: $classes(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral38(["Seal Clubber, Disco Bandit"]))),
    do: function() {
      return (0, import_kolmafia41.cliExecute)("barrelprayer glamour");
    }
  }, {
    name: "Unlock Beach",
    completed: function() {
      return (0, import_kolmafia41.canAdventure)($location(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral38(["South of the Border"]))));
    },
    do: function() {
      var desertAccessItem = (0, import_kolmafia41.knollAvailable)() ? $item(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral38(["bitchin' meatcar"]))) : $item(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral38(["Desert Bus pass"])));
      have(desertAccessItem) || (0, import_kolmafia41.cliExecute)("acquire ".concat(desertAccessItem.name));
    }
  }, {
    name: "Juice Bar",
    completed: function() {
    ...
    do: function() {
      (0, import_kolmafia41.visitUrl)("place.php?whichplace=chateau&action=chateau_desk2"), (0, import_kolmafia41.autosell)(1, $item(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral38(["gremlin juice"]))));
    }
  }, {
    name: "Vote!",
    completed: function() {
      return have($item(_templateObject3118 || (_templateObject3118 = _taggedTemplateLiteral38(['"I Voted!" sticker']))));
    },
    do: function() {
      (0, import_kolmafia41.visitUrl)("place.php?whichplace=town_right&action=townright_vote"), (0, import_kolmafia41.visitUrl)("choice.php?option=1&whichchoice=1331&g=2&local%5B%5D=".concat(BEST_INITIATIVE, "&local%5B%5D=").concat(BEST_INITIATIVE)), (0, import_kolmafia41.visitUrl)("place.php?whichplace=town_right&action=townright_vote");
    }
  }, {
    name: "Terminal Skills",
    completed: function() {
      return SourceTerminal_exports.getSkills().every(function(skill2) {
        return $skills(_templateObject3216 || (_templateObject3216 = _taggedTemplateLiteral38(["Extract, Portscan"]))).includes(skill2);
      }) && !!SourceTerminal_exports.getSkills().length;
    },
    do: function() {
      return SourceTerminal_exports.educate([$skill(_templateObject3313 || (_templateObject3313 = _taggedTemplateLiteral38(["Extract"]))), $skill(_templateObject3411 || (_templateObject3411 = _taggedTemplateLiteral38(["Portscan"])))]);
    }
  }, {
    name: "Change Clan",
    completed: function() {
    ...
    name: "Toot",
    completed: function() {
      return have($item(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral38(["big rock"]))));
    },
    do: function() {
      (0, import_kolmafia41.visitUrl)("tutorial.php?action=toot"), tryUse(1, $item(_templateObject369 || (_templateObject369 = _taggedTemplateLiteral38(["letter from King Ralph XI"])))), tryUse(1, $item(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral38(["pork elf goodies sack"])))), (0, import_kolmafia41.autosell)(5, $item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral38(["baconstone"])))), (0, import_kolmafia41.autosell)(5, $item(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral38(["hamethyst"]))));
    }
  }, {
    name: "Accordion",
    class: $classes(_templateObject406 || (_templateObject406 = _taggedTemplateLiteral38(["Seal Clubber, Turtle Tamer, Disco Bandit, Sauceror, Pastamancer"]))),
    completed: function() {
      return have($item(_templateObject4114 || (_templateObject4114 = _taggedTemplateLiteral38(["toy accordion"]))));
    },
    do: function() {
      return (0, import_kolmafia41.buy)(1, $item(_templateObject4212 || (_templateObject4212 = _taggedTemplateLiteral38(["toy accordion"]))));
    }
  }, {
    ...
    ready: function() {
      return have($skill(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral38(["Summon Confiscated Things"]))));
    },
    do: function() {
      (0, import_kolmafia41.useSkill)(1, $skill(_templateObject446 || (_templateObject446 = _taggedTemplateLiteral38(["Summon Confiscated Things"])))), $items(_templateObject456 || (_templateObject456 = _taggedTemplateLiteral38(['glow-in-the-dark necklace, "KICK ME" sign, LCD game: Burger Belt, LCD game: Food Eater, LCD game: Garbage River']))).forEach(function(item6) {
    ...
    ready: function() {
      return have($skill(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral38(["Summon Tasteful Items"]))));
    },
    do: function() {
      (0, import_kolmafia41.useSkill)(1, $skill(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral38(["Summon Tasteful Items"])))), $items(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral38(["black-and-blue light, blue plasma ball, cheap studded belt, flavored foot massage oil, foam dart, Loudmouth Larry Lamprey, personal massager, personalized coffee mug, stick-on eyebrow piercing"]))).forEach(function(item6) {
        return (0, import_kolmafia41.autosell)((0, import_kolmafia41.itemAmount)(item6), item6);
      });
    }
  }, {
    ...
    ready: function() {
      return have($skill(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral38(["Summon Alice's Army Cards"]))));
    },
    do: function() {
      (0, import_kolmafia41.useSkill)(1, $skill(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral38(["Summon Alice's Army Cards"])))), !have($item(_templateObject5114 || (_templateObject5114 = _taggedTemplateLiteral38(["tobiko marble soda"])))) && !CommunityService.SpellDamage.isDone() && (0, import_kolmafia41.buy)($coinmaster(_templateObject5212 || (_templateObject5212 = _taggedTemplateLiteral38(["Game Shoppe Snacks"]))), 1, $item(_templateObject538 || (_templateObject538 = _taggedTemplateLiteral38(["tobiko marble soda"]))));
    }
  }, {
    name: "Drinking Helmet",
    completed: function() {
      return have($item(_templateObject546 || (_templateObject546 = _taggedTemplateLiteral38(["dromedary drinking helmet"]))));
    },
    do: function() {
      (0, import_kolmafia41.useFamiliar)($familiar(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral38(["Melodramedary"])))), have($item(_templateObject566 || (_templateObject566 = _taggedTemplateLiteral38(["box of Familiar Jacks"])))) || (0, import_kolmafia41.create)(1, $item(_templateObject576 || (_templateObject576 = _taggedTemplateLiteral38(["box of Familiar Jacks"])))), (0, import_kolmafia41.use)(1, $item(_templateObject586 || (_templateObject586 = _taggedTemplateLiteral38(["box of Familiar Jacks"]))));
    }
  }, {
    name: "Mummery",
    completed: function() {
      return get("_mummeryMods").includes((0, import_kolmafia41.myPrimestat)().toString());
    },
    do: function() {
      (0, import_kolmafia41.useFamiliar)($familiar(_templateObject596 || (_templateObject596 = _taggedTemplateLiteral38(["Melodramedary"])))), (0, import_kolmafia41.cliExecute)("mummery ".concat((0, import_kolmafia41.myPrimestat)().toString().toLowerCase()));
    }
  }, {
    name: "Shortsuit",
    completed: function() {
      return !(0, import_kolmafia41.itemAmount)($item(_templateObject606 || (_templateObject606 = _taggedTemplateLiteral38(["tiny stillsuit"]))));
    },
    do: function() {
      return (0, import_kolmafia41.equip)($familiar(_templateObject6112 || (_templateObject6112 = _taggedTemplateLiteral38(["Shorter-Order Cook"]))), $item(_templateObject6211 || (_templateObject6211 = _taggedTemplateLiteral38(["tiny stillsuit"]))));
    }
  }, {
    name: "Horsery",
    completed: function() {
    ...
    name: "Cowboy Boots",
    completed: function() {
      return have($item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral38(["your cowboy boots"]))));
    },
    do: function() {
    ...
    completed: function() {
      return have($item(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral38(["gold detective badge"]))));
    },
    do: function() {
    ...
    name: "Codpiece",
    completed: function() {
      return have($item(_templateObject654 || (_templateObject654 = _taggedTemplateLiteral38(["codpiece"])))) || codpieceAttempted;
    },
    do: function() {
    ...
    do: function() {
      return (0, import_kolmafia41.use)($item(_templateObject664 || (_templateObject664 = _taggedTemplateLiteral38(["Bird-a-Day calendar"]))));
    }
  }, {
    name: "Guild Quest",
    completed: function() {
    ...
    do: function() {
      return (0, import_kolmafia41.visitUrl)("guild.php?place=challenge");
    }
  }])
...
var _templateObject170, _templateObject291, _templateObject361, _templateObject441, _templateObject539, _templateObject635, _templateObject730, _templateObject826, _templateObject924, _templateObject1023, _templateObject1123, _templateObject1223, _templateObject1323, _templateObject1418, _templateObject1518, _templateObject1618, _templateObject1717, _templateObject1817, _templateObject1917, _templateObject2016, _templateObject2121, _templateObject2221, _templateObject2318, _templateObject2416, _templateObject2515, _templateObject2615, _templateObject2715, _templateObject2813, _templateObject2913, _templateObject3012, _templateObject3119, _templateObject3217, _templateObject3314, _templateObject3412, _templateObject3511, _templateObject3610, _templateObject3710, _templateObject389, _templateObject398, _templateObject407, _templateObject4115, _templateObject4213, _templateObject4311, _templateObject447, _templateObject457, _templateObject467, _templateObject477, _templateObject487, _templateObject497, _templateObject507, _templateObject5115, _templateObject5213, _templateObject5310, _templateObject547, _templateObject557, _templateObject567, _templateObject577;
...
var buffs3 = $effects(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral39(["Carol of the Hells, Arched Eyebrow of the Archmage, Song of Sauce"]))), chefstaves = $items(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral39(["Staff of the Roaring Hearth, Staff of Simmering Hatred, Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist"]))), Spell = {
  name: "Spell Damage",
  type: "SERVICE",
  test: CommunityService.SpellDamage,
  outfit: function() {
    return _objectSpread12(_objectSpread12({
      hat: $items(_templateObject361 || (_templateObject361 = _taggedTemplateLiteral39(["astral chapeau, Hollandaise helmet, Iunion Crown"]))),
      weapon: [].concat(_toConsumableArray17(chefstaves), [$item(_templateObject441 || (_templateObject441 = _taggedTemplateLiteral39(["weeping willow wand"])))]),
      offhand: $item(_templateObject539 || (_templateObject539 = _taggedTemplateLiteral39(["Abracandalabra"]))),
      pants: $item(_templateObject635 || (_templateObject635 = _taggedTemplateLiteral39(["designer sweatpants"]))),
      acc1: $items(_templateObject730 || (_templateObject730 = _taggedTemplateLiteral39(["meteorite necklace, Kremlin's Greatest Briefcase"]))),
      ...
      familiar: $familiar(_templateObject1223 || (_templateObject1223 = _taggedTemplateLiteral39(["Left-Hand Man"]))),
      equipment: $item(_templateObject1323 || (_templateObject1323 = _taggedTemplateLiteral39(["astral statuette"])))
    }), have($item(_templateObject1418 || (_templateObject1418 = _taggedTemplateLiteral39(["Buddy Bjorn"])))) ? {
      back: $item(_templateObject1518 || (_templateObject1518 = _taggedTemplateLiteral39(["Buddy Bjorn"]))),
      riders: {
        "buddy-bjorn": $familiar(_templateObject1618 || (_templateObject1618 = _taggedTemplateLiteral39(["Mechanical Songbird"])))
      }
    } : {});
  },
  turnsSpent: 1,
  maxTurns: 30,
  tasks: [skillTask($skill(_templateObject1717 || (_templateObject1717 = _taggedTemplateLiteral39(["Simmer"])))), {
    name: "Do You Crush What I Crush?",
    completed: function() {
      return have($effect(_templateObject1817 || (_templateObject1817 = _taggedTemplateLiteral39(["Do You Crush What I Crush?"]))));
    },
    ready: function() {
      return !have($effect(_templateObject1917 || (_templateObject1917 = _taggedTemplateLiteral39(["Holiday Yoked"]))));
    },
    do: $location(_templateObject2016 || (_templateObject2016 = _taggedTemplateLiteral39(["The Dire Warren"]))),
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject2121 || (_templateObject2121 = _taggedTemplateLiteral39(["Ghost of Crimbo Carols"]))),
          famequip: $item.none
        }
      });
    },
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject2221 || (_templateObject2221 = _taggedTemplateLiteral39(["Asdon Martin: Spring-Loaded Front Bumper"])))).trySkill($skill(_templateObject2318 || (_templateObject2318 = _taggedTemplateLiteral39(["Feel Hatred"])))).trySkill($skill(_templateObject2416 || (_templateObject2416 = _taggedTemplateLiteral39(["Snokebomb"])))).abort();
    })
  }, {
    name: "Barrel Prayer",
    class: $classes(_templateObject2515 || (_templateObject2515 = _taggedTemplateLiteral39(["Sauceror"]))),
    completed: function() {
      return get("_barrelPrayer");
    },
    do: function() {
      return (0, import_kolmafia42.cliExecute)("barrelprayer buff");
    }
  }, potionTask($item(_templateObject2615 || (_templateObject2615 = _taggedTemplateLiteral39(["tobiko marble soda"])))), songTask($effect(_templateObject2715 || (_templateObject2715 = _taggedTemplateLiteral39(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject2813 || (_templateObject2813 = _taggedTemplateLiteral39(["The Sonata of Sneakiness"]))))].concat(_toConsumableArray17(restoreBuffTasks(buffs3)), [beachTask($effect(_templateObject2913 || (_templateObject2913 = _taggedTemplateLiteral39(["We're All Made of Starfish"])))), potionTask($item(_templateObject3012 || (_templateObject3012 = _taggedTemplateLiteral39(["LOV Elixir #6"])))), {
    name: "Cargopocket",
    completed: function() {
      return get("_cargoPocketEmptied");
    },
    ready: function() {
      return $items(_templateObject3119 || (_templateObject3119 = _taggedTemplateLiteral39(["sizzling desk bell, frost-rimed desk bell, uncanny desk bell, nasty desk bell, greasy desk bell"]))).every(function(item6) {
  ...
  }, potionTask($item(_templateObject3217 || (_templateObject3217 = _taggedTemplateLiteral39(["Yeg's Motel hand soap"])))), {
    name: "Briefcase",
    ready: function() {
      return !$items(_templateObject3314 || (_templateObject3314 = _taggedTemplateLiteral39(["meteorite fragment, meteorite earring, meteorite necklace, meteorite ring"]))).some(function(item6) {
        return have(item6);
      });
    },
    completed: function() {
      return (0, import_kolmafia42.numericModifier)($item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral39(["Kremlin's Greatest Briefcase"]))), "Spell Damage Percent") > 0;
    },
    do: function() {
    ...
    name: "Mariachi Hat",
    completed: function() {
      return have($item(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral39(["mariachi hat"]))));
    },
    do: function() {
      return (0, import_kolmafia42.retrieveItem)($item(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral39(["mariachi hat"]))));
    }
  }, {
    name: "Weeping Willow Wand",
    completed: function() {
      return have($item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral39(["weeping willow wand"]))));
    },
    core: "hard",
    do: function() {
      have($item(_templateObject389 || (_templateObject389 = _taggedTemplateLiteral39(["flimsy hardwood scraps"])))) || (0, import_kolmafia42.visitUrl)("shop.php?whichshop=lathe"), (0, import_kolmafia42.retrieveItem)($item(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral39(["weeping willow wand"]))));
    }
  }, {
    name: "Tea Party",
    completed: function() {
    ...
    prepare: function() {
      (0, import_kolmafia42.visitUrl)("clan_viplounge.php?action=lookingglass&whichfloor=2"), (0, import_kolmafia42.use)($item(_templateObject407 || (_templateObject407 = _taggedTemplateLiteral39(['"DRINK ME" potion']))));
    }
  }, skillTask($skill(_templateObject4115 || (_templateObject4115 = _taggedTemplateLiteral39(["Spirit of Cayenne"])))), potionTask($item(_templateObject4213 || (_templateObject4213 = _taggedTemplateLiteral39(["flask of baconstone juice"])))), {
    name: "Saucefingers",
    ready: function() {
      return (0, import_kolmafia42.myLevel)() >= 15 && have($familiar(_templateObject4311 || (_templateObject4311 = _taggedTemplateLiteral39(["Mini-Adventurer"]))));
    },
    completed: function() {
      return have($effect(_templateObject447 || (_templateObject447 = _taggedTemplateLiteral39(["Saucefingers"]))));
    },
    class: $classes(_templateObject457 || (_templateObject457 = _taggedTemplateLiteral39(["Pastamancer"]))),
    do: $location(_templateObject467 || (_templateObject467 = _taggedTemplateLiteral39(["The Dire Warren"]))),
    prepare: function() {
      return horsery() === "pale" && horse("dark");
    },
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral39(["Mini-Adventurer"])))
        }
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject487 || (_templateObject487 = _taggedTemplateLiteral39(["Asdon Martin: Spring-Loaded Front Bumper"])))).trySkill($skill(_templateObject497 || (_templateObject497 = _taggedTemplateLiteral39(["Feel Hatred"])))).trySkill($skill(_templateObject507 || (_templateObject507 = _taggedTemplateLiteral39(["Snokebomb"])))).abort();
    }),
    ...
    core: "soft",
    completed: function() {
      return have($item(_templateObject5115 || (_templateObject5115 = _taggedTemplateLiteral39(["meteorite necklace"]))));
    },
    ready: function() {
      return (0, import_kolmafia42.canadiaAvailable)() && $items(_templateObject5213 || (_templateObject5213 = _taggedTemplateLiteral39(["meteorite fragment, meteorite earring, meteorite ring"]))).some(function(item6) {
        return have(item6);
      });
    },
    do: function() {
      var meteor = $items(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral39(["meteorite ring, meteorite fragment, meteorite earring"]))).find(function(item6) {
        return have(item6);
      });
      meteor && (unequip(meteor), (0, import_kolmafia42.retrieveItem)(1, $item(_templateObject547 || (_templateObject547 = _taggedTemplateLiteral39(["tenderizing hammer"])))), (0, import_kolmafia42.retrieveItem)(1, $item(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral39(["jewelry-making pliers"])))), meteor !== $item(_templateObject567 || (_templateObject567 = _taggedTemplateLiteral39(["meteorite fragment"]))) && (0, import_kolmafia42.cliExecute)("smash ".concat(meteor)), (0, import_kolmafia42.cliExecute)("make ".concat($item(_templateObject577 || (_templateObject577 = _taggedTemplateLiteral39(["meteorite necklace"]))))));
    }
  }, {
    name: "Pull Staff",
    ready: function() {
      ...
      }).length > 0 && (0, import_kolmafia42.pullsRemaining)() > 0;
    },
    completed: function() {
...
var _templateObject171, _templateObject2100, _templateObject370, _templateObject448, _templateObject540, _templateObject636, _templateObject731, _templateObject827, _templateObject925, _templateObject1024, _templateObject1124, _templateObject1224, _templateObject1324, _templateObject1419, _templateObject1519, _templateObject1619, _templateObject1718, _templateObject1818, _templateObject1918, _templateObject2017, _templateObject2122, _templateObject2222, _templateObject2319, _templateObject2417, _templateObject2516, _templateObject2616, _templateObject2716, _templateObject2814, _templateObject2914, _templateObject3013, _templateObject3120, _templateObject3218, _templateObject3315, _templateObject3413, _templateObject3512, _templateObject3611, _templateObject3711, _templateObject3810, _templateObject399, _templateObject408, _templateObject4116, _templateObject4214, _templateObject4312, _templateObject449, _templateObject458, _templateObject468, _templateObject478, _templateObject488, _templateObject498, _templateObject508, _templateObject5116, _templateObject5214, _templateObject5311, _templateObject548, _templateObject558, _templateObject568, _templateObject578, _templateObject587, _templateObject597, _templateObject607, _templateObject6113, _templateObject6212, _templateObject637, _templateObject645, _templateObject655, _templateObject665, _templateObject674, _templateObject684, _templateObject694;
...
var SKILL_BUFFS = {
  ...
  MYSTICALITY: $effects(_templateObject2100 || (_templateObject2100 = _taggedTemplateLiteral40(["Feeling Excited, Big, Song of Bravado, Quiet Judgement"]))),
  MOXIE: $effects(_templateObject370 || (_templateObject370 = _taggedTemplateLiteral40(["Feeling Excited, Big, Song of Bravado, Quiet Desperation, Disco Fever, Blubbered Up, Mariachi Mood, Disco State of Mind"]))),
...
function thrallTask(thrall) {
  return {
    ...
    class: $classes(_templateObject540 || (_templateObject540 = _taggedTemplateLiteral40(["Pastamancer"]))),
    completed: function() {
...
function equalizeTask() {
  return _objectSpread13(_objectSpread13({}, potionTask(byStat({
    Moxie: $item(_templateObject636 || (_templateObject636 = _taggedTemplateLiteral40(["oil of slipperiness"]))),
    Muscle: $item(_templateObject731 || (_templateObject731 = _taggedTemplateLiteral40(["oil of stability"]))),
    Mysticality: $item(_templateObject827 || (_templateObject827 = _taggedTemplateLiteral40(["oil of expertise"])))
  }))), {}, {
    class: $classes(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral40(["Seal Clubber, Turtle Tamer, Disco Bandit, Accordion Thief, Sauceror"])))
  });
}
var Muscle = {
  name: "Muscle",
  ...
  outfit: function() {
    return have($item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject1124 || (_templateObject1124 = _taggedTemplateLiteral40(["wad of used tape"]))),
      weapon: $item(_templateObject1224 || (_templateObject1224 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject1324 || (_templateObject1324 = _taggedTemplateLiteral40(["dented scepter"]))),
      shirt: $item(_templateObject1419 || (_templateObject1419 = _taggedTemplateLiteral40(["Jurassic Parka"]))),
      back: $item(_templateObject1519 || (_templateObject1519 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      pants: $item(_templateObject1619 || (_templateObject1619 = _taggedTemplateLiteral40(["designer sweatpants"]))),
      acc1: $item(_templateObject1718 || (_templateObject1718 = _taggedTemplateLiteral40(["Brutal brogues"]))),
      acc2: $items(_templateObject1818 || (_templateObject1818 = _taggedTemplateLiteral40(["meteorite necklace, Retrospecs"]))),
      acc3: byStat({
        Muscle: $item(_templateObject1918 || (_templateObject1918 = _taggedTemplateLiteral40(["your cowboy boots"]))),
        default: $item(_templateObject2017 || (_templateObject2017 = _taggedTemplateLiteral40(["Kremlin's Greatest Briefcase"])))
      }),
      familiar: $familiar(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral40(["Left-Hand Man"]))),
      modes: {
        retrocape: ["vampire", RetroCape_exports.currentMode()],
        parka: "dilophosaur",
        umbrella: "broken"
      },
      famequip: $item(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral40(["unbreakable umbrella"])))
    };
  },
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MUSCLE")), [potionTask($item(_templateObject2319 || (_templateObject2319 = _taggedTemplateLiteral40(["LOV Elixir #3"])))), thrallTask($thrall(_templateObject2417 || (_templateObject2417 = _taggedTemplateLiteral40(["Elbow Macaroni"])))), beachTask($effect(_templateObject2516 || (_templateObject2516 = _taggedTemplateLiteral40(["Lack of Body-Building"])))), birdTask("Muscle Percent"), favouriteBirdTask("Muscle Percent"), _objectSpread13(_objectSpread13({}, innerElf()), {}, {
    core: "hard"
  }), _objectSpread13(_objectSpread13({}, potionTask($item(_templateObject2616 || (_templateObject2616 = _taggedTemplateLiteral40(["Ben-Gal\u2122 Balm"]))))), {}, {
    core: "hard"
  }), equalizeTask()])
}, Mysticality = {
  name: "Mysticality",
  ...
  outfit: function() {
    return have($item(_templateObject2716 || (_templateObject2716 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject2814 || (_templateObject2814 = _taggedTemplateLiteral40(["wad of used tape"]))),
      weapon: $item(_templateObject2914 || (_templateObject2914 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      offhand: $items(_templateObject3013 || (_templateObject3013 = _taggedTemplateLiteral40(["astral statuette, industrial fire extinguisher"]))),
      back: $item(_templateObject3120 || (_templateObject3120 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      shirt: $items(_templateObject3218 || (_templateObject3218 = _taggedTemplateLiteral40(["denim jacket, shoe ad T-shirt, fresh coat of paint"]))),
      pants: $item(_templateObject3315 || (_templateObject3315 = _taggedTemplateLiteral40(["designer sweatpants"]))),
      acc1: byStat({
        Mysticality: $item(_templateObject3413 || (_templateObject3413 = _taggedTemplateLiteral40(["your cowboy boots"]))),
        default: $items(_templateObject3512 || (_templateObject3512 = _taggedTemplateLiteral40(["barrel hoop earring, Powerful Glove"])))
      }),
      acc2: $item(_templateObject3611 || (_templateObject3611 = _taggedTemplateLiteral40(["codpiece"]))),
      acc3: $item(_templateObject3711 || (_templateObject3711 = _taggedTemplateLiteral40(["battle broom"]))),
      famequip: $items(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral40(["Abracandalabra"]))),
      familiar: $familiar(_templateObject399 || (_templateObject399 = _taggedTemplateLiteral40(["Left-Hand Man"]))),
      modes: {
  ...
  outfit: function() {
    return {
      hat: $item(_templateObject408 || (_templateObject408 = _taggedTemplateLiteral40(["very pointy crown"]))),
      shirt: $item(_templateObject4116 || (_templateObject4116 = _taggedTemplateLiteral40(["Jurassic Parka"]))),
      back: $item(_templateObject4214 || (_templateObject4214 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      weapon: $item(_templateObject4312 || (_templateObject4312 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject449 || (_templateObject449 = _taggedTemplateLiteral40(["unbreakable umbrella"]))),
      pants: $item(_templateObject458 || (_templateObject458 = _taggedTemplateLiteral40(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject468 || (_templateObject468 = _taggedTemplateLiteral40(["Beach Comb"]))),
      acc2: byStat({
        Moxie: $item(_templateObject478 || (_templateObject478 = _taggedTemplateLiteral40(["your cowboy boots"]))),
        default: $item(_templateObject488 || (_templateObject488 = _taggedTemplateLiteral40(['"I Voted!" sticker'])))
      }),
      acc3: $items(_templateObject498 || (_templateObject498 = _taggedTemplateLiteral40(["meteorite necklace, Retrospecs"]))),
      famequip: $item(_templateObject508 || (_templateObject508 = _taggedTemplateLiteral40(["miniature crystal ball"]))),
      modes: {
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MOXIE")), [birdTask("Moxie Percent"), favouriteBirdTask("Moxie Percent")], _toConsumableArray18($items(_templateObject5116 || (_templateObject5116 = _taggedTemplateLiteral40(["runproof mascara, confiscated love note, dollop of barbecue sauce"]))).map(potionTask)), [{
    name: "Rhinestones",
    completed: function() {
      return !have($item(_templateObject5214 || (_templateObject5214 = _taggedTemplateLiteral40(["rhinestone"]))));
    },
    do: function() {
      return (0, import_kolmafia43.use)((0, import_kolmafia43.itemAmount)($item(_templateObject5311 || (_templateObject5311 = _taggedTemplateLiteral40(["rhinestone"])))), $item(_templateObject548 || (_templateObject548 = _taggedTemplateLiteral40(["rhinestone"]))));
    }
  }, thrallTask($thrall(_templateObject558 || (_templateObject558 = _taggedTemplateLiteral40(["Penne Dreadful"])))), equalizeTask()])
}, Hitpoints = {
  name: "Hitpoints",
  type: "SERVICE",
  ...
  maxTurns: 1,
  outfit: function() {
    return have($item(_templateObject568 || (_templateObject568 = _taggedTemplateLiteral40(["wad of used tape"])))) || (0, import_kolmafia43.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject578 || (_templateObject578 = _taggedTemplateLiteral40(["wad of used tape"]))),
      weapon: $item(_templateObject587 || (_templateObject587 = _taggedTemplateLiteral40(["dented scepter"]))),
      offhand: $item(_templateObject597 || (_templateObject597 = _taggedTemplateLiteral40(["Fourth of May Cosplay Saber"]))),
      shirt: $items(_templateObject607 || (_templateObject607 = _taggedTemplateLiteral40(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
      back: $item(_templateObject6113 || (_templateObject6113 = _taggedTemplateLiteral40(["unwrapped knock-off retro superhero cape"]))),
      pants: $item(_templateObject6212 || (_templateObject6212 = _taggedTemplateLiteral40(["Cargo Cultist Shorts"]))),
      acc1: $item(_templateObject637 || (_templateObject637 = _taggedTemplateLiteral40(["Brutal brogues"]))),
      acc2: byStat({
        Muscle: $item(_templateObject645 || (_templateObject645 = _taggedTemplateLiteral40(["your cowboy boots"]))),
        default: $item(_templateObject655 || (_templateObject655 = _taggedTemplateLiteral40(["Kremlin's Greatest Briefcase"])))
      }),
      acc3: $items(_templateObject665 || (_templateObject665 = _taggedTemplateLiteral40(["meteorite necklace, Retrospecs"]))),
      famequip: $item(_templateObject674 || (_templateObject674 = _taggedTemplateLiteral40(["miniature crystal ball"]))),
      modes: {
        retrocape: ["vampire", RetroCape_exports.currentMode()],
        parka: "kachungasaur"
      }
  ...
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("HP")), [birdTask("Muscle Percent"), favouriteBirdTask("Muscle Percent"), potionTask($item(_templateObject684 || (_templateObject684 = _taggedTemplateLiteral40(["LOV Elixir #3"])))), thrallTask($thrall(_templateObject694 || (_templateObject694 = _taggedTemplateLiteral40(["Elbow Macaroni"])))), equalizeTask()])
}, StatTests = byStat({
...
var _templateObject180, _templateObject2101, _templateObject371, _templateObject450, _templateObject541, _templateObject638, _templateObject734, _templateObject828, _templateObject926, _templateObject1025, _templateObject1125, _templateObject1225, _templateObject1325, _templateObject1420, _templateObject1520, _templateObject1620, _templateObject1719, _templateObject1819, _templateObject1919, _templateObject2018, _templateObject2123, _templateObject2223, _templateObject2320, _templateObject2418, _templateObject2517, _templateObject2617, _templateObject2717, _templateObject2815, _templateObject2915, _templateObject3014, _templateObject3121, _templateObject3219, _templateObject3316, _templateObject3414, _templateObject3513, _templateObject3612, _templateObject3712, _templateObject3811, _templateObject3910, _templateObject409, _templateObject4117, _templateObject4215, _templateObject4313;
...
var buffs4 = $effects(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral41(["Carol of the Bulls, Song of the North, Rage of the Reindeer, Scowl of the Auk, Disdain of the War Snapper, Tenacity of the Snapper"]))), meteors, Weapon = {
  name: "Weapon Damage",
  type: "SERVICE",
  test: CommunityService.WeaponDamage,
  outfit: function() {
    return have($item(_templateObject2101 || (_templateObject2101 = _taggedTemplateLiteral41(["broken champagne bottle"])))) || (0, import_kolmafia44.cliExecute)("fold broken champagne bottle"), _objectSpread14({
      hat: $items(_templateObject371 || (_templateObject371 = _taggedTemplateLiteral41(["seal-skull helmet, Iunion Crown"]))),
      weapon: $item(_templateObject450 || (_templateObject450 = _taggedTemplateLiteral41(["broken champagne bottle"]))),
      offhand: $item(_templateObject541 || (_templateObject541 = _taggedTemplateLiteral41(["dented scepter"]))),
      acc1: $item(_templateObject638 || (_templateObject638 = _taggedTemplateLiteral41(["Brutal brogues"]))),
      acc2: $item(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral41(["Powerful Glove"]))),
  ...
  turnsSpent: 0,
  maxTurns: 1,
  tasks: [].concat(_toConsumableArray19(restoreBuffTasks(buffs4)), [birdTask("Weapon Damage Percent"), favouriteBirdTask("Weapon Damage Percent"), skillTask($effect(_templateObject1125 || (_templateObject1125 = _taggedTemplateLiteral41(["Frenzied, Bloody"])))), potionTask($item(_templateObject1225 || (_templateObject1225 = _taggedTemplateLiteral41(["LOV Elixir #3"])))), potionTask($item(_templateObject1325 || (_templateObject1325 = _taggedTemplateLiteral41(["vial of hamethyst juice"])))), beachTask($effect(_templateObject1420 || (_templateObject1420 = _taggedTemplateLiteral41(["Lack of Body-Building"])))), songTask($effect(_templateObject1520 || (_templateObject1520 = _taggedTemplateLiteral41(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject1620 || (_templateObject1620 = _taggedTemplateLiteral41(["The Sonata of Sneakiness"])))), {
    name: "Play Pool",
    completed: function() {
      return have($effect(_templateObject1719 || (_templateObject1719 = _taggedTemplateLiteral41(["Billiards Belligerence"]))));
    },
    do: function() {
    ...
    name: "Do You Crush What I Crush?",
    completed: function() {
      return have($effect(_templateObject1819 || (_templateObject1819 = _taggedTemplateLiteral41(["Do You Crush What I Crush?"]))));
    },
    ready: function() {
      return !have($effect(_templateObject1919 || (_templateObject1919 = _taggedTemplateLiteral41(["Holiday Yoked"]))));
    },
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject2223 || (_templateObject2223 = _taggedTemplateLiteral41(["Asdon Martin: Spring-Loaded Front Bumper"])))).trySkill($skill(_templateObject2320 || (_templateObject2320 = _taggedTemplateLiteral41(["Feel Hatred"])))).trySkill($skill(_templateObject2418 || (_templateObject2418 = _taggedTemplateLiteral41(["Snokebomb"])))).abort();
    })
    ...
    name: "Spit Ungulith",
    completed: function() {
      return have($effect(_templateObject2517 || (_templateObject2517 = _taggedTemplateLiteral41(["Spit Upon"]))));
    },
    ready: function() {
      return get("camelSpit") >= 100;
    },
    do: function() {
      meteors = get("_meteorShowerUses"), CombatLoversLocket_exports.reminisce($monster(_templateObject2617 || (_templateObject2617 = _taggedTemplateLiteral41(["ungulith"])))), (0, import_kolmafia44.handlingChoice)() && (0, import_kolmafia44.runChoice)(-1);
    },
    choices: _defineProperty22({}, 1387, 3),
    outfit: function() {
      return uniform({
        changes: {
          familiar: $familiar(_templateObject2717 || (_templateObject2717 = _taggedTemplateLiteral41(["Melodramedary"]))),
          weapon: $item(_templateObject2815 || (_templateObject2815 = _taggedTemplateLiteral41(["Fourth of May Cosplay Saber"])))
        }
      });
    },
    post: function() {
      have($effect(_templateObject2915 || (_templateObject2915 = _taggedTemplateLiteral41(["Spit Upon"])))) && _set("camelSpit", 0), meteors && have($effect(_templateObject3014 || (_templateObject3014 = _taggedTemplateLiteral41(["Meteor Showered"])))) && _set("_meteorShowerUses", meteors + 1);
      var ungId = $monster(_templateObject3121 || (_templateObject3121 = _taggedTemplateLiteral41(["ungulith"]))).id.toFixed(0), locketIdStrings = get("_locketMonstersFought").split(",").map(function(x) {
        return x.trim();
      }).filter(function(x) {
        return x.length > 0;
      });
    ...
    combat: new CSStrategy(function() {
      return Macro2.trySkill($skill(_templateObject3219 || (_templateObject3219 = _taggedTemplateLiteral41(["%fn, spit on me!"])))).trySkill($skill(_templateObject3316 || (_templateObject3316 = _taggedTemplateLiteral41(["Meteor Shower"])))).skill($skill(_templateObject3414 || (_templateObject3414 = _taggedTemplateLiteral41(["Use the Force"]))));
    })
  }, {
    name: "Meteorite Ring",
    core: "soft",
    completed: function() {
      return have($item(_templateObject3513 || (_templateObject3513 = _taggedTemplateLiteral41(["meteorite ring"]))));
    },
    ready: function() {
      return (0, import_kolmafia44.canadiaAvailable)() && $items(_templateObject3612 || (_templateObject3612 = _taggedTemplateLiteral41(["meteorite fragment, meteorite earring, meteorite necklace"]))).some(function(item6) {
        return have(item6);
      });
    },
    do: function() {
      var meteor = $items(_templateObject3712 || (_templateObject3712 = _taggedTemplateLiteral41(["meteorite necklace, meteorite fragment, meteorite earring"]))).find(function(item6) {
        return have(item6);
      });
      meteor && (unequip(meteor), (0, import_kolmafia44.retrieveItem)(1, $item(_templateObject3811 || (_templateObject3811 = _taggedTemplateLiteral41(["tenderizing hammer"])))), (0, import_kolmafia44.retrieveItem)(1, $item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral41(["jewelry-making pliers"])))), meteor !== $item(_templateObject409 || (_templateObject409 = _taggedTemplateLiteral41(["meteorite fragment"]))) && (0, import_kolmafia44.cliExecute)("smash ".concat(meteor)), (0, import_kolmafia44.cliExecute)("make ".concat($item(_templateObject4117 || (_templateObject4117 = _taggedTemplateLiteral41(["meteorite ring"]))))));
    }
  }, potionTask($item(_templateObject4215 || (_templateObject4215 = _taggedTemplateLiteral41(["corrupted marrow"])))), {
    name: "Swagger",
    completed: function() {
      return get("_bowleggedSwaggerUsed");
    },
    do: function() {
      return (0, import_kolmafia44.useSkill)($skill(_templateObject4313 || (_templateObject4313 = _taggedTemplateLiteral41(["Bow-Legged Swagger"]))));
    }
  }])
