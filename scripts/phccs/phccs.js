...
var UNCHANGING_OUTFIT = {
  ...
  acc1: byStat({
    Mysticality: $items(_templateObject329 || (_templateObject329 = _taggedTemplateLiteral29(["meteorite necklace, your cowboy boots"]))),
    default: $item(_templateObject426 || (_templateObject426 = _taggedTemplateLiteral29(["Powerful Glove"])))
  }),
  acc2: byStat({
    Mysticality: $item(_templateObject521 || (_templateObject521 = _taggedTemplateLiteral29(["codpiece"]))),
    Moxie: $items(_templateObject620 || (_templateObject620 = _taggedTemplateLiteral29(["LOV Earrings, Beach Comb"]))),
    Muscle: $items(_templateObject718 || (_templateObject718 = _taggedTemplateLiteral29(["Brutal brogues, Retrospecs"])))
  }),
  acc3: byStat({
    Mysticality: $items(_templateObject816 || (_templateObject816 = _taggedTemplateLiteral29(["battle broom, Powerful Glove"]))),
    default: $item(_templateObject914 || (_templateObject914 = _taggedTemplateLiteral29(["your cowboy boots"])))
  }),
  modes: {
    retrocape: [byStat({
      Muscle: "vampire",
  ...
  return _objectSpread7(_objectSpread7({}, UNCHANGING_OUTFIT), {}, {
    hat: DaylightShavings_exports.buffAvailable() ? $item(_templateObject1013 || (_templateObject1013 = _taggedTemplateLiteral29(["Daylight Shavings Helmet"]))) : byStat({
    ...
    pants: get("sweat") < 100 ? $item(_templateObject1410 || (_templateObject1410 = _taggedTemplateLiteral29(["designer sweatpants"]))) : $items(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral29(["astral trousers, astral shorts, designer sweatpants"]))),
    weapon: get("_juneCleaverFightsLeft") > 0 && get("_juneCleaverEncounters") < 2 ? $item(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral29(["June cleaver"]))) : byStat({
      Muscle: $items(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral29(["dented scepter, Fourth of May Cosplay Saber"]))),
      default: $item(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral29(["Fourth of May Cosplay Saber"])))
    }),
    back: get("questPAGhost") === "unstarted" && get("nextParanormalActivity") <= (0, import_kolmafia34.totalTurnsPlayed)() ? $item(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral29(["protonic accelerator pack"]))) : $items(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral29(["LOV Epaulettes, unwrapped knock-off retro superhero cape"])))
  });
}, FAMILIAR_PICKS = [{
  familiar: $familiar(_templateObject2113 || (_templateObject2113 = _taggedTemplateLiteral29(["Stocking Mimic"]))),
  famequip: $item.none,
  condition: function() {
    return !get("_bagOfCandy");
  }
}, {
  familiar: $familiar(_templateObject2213 || (_templateObject2213 = _taggedTemplateLiteral29(["Melodramedary"]))),
  famequip: $item(_templateObject2310 || (_templateObject2310 = _taggedTemplateLiteral29(["dromedary drinking helmet"]))),
  condition: function() {
    return get("camelSpit") < 100 && !have($effect(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral29(["Spit Upon"]))));
  }
}, {
  familiar: $familiar(_templateObject257 || (_templateObject257 = _taggedTemplateLiteral29(["Shorter-Order Cook"]))),
  condition: function() {
    return ![$effect(_templateObject267 || (_templateObject267 = _taggedTemplateLiteral29(["Shortly Stacked"]))), $item(_templateObject277 || (_templateObject277 = _taggedTemplateLiteral29(["short stack of pancakes"])))].some(function(x) {
      return have(x);
    }) && !CommunityService.FamiliarWeight.isDone();
  }
}, {
  familiar: $familiar(_templateObject285 || (_templateObject285 = _taggedTemplateLiteral29(["Garbage Fire"]))),
  condition: function() {
    return $familiar(_templateObject295 || (_templateObject295 = _taggedTemplateLiteral29(["Garbage Fire"]))).dropsToday < 1;
  }
}];
...
function chooseFamiliar(canAttack) {
  ...
  if (pick) {
    var _pick$famequip;
    return {
      famequip: (_pick$famequip = pick.famequip) !== null && _pick$famequip !== void 0 ? _pick$famequip : $item(_templateObject305 || (_templateObject305 = _taggedTemplateLiteral29(["tiny stillsuit"]))),
      familiar: pick.familiar
    };
  }
  return {
    famequip: $item(_templateObject3112 || (_templateObject3112 = _taggedTemplateLiteral29(["tiny stillsuit"]))),
    familiar: (_findFirstFamiliar = findFirstFamiliar($familiars(_templateObject3210 || (_templateObject3210 = _taggedTemplateLiteral29(["Puck Man, Ms. Puck Man"]))))) !== null && _findFirstFamiliar !== void 0 ? _findFirstFamiliar : $familiar(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral29(["Blood-Faced Volleyball"])))
  };
}
var DEFAULT_OPTIONS = {
  changes: {},
...
function meteorShower() {
  ...
  return {
    ...
    post: function() {
      have($effect(_templateObject354 || (_templateObject354 = _taggedTemplateLiteral30(["Meteor Showered"])))) && showers++, _set("_meteorShowerUses", showers), SourceTerminal_exports.educate([$skill(_templateObject364 || (_templateObject364 = _taggedTemplateLiteral30(["Extract"]))), $skill(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral30(["Portscan"])))]);
    }
  };
}
...
var BoozeDrop = {
  ...
  tasks: [{
    ...
    name: "Feel Lost",
    completed: function() {
      return have($effect(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral31(["Feeling Lost"]))));
    },
    do: function() {
      return (0, import_kolmafia36.useSkill)($skill(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral31(["Feel Lost"]))));
    }
  }])
...
var levellingComplete = (0, import_kolmafia43.myLevel)() >= 13 && get("_neverendingPartyFreeTurns") >= 10, lovePotionConsidered = !1, foldshirt = function() {
  ...
  tasks: [innerElf(), {
    ...
    do: function() {
      return (0, import_kolmafia43.useSkill)($skill(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral38(["CHEAT CODE: Triple Size"]))), 1);
    },
    outfit: {
      acc3: $item(_templateObject3117 || (_templateObject3117 = _taggedTemplateLiteral38(["Powerful Glove"])))
    }
  }, {
    name: "Feel Excited",
    completed: function() {
    ...
    completed: function() {
      return have($effect(_templateObject3411 || (_templateObject3411 = _taggedTemplateLiteral38(["Glowing Blue"])))) || have($item(_templateObject358 || (_templateObject358 = _taggedTemplateLiteral38(["blue rocket"]))));
    },
    do: function() {
      (0, import_kolmafia43.visitUrl)("clan_viplounge.php?action=fwshop&whichfloor=2"), (0, import_kolmafia43.buy)(1, $item(_templateObject368 || (_templateObject368 = _taggedTemplateLiteral38(["blue rocket"]))));
    }
  }, {
...
var _templateObject171, _templateObject290, _templateObject359, _templateObject440, _templateObject537, _templateObject635, _templateObject730, _templateObject827, _templateObject925, _templateObject1023, _templateObject1121, _templateObject1221, _templateObject1321, _templateObject1419, _templateObject1518, _templateObject1617, _templateObject1716, _templateObject1816, _templateObject1916, _templateObject2016, _templateObject2121, _templateObject2221, _templateObject2318, _templateObject2415, _templateObject2514, _templateObject2614, _templateObject2714, _templateObject2812, _templateObject2912, _templateObject3011, _templateObject3118, _templateObject3216, _templateObject3313, _templateObject3412, _templateObject3510, _templateObject369, _templateObject378, _templateObject388, _templateObject397, _templateObject407, _templateObject4114, _templateObject4212, _templateObject4310, _templateObject446, _templateObject456, _templateObject466, _templateObject476, _templateObject486, _templateObject496, _templateObject506, _templateObject5114, _templateObject5212, _templateObject538, _templateObject546, _templateObject556, _templateObject566, _templateObject576, _templateObject586, _templateObject595, _templateObject605, _templateObject6112, _templateObject6211, _templateObject636, _templateObject645, _templateObject655;
...
var PULLS = [$items(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral40(["repaid diaper, Great Wolf's beastly trousers"]))), byStat({
  ...
  default: $items(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral40(["norwhal helmet"])))
  ...
  tasks: [{
    ...
    name: "Vote!",
    completed: function() {
      return have($item(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral40(['"I Voted!" sticker']))));
    },
    do: function() {
    ...
    completed: function() {
      return SourceTerminal_exports.getSkills().every(function(skill) {
        return $skills(_templateObject3118 || (_templateObject3118 = _taggedTemplateLiteral40(["Extract, Portscan"]))).includes(skill);
    ...
    do: function() {
      (0, import_kolmafia45.visitUrl)("tutorial.php?action=toot"), tryUse(1, $item(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral40(["letter from King Ralph XI"])))), tryUse(1, $item(_templateObject369 || (_templateObject369 = _taggedTemplateLiteral40(["pork elf goodies sack"])))), (0, import_kolmafia45.autosell)(5, $item(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral40(["baconstone"])))), (0, import_kolmafia45.autosell)(5, $item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral40(["hamethyst"]))));
    }
  }, {
    name: "Accordion",
...
var _templateObject180, _templateObject291, _templateObject360, _templateObject441, _templateObject539, _templateObject637, _templateObject731, _templateObject828, _templateObject926, _templateObject1024, _templateObject1123, _templateObject1223, _templateObject1323, _templateObject1420, _templateObject1519, _templateObject1618, _templateObject1717, _templateObject1817, _templateObject1917, _templateObject2017, _templateObject2122, _templateObject2222, _templateObject2319, _templateObject2416, _templateObject2515, _templateObject2615, _templateObject2715, _templateObject2813, _templateObject2913, _templateObject3012, _templateObject3119, _templateObject3217, _templateObject3314, _templateObject3413, _templateObject3511, _templateObject3610, _templateObject379, _templateObject389, _templateObject398, _templateObject408, _templateObject4115, _templateObject4213, _templateObject4311, _templateObject447, _templateObject457, _templateObject467, _templateObject477, _templateObject487, _templateObject497, _templateObject507, _templateObject5115, _templateObject5213, _templateObject5310;
...
var buffs3 = $effects(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral41(["Carol of the Hells, Arched Eyebrow of the Archmage, Song of Sauce"]))), chefstaves = $items(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral41(["Staff of the Roaring Hearth, Staff of Simmering Hatred, Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist"]))), Spell = {
  ...
  outfit: function() {
    return _objectSpread13(_objectSpread13({
      hat: $items(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral41(["norwhal helmet, astral chapeau, Hollandaise helmet, Iunion Crown"]))),
  ...
  tasks: [skillTask($skill(_templateObject1618 || (_templateObject1618 = _taggedTemplateLiteral41(["Simmer"])))), {
    ...
    name: "Saucefingers",
    ready: function() {
      return (0, import_kolmafia46.myLevel)() >= 15 && have($familiar(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral41(["Mini-Adventurer"]))));
    },
    completed: function() {
...
var _templateObject181, _templateObject2100, _templateObject361, _templateObject448, _templateObject540, _templateObject638, _templateObject734, _templateObject829, _templateObject927, _templateObject1025, _templateObject1124, _templateObject1224, _templateObject1324, _templateObject1421, _templateObject1520, _templateObject1619, _templateObject1718, _templateObject1818, _templateObject1918, _templateObject2018, _templateObject2123, _templateObject2223, _templateObject2320, _templateObject2417, _templateObject2516, _templateObject2616, _templateObject2716, _templateObject2814, _templateObject2914, _templateObject3013, _templateObject3120, _templateObject3218, _templateObject3315, _templateObject3414, _templateObject3512, _templateObject3611, _templateObject3710, _templateObject3810, _templateObject399, _templateObject409, _templateObject4116, _templateObject4214, _templateObject4312, _templateObject449, _templateObject458, _templateObject468, _templateObject478, _templateObject488, _templateObject498, _templateObject508, _templateObject5116, _templateObject5214, _templateObject5311, _templateObject547, _templateObject557, _templateObject567, _templateObject577, _templateObject587, _templateObject596, _templateObject606, _templateObject6113, _templateObject6212, _templateObject639, _templateObject646, _templateObject656, _templateObject665, _templateObject675, _templateObject684, _templateObject694, _templateObject704, _templateObject7111, _templateObject7210, _templateObject735, _templateObject744, _templateObject754, _templateObject764;
...
var Muscle = {
  ...
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MUSCLE")), [potionTask($item(_templateObject2716 || (_templateObject2716 = _taggedTemplateLiteral42(["LOV Elixir #3"])))), thrallTask($thrall(_templateObject2814 || (_templateObject2814 = _taggedTemplateLiteral42(["Elbow Macaroni"])))), beachTask($effect(_templateObject2914 || (_templateObject2914 = _taggedTemplateLiteral42(["Lack of Body-Building"])))), birdTask("Muscle Percent"), favouriteBirdTask("Muscle Percent"), _objectSpread14(_objectSpread14({}, innerElf()), {}, {
    core: "hard",
    class: $classes(_templateObject3013 || (_templateObject3013 = _taggedTemplateLiteral42(["Pastamancer, Sauceror, Disco Bandit, Accordion Thief"])))
  }), _objectSpread14(_objectSpread14({}, potionTask($item(_templateObject3120 || (_templateObject3120 = _taggedTemplateLiteral42(["Ben-Gal\u2122 Balm"]))))), {}, {
    core: "hard"
  ...
  outfit: function() {
    return have($item(_templateObject3218 || (_templateObject3218 = _taggedTemplateLiteral42(["wad of used tape"])))) || (0, import_kolmafia47.cliExecute)("fold wad of used tape"), {
      ...
      back: $item(_templateObject3611 || (_templateObject3611 = _taggedTemplateLiteral42(["unwrapped knock-off retro superhero cape"]))),
...
var _templateObject190, _templateObject2101, _templateObject370, _templateObject450, _templateObject541, _templateObject640, _templateObject736, _templateObject830, _templateObject928, _templateObject1026, _templateObject1125, _templateObject1225, _templateObject1325, _templateObject1423, _templateObject1521, _templateObject1620, _templateObject1719, _templateObject1819, _templateObject1919, _templateObject2019, _templateObject2124, _templateObject2224, _templateObject2321, _templateObject2418, _templateObject2517, _templateObject2617, _templateObject2717, _templateObject2815, _templateObject2915, _templateObject3014, _templateObject3121, _templateObject3219, _templateObject3316, _templateObject3415, _templateObject3513, _templateObject3612, _templateObject3711, _templateObject3811, _templateObject3910, _templateObject4010, _templateObject4117, _templateObject4215, _templateObject4313, _templateObject4410, _templateObject459, _templateObject469, _templateObject479, _templateObject489;
...
var buffs4 = $effects(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral43(["Carol of the Bulls, Song of the North, Rage of the Reindeer, Scowl of the Auk, Disdain of the War Snapper, Tenacity of the Snapper"]))), meteors, Weapon = {
  ...
  tasks: [].concat(_toConsumableArray19(restoreBuffTasks(buffs4)), [birdTask("Weapon Damage Percent"), favouriteBirdTask("Weapon Damage Percent"), skillTask($effect(_templateObject1225 || (_templateObject1225 = _taggedTemplateLiteral43(["Frenzied, Bloody"])))), potionTask($item(_templateObject1325 || (_templateObject1325 = _taggedTemplateLiteral43(["LOV Elixir #3"])))), potionTask($item(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral43(["vial of hamethyst juice"])))), potionTask($item(_templateObject1521 || (_templateObject1521 = _taggedTemplateLiteral43(["imported taffy"])))), beachTask($effect(_templateObject1620 || (_templateObject1620 = _taggedTemplateLiteral43(["Lack of Body-Building"])))), songTask($effect(_templateObject1719 || (_templateObject1719 = _taggedTemplateLiteral43(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject1819 || (_templateObject1819 = _taggedTemplateLiteral43(["The Sonata of Sneakiness"])))), {
    ...
    do: function() {
      meteors = get("_meteorShowerUses"), CombatLoversLocket_exports.reminisce($monster(_templateObject3014 || (_templateObject3014 = _taggedTemplateLiteral43(["ungulith"])))), (0, import_kolmafia48.handlingChoice)() && (0, import_kolmafia48.runChoice)(-1);
    },
    choices: _defineProperty23({}, 1387, 3),
    outfit: function() {
      var changes = {
        weapon: $item(_templateObject3121 || (_templateObject3121 = _taggedTemplateLiteral43(["Fourth of May Cosplay Saber"])))
      };
    ...
    post: function() {
      ...
      var ungId = $monster(_templateObject3612 || (_templateObject3612 = _taggedTemplateLiteral43(["ungulith"]))).id.toFixed(0), locketIdStrings = get("_locketMonstersFought").split(",").map(function(x) {
        return x.trim();
      }).filter(function(x) {
        return x.length > 0;
      });
