...
var UNCHANGING_OUTFIT = {
  ...
  return _objectSpread6(_objectSpread6({}, UNCHANGING_OUTFIT), {}, {
    ...
    back: get("questPAGhost") === "unstarted" && get("nextParanormalActivity") <= (0, import_kolmafia33.totalTurnsPlayed)() ? $item(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral29(["protonic accelerator pack"]))) : $items(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral29(["LOV Epaulettes, unwrapped knock-off retro superhero cape"])))
  });
}, FAMILIAR_PICKS = [{
...
function uniform() {
  ...
  return "familiar" in changes && !("famequip" in changes) && (changes.famequip = $item(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral29(["tiny stillsuit"])))), _objectSpread6(_objectSpread6(_objectSpread6({}, DEFAULT_UNIFORM()), chooseFamiliar(canAttack)), changes);
}
...
function meteorShower() {
  ...
  return {
    ...
    post: function() {
      have($effect(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral30(["Meteor Showered"])))) && showers++, _set("_meteorShowerUses", showers), SourceTerminal_exports.educate([$skill(_templateObject3211 || (_templateObject3211 = _taggedTemplateLiteral30(["Extract"]))), $skill(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral30(["Portscan"])))]);
    }
  };
}
...
var _templateObject120, _templateObject241, _templateObject331, _templateObject428, _templateObject525, _templateObject624, _templateObject720, _templateObject818, _templateObject916, _templateObject1015, _templateObject1114, _templateObject1214, _templateObject1314;
...
var GLOBAL_TASKS = [{
  name: "Beaten Up!",
  completed: function() {
    return !have($effect(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral31(["Beaten Up"]))));
  },
  ready: function() {
  ...
  do: function() {
    return (0, import_kolmafia35.useSkill)($skill(_templateObject241 || (_templateObject241 = _taggedTemplateLiteral31(["Sweat Out Some Booze"]))));
  },
  outfit: {
    pants: $item(_templateObject331 || (_templateObject331 = _taggedTemplateLiteral31(["designer sweatpants"])))
  }
}, {
  name: "Numberology",
  ready: function() {
  ...
  do: function() {
    return withProperty("recoveryScript", "", function() {
      (0, import_kolmafia35.adv1)($location(_templateObject428 || (_templateObject428 = _taggedTemplateLiteral31(["Noob Cave"]))), -1, ""), get("lastEncounter") === "Poetic Justice" && (0, import_kolmafia35.useSkill)($skill(_templateObject525 || (_templateObject525 = _taggedTemplateLiteral31(["Tongue of the Walrus"]))));
    });
  },
  outfit: {
    weapon: $item(_templateObject624 || (_templateObject624 = _taggedTemplateLiteral31(["June cleaver"])))
  }
}, {
  name: "Ghost",
  completed: function() {
  ...
  ready: function() {
    return have($item(_templateObject720 || (_templateObject720 = _taggedTemplateLiteral31(["protonic accelerator pack"])))) && get("questPAGhost") !== "unstarted" && !!get("ghostLocation") && !have($effect(_templateObject818 || (_templateObject818 = _taggedTemplateLiteral31(["Meteor Showered"]))));
  },
  do: function() {
    var _get3;
    return (_get3 = get("ghostLocation")) !== null && _get3 !== void 0 ? _get3 : (0, import_kolmafia35.abort)("Failed to identify ghost location");
  },
  combat: new CSStrategy(function() {
    return Macro2.delevel().easyFight().trySkill($skill(_templateObject916 || (_templateObject916 = _taggedTemplateLiteral31(["Shoot Ghost"])))).trySkill($skill(_templateObject1015 || (_templateObject1015 = _taggedTemplateLiteral31(["Shoot Ghost"])))).trySkill($skill(_templateObject1114 || (_templateObject1114 = _taggedTemplateLiteral31(["Shoot Ghost"])))).trySkill($skill(_templateObject1214 || (_templateObject1214 = _taggedTemplateLiteral31(["Trap Ghost"]))));
  }),
  outfit: function() {
    return uniform({
      changes: {
        back: $item(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral31(["protonic accelerator pack"])))
      }
    });
  }
}], GLOBAL_QUEST = {
...
var _templateObject121, _templateObject249;
...
var HIGHLIGHT = (0, import_kolmafia36.isDarkMode)() ? "yellow" : "blue", CSEngine = /* @__PURE__ */ function(_Engine) {
  ...
  return _createClass14(CSEngine2, [{
    ...
    key: "runTests",
    value: function() {
      (0, import_kolmafia36.myPath)() !== $path(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral32(["Community Service"]))) && (0, import_kolmafia36.abort)(), (0, import_kolmafia36.visitUrl)("council.php"), CSEngine2.initiate();
      try {
...
var BoozeDrop = {
  ...
  outfit: function() {
    return have($item(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral33(["wad of used tape"])))) || (0, import_kolmafia37.cliExecute)("fold wad of used tape"), {
      hat: $item(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral33(["wad of used tape"]))),
      weapon: $items(_templateObject337 || (_templateObject337 = _taggedTemplateLiteral33(["extra-large utility candle, Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject429 || (_templateObject429 = _taggedTemplateLiteral33(["unbreakable umbrella"]))),
      back: $items(_templateObject526 || (_templateObject526 = _taggedTemplateLiteral33(["Buddy Bjorn, protonic accelerator pack"]))),
      riders: CSEngine.core === "soft" ? {
        "buddy-bjorn": $familiar(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral33(["Party Mouse"])))
      } : {},
      acc1: $item(_templateObject721 || (_templateObject721 = _taggedTemplateLiteral33(["Guzzlr tablet"]))),
      acc2: $item(_templateObject819 || (_templateObject819 = _taggedTemplateLiteral33(["Cincho de Mayo"]))),
      acc3: $items(_templateObject917 || (_templateObject917 = _taggedTemplateLiteral33(["barrel hoop earring, gold detective badge, government-issued night-vision goggles, combat lover's locket"]))),
      famequip: $item(_templateObject1016 || (_templateObject1016 = _taggedTemplateLiteral33(["li'l ninja costume"]))),
      familiar: $familiar(_templateObject1115 || (_templateObject1115 = _taggedTemplateLiteral33(["Trick-or-Treating Tot"]))),
      modes: {
  ...
  tasks: [{
    name: "Batform",
    completed: function() {
      return have($effect(_templateObject1215 || (_templateObject1215 = _taggedTemplateLiteral33(["Bat-Adjacent Form"]))));
    },
    do: $location(_templateObject1315 || (_templateObject1315 = _taggedTemplateLiteral33(["The Dire Warren"]))),
    outfit: function() {
      return uniform({
        changes: {
          back: $item(_templateObject1412 || (_templateObject1412 = _taggedTemplateLiteral33(["vampyric cloake"]))),
          offhand: $item(_templateObject1511 || (_templateObject1511 = _taggedTemplateLiteral33(["latte lovers member's mug"])))
        },
        canAttack: !1
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject1611 || (_templateObject1611 = _taggedTemplateLiteral33(["Become a Bat"])))).skill($skill(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral33(["Throw Latte on Opponent"]))));
    })
  }, _objectSpread7(_objectSpread7({}, deckTask("X - The Wheel of Fortune")), {}, {
    class: $classes(_templateObject1810 || (_templateObject1810 = _taggedTemplateLiteral33(["Sauceror, Turtle Tamer"]))),
    core: "hard"
  }), songTask($effect(_templateObject1910 || (_templateObject1910 = _taggedTemplateLiteral33(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject2010 || (_templateObject2010 = _taggedTemplateLiteral33(["Ode to Booze"])))), {
    name: "Items.enh",
    completed: function() {
      return have($effect(_templateObject2115 || (_templateObject2115 = _taggedTemplateLiteral33(["items.enh"]))));
    },
    do: function() {
      return SourceTerminal_exports.enhance($effect(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral33(["items.enh"]))));
    }
  }, skillTask($skill(_templateObject2312 || (_templateObject2312 = _taggedTemplateLiteral33(["The Spirit of Taking"])))), skillTask($skill(_templateObject2410 || (_templateObject2410 = _taggedTemplateLiteral33(["Singer's Faithful Ocelot"])))), {
    name: "Play Pool",
    completed: function() {
      return have($effect(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral33(["Hustlin'"]))));
    },
    do: function() {
    ...
    name: "Get Anticheese",
    ready: function() {
      return (0, import_kolmafia37.canAdventure)($location(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral33(["South of the Border"]))));
    },
    completed: function() {
    ...
    name: "Government",
    ready: function() {
      return have($item(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral33(["anticheese"])))) && have($item(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral33(["government cheese"]))));
    },
    completed: function() {
      return have($effect(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral33(["I See Everything Thrice!"]))));
    },
    do: function() {
      return (0, import_kolmafia37.create)(1, $item(_templateObject307 || (_templateObject307 = _taggedTemplateLiteral33(["government"])))) && (0, import_kolmafia37.use)(1, $item(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral33(["government"]))));
    }
  }, {
    name: "Pray",
    class: $classes(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral33(["Pastamancer"]))),
    completed: function() {
  ...
  }].concat(_toConsumableArray11($items(_templateObject338 || (_templateObject338 = _taggedTemplateLiteral33(["Salsa Caliente\u2122 candle, lavender candy heart, bag of grain, emergency glowstick"]))).map(potionTask)), [{
    name: "Steely-Eyed Squint",
    completed: function() {
      return have($effect(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral33(["Steely-Eyed Squint"]))));
    },
    do: function() {
      return (0, import_kolmafia37.useSkill)($skill(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral33(["Steely-Eyed Squint"]))));
    }
  }, {
    name: "Feel Lost",
    completed: function() {
      return have($effect(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral33(["Feeling Lost"]))));
    },
    do: function() {
      return (0, import_kolmafia37.useSkill)($skill(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral33(["Feel Lost"]))));
    }
  }])
...
var CoilWire = {
  ...
  tasks: [{
    ...
    do: function() {
      (0, import_kolmafia38.adv1)(byStat({
        Mysticality: $location(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral34(["The Haunted Pantry"]))),
        Moxie: $location(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral34(["The Sleazy Back Alley"]))),
        Muscle: $location(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral34(["The Outskirts of Cobb's Knob"])))
      }), -1, ""), have($item(_templateObject430 || (_templateObject430 = _taggedTemplateLiteral34(["magical sausage casing"])))) && (0, import_kolmafia38.create)(1, $item(_templateObject527 || (_templateObject527 = _taggedTemplateLiteral34(["magical sausage"])))), (0, import_kolmafia38.eat)(1, $item(_templateObject626 || (_templateObject626 = _taggedTemplateLiteral34(["magical sausage"]))));
    },
    outfit: function() {
      return uniform({
        changes: {
          offhand: $item(_templateObject723 || (_templateObject723 = _taggedTemplateLiteral34(["Kramco Sausage-o-Matic\u2122"])))
        }
      });
    },
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject820 || (_templateObject820 = _taggedTemplateLiteral34(["Micrometeorite"])))).attack().repeat();
    })
  }, {
    name: "Fruity Skeleton",
    class: $classes(_templateObject918 || (_templateObject918 = _taggedTemplateLiteral34(["Sauceror, Seal Clubber, Turtle Tamer"]))),
    completed: function() {
      return have($item(_templateObject1017 || (_templateObject1017 = _taggedTemplateLiteral34(["cherry"]))));
    },
    ready: function() {
      return !have($effect(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral34(["Everything Looks Yellow"]))));
    },
    do: function() {
      Cartography_exports.mapMonster($location(_templateObject1216 || (_templateObject1216 = _taggedTemplateLiteral34(["The Skeleton Store"]))), $monster(_templateObject1316 || (_templateObject1316 = _taggedTemplateLiteral34(["novelty tropical skeleton"]))));
    },
    outfit: function() {
      return uniform({
        canAttack: !1,
        changes: {
          shirt: $item(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral34(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
        }
    ...
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject1512 || (_templateObject1512 = _taggedTemplateLiteral34(["Spit jurassic acid"]))));
    })
  }, {
    name: "Evil Olive",
    class: $classes(_templateObject1612 || (_templateObject1612 = _taggedTemplateLiteral34(["Disco Bandit, Accordion Thief"]))),
    completed: function() {
      return have($item(_templateObject1711 || (_templateObject1711 = _taggedTemplateLiteral34(["jumbo olive"]))));
    },
    ready: function() {
      return !have($effect(_templateObject1811 || (_templateObject1811 = _taggedTemplateLiteral34(["Everything Looks Yellow"]))));
    },
    do: function() {
      return CombatLoversLocket_exports.reminisce($monster(_templateObject1911 || (_templateObject1911 = _taggedTemplateLiteral34(["Evil Olive"]))));
    },
    outfit: function() {
      return uniform({
        canAttack: !1,
        changes: {
          shirt: $item(_templateObject2011 || (_templateObject2011 = _taggedTemplateLiteral34(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
        }
    ...
    combat: new CSStrategy(function() {
      return Macro2.skill($skill(_templateObject2116 || (_templateObject2116 = _taggedTemplateLiteral34(["Spit jurassic acid"]))));
    })
  }],
  outfit: function() {
    return {
      hat: $item(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral34(["Iunion Crown"]))),
      shirt: $item(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral34(["fresh coat of paint"]))),
      pants: $item(_templateObject2411 || (_templateObject2411 = _taggedTemplateLiteral34(["Cargo Cultist Shorts"]))),
      weapon: $item(_templateObject2510 || (_templateObject2510 = _taggedTemplateLiteral34(["Fourth of May Cosplay Saber"]))),
      offhand: $item(_templateObject2610 || (_templateObject2610 = _taggedTemplateLiteral34(["familiar scrapbook"]))),
      acc1: $item(_templateObject2710 || (_templateObject2710 = _taggedTemplateLiteral34(["Eight Days a Week Pill Keeper"]))),
      acc2: $item(_templateObject288 || (_templateObject288 = _taggedTemplateLiteral34(["Powerful Glove"]))),
      acc3: $item(_templateObject298 || (_templateObject298 = _taggedTemplateLiteral34(["Guzzlr tablet"])))
    };
  }
...
var _templateObject140, _templateObject260, _templateObject340, _templateObject431, _templateObject528, _templateObject627, _templateObject724;
function _taggedTemplateLiteral35(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var totalInebriety = function() {
  return (0, import_kolmafia39.myInebriety)() + get("_sweatOutSomeBoozeUsed");
}, Drink = {
  name: "Drink Pilsners",
  type: "MISC",
  completed: function() {
  ...
  tasks: [{
    name: "Open Pilsners",
    completed: function() {
      return !have($item(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral35(["astral six-pack"]))));
    },
    do: function() {
      return (0, import_kolmafia39.use)($item(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral35(["astral six-pack"]))));
    }
  }, songTask($effect(_templateObject340 || (_templateObject340 = _taggedTemplateLiteral35(["Ode to Booze"]))), $effect(_templateObject431 || (_templateObject431 = _taggedTemplateLiteral35(["The Magical Mojomuscular Melody"])))), {
    name: "Drink Pilsners",
    ready: function() {
      return have($item(_templateObject528 || (_templateObject528 = _taggedTemplateLiteral35(["astral pilsner"]))));
    },
    completed: function() {
      return totalInebriety() >= 5;
    },
    do: function() {
      return (0, import_kolmafia39.drink)($item(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral35(["astral pilsner"]))), clamp((0, import_kolmafia39.itemAmount)($item(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral35(["astral pilsner"])))), 0, 5 - totalInebriety()));
    }
  }]
...
var familiar = have($familiar(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral36(["Comma Chameleon"])))) ? $familiar(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral36(["Comma Chameleon"]))) : $familiar(_templateObject341 || (_templateObject341 = _taggedTemplateLiteral36(["Mini-Trainbot"]))), FamiliarWeight = {
...
var buffs2 = $effects(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral37(["Elemental Saucesphere, Astral Shell"]))), HotRes = {
  ...
  outfit: function() {
    return {
      hat: $item(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral37(["Daylight Shavings Helmet"]))),
...
var levellingComplete = (0, import_kolmafia42.myLevel)() >= 13 && get("_neverendingPartyFreeTurns") >= 10, lovePotionConsidered = !1, foldshirt = function() {
  ...
  tasks: [innerElf(), {
  ...
  }, beachTask($effect(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral38(["You Learned Something Maybe!"])))), beachTask($effect(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral38(["We're All Made of Starfish"])))), {
    name: "Smile of Lyle",
    completed: function() {
    ...
    },
    {
      ...
      completed: function() {
        return have(byStat({
          Mysticality: $effect(_templateObject535 || (_templateObject535 = _taggedTemplateLiteral38(["Nanobrainy"]))),
          Muscle: $effect(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral38(["Nanobrawny"]))),
          Moxie: $effect(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral38(["Nanoballsy"])))
        }));
      },
      ready: function() {
        return have($familiar(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral38(["Nanorhino"])))) && get("_nanorhinoCharge") >= 100 && get("_speakeasyFreeFights") < 3;
      },
      do: $location(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral38(["An Unusually Quiet Barroom Brawl"]))),
      outfit: function() {
        return uniform({
          changes: {
            familiar: $familiar(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral38(["Nanorhino"])))
          }
        });
      },
      combat: new CSStrategy(function() {
        return Macro2.skill(byStat({
          Mysticality: $skill(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral38(["Spaghetti Spear"]))),
          Moxie: $skill(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral38(["Suckerpunch"]))),
          Muscle: $skill(_templateObject6111 || (_templateObject6111 = _taggedTemplateLiteral38(["Clobber"])))
        })).defaultKill();
      })
    },
    {
      ...
      core: "soft",
      completed: function() {
        return have($effect(_templateObject6210 || (_templateObject6210 = _taggedTemplateLiteral38(["Giant Growth"]))));
      },
      ready: function() {
        return have($item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral38(["green mana"])))) && get("_snojoFreeFights") < 10;
      },
      do: $location(_templateObject643 || (_templateObject643 = _taggedTemplateLiteral38(["The X-32-F Combat Training Snowman"]))),
      outfit: uniform,
      combat: new CSStrategy(function() {
        return Macro2.externalIf(!have($effect(_templateObject653 || (_templateObject653 = _taggedTemplateLiteral38(["Cosmic Ball in the Air"])))), Macro2.skill($skill(_templateObject663 || (_templateObject663 = _taggedTemplateLiteral38(["Bowl Straight Up"]))))).delevel().tryItem($item(_templateObject673 || (_templateObject673 = _taggedTemplateLiteral38(["blue rocket"])))).trySkill($skill(_templateObject683 || (_templateObject683 = _taggedTemplateLiteral38(["Giant Growth"])))).defaultKill();
      })
    },
    {
      name: "Map Ninja",
      completed: function() {
        return have($item(_templateObject693 || (_templateObject693 = _taggedTemplateLiteral38(["li'l ninja costume"]))));
      },
      do: function() {
        Cartography_exports.mapMonster($location(_templateObject703 || (_templateObject703 = _taggedTemplateLiteral38(["The Haiku Dungeon"]))), $monster(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral38(["amateur ninja"]))));
      },
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject728 || (_templateObject728 = _taggedTemplateLiteral38(["amateur ninja"]))), Macro2.skill($skill(_templateObject733 || (_templateObject733 = _taggedTemplateLiteral38(["Chest X-Ray"]))))).abort();
      }),
      outfit: function() {
        return uniform({
          canAttack: !1,
          changes: {
            acc3: $item(_templateObject743 || (_templateObject743 = _taggedTemplateLiteral38(["Lil' Doctor\u2122 bag"])))
          }
        });
      }
    },
    {
      name: "Witch",
      completed: function() {
        return have($item(_templateObject753 || (_templateObject753 = _taggedTemplateLiteral38(["battle broom"]))));
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject763 || (_templateObject763 = _taggedTemplateLiteral38(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject773 || (_templateObject773 = _taggedTemplateLiteral38(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject783 || (_templateObject783 = _taggedTemplateLiteral38(["familiar scrapbook"])))
          }
        });
      },
      prepare: function() {
        (0, import_kolmafia42.useSkill)($skill(_templateObject793 || (_templateObject793 = _taggedTemplateLiteral38(["Cannelloni Cocoon"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject803 || (_templateObject803 = _taggedTemplateLiteral38(["Witchess Witch"]))));
      },
      combat: new CSStrategy(function() {
    ...
    },
    {
      name: "King",
      completed: function() {
        return have($item(_templateObject8110 || (_templateObject8110 = _taggedTemplateLiteral38(["dented scepter"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject824 || (_templateObject824 = _taggedTemplateLiteral38(["Witchess King"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject832 || (_templateObject832 = _taggedTemplateLiteral38(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject842 || (_templateObject842 = _taggedTemplateLiteral38(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject852 || (_templateObject852 = _taggedTemplateLiteral38(["familiar scrapbook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
      ...
      prepare: function() {
        (0, import_kolmafia42.useSkill)($skill(_templateObject862 || (_templateObject862 = _taggedTemplateLiteral38(["Cannelloni Cocoon"]))));
      }
    },
    {
      name: "Queen",
      completed: function() {
        return have($item(_templateObject872 || (_templateObject872 = _taggedTemplateLiteral38(["very pointy crown"]))));
      },
      do: function() {
        return Witchess_exports.fightPiece($monster(_templateObject882 || (_templateObject882 = _taggedTemplateLiteral38(["Witchess Queen"]))));
      },
      ready: function() {
        return Witchess_exports.fightsDone() < 5;
      },
        ...
        return foldshirt(), uniform({
          changes: {
            weapon: byStat({
              ...
              default: $item(_templateObject902 || (_templateObject902 = _taggedTemplateLiteral38(["Fourth of May Cosplay Saber"])))
            }),
            shirt: $item(_templateObject9110 || (_templateObject9110 = _taggedTemplateLiteral38(["makeshift garbage shirt"]))),
            offhand: $item(_templateObject922 || (_templateObject922 = _taggedTemplateLiteral38(["familiar scrapbook"]))),
            familiar: $familiar(_templateObject932 || (_templateObject932 = _taggedTemplateLiteral38(["Shorter-Order Cook"])))
          }
        });
      },
      combat: new CSStrategy(function() {
      ...
      prepare: function() {
        (0, import_kolmafia42.useSkill)($skill(_templateObject942 || (_templateObject942 = _taggedTemplateLiteral38(["Cannelloni Cocoon"])))), have($effect(_templateObject952 || (_templateObject952 = _taggedTemplateLiteral38(["Psalm of Pointiness"])))) || (0, import_kolmafia42.useSkill)($skill(_templateObject962 || (_templateObject962 = _taggedTemplateLiteral38(["The Psalm of Pointiness"]))));
      },
      post: function() {
        return uneffect($effect(_templateObject972 || (_templateObject972 = _taggedTemplateLiteral38(["Psalm of Pointiness"]))));
      }
    },
    {
      ...
      combat: new CSStrategy(function() {
        return Macro2.skill($skill(_templateObject992 || (_templateObject992 = _taggedTemplateLiteral38(["Portscan"])))).defaultKill();
      })
    },
    {
      ...
      completed: function() {
        return have($item(_templateObject1002 || (_templateObject1002 = _taggedTemplateLiteral38(["government cheese"]))));
      },
      do: $location(_templateObject10110 || (_templateObject10110 = _taggedTemplateLiteral38(["An Unusually Quiet Barroom Brawl"]))),
      outfit: function() {
        return uniform({
          changes: {
            back: $item(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral38(["vampyric cloake"]))),
            acc3: $item(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral38(["Lil' Doctor\u2122 bag"])))
          }
        });
      },
      combat: new CSStrategy(function() {
        return Macro2.skill($skill(_templateObject1042 || (_templateObject1042 = _taggedTemplateLiteral38(["Become a Bat"])))).skill($skill(_templateObject1052 || (_templateObject1052 = _taggedTemplateLiteral38(["Otoscope"])))).attack().repeat();
      })
    },
    {
      name: "LOV",
      ...
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            weapon: $item(_templateObject1062 || (_templateObject1062 = _taggedTemplateLiteral38(["Fourth of May Cosplay Saber"]))),
            shirt: $item(_templateObject1072 || (_templateObject1072 = _taggedTemplateLiteral38(["makeshift garbage shirt"])))
          },
          canAttack: !1
        });
      },
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject1082 || (_templateObject1082 = _taggedTemplateLiteral38(["LOV Enforcer"]))), Macro2.attack().repeat()).if_($monster(_templateObject1092 || (_templateObject1092 = _taggedTemplateLiteral38(["LOV Engineer"]))), Macro2.candyblast().trySkillRepeat($skill(_templateObject1102 || (_templateObject1102 = _taggedTemplateLiteral38(["Weapon of the Pastalord"]))))).if_($monster(_templateObject11110 || (_templateObject11110 = _taggedTemplateLiteral38(["LOV Equivocator"]))), Macro2.delevel().easyFight().candyblast().defaultKill());
      }),
      post: function() {
        (0, import_kolmafia42.use)(1, $item(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral38(["LOV Extraterrestrial Chocolate"])))), burnLibrams();
      }
    },
    {
      name: "Snojo",
      ...
      outfit: uniform,
      do: $location(_templateObject1132 || (_templateObject1132 = _taggedTemplateLiteral38(["The X-32-F Combat Training Snowman"]))),
      combat: new CSStrategy(function() {
    ...
    },
    {
      ...
      completed: function() {
        return $effects(_templateObject1142 || (_templateObject1142 = _taggedTemplateLiteral38(["Snowballed, Half-Blooded, Half-Drained, Bruised, Relaxed Muscles, Hypnotized, Bad Haircut"]))).every(function(effect) {
          return !have(effect);
        });
      },
      do: function() {
    ...
    },
    {
      ...
      do: function() {
        return withProperties({
          ...
          try {
            (0, import_kolmafia42.useSkill)($skill(_templateObject1152 || (_templateObject1152 = _taggedTemplateLiteral38(["Evoke Eldritch Horror"])))), (0, import_kolmafia42.runCombat)();
          } catch (e) {
            (0, import_kolmafia42.print)("".concat(e));
          } finally {
            (have($effect(_templateObject1162 || (_templateObject1162 = _taggedTemplateLiteral38(["Beaten Up"])))) || (0, import_kolmafia42.myHp)() === 0 || !get("_lastCombatWon")) && (0, import_kolmafia42.cliExecute)("hottub");
          }
        });
      },
      outfit: uniform,
    ...
    },
    {
      ...
      outfit: function() {
        var _find, gear = (_find = $items(_templateObject1172 || (_templateObject1172 = _taggedTemplateLiteral38(["God Lobster's Crown, God Lobster's Robe, God Lobster's Rod, God Lobster's Ring, God Lobster's Scepter"]))).find(function(it) {
          return have(it);
        })) !== null && _find !== void 0 ? _find : $item(_templateObject1182 || (_templateObject1182 = _taggedTemplateLiteral38(["tiny stillsuit"])));
        return uniform({
          changes: {
            familiar: $familiar(_templateObject1192 || (_templateObject1192 = _taggedTemplateLiteral38(["God Lobster"]))),
            famequip: gear
          }
        });
      },
    ...
    },
    {
      ...
      do: $location(_templateObject1202 || (_templateObject1202 = _taggedTemplateLiteral38(["The Deep Machine Tunnels"]))),
      outfit: function() {
        return foldshirt(), uniform({
          changes: {
            shirt: $item(_templateObject12110 || (_templateObject12110 = _taggedTemplateLiteral38(["makeshift garbage shirt"]))),
            familiar: $familiar(_templateObject1222 || (_templateObject1222 = _taggedTemplateLiteral38(["Machine Elf"])))
          }
        });
      },
      combat: new CSStrategy()
    ...
    },
    {
      ...
      do: $location(_templateObject1232 || (_templateObject1232 = _taggedTemplateLiteral38(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var enoughSausages = get("_sausageFights") > 4, changes = _objectSpread10({
          shirt: $items(_templateObject1242 || (_templateObject1242 = _taggedTemplateLiteral38(["makeshift garbage shirt"])))
        }, enoughSausages ? {} : {
          offhand: $item(_templateObject1252 || (_templateObject1252 = _taggedTemplateLiteral38(["Kramco Sausage-o-Matic\u2122"])))
        });
        return uniform({
          changes: changes
        });
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($effect(_templateObject1262 || (_templateObject1262 = _taggedTemplateLiteral38(["Inner Elf"]))), Macro2.if_("!hascombatitem ".concat($item(_templateObject1272 || (_templateObject1272 = _taggedTemplateLiteral38(["cosmic bowling ball"])))), Macro2.trySkill($skill(_templateObject1282 || (_templateObject1282 = _taggedTemplateLiteral38(["Feel Pride"])))))).trySkill($skill(_templateObject1292 || (_templateObject1292 = _taggedTemplateLiteral38(["Bowl Sideways"])))).delevel().defaultKill();
      }),
    ...
    },
    {
      name: "Freekill NEP",
      completed: function() {
        return get("_shatteringPunchUsed") >= 3 && get("_gingerbreadMobHitUsed") && have($effect(_templateObject1302 || (_templateObject1302 = _taggedTemplateLiteral38(["Everything Looks Yellow"])))) && get("_chestXRayUsed") >= 3;
      },
      do: $location(_templateObject13110 || (_templateObject13110 = _taggedTemplateLiteral38(["The Neverending Party"]))),
      outfit: function() {
        foldshirt();
        var killSource = have($effect(_templateObject1322 || (_templateObject1322 = _taggedTemplateLiteral38(["Everything Looks Yellow"])))) ? get("_chestXRayUsed") < 3 ? {
          acc3: $item(_templateObject1342 || (_templateObject1342 = _taggedTemplateLiteral38(["Lil' Doctor\u2122 bag"])))
        } : {} : {
          shirt: $item(_templateObject1332 || (_templateObject1332 = _taggedTemplateLiteral38(["Jurassic Parka"]))),
          modes: {
            parka: "dilophosaur"
          }
      ...
      combat: new CSStrategy(function() {
        return Macro2.if_($monster(_templateObject1372 || (_templateObject1372 = _taggedTemplateLiteral38(["sausage goblin"]))), Macro2.defaultKill()).trySkill($skill(_templateObject1382 || (_templateObject1382 = _taggedTemplateLiteral38(["Bowl Sideways"])))).trySkill($skill(_templateObject1392 || (_templateObject1392 = _taggedTemplateLiteral38(["Spit jurassic acid"])))).trySkill($skill(_templateObject1402 || (_templateObject1402 = _taggedTemplateLiteral38(["Chest X-Ray"])))).trySkill($skill(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral38(["Shattering Punch"])))).trySkill($skill(_templateObject1422 || (_templateObject1422 = _taggedTemplateLiteral38(["Gingerbread Mob Hit"])))).abort();
      }),
      choices: _defineProperty17({}, 1324, 5)
    }
  ])
...
var Noncombat = {
  ...
  outfit: function() {
    return {
      ...
      back: $item(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral39(["protonic accelerator pack"]))),
...
var PULLS = [$items(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral40(["repaid diaper, Great Wolf's beastly trousers"]))), $items(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral40(["meteorite necklace"]))), $items(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral40(["Stick-Knife of Loathing"]))), $items(_templateObject440 || (_templateObject440 = _taggedTemplateLiteral40(["Buddy Bjorn"])))], codpieceAttempted = !1, MARKET_QUESTS = [{
  ...
  tasks: [{
    ...
    class: $classes(_templateObject2415 || (_templateObject2415 = _taggedTemplateLiteral40(["Seal Clubber, Disco Bandit"]))),
    do: function() {
...
var buffs3 = $effects(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral41(["Carol of the Hells, Arched Eyebrow of the Archmage, Song of Sauce"]))), chefstaves = $items(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral41(["Staff of the Roaring Hearth, Staff of Simmering Hatred, Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist"]))), Spell = {
  name: "Spell Damage",
  type: "SERVICE",
  ...
  tasks: [skillTask($skill(_templateObject1618 || (_templateObject1618 = _taggedTemplateLiteral41(["Simmer"])))), {
    ...
    core: "hard",
    do: function() {
      have($item(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral41(["flimsy hardwood scraps"])))) || (0, import_kolmafia45.visitUrl)("shop.php?whichshop=lathe"), (0, import_kolmafia45.retrieveItem)($item(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral41(["weeping willow wand"]))));
    }
  }, skillTask($skill(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral41(["Spirit of Cayenne"])))), potionTask($item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral41(["flask of baconstone juice"])))), {
    name: "Saucefingers",
    ready: function() {
      return (0, import_kolmafia45.myLevel)() >= 15 && have($familiar(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral41(["Mini-Adventurer"]))));
    },
    completed: function() {
    ...
    ready: function() {
      return (0, import_kolmafia45.canadiaAvailable)() && $items(_templateObject487 || (_templateObject487 = _taggedTemplateLiteral41(["meteorite fragment, meteorite earring, meteorite ring"]))).some(function(item6) {
        return have(item6);
      });
    },
    do: function() {
      ...
      meteor && (unequip(meteor), (0, import_kolmafia45.retrieveItem)(1, $item(_templateObject507 || (_templateObject507 = _taggedTemplateLiteral41(["tenderizing hammer"])))), (0, import_kolmafia45.retrieveItem)(1, $item(_templateObject5115 || (_templateObject5115 = _taggedTemplateLiteral41(["jewelry-making pliers"])))), meteor !== $item(_templateObject5213 || (_templateObject5213 = _taggedTemplateLiteral41(["meteorite fragment"]))) && (0, import_kolmafia45.cliExecute)("smash ".concat(meteor)), (0, import_kolmafia45.cliExecute)("make ".concat($item(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral41(["meteorite necklace"]))))));
    }
  }, {
    name: "Pull Staff",
    ready: function() {
...
var _templateObject171, _templateObject291, _templateObject361, _templateObject448, _templateObject540, _templateObject638, _templateObject734, _templateObject828, _templateObject926, _templateObject1025, _templateObject1124, _templateObject1224, _templateObject1324, _templateObject1421, _templateObject1519, _templateObject1619, _templateObject1718, _templateObject1818, _templateObject1918, _templateObject2017, _templateObject2122, _templateObject2222, _templateObject2319, _templateObject2417, _templateObject2516, _templateObject2616, _templateObject2716, _templateObject2814, _templateObject2914, _templateObject3013, _templateObject3120, _templateObject3218, _templateObject3315, _templateObject3413, _templateObject3512, _templateObject3611, _templateObject3710, _templateObject389, _templateObject398, _templateObject408, _templateObject4116, _templateObject4214, _templateObject4312, _templateObject449, _templateObject458, _templateObject468, _templateObject478, _templateObject488, _templateObject498, _templateObject508, _templateObject5116, _templateObject5214, _templateObject5311, _templateObject547, _templateObject557, _templateObject567, _templateObject577, _templateObject587, _templateObject596, _templateObject606, _templateObject6113, _templateObject6212, _templateObject639, _templateObject645, _templateObject654, _templateObject664, _templateObject674, _templateObject684, _templateObject694;
...
var SKILL_BUFFS = {
  ...
  MYSTICALITY: $effects(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral42(["Feeling Excited, Big, Song of Bravado, Quiet Judgement"]))),
...
var Muscle = {
  ...
  outfit: function() {
    return have($item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral42(["wad of used tape"])))) || (0, import_kolmafia46.cliExecute)("fold wad of used tape"), {
      ...
      shirt: $item(_templateObject1421 || (_templateObject1421 = _taggedTemplateLiteral42(["Jurassic Parka"]))),
  ...
  outfit: function() {
    return have($item(_templateObject2716 || (_templateObject2716 = _taggedTemplateLiteral42(["wad of used tape"])))) || (0, import_kolmafia46.cliExecute)("fold wad of used tape"), {
      ...
      acc1: byStat({
        ...
        default: $items(_templateObject3512 || (_templateObject3512 = _taggedTemplateLiteral42(["barrel hoop earring, Powerful Glove"])))
      }),
  ...
  tasks: [].concat(_toConsumableArray18(skillBuffTasks("MOXIE")), [birdTask("Moxie Percent"), favouriteBirdTask("Moxie Percent")], _toConsumableArray18($items(_templateObject5116 || (_templateObject5116 = _taggedTemplateLiteral42(["runproof mascara, confiscated love note, dollop of barbecue sauce"]))).map(potionTask)), [{
    ...
    do: function() {
      return (0, import_kolmafia46.use)((0, import_kolmafia46.itemAmount)($item(_templateObject5311 || (_templateObject5311 = _taggedTemplateLiteral42(["rhinestone"])))), $item(_templateObject547 || (_templateObject547 = _taggedTemplateLiteral42(["rhinestone"]))));
    }
  }, thrallTask($thrall(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral42(["Penne Dreadful"])))), equalizeTask()])
}, Hitpoints = {
  name: "Hitpoints",
  type: "SERVICE",
  ...
  maxTurns: 1,
  outfit: function() {
    return have($item(_templateObject567 || (_templateObject567 = _taggedTemplateLiteral42(["wad of used tape"])))) || (0, import_kolmafia46.cliExecute)("fold wad of used tape"), {
...
var buffs4 = $effects(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral43(["Carol of the Bulls, Song of the North, Rage of the Reindeer, Scowl of the Auk, Disdain of the War Snapper, Tenacity of the Snapper"]))), meteors, Weapon = {
  ...
  outfit: function() {
    return have($item(_templateObject2100 || (_templateObject2100 = _taggedTemplateLiteral43(["broken champagne bottle"])))) || (0, import_kolmafia47.cliExecute)("fold broken champagne bottle"), _objectSpread14({
  ...
  tasks: [].concat(_toConsumableArray19(restoreBuffTasks(buffs4)), [birdTask("Weapon Damage Percent"), favouriteBirdTask("Weapon Damage Percent"), skillTask($effect(_templateObject1125 || (_templateObject1125 = _taggedTemplateLiteral43(["Frenzied, Bloody"])))), potionTask($item(_templateObject1225 || (_templateObject1225 = _taggedTemplateLiteral43(["LOV Elixir #3"])))), potionTask($item(_templateObject1325 || (_templateObject1325 = _taggedTemplateLiteral43(["vial of hamethyst juice"])))), beachTask($effect(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral43(["Lack of Body-Building"])))), songTask($effect(_templateObject1520 || (_templateObject1520 = _taggedTemplateLiteral43(["Jackasses' Symphony of Destruction"]))), $effect(_templateObject1620 || (_templateObject1620 = _taggedTemplateLiteral43(["The Sonata of Sneakiness"])))), {
    ...
    core: "soft",
    completed: function() {
      return have($item(_templateObject3513 || (_templateObject3513 = _taggedTemplateLiteral43(["meteorite ring"]))));
    },
    ready: function() {
