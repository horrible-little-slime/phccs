...
function useDefaultFamiliar() {
  ...
  if (!property_get("_bagOfCandy") && canAttack) {
    ...
    (0,external_kolmafia_namespaceObject.equip)($slot(lib_templateObject48 || (lib_templateObject48 = lib_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject49 || (_templateObject49 = lib_taggedTemplateLiteral(["dromedary drinking helmet"]))));
