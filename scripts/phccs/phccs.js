  ...
  while (canCastLibrams()) {
    if (!testsDone.includes("Breed More Collies")) {
      ...
      if (lib_have($skill(lib_templateObject98 || (lib_templateObject98 = src_lib_taggedTemplateLiteral(["Summon BRICKOs"]))))) {
        ...
        if (lib_have(template_string_$familiar(lib_templateObject102 || (lib_templateObject102 = src_lib_taggedTemplateLiteral(["Garbage Fire"])))) && !lib_have(template_string_$item(lib_templateObject103 || (lib_templateObject103 = src_lib_taggedTemplateLiteral(["burning paper crane"])))) && !lib_have(template_string_$item(lib_templateObject104 || (lib_templateObject104 = src_lib_taggedTemplateLiteral(["burning newspaper"])))) && availableFights() < 30 - property_get("garbageFireProgress") && potentialFights() >= 30 - property_get("garbageFireProgress")) {
          var _decisionMap$get;

          var value = 5 / (30 - property_get("garbageFireProgress") - availableFights());
          var otherBrickoValue = (_decisionMap$get = decisionMap.get($skill(lib_templateObject105 || (lib_templateObject105 = src_lib_taggedTemplateLiteral(["Summon BRICKOs"]))))) !== null && _decisionMap$get !== void 0 ? _decisionMap$get : 0;

          if (value > otherBrickoValue) {
            decisionMap.set($skill(lib_templateObject106 || (lib_templateObject106 = src_lib_taggedTemplateLiteral(["Summon BRICKOs"]))), value);
          }
        }
