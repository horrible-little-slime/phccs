...
function synthExp() {
  ...
  if (fudges >= 2) {
    ...
    if (!lib_have(template_string_$item(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["sugar shotgun"]))))) {
      if (!lib_have(template_string_$item(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["sugar sheet"]))))) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["Summon Sugar Sheets"]))));
...
function synthItem() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
...
function synthMyst() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(lib_templateObject30 || (lib_templateObject30 = lib_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  } //const fudge = $item`Crimbo fudge`;
  ...
  if (lib_have(template_string_$item(lib_templateObject31 || (lib_templateObject31 = lib_taggedTemplateLiteral(["bag of many confections"]))))) {
    if (!property_get("_chubbyAndPlumpUsed")) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(lib_templateObject32 || (lib_templateObject32 = lib_taggedTemplateLiteral(["Chubby and Plump"]))));
    }
    ...
    while (mints + orangeHearts() + pinkHearts() === 0 && n < 11) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(lib_templateObject39 || (lib_templateObject39 = lib_taggedTemplateLiteral(["Summon Candy Heart"]))));
      n++;
    }
...
function useDefaultFamiliar() {
  ...
  if (!property_get("_bagOfCandy") && canAttack) {
    ...
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject53 || (_templateObject53 = lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  } else if (!lib_have(template_string_$item(_templateObject54 || (_templateObject54 = lib_taggedTemplateLiteral(["burning newspaper"])))) && !lib_have(template_string_$item(_templateObject55 || (_templateObject55 = lib_taggedTemplateLiteral(["burning paper crane"]))))) {
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject56 || (_templateObject56 = lib_taggedTemplateLiteral(["Garbage Fire"]))));
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject57 || (_templateObject57 = lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  } else {
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject58 || (_templateObject58 = lib_taggedTemplateLiteral(["Artistic Goth Kid"]))));
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject59 || (_templateObject59 = lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  }
}
...
function ensureInnerElf() {
  ...
  if (!lib_have($effect(_templateObject60 || (_templateObject60 = lib_taggedTemplateLiteral(["Inner Elf"])))) && (0,external_kolmafia_namespaceObject.myLevel)() >= 13) {
    setClan(property_get("phccs_elfClan", "Hobopolis Vacation Home"));

    try {
      withOutfit(new Outfit({
        acc3: template_string_$item(_templateObject61 || (_templateObject61 = lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))
      }, template_string_$familiar(_templateObject62 || (_templateObject62 = lib_taggedTemplateLiteral(["Machine Elf"])))), () => {
        lib_ensureEffect($effect(_templateObject63 || (_templateObject63 = lib_taggedTemplateLiteral(["Blood Bubble"]))));
        setChoice(326, 1);
        if (property_get("_kgbTranquilizerDartUses") >= 3) ensureMp(50);
        advMacro($location(_templateObject64 || (_templateObject64 = lib_taggedTemplateLiteral(["The Slime Tube"]))), combat_Macro.trySkill(template_string_$skill(_templateObject65 || (_templateObject65 = lib_taggedTemplateLiteral(["KGB tranquilizer dart"])))).trySkill(template_string_$skill(_templateObject66 || (_templateObject66 = lib_taggedTemplateLiteral(["Snokebomb"])))));
      });
    } finally {
      setClan(property_get("phccs_mainClan", "Alliance From Heck"));
    }

    if (!lib_have($effect(_templateObject67 || (_templateObject67 = lib_taggedTemplateLiteral(["Inner Elf"]))))) {
...
function fightSausageIfAble(location, macro) {
  if (kramcoCheck()) {
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject68 || (_templateObject68 = lib_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject69 || (_templateObject69 = lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
...
function mapMacro(location, monster, macro) {
  macro.setAutoAttack();
  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject70 || (_templateObject70 = lib_taggedTemplateLiteral(["Map the Monsters"]))));
...
function ensureMp(mp) {
  ...
  while (lib_have(template_string_$item(_templateObject71 || (_templateObject71 = lib_taggedTemplateLiteral(["magical sausage"])))) || lib_have(template_string_$item(_templateObject72 || (_templateObject72 = lib_taggedTemplateLiteral(["magical sausage casing"])))) && (0,external_kolmafia_namespaceObject.myMp)() < mp && property_get("_sausagesEaten") < 23) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject73 || (_templateObject73 = lib_taggedTemplateLiteral(["magical sausage"]))));
    (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject74 || (_templateObject74 = lib_taggedTemplateLiteral(["magical sausage"]))));
  }

  while (lib_have(template_string_$item(_templateObject75 || (_templateObject75 = lib_taggedTemplateLiteral(["psychokinetic energy blob"])))) && (0,external_kolmafia_namespaceObject.myMp)() < mp) {
    (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject76 || (_templateObject76 = lib_taggedTemplateLiteral(["psychokinetic energy blob"]))));
  }

  if ((0,external_kolmafia_namespaceObject.myMp)() < mp) (0,external_kolmafia_namespaceObject.restoreMp)(mp);
}
var maximizeFamiliar = lib_have(template_string_$familiar(_templateObject77 || (_templateObject77 = lib_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$familiar(_templateObject78 || (_templateObject78 = lib_taggedTemplateLiteral(["Disembodied Hand"]))) : template_string_$familiar(_templateObject79 || (_templateObject79 = lib_taggedTemplateLiteral(["Left-Hand Man"])));
...
var availableFights = () => clamp(5 - fightsDone(), 0, 5) + clamp((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject80 || (_templateObject80 = lib_taggedTemplateLiteral(["BRICKO eye brick"])))), 0, 10 - property_get("_brickoFights"));

var potentialFights = () => clamp(5 - fightsDone(), 0, 5) + clamp((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject81 || (_templateObject81 = lib_taggedTemplateLiteral(["BRICKO eye brick"])))), 0, 10 - property_get("_brickoFights")) + clamp(3 - property_get("_brickoEyeSummons"), 0, 10 - property_get("_brickoFights"));
...
function burnLibrams() {
  ...
  if (!$skills(_templateObject82 || (_templateObject82 = lib_taggedTemplateLiteral(["Summon BRICKOs, Summon Taffy, Summon Love Song, Summon Candy Heart"]))).some(skill => lib_have(skill))) return;
  ...
  while (canCastLibrams()) {
    if (!testsDone.includes("Breed More Collies")) {
      ...
      if (lib_have(template_string_$skill(_templateObject83 || (_templateObject83 = lib_taggedTemplateLiteral(["Summon Candy Heart"])))) && totalDuration(template_string_$item(_templateObject84 || (_templateObject84 = lib_taggedTemplateLiteral(["green candy heart"])))) <= 0) {
        var _libramPossibilities$, _libramPossibilities$2;

        var probability = (_libramPossibilities$ = (_libramPossibilities$2 = libramPossibilities.get(template_string_$skill(_templateObject85 || (_templateObject85 = lib_taggedTemplateLiteral(["Summon Candy Heart"]))))) === null || _libramPossibilities$2 === void 0 ? void 0 : _libramPossibilities$2.get(template_string_$item(_templateObject86 || (_templateObject86 = lib_taggedTemplateLiteral(["green candy heart"]))))) !== null && _libramPossibilities$ !== void 0 ? _libramPossibilities$ : 0;
        decisionMap.set(template_string_$skill(_templateObject87 || (_templateObject87 = lib_taggedTemplateLiteral(["Summon Candy Heart"]))), 3 * probability);
      }

      if (lib_have(template_string_$skill(_templateObject88 || (_templateObject88 = lib_taggedTemplateLiteral(["Summon Taffy"])))) && totalDuration(template_string_$item(_templateObject89 || (_templateObject89 = lib_taggedTemplateLiteral(["pulled blue taffy"])))) < 50) {
        var _libramPossibilities$3, _libramPossibilities$4;

        var _probability = (_libramPossibilities$3 = (_libramPossibilities$4 = libramPossibilities.get(template_string_$skill(_templateObject90 || (_templateObject90 = lib_taggedTemplateLiteral(["Summon Taffy"]))))) === null || _libramPossibilities$4 === void 0 ? void 0 : _libramPossibilities$4.get(template_string_$item(_templateObject91 || (_templateObject91 = lib_taggedTemplateLiteral(["pulled blue taffy"]))))) !== null && _libramPossibilities$3 !== void 0 ? _libramPossibilities$3 : 0;

        decisionMap.set(template_string_$skill(_templateObject92 || (_templateObject92 = lib_taggedTemplateLiteral(["Summon Taffy"]))), 1 * _probability);
      }

      if (lib_have(template_string_$skill(_templateObject93 || (_templateObject93 = lib_taggedTemplateLiteral(["Summon Love Song"])))) && totalDuration(template_string_$item(_templateObject94 || (_templateObject94 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) < 20) {
        var _libramPossibilities$5, _libramPossibilities$6;

        var _probability2 = (_libramPossibilities$5 = (_libramPossibilities$6 = libramPossibilities.get(template_string_$skill(_templateObject95 || (_templateObject95 = lib_taggedTemplateLiteral(["Summon Love Song"]))))) === null || _libramPossibilities$6 === void 0 ? void 0 : _libramPossibilities$6.get(template_string_$item(_templateObject96 || (_templateObject96 = lib_taggedTemplateLiteral(["love song of icy revenge"]))))) !== null && _libramPossibilities$5 !== void 0 ? _libramPossibilities$5 : 0;

        var currentWeightValue = clamp(Math.ceil(totalDuration(template_string_$item(_templateObject97 || (_templateObject97 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) / 2), 0, 10);
        var newWeightValue = clamp(Math.ceil((totalDuration(template_string_$item(_templateObject98 || (_templateObject98 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) + 5) / 2), 0, 10);
        decisionMap.set(template_string_$skill(_templateObject99 || (_templateObject99 = lib_taggedTemplateLiteral(["Summon Love Song"]))), _probability2 * (newWeightValue - currentWeightValue));
      }

      if (lib_have(template_string_$skill(_templateObject100 || (_templateObject100 = lib_taggedTemplateLiteral(["Summon BRICKOs"])))) && property_get("_brickoEyeSummons") < 3 && testsDone.includes("Donate Blood")) {
        var _libramPossibilities$7, _libramPossibilities$8;

        var _probability3 = (_libramPossibilities$7 = (_libramPossibilities$8 = libramPossibilities.get(template_string_$skill(_templateObject101 || (_templateObject101 = lib_taggedTemplateLiteral(["Summon BRICKOs"]))))) === null || _libramPossibilities$8 === void 0 ? void 0 : _libramPossibilities$8.get(template_string_$item(_templateObject102 || (_templateObject102 = lib_taggedTemplateLiteral(["BRICKO eye brick"]))))) !== null && _libramPossibilities$7 !== void 0 ? _libramPossibilities$7 : 0;

        if (lib_have(template_string_$familiar(_templateObject103 || (_templateObject103 = lib_taggedTemplateLiteral(["Shorter-Order Cook"])))) && totalDuration(template_string_$item(_templateObject104 || (_templateObject104 = lib_taggedTemplateLiteral(["short stack of pancakes"])))) === 0 && availableFights() < 11 - property_get("_shortOrderCookCharge") && potentialFights() >= 11 - property_get("_shortOrderCookCharge")) {
          decisionMap.set(template_string_$skill(_templateObject105 || (_templateObject105 = lib_taggedTemplateLiteral(["Summon BRICKOs"]))), _probability3 * 11 / (11 - property_get("_shortOrderCookCharge") - availableFights()));
        }

        if (lib_have(template_string_$familiar(_templateObject106 || (_templateObject106 = lib_taggedTemplateLiteral(["Garbage Fire"])))) && !lib_have(template_string_$item(_templateObject107 || (_templateObject107 = lib_taggedTemplateLiteral(["burning paper crane"])))) && !lib_have(template_string_$item(_templateObject108 || (_templateObject108 = lib_taggedTemplateLiteral(["burning newspaper"])))) && availableFights() < 30 - property_get("garbageFireProgress") && potentialFights() >= 30 - property_get("garbageFireProgress")) {
          var _decisionMap$get;

          var value = 5 / (30 - property_get("garbageFireProgress") - availableFights()) * _probability3;

          var otherBrickoValue = (_decisionMap$get = decisionMap.get(template_string_$skill(_templateObject109 || (_templateObject109 = lib_taggedTemplateLiteral(["Summon BRICKOs"]))))) !== null && _decisionMap$get !== void 0 ? _decisionMap$get : 0;

          if (value > otherBrickoValue) {
            decisionMap.set(template_string_$skill(_templateObject110 || (_templateObject110 = lib_taggedTemplateLiteral(["Summon BRICKOs"]))), value);
          }
        }
      }
...
function equalizeMuscle() {
  if ((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(_templateObject111 || (_templateObject111 = lib_taggedTemplateLiteral(["Pastamancer"])))) return (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject112 || (_templateObject112 = lib_taggedTemplateLiteral(["Bind Undead Elbow Macaroni"]))));else {
    if (lib_have($effect(_templateObject113 || (_templateObject113 = lib_taggedTemplateLiteral(["Expert Oiliness"]))))) return true;

    if (!lib_have(template_string_$item(_templateObject114 || (_templateObject114 = lib_taggedTemplateLiteral(["oil of expertise"]))))) {
      if (!lib_have(template_string_$item(_templateObject115 || (_templateObject115 = lib_taggedTemplateLiteral(["cherry"])))) && property_get("_monstersMapped") < 2) {
        uniform();
        useDefaultFamiliar();
        setChoice(1387, 3);
        ...
        mapMacro($location(_templateObject116 || (_templateObject116 = lib_taggedTemplateLiteral(["The Skeleton Store"]))), $monster(_templateObject117 || (_templateObject117 = lib_taggedTemplateLiteral(["novelty tropical skeleton"]))), combat_Macro.skill(template_string_$skill(_templateObject118 || (_templateObject118 = lib_taggedTemplateLiteral(["Use the Force"])))));
      }

      if (!property_get("hasRange")) {
        if (!lib_have(template_string_$item(_templateObject119 || (_templateObject119 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))))) {
          (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(_templateObject120 || (_templateObject120 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
        }

        (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject121 || (_templateObject121 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
      }

      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject122 || (_templateObject122 = lib_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
      (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject123 || (_templateObject123 = lib_taggedTemplateLiteral(["oil of expertise"]))));
    }

    return (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject124 || (_templateObject124 = lib_taggedTemplateLiteral(["oil of expertise"]))));
  }
}
function equalizeMoxie() {
  if ((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(_templateObject125 || (_templateObject125 = lib_taggedTemplateLiteral(["Pastamancer"])))) return (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject126 || (_templateObject126 = lib_taggedTemplateLiteral(["Bind Penne Dreadful"]))));else {
    if (lib_have($effect(_templateObject127 || (_templateObject127 = lib_taggedTemplateLiteral(["Expert Oiliness"]))))) return true;

    if (!lib_have(template_string_$item(_templateObject128 || (_templateObject128 = lib_taggedTemplateLiteral(["oil of expertise"]))))) {
      if (!lib_have(template_string_$item(_templateObject129 || (_templateObject129 = lib_taggedTemplateLiteral(["cherry"])))) && property_get("_monstersMapped") < 2) {
        uniform();
        useDefaultFamiliar();
        setChoice(1387, 3);
        ...
        mapMacro($location(_templateObject130 || (_templateObject130 = lib_taggedTemplateLiteral(["The Skeleton Store"]))), $monster(_templateObject131 || (_templateObject131 = lib_taggedTemplateLiteral(["novelty tropical skeleton"]))), combat_Macro.skill(template_string_$skill(_templateObject132 || (_templateObject132 = lib_taggedTemplateLiteral(["Use the Force"])))));
      }

      if (!property_get("hasRange")) {
        if (!lib_have(template_string_$item(_templateObject133 || (_templateObject133 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))))) {
          (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(_templateObject134 || (_templateObject134 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
        }

        (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject135 || (_templateObject135 = lib_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
      }

      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject136 || (_templateObject136 = lib_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
      (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject137 || (_templateObject137 = lib_taggedTemplateLiteral(["oil of expertise"]))));
    }

    return (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject138 || (_templateObject138 = lib_taggedTemplateLiteral(["oil of expertise"]))));
  }
}
...
function outfits_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function outfits_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { outfits_ownKeys(Object(source), true).forEach(function (key) { outfits_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { outfits_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var modeables = {
  backupcamera: template_string_$item(outfits_templateObject || (outfits_templateObject = outfits_taggedTemplateLiteral(["backup camera"]))),
  umbrella: template_string_$item(outfits_templateObject2 || (outfits_templateObject2 = outfits_taggedTemplateLiteral(["unbreakable umbrella"]))),
  snowsuit: template_string_$item(outfits_templateObject3 || (outfits_templateObject3 = outfits_taggedTemplateLiteral(["Snow Suit"]))),
  edpiece: template_string_$item(outfits_templateObject4 || (outfits_templateObject4 = outfits_taggedTemplateLiteral(["The Crown of Ed the Undying"]))),
...
var Outfit = /*#__PURE__*/function () {
  ...
  function Outfit(equips, familiar, modes) {
    ...
    outfits_defineProperty(this, "modes", void 0);
  ...
  outfits_createClass(Outfit, [{
    ...
    value: function dress() {
      ...
      var accessorySlots = $slots(outfits_templateObject7 || (outfits_templateObject7 = outfits_taggedTemplateLiteral(["acc1, acc2, acc3"])));
      ...
      var _iterator = outfits_createForOfIteratorHelper($slots(outfits_templateObject8 || (outfits_templateObject8 = outfits_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var slot = _step.value;
          if (targetEquipment.includes((0,external_kolmafia_namespaceObject.equippedItem)(slot)) && equipmentMap.get(slot) !== (0,external_kolmafia_namespaceObject.equippedItem)(slot)) (0,external_kolmafia_namespaceObject.equip)(slot, template_string_$item(outfits_templateObject9 || (outfits_templateObject9 = outfits_taggedTemplateLiteral(["none"]))));
      ...
      var _iterator2 = outfits_createForOfIteratorHelper($slots(outfits_templateObject10 || (outfits_templateObject10 = outfits_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step2;
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (equipment) {
            if (!lib_have(equipment) && getFoldGroup(equipment).some(i => lib_have(i))) {
              (0,external_kolmafia_namespaceObject.cliExecute)("fold ".concat(equipment));
            }
      ...
      try {
        var _loop = function _loop() {
          ...
          if (currentEquip === template_string_$item(outfits_templateObject11 || (outfits_templateObject11 = outfits_taggedTemplateLiteral(["none"]))) || (0,external_kolmafia_namespaceObject.equippedAmount)(currentEquip) > accessoryEquips.filter(accessory => accessory === currentEquip).length) {
      ...
      for (var _i2 = 0, _Object$entries = Object.entries(this.modes); _i2 < _Object$entries.length; _i2++) {
        ...
        if ((0,external_kolmafia_namespaceObject.haveEquipped)(modeables[cliCommand])) {
          var parsedArguments = typeof args === "string" ? args : args.join(" ");
          var props = modeableProperties[cliCommand];
          ...
          (0,external_kolmafia_namespaceObject.cliExecute)("".concat(cliCommand, " ").concat(parsedArguments));
        }
      }
    }
  }, {
    ...
    value: function current() {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          if (item !== template_string_$item(outfits_templateObject12 || (outfits_templateObject12 = outfits_taggedTemplateLiteral(["none"])))) fit[slotName] = item;
        }
      } catch (err) {
        _iterator4.e(err);
      } finally {
...
var OutfitPlan = /*#__PURE__*/function () {
  function OutfitPlan(outline) {
    ...
    outfits_classCallCheck(this, OutfitPlan);

    outfits_defineProperty(this, "outline", void 0);

    outfits_defineProperty(this, "filler", void 0);
  ...
  outfits_createClass(OutfitPlan, [{
    key: "build",
    value: function build() {
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          var itemChoice = Array.isArray(itemOrItems) ? itemOrItems.find(item => (lib_have(item) || getFoldGroup(item).some(i => lib_have(i))) && ((0,external_kolmafia_namespaceObject.toSlot)(slotName) === $slot(outfits_templateObject13 || (outfits_templateObject13 = outfits_taggedTemplateLiteral(["familiar"]))) || (0,external_kolmafia_namespaceObject.canEquip)(item))) : itemOrItems;
    ...
    value: function dress(filler) {
      ...
      if (filler) {
        new Requirement([], {
          preventSlot: Object.keys(fit).map(s => (0,external_kolmafia_namespaceObject.toSlot)(s))
    ...
    value: function merge(other) {
      if (other instanceof OutfitPlan) {
        ...
        return new OutfitPlan(merged, {
          ...
          filler: (_other$filler$merge = (_other$filler = other.filler) === null || _other$filler === void 0 ? void 0 : _other$filler.merge((_this$filler = this.filler) !== null && _this$filler !== void 0 ? _this$filler : new Requirement([], {}))) !== null && _other$filler$merge !== void 0 ? _other$filler$merge : this.filler,
          modes: outfits_objectSpread(outfits_objectSpread({}, (_other$modes = other.modes) !== null && _other$modes !== void 0 ? _other$modes : {}), (_this$modes = this.modes) !== null && _this$modes !== void 0 ? _this$modes : {})
        });
      } else {
    ...
    key: "modifier",
    value: function modifier(mod) {
      if (utils_arrayContains(mod, modifierTypes_numericModifiers)) return this.build().modifier(mod);else return this.build().modifier(mod);
    }
  }], [{
    key: "merge",
    value: function merge() {
...
function uniform() {
  var defaultUniform = {
    hat: template_string_$items(outfits_templateObject14 || (outfits_templateObject14 = outfits_taggedTemplateLiteral(["astral chapeau, Iunion Crown"]))),
    shirt: template_string_$items(outfits_templateObject15 || (outfits_templateObject15 = outfits_taggedTemplateLiteral(["Jurassic Parka, fresh coat of paint"]))),
    pants: template_string_$items(outfits_templateObject16 || (outfits_templateObject16 = outfits_taggedTemplateLiteral(["designer sweatpants, old sweatpants"]))),
    weapon: property_get("_juneCleaverFightsLeft") > 0 && property_get("_juneCleaverEncounters") < 2 ? template_string_$item(outfits_templateObject17 || (outfits_templateObject17 = outfits_taggedTemplateLiteral(["June cleaver"]))) : template_string_$item(outfits_templateObject18 || (outfits_templateObject18 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
    offhand: template_string_$item(outfits_templateObject19 || (outfits_templateObject19 = outfits_taggedTemplateLiteral(["unbreakable umbrella"]))),
    acc1: template_string_$items(outfits_templateObject20 || (outfits_templateObject20 = outfits_taggedTemplateLiteral(["meteorite necklace, your cowboy boots"]))),
    acc2: template_string_$item(outfits_templateObject21 || (outfits_templateObject21 = outfits_taggedTemplateLiteral(["codpiece"]))),
    acc3: template_string_$items(outfits_templateObject22 || (outfits_templateObject22 = outfits_taggedTemplateLiteral(["battle broom, Powerful Glove"]))),
    back: template_string_$items(outfits_templateObject23 || (outfits_templateObject23 = outfits_taggedTemplateLiteral(["LOV Epaulettes, unwrapped knock-off retro superhero cape"])))
  };
...
var wireOutfit = new Outfit({
  hat: template_string_$item(outfits_templateObject24 || (outfits_templateObject24 = outfits_taggedTemplateLiteral(["Iunion Crown"]))),
  shirt: template_string_$item(outfits_templateObject25 || (outfits_templateObject25 = outfits_taggedTemplateLiteral(["fresh coat of paint"]))),
  pants: template_string_$item(outfits_templateObject26 || (outfits_templateObject26 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  weapon: template_string_$item(outfits_templateObject27 || (outfits_templateObject27 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfits_templateObject28 || (outfits_templateObject28 = outfits_taggedTemplateLiteral(["familiar scrapbook"]))),
  acc1: template_string_$item(outfits_templateObject29 || (outfits_templateObject29 = outfits_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"]))),
  acc2: template_string_$item(outfits_templateObject30 || (outfits_templateObject30 = outfits_taggedTemplateLiteral(["Powerful Glove"]))),
  acc3: template_string_$item(outfits_templateObject31 || (outfits_templateObject31 = outfits_taggedTemplateLiteral(["Guzzlr tablet"])))
});
var moxieOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject32 || (outfits_templateObject32 = outfits_taggedTemplateLiteral(["very pointy crown"]))),
  shirt: template_string_$items(outfits_templateObject33 || (outfits_templateObject33 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject34 || (outfits_templateObject34 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$item(outfits_templateObject35 || (outfits_templateObject35 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfits_templateObject36 || (outfits_templateObject36 = outfits_taggedTemplateLiteral(["unbreakable umbrella"]))),
  pants: template_string_$item(outfits_templateObject37 || (outfits_templateObject37 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject38 || (outfits_templateObject38 = outfits_taggedTemplateLiteral(["Beach Comb"]))),
  acc2: template_string_$item(outfits_templateObject39 || (outfits_templateObject39 = outfits_taggedTemplateLiteral(["\"I Voted!\" sticker"]))),
  acc3: template_string_$item(outfits_templateObject40 || (outfits_templateObject40 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  familiar: template_string_$item(outfits_templateObject41 || (outfits_templateObject41 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var hpOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject42 || (outfits_templateObject42 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(outfits_templateObject43 || (outfits_templateObject43 = outfits_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(outfits_templateObject44 || (outfits_templateObject44 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(outfits_templateObject45 || (outfits_templateObject45 = outfits_taggedTemplateLiteral(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject46 || (outfits_templateObject46 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(outfits_templateObject47 || (outfits_templateObject47 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject48 || (outfits_templateObject48 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(outfits_templateObject49 || (outfits_templateObject49 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(outfits_templateObject50 || (outfits_templateObject50 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(outfits_templateObject51 || (outfits_templateObject51 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var muscleOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject52 || (outfits_templateObject52 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(outfits_templateObject53 || (outfits_templateObject53 = outfits_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(outfits_templateObject54 || (outfits_templateObject54 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(outfits_templateObject55 || (outfits_templateObject55 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject56 || (outfits_templateObject56 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(outfits_templateObject57 || (outfits_templateObject57 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject58 || (outfits_templateObject58 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(outfits_templateObject59 || (outfits_templateObject59 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(outfits_templateObject60 || (outfits_templateObject60 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(outfits_templateObject61 || (outfits_templateObject61 = outfits_taggedTemplateLiteral(["unbreakable umbrella"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject62 || (outfits_templateObject62 = outfits_taggedTemplateLiteral(["Left-Hand Man"]))),
  modes: {
    retrocape: ["vampire", currentMode()]
  }
});
var mysticalityOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject63 || (outfits_templateObject63 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(outfits_templateObject64 || (outfits_templateObject64 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(outfits_templateObject65 || (outfits_templateObject65 = outfits_taggedTemplateLiteral(["astral statuette, cosmetic football"]))),
  back: template_string_$item(outfits_templateObject66 || (outfits_templateObject66 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  shirt: template_string_$items(outfits_templateObject67 || (outfits_templateObject67 = outfits_taggedTemplateLiteral(["denim jacket, shoe ad T-shirt, fresh coat of paint"]))),
  pants: template_string_$item(outfits_templateObject68 || (outfits_templateObject68 = outfits_taggedTemplateLiteral(["designer sweatpants"]))),
  acc1: template_string_$item(outfits_templateObject69 || (outfits_templateObject69 = outfits_taggedTemplateLiteral(["your cowboy boots"]))),
  acc2: template_string_$item(outfits_templateObject70 || (outfits_templateObject70 = outfits_taggedTemplateLiteral(["codpiece"]))),
  acc3: template_string_$item(outfits_templateObject71 || (outfits_templateObject71 = outfits_taggedTemplateLiteral(["battle broom"]))),
  familiar: template_string_$items(outfits_templateObject72 || (outfits_templateObject72 = outfits_taggedTemplateLiteral(["Abracandalabra"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject73 || (outfits_templateObject73 = outfits_taggedTemplateLiteral(["Left-Hand Man"]))),
  modes: {
    retrocape: ["vampire", currentMode()]
  }
});
var itemOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject74 || (outfits_templateObject74 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$items(outfits_templateObject75 || (outfits_templateObject75 = outfits_taggedTemplateLiteral(["extra-large utility candle"]))),
  offhand: template_string_$item(outfits_templateObject76 || (outfits_templateObject76 = outfits_taggedTemplateLiteral(["cursed magnifying glass"]))),
  back: template_string_$item(outfits_templateObject77 || (outfits_templateObject77 = outfits_taggedTemplateLiteral(["protonic accelerator pack"]))),
  acc1: template_string_$item(outfits_templateObject78 || (outfits_templateObject78 = outfits_taggedTemplateLiteral(["Guzzlr tablet"]))),
  acc2: template_string_$item(outfits_templateObject79 || (outfits_templateObject79 = outfits_taggedTemplateLiteral(["gold detective badge"]))),
  acc3: template_string_$items(outfits_templateObject80 || (outfits_templateObject80 = outfits_taggedTemplateLiteral(["government-issued night-vision goggles"]))),
  familiar: template_string_$item(outfits_templateObject81 || (outfits_templateObject81 = outfits_taggedTemplateLiteral(["li'l ninja costume"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject82 || (outfits_templateObject82 = outfits_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
});
var hotresOutfit = new OutfitPlan({
  back: template_string_$item(outfits_templateObject83 || (outfits_templateObject83 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$item(outfits_templateObject84 || (outfits_templateObject84 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$item(outfits_templateObject85 || (outfits_templateObject85 = outfits_taggedTemplateLiteral(["Jurassic Parka"]))),
  offhand: template_string_$item(outfits_templateObject86 || (outfits_templateObject86 = outfits_taggedTemplateLiteral(["meteorite guard"]))),
  pants: template_string_$item(outfits_templateObject87 || (outfits_templateObject87 = outfits_taggedTemplateLiteral(["designer sweatpants"]))),
  acc1: template_string_$item(outfits_templateObject88 || (outfits_templateObject88 = outfits_taggedTemplateLiteral(["your cowboy boots"]))),
  acc2: template_string_$item(outfits_templateObject89 || (outfits_templateObject89 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc3: template_string_$item(outfits_templateObject90 || (outfits_templateObject90 = outfits_taggedTemplateLiteral(["Beach Comb"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject91 || (outfits_templateObject91 = outfits_taggedTemplateLiteral(["Exotic Parrot"]))),
  modes: {
...
var noncombatOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject92 || (outfits_templateObject92 = outfits_taggedTemplateLiteral(["very pointy crown"]))),
  back: template_string_$item(outfits_templateObject93 || (outfits_templateObject93 = outfits_taggedTemplateLiteral(["protonic accelerator pack"]))),
  weapon: template_string_$item(outfits_templateObject94 || (outfits_templateObject94 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$item(outfits_templateObject95 || (outfits_templateObject95 = outfits_taggedTemplateLiteral(["Jurassic Parka"]))),
  offhand: template_string_$items(outfits_templateObject96 || (outfits_templateObject96 = outfits_taggedTemplateLiteral(["unbreakable umbrella, burning paper crane, familiar scrapbook"]))),
  acc1: template_string_$item(outfits_templateObject97 || (outfits_templateObject97 = outfits_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
  acc2: template_string_$item(outfits_templateObject98 || (outfits_templateObject98 = outfits_taggedTemplateLiteral(["codpiece"]))),
  acc3: template_string_$item(outfits_templateObject99 || (outfits_templateObject99 = outfits_taggedTemplateLiteral(["Brutal brogues"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject100 || (outfits_templateObject100 = outfits_taggedTemplateLiteral(["Disgeist"]))),
  modes: {
    umbrella: "cocoon",
    parka: "pterodactyl"
  }
...
var _ref3 = !(0,external_kolmafia_namespaceObject.inHardcore)() && lib_have(template_string_$familiar(outfits_templateObject101 || (outfits_templateObject101 = outfits_taggedTemplateLiteral(["Doppelshifter"])))) ? {
  fam: template_string_$familiar(outfits_templateObject102 || (outfits_templateObject102 = outfits_taggedTemplateLiteral(["Doppelshifter"]))),
  famEquip: template_string_$item(outfits_templateObject103 || (outfits_templateObject103 = outfits_taggedTemplateLiteral(["tiny costume wardrobe"])))
} : lib_have(template_string_$familiar(outfits_templateObject104 || (outfits_templateObject104 = outfits_taggedTemplateLiteral(["Baby Bugged Bugbear"])))) ? {
  fam: template_string_$familiar(outfits_templateObject105 || (outfits_templateObject105 = outfits_taggedTemplateLiteral(["Baby Bugged Bugbear"]))),
  famEquip: template_string_$item(outfits_templateObject106 || (outfits_templateObject106 = outfits_taggedTemplateLiteral(["bugged beanie"])))
} : {
  fam: template_string_$familiar(outfits_templateObject107 || (outfits_templateObject107 = outfits_taggedTemplateLiteral(["Blood-Faced Volleyball"]))),
  famEquip: template_string_$items(outfits_templateObject108 || (outfits_templateObject108 = outfits_taggedTemplateLiteral(["astral pet sweater"])))
},
    fam = _ref3.fam,
    famEquip = _ref3.famEquip;

var famweightOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject109 || (outfits_templateObject109 = outfits_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
  weapon: template_string_$item(outfits_templateObject110 || (outfits_templateObject110 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(outfits_templateObject111 || (outfits_templateObject111 = outfits_taggedTemplateLiteral(["burning paper crane, familiar scrapbook"]))),
  pants: template_string_$items(outfits_templateObject112 || (outfits_templateObject112 = outfits_taggedTemplateLiteral(["repaid diaper, Great Wolf's beastly trousers, designer sweatpants"]))),
  acc1: template_string_$item(outfits_templateObject113 || (outfits_templateObject113 = outfits_taggedTemplateLiteral(["Beach Comb"]))),
  acc2: template_string_$item(outfits_templateObject114 || (outfits_templateObject114 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc3: template_string_$item(outfits_templateObject115 || (outfits_templateObject115 = outfits_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
  familiar: famEquip
}, {
  familiar: fam
});
var weaponOutfit = new OutfitPlan({
  ...
  familiar: template_string_$familiar(outfits_templateObject123 || (outfits_templateObject123 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))
});

var _ref4 = (0,external_kolmafia_namespaceObject.inHardcore)() ? {
  spellFamiliar: template_string_$familiar(outfits_templateObject124 || (outfits_templateObject124 = outfits_taggedTemplateLiteral(["Left-Hand Man"]))),
  spellFamEquip: template_string_$items(outfits_templateObject125 || (outfits_templateObject125 = outfits_taggedTemplateLiteral(["astral statuette"])))
} : {
  spellFamiliar: template_string_$familiar(outfits_templateObject126 || (outfits_templateObject126 = outfits_taggedTemplateLiteral(["Disembodied Hand"]))),
  spellFamEquip: template_string_$items(outfits_templateObject127 || (outfits_templateObject127 = outfits_taggedTemplateLiteral(["Stick-Knife of Loathing"])))
},
    spellFamiliar = _ref4.spellFamiliar,
    spellFamEquip = _ref4.spellFamEquip;

var spellOutfit = new OutfitPlan({
  hat: template_string_$items(outfits_templateObject128 || (outfits_templateObject128 = outfits_taggedTemplateLiteral(["sugar chapeau, astral chapeau, Hollandaise helmet"]))),
  weapon: !(0,external_kolmafia_namespaceObject.inHardcore)() ? chefstaves : template_string_$item(outfits_templateObject129 || (outfits_templateObject129 = outfits_taggedTemplateLiteral(["weeping willow wand"]))),
  offhand: [template_string_$item(outfits_templateObject130 || (outfits_templateObject130 = outfits_taggedTemplateLiteral(["Abracandalabra"])))].concat(outfits_toConsumableArray((0,external_kolmafia_namespaceObject.inHardcore)() ? template_string_$items(outfits_templateObject131 || (outfits_templateObject131 = outfits_taggedTemplateLiteral(["weeping willow wand, astral statuette"]))) : template_string_$items(outfits_templateObject132 || (outfits_templateObject132 = outfits_taggedTemplateLiteral(["obsidian nutcracker"]))))),
  familiar: spellFamEquip,
  pants: template_string_$item(outfits_templateObject133 || (outfits_templateObject133 = outfits_taggedTemplateLiteral(["designer sweatpants"]))),
  acc1: template_string_$items(outfits_templateObject134 || (outfits_templateObject134 = outfits_taggedTemplateLiteral(["meteorite necklace, Kremlin's Greatest Briefcase"]))),
  acc2: template_string_$item(outfits_templateObject135 || (outfits_templateObject135 = outfits_taggedTemplateLiteral(["codpiece"]))),
  acc3: template_string_$item(outfits_templateObject136 || (outfits_templateObject136 = outfits_taggedTemplateLiteral(["battle broom"])))
}, {
...
function doPulls() {
  ...
  var pulls = [template_string_$items(runstart_templateObject20 || (runstart_templateObject20 = runstart_taggedTemplateLiteral(["repaid diaper, Great Wolf's beastly trousers"]))), template_string_$items(runstart_templateObject21 || (runstart_templateObject21 = runstart_taggedTemplateLiteral(["meteorite necklace, meteorite ring, meteorite fragment, meteorite earring"]))), template_string_$item(runstart_templateObject22 || (runstart_templateObject22 = runstart_taggedTemplateLiteral(["Stick-Knife of Loathing"]))), [].concat(runstart_toConsumableArray(lib_have(template_string_$familiar(runstart_templateObject23 || (runstart_templateObject23 = runstart_taggedTemplateLiteral(["Doppelshifter"])))) ? template_string_$items(runstart_templateObject24 || (runstart_templateObject24 = runstart_taggedTemplateLiteral(["tiny costume wardrobe"]))) : []), runstart_toConsumableArray(template_string_$items(runstart_templateObject25 || (runstart_templateObject25 = runstart_taggedTemplateLiteral(["moveable feast, Snow Suit"])))))];
...
function getTurns() {
  ...
  if (!property_get("_borrowedTimeUsed")) {
    if (!lib_have(template_string_$item(runstart_templateObject26 || (runstart_templateObject26 = runstart_taggedTemplateLiteral(["borrowed time"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(runstart_templateObject27 || (runstart_templateObject27 = runstart_taggedTemplateLiteral(["borrowed time"]))));
    }

    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runstart_templateObject28 || (runstart_templateObject28 = runstart_taggedTemplateLiteral(["borrowed time"]))));
  }
}

function prepGear() {
  if (!lib_have(template_string_$item(runstart_templateObject29 || (runstart_templateObject29 = runstart_taggedTemplateLiteral(["dromedary drinking helmet"]))))) {
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(runstart_templateObject30 || (runstart_templateObject30 = runstart_taggedTemplateLiteral(["Melodramedary"]))));

    if (!lib_have(template_string_$item(runstart_templateObject31 || (runstart_templateObject31 = runstart_taggedTemplateLiteral(["box of Familiar Jacks"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(runstart_templateObject32 || (runstart_templateObject32 = runstart_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    }

    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runstart_templateObject33 || (runstart_templateObject33 = runstart_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    (0,external_kolmafia_namespaceObject.cliExecute)("mummery myst");
  }

  (0,external_kolmafia_namespaceObject.equip)(template_string_$familiar(runstart_templateObject34 || (runstart_templateObject34 = runstart_taggedTemplateLiteral(["Shorter-Order Cook"]))), template_string_$item(runstart_templateObject35 || (runstart_templateObject35 = runstart_taggedTemplateLiteral(["tiny stillsuit"]))));

  if (!lib_have(template_string_$item(runstart_templateObject36 || (runstart_templateObject36 = runstart_taggedTemplateLiteral(["your cowboy boots"]))))) {
  ...
  if (lib_have(template_string_$item(runstart_templateObject37 || (runstart_templateObject37 = runstart_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && !property_get("_saberMod")) {
    (0,external_kolmafia_namespaceObject.visitUrl)("main.php?action=may4");
    (0,external_kolmafia_namespaceObject.runChoice)(4);
  }

  if (!lib_have(template_string_$item(runstart_templateObject38 || (runstart_templateObject38 = runstart_taggedTemplateLiteral(["gold detective badge"]))))) {
    (0,external_kolmafia_namespaceObject.visitUrl)("place.php?whichplace=town_wrong&action=townwrong_precinct");
  }

  if (lib_have(template_string_$item(runstart_templateObject39 || (runstart_templateObject39 = runstart_taggedTemplateLiteral(["GameInformPowerDailyPro magazine"]))))) {
    (0,external_kolmafia_namespaceObject.visitUrl)("inv_use.php?whichitem=6174&confirm=Yep.");
  }

  if ((0,external_kolmafia_namespaceObject.eudoraItem)() === template_string_$item(runstart_templateObject40 || (runstart_templateObject40 = runstart_taggedTemplateLiteral(["GameInformPowerDailyPro subscription card"])))) {
    if (!lib_have(template_string_$item(runstart_templateObject41 || (runstart_templateObject41 = runstart_taggedTemplateLiteral(["scroll of Puddingskin"])))) && !lib_have(template_string_$item(runstart_templateObject42 || (runstart_templateObject42 = runstart_taggedTemplateLiteral(["dungeoneering kit"]))))) {
      (0,external_kolmafia_namespaceObject.visitUrl)("adventure.php?snarfblat=319");
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runstart_templateObject43 || (runstart_templateObject43 = runstart_taggedTemplateLiteral(["dungeoneering kit"]))));
    }
  }
...
function deck() {
  if (!property_get("_deckCardsDrawn")) {
    ...
    (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(runstart_templateObject44 || (runstart_templateObject44 = runstart_taggedTemplateLiteral(["1952 Mickey Mantle card"]))));
    (0,external_kolmafia_namespaceObject.useSkill)(2, template_string_$skill(runstart_templateObject45 || (runstart_templateObject45 = runstart_taggedTemplateLiteral(["Ancestral Recall"]))));
  }
}
...
function deepDarkVisions() {
  ...
  new OutfitPlan({
    ...
    shirt: template_string_$items(hotres_templateObject20 || (hotres_templateObject20 = hotres_taggedTemplateLiteral(["Jurassic Parka, denim jacket"]))),
...
function getYoked() {
  ...
  heal();
  advMacroAA($location(level_templateObject44 || (level_templateObject44 = level_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), combat_Macro.externalIf(!lib_have($effect(level_templateObject45 || (level_templateObject45 = level_taggedTemplateLiteral(["Cosmic Ball in the Air"])))), combat_Macro.skill(template_string_$skill(level_templateObject46 || (level_templateObject46 = level_taggedTemplateLiteral(["Bowl Straight Up"]))))).delevel().tryItem(template_string_$item(level_templateObject47 || (level_templateObject47 = level_taggedTemplateLiteral(["blue rocket"])))).defaultKill(), () => {
    return !lib_have($effect(level_templateObject48 || (level_templateObject48 = level_taggedTemplateLiteral(["Holiday Yoked"]))));
  }, () => ensureMp(30));
}
...
function witchGhostAgent() {
  ...
  uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject49 || (level_templateObject49 = level_taggedTemplateLiteral(["protonic accelerator pack, makeshift garbage shirt, familiar scrapbook, Fourth of May Cosplay Saber"])))));
  heal();
  useDefaultFamiliar();
  ensureMp(100);
  combat_Macro.trySkill(template_string_$skill(level_templateObject50 || (level_templateObject50 = level_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkill(template_string_$skill(level_templateObject51 || (level_templateObject51 = level_taggedTemplateLiteral(["Micrometeorite"])))).defaultKill().repeat().setAutoAttack();

  if (!lib_have(template_string_$item(level_templateObject52 || (level_templateObject52 = level_taggedTemplateLiteral(["battle broom"]))))) {
    fightPiece($monster(level_templateObject53 || (level_templateObject53 = level_taggedTemplateLiteral(["Witchess Witch"]))));
  }

  (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject54 || (level_templateObject54 = level_taggedTemplateLiteral(["acc3"]))), template_string_$item(level_templateObject55 || (level_templateObject55 = level_taggedTemplateLiteral(["battle broom"]))));
  var ghostLocation = property_get("ghostLocation");

  if (ghostLocation) {
    (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject56 || (level_templateObject56 = level_taggedTemplateLiteral(["off-hand"]))), template_string_$item(level_templateObject57 || (level_templateObject57 = level_taggedTemplateLiteral(["latte lovers member's mug"]))));
    useDefaultFamiliar();
    advMacro(ghostLocation, combat_Macro.delevel().easyFight().trySkill(template_string_$skill(level_templateObject58 || (level_templateObject58 = level_taggedTemplateLiteral(["Portscan"])))).trySkill(template_string_$skill(level_templateObject59 || (level_templateObject59 = level_taggedTemplateLiteral(["Shoot Ghost"])))).trySkill(template_string_$skill(level_templateObject60 || (level_templateObject60 = level_taggedTemplateLiteral(["Shoot Ghost"])))).trySkill(template_string_$skill(level_templateObject61 || (level_templateObject61 = level_taggedTemplateLiteral(["Shoot Ghost"])))).trySkill(template_string_$skill(level_templateObject62 || (level_templateObject62 = level_taggedTemplateLiteral(["Trap Ghost"])))));
  }

  if (!lib_have(template_string_$item(level_templateObject63 || (level_templateObject63 = level_taggedTemplateLiteral(["government"])))) && !lib_have(template_string_$item(level_templateObject64 || (level_templateObject64 = level_taggedTemplateLiteral(["government cheese"]))))) {
    useDefaultFamiliar();
    uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject65 || (level_templateObject65 = level_taggedTemplateLiteral(["vampyric cloake, latte lovers member's mug"])))));
    (0,external_kolmafia_namespaceObject.cliExecute)("parka dilophosaur");
    advMacroAA($location(level_templateObject66 || (level_templateObject66 = level_taggedTemplateLiteral(["Noob Cave"]))), combat_Macro.delevel().trySkill(template_string_$skill(level_templateObject67 || (level_templateObject67 = level_taggedTemplateLiteral(["Become a Bat"])))).trySkill(template_string_$skill(level_templateObject68 || (level_templateObject68 = level_taggedTemplateLiteral(["Spit jurassic acid"])))), () => {
      return (0,external_kolmafia_namespaceObject.getCounters)("Portscan", 0, 0) !== "";
    }, () => () => ensureMp(30));
    var desertAccessItem = (0,external_kolmafia_namespaceObject.knollAvailable)() ? template_string_$item(level_templateObject69 || (level_templateObject69 = level_taggedTemplateLiteral(["bitchin' meatcar"]))) : template_string_$item(level_templateObject70 || (level_templateObject70 = level_taggedTemplateLiteral(["Desert Bus pass"])));
...
function lov() {
  (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
  uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject71 || (level_templateObject71 = level_taggedTemplateLiteral(["protonic accelerator pack, makeshift garbage shirt, Fourth of May Cosplay Saber"])))));
  heal();
  useDefaultFamiliar();
  combat_Macro.if_("monstername LOV enforcer", combat_Macro.attack().repeat()).if_("monstername LOV Engineer", combat_Macro.candyblast().trySkillRepeat(template_string_$skill(level_templateObject72 || (level_templateObject72 = level_taggedTemplateLiteral(["Weapon of the Pastalord"]))))).if_("monstername LOV equivocator", combat_Macro.delevel().easyFight().candyblast().defaultKill()).setAutoAttack();

  if (!property_get("_loveTunnelUsed")) {
    fightAll("LOV Epaulettes", "Open Heart Surgery", "LOV Extraterrestrial Chocolate");
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject73 || (level_templateObject73 = level_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))));
  }
...
function tomatoJuiceAndNinjaCostume() {
  ...
  if (lib_have(template_string_$item(level_templateObject74 || (level_templateObject74 = level_taggedTemplateLiteral(["magical sausage casing"])))) || lib_have(template_string_$item(level_templateObject75 || (level_templateObject75 = level_taggedTemplateLiteral(["magical sausage"]))))) {
    (0,external_kolmafia_namespaceObject.cliExecute)("eat magic sausage");
  }

  uniform();

  if (property_get("_monstersMapped") < 2 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject76 || (level_templateObject76 = level_taggedTemplateLiteral(["tomato"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject77 || (level_templateObject77 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) + (0,external_kolmafia_namespaceObject.haveEffect)($effect(level_templateObject78 || (level_templateObject78 = level_taggedTemplateLiteral(["Tomato Power"])))) === 0) {
    (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject79 || (level_templateObject79 = level_taggedTemplateLiteral(["acc3"]))), template_string_$item(level_templateObject80 || (level_templateObject80 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
    useDefaultFamiliar();
    mapMacro($location(level_templateObject81 || (level_templateObject81 = level_taggedTemplateLiteral(["The Haunted Pantry"]))), $monster(level_templateObject82 || (level_templateObject82 = level_taggedTemplateLiteral(["possessed can of tomatoes"]))), combat_Macro.if_("monsterid ".concat($monster(level_templateObject83 || (level_templateObject83 = level_taggedTemplateLiteral(["possessed can of tomatoes"]))).id), combat_Macro.skill(template_string_$skill(level_templateObject84 || (level_templateObject84 = level_taggedTemplateLiteral(["Reflex Hammer"]))))));
    useDefaultFamiliar(false);
    uniform.apply(void 0, level_toConsumableArray((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(level_templateObject85 || (level_templateObject85 = level_taggedTemplateLiteral(["Sauceror"]))) && !hasBuff() ? template_string_$items(level_templateObject86 || (level_templateObject86 = level_taggedTemplateLiteral(["Daylight Shavings Helmet"]))) : []));
    ensureMp(31);
    mapMacro($location(level_templateObject87 || (level_templateObject87 = level_taggedTemplateLiteral(["The Haiku Dungeon"]))), $monster(level_templateObject88 || (level_templateObject88 = level_taggedTemplateLiteral(["amateur ninja"]))), combat_Macro.if_("monsterid ".concat($monster(level_templateObject89 || (level_templateObject89 = level_taggedTemplateLiteral(["amateur ninja"]))).id), combat_Macro.skill(template_string_$skill(level_templateObject90 || (level_templateObject90 = level_taggedTemplateLiteral(["Feel Nostalgic"])))).skill(template_string_$skill(level_templateObject91 || (level_templateObject91 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"]))))).step("abort"));
  }

  if (!property_get("hasRange")) {
    if (!lib_have(template_string_$item(level_templateObject92 || (level_templateObject92 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))))) {
      (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(level_templateObject93 || (level_templateObject93 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
    }

    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject94 || (level_templateObject94 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
  }

  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject95 || (level_templateObject95 = level_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject96 || (level_templateObject96 = level_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))));

  if (!lib_have($effect(level_templateObject97 || (level_templateObject97 = level_taggedTemplateLiteral(["Tomato Power"]))))) {
    if (!lib_have(template_string_$item(level_templateObject98 || (level_templateObject98 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) && lib_have(template_string_$item(level_templateObject99 || (level_templateObject99 = level_taggedTemplateLiteral(["tomato"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(level_templateObject100 || (level_templateObject100 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }

    if (lib_have(template_string_$item(level_templateObject101 || (level_templateObject101 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))))) {
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject102 || (level_templateObject102 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }
  }

  if (!lib_have($effect(level_templateObject103 || (level_templateObject103 = level_taggedTemplateLiteral(["Mystically Oiled"]))))) {
    if (!lib_have(template_string_$item(level_templateObject104 || (level_templateObject104 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(level_templateObject105 || (level_templateObject105 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }
    ...
    if (lib_have(template_string_$item(level_templateObject106 || (level_templateObject106 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject107 || (level_templateObject107 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }
  }
}
...
function godLob() {
  ...
  while (property_get("_godLobsterFights") < 3) {
    ...
    uniform(template_string_$item(level_templateObject108 || (level_templateObject108 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    heal();
    ...
    var gear = template_string_$items(level_templateObject110 || (level_templateObject110 = level_taggedTemplateLiteral(["God Lobster's Crown, God Lobster's Robe, God Lobster's Rod, God Lobster's Ring, God Lobster's Scepter"]))).find(it => lib_have(it));
    if (gear) (0,external_kolmafia_namespaceObject.equip)(gear);
...
function snojo() {
  uniform();
  useDefaultFamiliar();
  advMacroAA($location(level_templateObject111 || (level_templateObject111 = level_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), combat_Macro.delevel().easyFight().attack().repeat(), () => {
...
function tentacle() {
  if (!lib_have(template_string_$skill(level_templateObject112 || (level_templateObject112 = level_taggedTemplateLiteral(["Evoke Eldritch Horror"]))))) return;
  withProperties({
    ...
    try {
      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject113 || (level_templateObject113 = level_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
      (0,external_kolmafia_namespaceObject.runCombat)(macro.toString());
    } catch (_unused) {
      if (lib_have($effect(level_templateObject114 || (level_templateObject114 = level_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
    }

    if (lib_have($effect(level_templateObject115 || (level_templateObject115 = level_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
  });
}
...
function NEP() {
  ...
  uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject116 || (level_templateObject116 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])))));
  useDefaultFamiliar();
  advMacroAA($location(level_templateObject117 || (level_templateObject117 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.delevel().if_($effect(level_templateObject118 || (level_templateObject118 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject119 || (level_templateObject119 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject120 || (level_templateObject120 = level_taggedTemplateLiteral(["Bowl Sideways"])))).defaultKill(), () => {
    return property_get("_neverendingPartyFreeTurns") < 10;
  }, () => {
    useDefaultFamiliar();
    heal();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(level_templateObject121 || (level_templateObject121 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(level_templateObject122 || (level_templateObject122 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
  ...
  advMacroAA($location(level_templateObject123 || (level_templateObject123 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject124 || (level_templateObject124 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject125 || (level_templateObject125 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject126 || (level_templateObject126 = level_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(level_templateObject127 || (level_templateObject127 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(level_templateObject128 || (level_templateObject128 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(level_templateObject129 || (level_templateObject129 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill()), () => {
    return property_get("_shatteringPunchUsed") < 3 && !property_get("_gingerbreadMobHitUsed");
  }, () => {
    heal();
    useDefaultFamiliar();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(level_templateObject130 || (level_templateObject130 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(level_templateObject131 || (level_templateObject131 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
    uniform.apply(void 0, level_toConsumableArray(changes));
  ...
  advMacroAA($location(level_templateObject132 || (level_templateObject132 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject133 || (level_templateObject133 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject134 || (level_templateObject134 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject135 || (level_templateObject135 = level_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(level_templateObject136 || (level_templateObject136 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(level_templateObject137 || (level_templateObject137 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(level_templateObject138 || (level_templateObject138 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill()), () => {
    return property_get("_shatteringPunchUsed") < 3;
  }, () => {
    heal();
    useDefaultFamiliar();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(level_templateObject139 || (level_templateObject139 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(level_templateObject140 || (level_templateObject140 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
    uniform.apply(void 0, level_toConsumableArray(changes));
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject141 || (level_templateObject141 = level_taggedTemplateLiteral(["acc3"]))), template_string_$item(level_templateObject142 || (level_templateObject142 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  advMacroAA($location(level_templateObject143 || (level_templateObject143 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(_templateObject144 || (_templateObject144 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(_templateObject145 || (_templateObject145 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(_templateObject146 || (_templateObject146 = level_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject147 || (_templateObject147 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(_templateObject148 || (_templateObject148 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject149 || (_templateObject149 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill()), () => {
    return property_get("_chestXRayUsed") < 3;
  }, () => {
    heal();
    useDefaultFamiliar();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(_templateObject150 || (_templateObject150 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(_templateObject151 || (_templateObject151 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
    uniform.apply(void 0, level_toConsumableArray(changes).concat([[template_string_$item(_templateObject152 || (_templateObject152 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))), $slot(_templateObject153 || (_templateObject153 = level_taggedTemplateLiteral(["acc3"])))]]));
...
function mElfLeveling() {
  ...
  uniform(template_string_$item(_templateObject154 || (_templateObject154 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject155 || (_templateObject155 = level_taggedTemplateLiteral(["Machine Elf"]))));
  advMacroAA($location(_templateObject156 || (_templateObject156 = level_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), combat_Macro.defaultKill(), () => {
...
function royalty() {
  if (!lib_have(template_string_$item(_templateObject157 || (_templateObject157 = level_taggedTemplateLiteral(["very pointy crown"]))))) {
    combat_Macro.tryItem(template_string_$item(_templateObject158 || (_templateObject158 = level_taggedTemplateLiteral(["jam band bootleg"])))).tryItem(template_string_$item(_templateObject159 || (_templateObject159 = level_taggedTemplateLiteral(["gas can"])))).tryItem(template_string_$item(_templateObject160 || (_templateObject160 = level_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat().setAutoAttack();
    (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
    uniform.apply(void 0, level_toConsumableArray(template_string_$items(_templateObject161 || (_templateObject161 = level_taggedTemplateLiteral(["makeshift garbage shirt, familiar scrapbook"])))));
    useDefaultFamiliar();
    heal();
    fightPiece($monster(_templateObject162 || (_templateObject162 = level_taggedTemplateLiteral(["Witchess Queen"]))));
  }

  if (!lib_have(template_string_$item(_templateObject163 || (_templateObject163 = level_taggedTemplateLiteral(["dented scepter"]))))) {
    combat_Macro.delevel().attack().repeat().setAutoAttack();
    (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
    uniform.apply(void 0, level_toConsumableArray(template_string_$items(_templateObject164 || (_templateObject164 = level_taggedTemplateLiteral(["makeshift garbage shirt, familiar scrapbook"])))));
    useDefaultFamiliar();
    heal();
    fightPiece($monster(_templateObject165 || (_templateObject165 = level_taggedTemplateLiteral(["Witchess King"]))));
  }
}
...
function restAndBuff() {
  ...
  uniform(template_string_$item(_templateObject166 || (_templateObject166 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
...
var noncombat_templateObject, noncombat_templateObject2, noncombat_templateObject3, noncombat_templateObject4, noncombat_templateObject5, noncombat_templateObject6, noncombat_templateObject7, noncombat_templateObject8, noncombat_templateObject9, noncombat_templateObject10, noncombat_templateObject11, noncombat_templateObject12, noncombat_templateObject13;
...
function noncombat_testPrep() {
  ...
  if (noncombat_predictor() > 1) {
    if (!lib_have($effect(noncombat_templateObject9 || (noncombat_templateObject9 = noncombat_taggedTemplateLiteral(["Gummed Shoes"]))))) {
      if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(noncombat_templateObject10 || (noncombat_templateObject10 = noncombat_taggedTemplateLiteral(["cop dollar"])))) < 10) (0,external_kolmafia_namespaceObject.cliExecute)("Detective Solver.ash");
      (0,external_kolmafia_namespaceObject.buy)($coinmaster(noncombat_templateObject11 || (noncombat_templateObject11 = noncombat_taggedTemplateLiteral(["Precinct Materiel Division"]))), 1, template_string_$item(noncombat_templateObject12 || (noncombat_templateObject12 = noncombat_taggedTemplateLiteral(["shoe gum"]))));
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(noncombat_templateObject13 || (noncombat_templateObject13 = noncombat_taggedTemplateLiteral(["shoe gum"]))));
    }
  }
}
...
function spell_testPrep() {
  ...
  if (!lib_have(template_string_$item(spell_templateObject40 || (spell_templateObject40 = spell_taggedTemplateLiteral(["Abracandalabra"])))) && !lib_have(template_string_$item(spell_templateObject41 || (spell_templateObject41 = spell_taggedTemplateLiteral(["obsidian nutcracker"])))) && (0,external_kolmafia_namespaceObject.inHardcore)()) {
    (0,external_kolmafia_namespaceObject.buy)(template_string_$item(spell_templateObject42 || (spell_templateObject42 = spell_taggedTemplateLiteral(["obsidian nutcracker"]))));
  }
...
function spellTest() {
  spell_castBuffs();
  fingies();
  uniform.apply(void 0, spell_toConsumableArray((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(spell_templateObject43 || (spell_templateObject43 = spell_taggedTemplateLiteral(["Sauceror"]))) && !hasBuff() ? template_string_$items(spell_templateObject44 || (spell_templateObject44 = spell_taggedTemplateLiteral(["Daylight Shavings Helmet"]))) : []));
  ensureInnerElf();
  shower();
  spell_testPrep();
  burnLibrams();
