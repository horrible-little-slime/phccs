...
var telescopeStats = new Map([["standing around flexing their muscles and using grip exercisers", $stat(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["Muscle"])))], ["sitting around playing chess and solving complicated-looking logic puzzles", $stat(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["Mysticality"])))], ["all wearing sunglasses and dancing", $stat(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["Moxie"])))]]);
...
var Outfit = /*#__PURE__*/function () {
  ...
  outfits_createClass(Outfit, [{
    ...
    value: function dress() {
      ...
      var accessorySlots = $slots(outfits_templateObject6 || (outfits_templateObject6 = outfits_taggedTemplateLiteral(["acc1, acc2, acc3"])));
      ...
      var _iterator = outfits_createForOfIteratorHelper($slots(outfits_templateObject7 || (outfits_templateObject7 = outfits_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var slot = _step.value;
          if (targetEquipment.includes((0,external_kolmafia_namespaceObject.equippedItem)(slot)) && equipmentMap.get(slot) !== (0,external_kolmafia_namespaceObject.equippedItem)(slot)) (0,external_kolmafia_namespaceObject.equip)(slot, template_string_$item(outfits_templateObject8 || (outfits_templateObject8 = outfits_taggedTemplateLiteral(["none"]))));
      ...
      var _iterator2 = outfits_createForOfIteratorHelper($slots(outfits_templateObject9 || (outfits_templateObject9 = outfits_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step2;
      ...
      try {
        var _loop = function _loop() {
          ...
          if (currentEquip === template_string_$item(outfits_templateObject10 || (outfits_templateObject10 = outfits_taggedTemplateLiteral(["none"]))) || (0,external_kolmafia_namespaceObject.equippedAmount)(currentEquip) > accessoryEquips.filter(accessory => accessory === currentEquip).length) {
    ...
    value: function current() {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          if (item !== template_string_$item(outfits_templateObject11 || (outfits_templateObject11 = outfits_taggedTemplateLiteral(["none"])))) fit[slotName] = item;
        }
      } catch (err) {
        _iterator4.e(err);
      } finally {
...
function uniform() {
  var defaultUniform = {
    hat: template_string_$items(outfits_templateObject13 || (outfits_templateObject13 = outfits_taggedTemplateLiteral(["astral chapeau, Iunion Crown"]))),
    shirt: template_string_$item(outfits_templateObject14 || (outfits_templateObject14 = outfits_taggedTemplateLiteral(["fresh coat of paint"]))),
    pants: template_string_$items(outfits_templateObject15 || (outfits_templateObject15 = outfits_taggedTemplateLiteral(["designer sweatpants, old sweatpants"]))),
    weapon: property_get("_juneCleaverFightsLeft") > 0 && property_get("_juneCleaverEncounters") < 2 ? template_string_$item(outfits_templateObject16 || (outfits_templateObject16 = outfits_taggedTemplateLiteral(["June cleaver"]))) : template_string_$item(outfits_templateObject17 || (outfits_templateObject17 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
    offhand: template_string_$item(outfits_templateObject18 || (outfits_templateObject18 = outfits_taggedTemplateLiteral(["unbreakable umbrella"]))),
    acc1: template_string_$items(outfits_templateObject19 || (outfits_templateObject19 = outfits_taggedTemplateLiteral(["meteorite necklace, your cowboy boots"]))),
    acc2: template_string_$item(outfits_templateObject20 || (outfits_templateObject20 = outfits_taggedTemplateLiteral(["codpiece"]))),
    acc3: template_string_$items(outfits_templateObject21 || (outfits_templateObject21 = outfits_taggedTemplateLiteral(["battle broom, Powerful Glove"]))),
    back: template_string_$items(outfits_templateObject22 || (outfits_templateObject22 = outfits_taggedTemplateLiteral(["LOV Epaulettes, unwrapped knock-off retro superhero cape"])))
  };
...
var wireOutfit = new Outfit({
  hat: template_string_$item(outfits_templateObject23 || (outfits_templateObject23 = outfits_taggedTemplateLiteral(["Iunion Crown"]))),
  shirt: template_string_$item(outfits_templateObject24 || (outfits_templateObject24 = outfits_taggedTemplateLiteral(["fresh coat of paint"]))),
  pants: template_string_$item(outfits_templateObject25 || (outfits_templateObject25 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  weapon: template_string_$item(outfits_templateObject26 || (outfits_templateObject26 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfits_templateObject27 || (outfits_templateObject27 = outfits_taggedTemplateLiteral(["familiar scrapbook"]))),
  acc1: template_string_$item(outfits_templateObject28 || (outfits_templateObject28 = outfits_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"]))),
  acc2: template_string_$item(outfits_templateObject29 || (outfits_templateObject29 = outfits_taggedTemplateLiteral(["Powerful Glove"]))),
  acc3: template_string_$item(outfits_templateObject30 || (outfits_templateObject30 = outfits_taggedTemplateLiteral(["Guzzlr tablet"])))
});
var moxieOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject31 || (outfits_templateObject31 = outfits_taggedTemplateLiteral(["very pointy crown"]))),
  shirt: template_string_$items(outfits_templateObject32 || (outfits_templateObject32 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject33 || (outfits_templateObject33 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$item(outfits_templateObject34 || (outfits_templateObject34 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfits_templateObject35 || (outfits_templateObject35 = outfits_taggedTemplateLiteral(["unbreakable umbrella"]))),
  pants: template_string_$item(outfits_templateObject36 || (outfits_templateObject36 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject37 || (outfits_templateObject37 = outfits_taggedTemplateLiteral(["Beach Comb"]))),
  acc2: template_string_$item(outfits_templateObject38 || (outfits_templateObject38 = outfits_taggedTemplateLiteral(["\"I Voted!\" sticker"]))),
  acc3: template_string_$item(outfits_templateObject39 || (outfits_templateObject39 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  familiar: template_string_$item(outfits_templateObject40 || (outfits_templateObject40 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var hpOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject41 || (outfits_templateObject41 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(outfits_templateObject42 || (outfits_templateObject42 = outfits_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(outfits_templateObject43 || (outfits_templateObject43 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(outfits_templateObject44 || (outfits_templateObject44 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject45 || (outfits_templateObject45 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(outfits_templateObject46 || (outfits_templateObject46 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject47 || (outfits_templateObject47 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(outfits_templateObject48 || (outfits_templateObject48 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(outfits_templateObject49 || (outfits_templateObject49 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(outfits_templateObject50 || (outfits_templateObject50 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var muscleOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject51 || (outfits_templateObject51 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(outfits_templateObject52 || (outfits_templateObject52 = outfits_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(outfits_templateObject53 || (outfits_templateObject53 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(outfits_templateObject54 || (outfits_templateObject54 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfits_templateObject55 || (outfits_templateObject55 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(outfits_templateObject56 || (outfits_templateObject56 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfits_templateObject57 || (outfits_templateObject57 = outfits_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(outfits_templateObject58 || (outfits_templateObject58 = outfits_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(outfits_templateObject59 || (outfits_templateObject59 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(outfits_templateObject60 || (outfits_templateObject60 = outfits_taggedTemplateLiteral(["unbreakable umbrella"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject61 || (outfits_templateObject61 = outfits_taggedTemplateLiteral(["Left-Hand Man"]))),
  modes: {
    retrocape: ["vampire", currentMode()]
  }
});
var mysticalityOutfit = new OutfitPlan({
  ...
  pants: template_string_$item(outfits_templateObject67 || (outfits_templateObject67 = outfits_taggedTemplateLiteral(["designer sweatpants"]))),
  ...
  familiar: template_string_$familiar(outfits_templateObject72 || (outfits_templateObject72 = outfits_taggedTemplateLiteral(["Left-Hand Man"]))),
  modes: {
    retrocape: ["vampire", currentMode()]
  }
});
var itemOutfit = new OutfitPlan({
  hat: template_string_$item(outfits_templateObject73 || (outfits_templateObject73 = outfits_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$items(outfits_templateObject74 || (outfits_templateObject74 = outfits_taggedTemplateLiteral(["extra-large utility candle"]))),
  offhand: template_string_$item(outfits_templateObject75 || (outfits_templateObject75 = outfits_taggedTemplateLiteral(["cursed magnifying glass"]))),
  back: template_string_$item(outfits_templateObject76 || (outfits_templateObject76 = outfits_taggedTemplateLiteral(["protonic accelerator pack"]))),
  acc1: template_string_$item(outfits_templateObject77 || (outfits_templateObject77 = outfits_taggedTemplateLiteral(["Guzzlr tablet"]))),
  acc2: template_string_$item(outfits_templateObject78 || (outfits_templateObject78 = outfits_taggedTemplateLiteral(["gold detective badge"]))),
  acc3: template_string_$items(outfits_templateObject79 || (outfits_templateObject79 = outfits_taggedTemplateLiteral(["government-issued night-vision goggles"]))),
  familiar: template_string_$item(outfits_templateObject80 || (outfits_templateObject80 = outfits_taggedTemplateLiteral(["li'l ninja costume"])))
}, {
  familiar: template_string_$familiar(outfits_templateObject81 || (outfits_templateObject81 = outfits_taggedTemplateLiteral(["Trick-or-Treating Tot"])))
});
var hotresOutfit = new OutfitPlan({
  back: template_string_$item(outfits_templateObject82 || (outfits_templateObject82 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$item(outfits_templateObject83 || (outfits_templateObject83 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfits_templateObject84 || (outfits_templateObject84 = outfits_taggedTemplateLiteral(["meteorite guard"]))),
...
function witchGhostAgent() {
  ...
  if (!lib_have(template_string_$item(level_templateObject63 || (level_templateObject63 = level_taggedTemplateLiteral(["government"])))) && !lib_have(template_string_$item(level_templateObject64 || (level_templateObject64 = level_taggedTemplateLiteral(["government cheese"]))))) {
    useDefaultFamiliar();
    uniform(template_string_$item(level_templateObject65 || (level_templateObject65 = level_taggedTemplateLiteral(["vampyric cloake"]))), template_string_$item(level_templateObject66 || (level_templateObject66 = level_taggedTemplateLiteral(["latte lovers member's mug"]))), [template_string_$item(level_templateObject67 || (level_templateObject67 = level_taggedTemplateLiteral(["gold detective badge"]))), $slot(level_templateObject68 || (level_templateObject68 = level_taggedTemplateLiteral(["acc2"])))], [template_string_$item(level_templateObject69 || (level_templateObject69 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))), $slot(level_templateObject70 || (level_templateObject70 = level_taggedTemplateLiteral(["acc3"])))]);
    advMacroAA($location(level_templateObject71 || (level_templateObject71 = level_taggedTemplateLiteral(["Noob Cave"]))), combat_Macro.delevel().trySkill(template_string_$skill(level_templateObject72 || (level_templateObject72 = level_taggedTemplateLiteral(["Otoscope"])))).trySkill(template_string_$skill(level_templateObject73 || (level_templateObject73 = level_taggedTemplateLiteral(["Become a Bat"])))).trySkill(template_string_$skill(level_templateObject74 || (level_templateObject74 = level_taggedTemplateLiteral(["Chest X-Ray"])))), //1
    () => {
      return (0,external_kolmafia_namespaceObject.getCounters)("Portscan", 0, 0) !== "";
    }, () => () => ensureMp(30));
    var desertAccessItem = (0,external_kolmafia_namespaceObject.knollAvailable)() ? template_string_$item(level_templateObject75 || (level_templateObject75 = level_taggedTemplateLiteral(["bitchin' meatcar"]))) : template_string_$item(level_templateObject76 || (level_templateObject76 = level_taggedTemplateLiteral(["Desert Bus pass"])));
...
function lov() {
  (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
  uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject77 || (level_templateObject77 = level_taggedTemplateLiteral(["protonic accelerator pack, makeshift garbage shirt, Fourth of May Cosplay Saber"])))));
  heal();
  useDefaultFamiliar();
  combat_Macro.if_("monstername LOV enforcer", combat_Macro.attack().repeat()).if_("monstername LOV Engineer", combat_Macro.candyblast().trySkillRepeat(template_string_$skill(level_templateObject78 || (level_templateObject78 = level_taggedTemplateLiteral(["Weapon of the Pastalord"]))))).if_("monstername LOV equivocator", combat_Macro.delevel().easyFight().candyblast().defaultKill()).setAutoAttack();

  if (!property_get("_loveTunnelUsed")) {
    fightAll("LOV Epaulettes", "Open Heart Surgery", "LOV Extraterrestrial Chocolate");
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject79 || (level_templateObject79 = level_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))));
  }
...
function tomatoJuiceAndNinjaCostume() {
  ...
  if (lib_have(template_string_$item(level_templateObject80 || (level_templateObject80 = level_taggedTemplateLiteral(["magical sausage casing"])))) || lib_have(template_string_$item(level_templateObject81 || (level_templateObject81 = level_taggedTemplateLiteral(["magical sausage"]))))) {
    (0,external_kolmafia_namespaceObject.cliExecute)("eat magic sausage");
  }

  uniform();

  if (property_get("_monstersMapped") < 2 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject82 || (level_templateObject82 = level_taggedTemplateLiteral(["tomato"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject83 || (level_templateObject83 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) + (0,external_kolmafia_namespaceObject.haveEffect)($effect(level_templateObject84 || (level_templateObject84 = level_taggedTemplateLiteral(["Tomato Power"])))) === 0) {
    (0,external_kolmafia_namespaceObject.equip)($slot(level_templateObject85 || (level_templateObject85 = level_taggedTemplateLiteral(["acc3"]))), template_string_$item(level_templateObject86 || (level_templateObject86 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
    useDefaultFamiliar();
    mapMacro($location(level_templateObject87 || (level_templateObject87 = level_taggedTemplateLiteral(["The Haunted Pantry"]))), $monster(level_templateObject88 || (level_templateObject88 = level_taggedTemplateLiteral(["possessed can of tomatoes"]))), combat_Macro.if_("monsterid ".concat($monster(level_templateObject89 || (level_templateObject89 = level_taggedTemplateLiteral(["possessed can of tomatoes"]))).id), combat_Macro.skill(template_string_$skill(level_templateObject90 || (level_templateObject90 = level_taggedTemplateLiteral(["Reflex Hammer"]))))));
    useDefaultFamiliar(false);
    uniform.apply(void 0, level_toConsumableArray((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(level_templateObject91 || (level_templateObject91 = level_taggedTemplateLiteral(["Sauceror"]))) && !hasBuff() ? template_string_$items(level_templateObject92 || (level_templateObject92 = level_taggedTemplateLiteral(["Daylight Shavings Helmet"]))) : []));
    ensureMp(31);
    mapMacro($location(level_templateObject93 || (level_templateObject93 = level_taggedTemplateLiteral(["The Haiku Dungeon"]))), $monster(level_templateObject94 || (level_templateObject94 = level_taggedTemplateLiteral(["amateur ninja"]))), combat_Macro.if_("monsterid ".concat($monster(level_templateObject95 || (level_templateObject95 = level_taggedTemplateLiteral(["amateur ninja"]))).id), combat_Macro.skill(template_string_$skill(level_templateObject96 || (level_templateObject96 = level_taggedTemplateLiteral(["Feel Nostalgic"])))).skill(template_string_$skill(level_templateObject97 || (level_templateObject97 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"]))))).step("abort"));
  }

  if (!property_get("hasRange")) {
    if (!lib_have(template_string_$item(level_templateObject98 || (level_templateObject98 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))))) {
      (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(level_templateObject99 || (level_templateObject99 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
    }

    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject100 || (level_templateObject100 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
  }

  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject101 || (level_templateObject101 = level_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject102 || (level_templateObject102 = level_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))));

  if (!lib_have($effect(level_templateObject103 || (level_templateObject103 = level_taggedTemplateLiteral(["Tomato Power"]))))) {
    if (!lib_have(template_string_$item(level_templateObject104 || (level_templateObject104 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) && lib_have(template_string_$item(level_templateObject105 || (level_templateObject105 = level_taggedTemplateLiteral(["tomato"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(level_templateObject106 || (level_templateObject106 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }

    if (lib_have(template_string_$item(level_templateObject107 || (level_templateObject107 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))))) {
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject108 || (level_templateObject108 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }
  }

  if (!lib_have($effect(level_templateObject109 || (level_templateObject109 = level_taggedTemplateLiteral(["Mystically Oiled"]))))) {
    if (!lib_have(template_string_$item(level_templateObject110 || (level_templateObject110 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(level_templateObject111 || (level_templateObject111 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }

    if (lib_have(template_string_$item(level_templateObject112 || (level_templateObject112 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(level_templateObject113 || (level_templateObject113 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }
  }
}
...
function godLob() {
  ...
  while (property_get("_godLobsterFights") < 2) {
    ...
    uniform(template_string_$item(level_templateObject114 || (level_templateObject114 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    heal();
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(level_templateObject115 || (level_templateObject115 = level_taggedTemplateLiteral(["God Lobster"]))));
    var gear = template_string_$items(level_templateObject116 || (level_templateObject116 = level_taggedTemplateLiteral(["God Lobster's Crown, God Lobster's Robe, God Lobster's Rod, God Lobster's Ring, God Lobster's Scepter"]))).find(it => lib_have(it));
...
function snojo() {
  uniform();
  useDefaultFamiliar();
  advMacroAA($location(level_templateObject117 || (level_templateObject117 = level_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), combat_Macro.delevel().easyFight().attack().repeat(), () => {
...
function tentacle() {
  if (!lib_have(template_string_$skill(level_templateObject118 || (level_templateObject118 = level_taggedTemplateLiteral(["Evoke Eldritch Horror"]))))) return;
  withProperties({
    ...
    try {
      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(level_templateObject119 || (level_templateObject119 = level_taggedTemplateLiteral(["Evoke Eldritch Horror"]))));
      (0,external_kolmafia_namespaceObject.runCombat)(macro.toString());
    } catch (_unused) {
      if (lib_have($effect(level_templateObject120 || (level_templateObject120 = level_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
    }

    if (lib_have($effect(level_templateObject121 || (level_templateObject121 = level_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
  });
}
...
function NEP() {
  ...
  uniform.apply(void 0, level_toConsumableArray(template_string_$items(level_templateObject122 || (level_templateObject122 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])))));
  useDefaultFamiliar();
  advMacroAA($location(level_templateObject123 || (level_templateObject123 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.delevel().if_($effect(level_templateObject124 || (level_templateObject124 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject125 || (level_templateObject125 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject126 || (level_templateObject126 = level_taggedTemplateLiteral(["Bowl Sideways"])))).defaultKill(), () => {
    return property_get("_neverendingPartyFreeTurns") < 10;
  }, () => {
    useDefaultFamiliar();
    heal();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(level_templateObject127 || (level_templateObject127 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(level_templateObject128 || (level_templateObject128 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
  ...
  advMacroAA($location(level_templateObject129 || (level_templateObject129 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject130 || (level_templateObject130 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject131 || (level_templateObject131 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject132 || (level_templateObject132 = level_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(level_templateObject133 || (level_templateObject133 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(level_templateObject134 || (level_templateObject134 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(level_templateObject135 || (level_templateObject135 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill()), () => {
    return property_get("_shatteringPunchUsed") < 3 && !property_get("_gingerbreadMobHitUsed");
  }, () => {
    heal();
    useDefaultFamiliar();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(level_templateObject136 || (level_templateObject136 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(level_templateObject137 || (level_templateObject137 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
    uniform.apply(void 0, level_toConsumableArray(changes));
  ...
  advMacroAA($location(level_templateObject138 || (level_templateObject138 = level_taggedTemplateLiteral(["The Neverending Party"]))), combat_Macro.if_("!monstername sausage goblin", combat_Macro.if_($effect(level_templateObject139 || (level_templateObject139 = level_taggedTemplateLiteral(["Inner Elf"]))), combat_Macro.trySkill(template_string_$skill(level_templateObject140 || (level_templateObject140 = level_taggedTemplateLiteral(["Feel Pride"]))))).trySkill(template_string_$skill(level_templateObject141 || (level_templateObject141 = level_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(level_templateObject142 || (level_templateObject142 = level_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(level_templateObject143 || (level_templateObject143 = level_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject144 || (_templateObject144 = level_taggedTemplateLiteral(["Chest X-Ray"]))))).if_("monstername sausage goblin", combat_Macro.delevel().candyblast().defaultKill()), () => {
    return property_get("_shatteringPunchUsed") < 3;
  }, () => {
    heal();
    useDefaultFamiliar();
    var changes = property_get("_sausageFights") > 4 ? template_string_$items(_templateObject145 || (_templateObject145 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))) : template_string_$items(_templateObject146 || (_templateObject146 = level_taggedTemplateLiteral(["makeshift garbage shirt, Kramco Sausage-o-Matic\u2122"])));
    uniform.apply(void 0, level_toConsumableArray(changes));
...
function mElfLeveling() {
  ...
  uniform(template_string_$item(_templateObject160 || (_templateObject160 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject161 || (_templateObject161 = level_taggedTemplateLiteral(["Machine Elf"]))));
  advMacroAA($location(_templateObject162 || (_templateObject162 = level_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), combat_Macro.defaultKill(), () => {
...
function royalty() {
  if (!lib_have(template_string_$item(_templateObject163 || (_templateObject163 = level_taggedTemplateLiteral(["very pointy crown"]))))) {
    combat_Macro.tryItem(template_string_$item(_templateObject164 || (_templateObject164 = level_taggedTemplateLiteral(["jam band bootleg"])))).tryItem(template_string_$item(_templateObject165 || (_templateObject165 = level_taggedTemplateLiteral(["gas can"])))).tryItem(template_string_$item(_templateObject166 || (_templateObject166 = level_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat().setAutoAttack();
    (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
    uniform.apply(void 0, level_toConsumableArray(template_string_$items(_templateObject167 || (_templateObject167 = level_taggedTemplateLiteral(["makeshift garbage shirt, familiar scrapbook"])))));
    useDefaultFamiliar();
    heal();
  ...
  if (!lib_have(template_string_$item(_templateObject169 || (_templateObject169 = level_taggedTemplateLiteral(["dented scepter"]))))) {
    ...
    (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
    uniform.apply(void 0, level_toConsumableArray(template_string_$items(_templateObject170 || (_templateObject170 = level_taggedTemplateLiteral(["makeshift garbage shirt, familiar scrapbook"])))));
    useDefaultFamiliar();
    heal();
...
function restAndBuff() {
  ...
  uniform(template_string_$item(_templateObject172 || (_templateObject172 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
