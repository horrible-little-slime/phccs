...
function doPulls() {
  ...
  for (var _i = 0, _pulls = pulls; _i < _pulls.length; _i++) {
    var pull = _pulls[_i];
    if (Array.isArray(pull) && pull.some(item => (0,external_kolmafia_namespaceObject.itemAmount)(item) > 0) || !Array.isArray(pull) && (0,external_kolmafia_namespaceObject.itemAmount)(pull) > 0) return;
...
function tomatoJuiceAndNinjaCostume() {
  ...
  if (property_get("_monstersMapped") < 2 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject79 || (level_templateObject79 = level_taggedTemplateLiteral(["tomato"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(level_templateObject80 || (level_templateObject80 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) + (0,external_kolmafia_namespaceObject.haveEffect)($effect(level_templateObject81 || (level_templateObject81 = level_taggedTemplateLiteral(["Tomato Power"])))) === 0) {
    ...
    useDefaultFamiliar(false);
    uniform.apply(void 0, level_toConsumableArray((0,external_kolmafia_namespaceObject.myClass)() === template_string_$class(level_templateObject88 || (level_templateObject88 = level_taggedTemplateLiteral(["Sauceror"]))) && !hasBuff() ? template_string_$items(level_templateObject89 || (level_templateObject89 = level_taggedTemplateLiteral(["Daylight Shavings Helmet"]))) : []));
    ensureMp(31);
