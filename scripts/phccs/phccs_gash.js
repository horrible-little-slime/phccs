...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray6($slots(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral6(["acc1, acc2, acc3"]))))).includes(slot) || (0, import_kolmafia13.toSlot)(item) !== $slot(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral6(["acc1"]))) || !(0, import_kolmafia13.canEquip)(item))
        return !1;
      if (slot === void 0) {
