...
/* harmony export */ });
/* unused harmony exports $bounty, $bounties, $classes, $coinmaster, $coinmasters, $effect, $effects, $elements, $familiars, $location, $locations, $monster, $phylum, $phyla, $servant, $servants, $skills, $slot, $slots, $stats, $thrall, $thralls, $paths */
...
function main() {
  ...
  ascend($path.none, $class(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Seal Clubber"]))), Lifestyle.casual, "canadia", $item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"]))));
}
...
var AscendError = /*#__PURE__*/function (_Error) {
  ...
  function AscendError(cause) {
    ...
    if (!cause) {
      ...
      _defineProperty(_assertThisInitialized(_this), "cause", void 0);
    } else if (cause instanceof external_kolmafia_.Path) {
...
function toMoonId(moon, playerClass) {
  ...
  var offset = () => {
    switch (playerClass.primestat) {
      case (0,template_string/* $stat */.Ri)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Muscle"]))):
        return 0;

      case (0,template_string/* $stat */.Ri)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Mysticality"]))):
        return 1;

      case (0,template_string/* $stat */.Ri)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Moxie"]))):
        return 2;
...
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : (0,template_string/* $item */.xr)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"])));
...
var lib_templateObject, lib_templateObject2, lib_templateObject3, lib_templateObject4, lib_templateObject5, lib_templateObject6, _templateObject7, _templateObject8, _templateObject9, _templateObject10, _templateObject11, _templateObject12, _templateObject13, _templateObject14, _templateObject15, _templateObject16, _templateObject17, _templateObject18, _templateObject19, _templateObject20, _templateObject21, _templateObject22, _templateObject23, _templateObject24, _templateObject25, _templateObject26, _templateObject27, _templateObject28, _templateObject29, _templateObject30, _templateObject31, _templateObject32, _templateObject33;
...
function canUse(item) {
  ...
  if (path !== Path.get("Nuclear Autumn")) {
    if ($items(lib_templateObject3 || (lib_templateObject3 = lib_taggedTemplateLiteral(["Shrieking Weasel holo-record, Power-Guy 2000 holo-record, Lucky Strikes holo-record, EMD holo-record, Superdrifter holo-record, The Pigs holo-record, Drunk Uncles holo-record"]))).includes(item)) {
      return false;
    }
  }
...
function findLeprechaunMultiplier(familiar) {
  if (familiar === $familiar(lib_templateObject4 || (lib_templateObject4 = lib_taggedTemplateLiteral(["Mutant Cactus Bud"])))) {
    return numericModifier(familiar, "Leprechaun Effectiveness", 1, $item.none);
  }

  if (familiar === $familiar(lib_templateObject5 || (lib_templateObject5 = lib_taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
...
function findFairyMultiplier(familiar) {
  if (familiar === $familiar(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["Mutant Fire Ant"])))) {
...
var holidayWanderers = new Map([["El Dia De Los Muertos Borrachos", (0,template_string/* $monsters */.fr)(_templateObject8 || (_templateObject8 = lib_taggedTemplateLiteral(["Novia Cad\xE1ver, Novio Cad\xE1ver, Padre Cad\xE1ver, Persona Inocente Cad\xE1ver"])))], ["Feast of Boris", (0,template_string/* $monsters */.fr)(_templateObject9 || (_templateObject9 = lib_taggedTemplateLiteral(["Candied Yam Golem, Malevolent Tofurkey, Possessed Can of Cranberry Sauce, Stuffing Golem"])))], ["Talk Like a Pirate Day", (0,template_string/* $monsters */.fr)(_templateObject10 || (_templateObject10 = lib_taggedTemplateLiteral(["ambulatory pirate, migratory pirate, peripatetic pirate"])))]]);
...
var telescopeStats = new Map([["standing around flexing their muscles and using grip exercisers", (0,template_string/* $stat */.Ri)(_templateObject11 || (_templateObject11 = lib_taggedTemplateLiteral(["Muscle"])))], ["sitting around playing chess and solving complicated-looking logic puzzles", (0,template_string/* $stat */.Ri)(_templateObject12 || (_templateObject12 = lib_taggedTemplateLiteral(["Mysticality"])))], ["all wearing sunglasses and dancing", (0,template_string/* $stat */.Ri)(_templateObject13 || (_templateObject13 = lib_taggedTemplateLiteral(["Moxie"])))]]);
var telescopeElements = new Map([["people, all of whom appear to be on fire", (0,template_string/* $element */.SS)(_templateObject14 || (_templateObject14 = lib_taggedTemplateLiteral(["hot"])))], ["people, surrounded by a cloud of eldritch mist", (0,template_string/* $element */.SS)(_templateObject15 || (_templateObject15 = lib_taggedTemplateLiteral(["spooky"])))], ["greasy-looking people furtively skulking around", (0,template_string/* $element */.SS)(_templateObject16 || (_templateObject16 = lib_taggedTemplateLiteral(["sleaze"])))], ["people, surrounded by garbage and clouds of flies", (0,template_string/* $element */.SS)(_templateObject17 || (_templateObject17 = lib_taggedTemplateLiteral(["stench"])))], ["people, clustered around a group of igloos", (0,template_string/* $element */.SS)(_templateObject18 || (_templateObject18 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap1 = new Map([["smoldering bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject19 || (_templateObject19 = lib_taggedTemplateLiteral(["hot"])))], ["creepy-looking black bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject20 || (_templateObject20 = lib_taggedTemplateLiteral(["spooky"])))], ["purplish, greasy-looking hedges", (0,template_string/* $element */.SS)(_templateObject21 || (_templateObject21 = lib_taggedTemplateLiteral(["sleaze"])))], ["nasty-looking, dripping green bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject22 || (_templateObject22 = lib_taggedTemplateLiteral(["stench"])))], ["frost-rimed bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject23 || (_templateObject23 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap2 = new Map([["smoke rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject24 || (_templateObject24 = lib_taggedTemplateLiteral(["hot"])))], ["a miasma of eldritch vapors rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject25 || (_templateObject25 = lib_taggedTemplateLiteral(["spooky"])))], ["a greasy purple cloud hanging over the center of the maze", (0,template_string/* $element */.SS)(_templateObject26 || (_templateObject26 = lib_taggedTemplateLiteral(["sleaze"])))], ["a cloud of green gas hovering over the maze", (0,template_string/* $element */.SS)(_templateObject27 || (_templateObject27 = lib_taggedTemplateLiteral(["stench"])))], ["wintry mists rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject28 || (_templateObject28 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap3 = new Map([["with lava slowly oozing out of it", (0,template_string/* $element */.SS)(_templateObject29 || (_templateObject29 = lib_taggedTemplateLiteral(["hot"])))], ["surrounded by creepy black mist", (0,template_string/* $element */.SS)(_templateObject30 || (_templateObject30 = lib_taggedTemplateLiteral(["spooky"])))], ["that occasionally vomits out a greasy ball of hair", (0,template_string/* $element */.SS)(_templateObject31 || (_templateObject31 = lib_taggedTemplateLiteral(["sleaze"])))], ["disgorging a really surprising amount of sewage", (0,template_string/* $element */.SS)(_templateObject32 || (_templateObject32 = lib_taggedTemplateLiteral(["stench"])))], ["occasionally disgorging a bunch of ice cubes", (0,template_string/* $element */.SS)(_templateObject33 || (_templateObject33 = lib_taggedTemplateLiteral(["cold"])))]]);
/**
