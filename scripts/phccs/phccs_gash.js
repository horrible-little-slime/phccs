...
/* harmony export */ });
/* unused harmony exports $bounty, $bounties, $coinmaster, $coinmasters, $effect, $effects, $elements, $familiars, $location, $locations, $monster, $phylum, $phyla, $servant, $servants, $skills, $slot, $slots, $stats, $thrall, $thralls */
...
function main() {
  ...
  ascend(Paths.Unrestricted, $class(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Seal Clubber"]))), Lifestyle.casual, "canadia", $item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"]))));
}
...
function Path(name, id) {
  ...
  var classes = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : (0,template_string/* $classes */.JT)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Seal Clubber, Turtle Tamer, Sauceror, Pastamancer, Disco Bandit, Accordion Thief"])));
...
var Paths = {
  ...
  AvatarOfBoris: new Path("Avatar of Boris", 8, false, true, false, 20, 5, 15, (0,template_string/* $classes */.JT)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Avatar of Boris"])))),
  BugbearInvasion: new Path("Bugbear Invasion", 9),
  ZombieSlayer: new Path("Zombie Slayer", 10, false, true, true, 15, 5, 15, (0,template_string/* $classes */.JT)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Zombie Master"])))),
  ClassAct: new Path("Class Act", 11, false),
  AvatarofJarlsberg: new Path("Avatar of Jarlsberg", 12, false, true, false, 10, 10, 15, (0,template_string/* $classes */.JT)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["Avatar of Jarlsberg"])))),
  Big: new Path("BIG!", 14),
  KolHs: new Path("KOLHS", 15),
  ClassAct2: new Path("Class Act II: A Class For Pigs", 16, false),
  AvatarofSneakyPete: new Path("Avatar of Sneaky Pete", 17, false, true, false, 5, 20, 15, (0,template_string/* $classes */.JT)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Avatar of Sneaky Pete"])))),
  ...
  ActuallyEdTheUndying: new Path("Actually Ed the Undying", 23, false, false, false, 0, 0, 5, (0,template_string/* $classes */.JT)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["Ed"])))),
  OneCrazyRandomSummer: new Path("One Crazy Random Summer", 24),
  CommunityService: new Path("Community Service", 25),
  AvatarOfWestOfLoathing: new Path("Avatar of West of Loathing", 26, false, true, true, 10, 10, 10, (0,template_string/* $classes */.JT)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["Cow Puncher, Snake Oiler, Beanslinger"])))),
  TheSource: new Path("The Source", 27),
  NuclearAutumn: new Path("Nuclear Autumn", 28, false, false, true, 3, 3, 3),
  GelatinousNoob: new Path("Gelatinous Noob", 29, false, true, true, 0, 0, 0, (0,template_string/* $classes */.JT)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["Gelatinous Noob"])))),
  ...
  DarkGyffte: new Path("Dark Gyffte", 35, false, true, false, 5, 5, 15, (0,template_string/* $classes */.JT)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["Vampyre"])))),
  TwoCrazyRandomSummer: new Path("Two Crazy Random Summer", 36),
  KingdomOfExploathing: new Path("Kingdom of Exploathing", 37),
  PathOfThePlumber: new Path("Path of the Plumber", 38, false, true, true, 20, 0, 5, (0,template_string/* $classes */.JT)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Plumber"])))),
  ...
  (0,template_string/* $classes */.JT)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Grey Goo"]))))
};
...
function getDesk() {
  ...
  return (_desks$find = desks.find(desk => Object.keys((0,external_kolmafia_.getChateau)()).includes(desk))) !== null && _desks$find !== void 0 ? _desks$find : null;
}
function getCeiling() {
  var _ceilings$find;

  return (_ceilings$find = ceilings.find(ceiling => Object.keys((0,external_kolmafia_.getChateau)()).includes(ceiling))) !== null && _ceilings$find !== void 0 ? _ceilings$find : null;
}
...
function changeDesk(desk) {
  ...
  (0,external_kolmafia_.buy)(external_kolmafia_.Item.get(desk));
  return getDesk() === desk;
}
function changeCeiling(ceiling) {
  if (getCeiling() === ceiling) return true;
  if (!ceilings.includes(ceiling)) return false;
  (0,external_kolmafia_.buy)(external_kolmafia_.Item.get(ceiling));
...
var isWorkshed = (0,utils/* createStringUnionTypeGuardFunction */.S$)(worksheds);
var isGarden = (0,utils/* createStringUnionTypeGuardFunction */.S$)(gardens);
var isEudora = (0,utils/* createStringUnionTypeGuardFunction */.S$)(eudorae);
var isDesk = (0,utils/* createStringUnionTypeGuardFunction */.S$)(desks);
var isNightstand = (0,utils/* createStringUnionTypeGuardFunction */.S$)(nightstands);
var isCeiling = (0,utils/* createStringUnionTypeGuardFunction */.S$)(ceilings);
...
function toMoonId(moon, playerClass) {
  ...
  var offset = () => {
    switch (playerClass.primestat) {
      case (0,template_string/* $stat */.Ri)(ascend_templateObject || (ascend_templateObject = ascend_taggedTemplateLiteral(["Muscle"]))):
        return 0;

      case (0,template_string/* $stat */.Ri)(ascend_templateObject2 || (ascend_templateObject2 = ascend_taggedTemplateLiteral(["Mysticality"]))):
        return 1;

      case (0,template_string/* $stat */.Ri)(ascend_templateObject3 || (ascend_templateObject3 = ascend_taggedTemplateLiteral(["Moxie"]))):
        return 2;
...
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : (0,template_string/* $item */.xr)(ascend_templateObject4 || (ascend_templateObject4 = ascend_taggedTemplateLiteral(["astral six-pack"])));
  ...
  if (consumable && !(0,template_string/* $items */.vS)(ascend_templateObject5 || (ascend_templateObject5 = ascend_taggedTemplateLiteral(["astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable)) {
    throw new AscendError(consumable);
  }

  if (pet && !(0,template_string/* $items */.vS)(ascend_templateObject6 || (ascend_templateObject6 = ascend_taggedTemplateLiteral(["astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet)) {
  ...
  if (consumable) {
    (0,external_kolmafia_.visitUrl)("afterlife.php?action=buydeli&whichitem=".concat((0,external_kolmafia_.toInt)(consumable)));
  }

  if (pet) (0,external_kolmafia_.visitUrl)("afterlife.php?action=buyarmory&whichitem=".concat((0,external_kolmafia_.toInt)(pet)));

  if (permSkills) {
    var _iterator = _createForOfIteratorHelper(permSkills.entries()),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (permLevel !== Lifestyle.casual) {
          ...
          (0,external_kolmafia_.visitUrl)("afterlife.php?action=".concat(permText, "&whichskill=").concat((0,external_kolmafia_.toInt)(skill)));
        }
      }
    } catch (err) {
      _iterator.e(err);
  ...
  (0,external_kolmafia_.visitUrl)("afterlife.php?action=ascend&confirmascend=1&whichsign=".concat(moonId, "&gender=2&whichclass=").concat((0,external_kolmafia_.toInt)(playerClass), "&whichpath=").concat(path.id, "&asctype=").concat(lifestyle, "&nopetok=1&noskillsok=1&lamepathok=1&lamesignok=1&pwd"), true);
}
/**
...
function prepareAscension() {
  ...
  if (workshed && (0,external_kolmafia_.getWorkshed)() !== external_kolmafia_.Item.get(workshed)) {
    (0,external_kolmafia_.use)(external_kolmafia_.Item.get(workshed));

    if ((0,external_kolmafia_.getWorkshed)().name !== workshed && throwOnFail) {
      throw new AscensionPrepError(workshed, (0,external_kolmafia_.getWorkshed)());
    }
  }

  if (garden && !Object.getOwnPropertyNames((0,external_kolmafia_.getCampground)()).includes(garden)) {
    (0,external_kolmafia_.use)(external_kolmafia_.Item.get(garden));
    var gardenName = Object.getOwnPropertyNames((0,external_kolmafia_.getCampground)()).find(isGarden);
  ...
  if (eudora && (0,external_kolmafia_.eudoraItem)().name !== eudora) {
    ...
    if ((0,external_kolmafia_.eudoraItem)() !== external_kolmafia_.Item.get(eudora) && throwOnFail) {
      throw new AscensionPrepError(eudora, (0,external_kolmafia_.eudoraItem)());
    }
  }
...
function findLeprechaunMultiplier(familiar) {
  if (familiar === $familiar(lib_templateObject5 || (lib_templateObject5 = lib_taggedTemplateLiteral(["Mutant Cactus Bud"])))) {
    return numericModifier(familiar, "Leprechaun Effectiveness", 1, $item(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["none"]))));
  }

  if (familiar === $familiar(lib_templateObject7 || (lib_templateObject7 = lib_taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
  var meatBonus = numericModifier(familiar, "Meat Drop", 1, $item(lib_templateObject8 || (lib_templateObject8 = lib_taggedTemplateLiteral(["none"]))));
...
function findFairyMultiplier(familiar) {
  if (familiar === $familiar(lib_templateObject9 || (lib_templateObject9 = lib_taggedTemplateLiteral(["Mutant Fire Ant"])))) {
    return numericModifier(familiar, "Fairy Effectiveness", 1, $item(lib_templateObject10 || (lib_templateObject10 = lib_taggedTemplateLiteral(["none"]))));
  }

  if (familiar === $familiar(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
  var itemBonus = numericModifier(familiar, "Item Drop", 1, $item(_templateObject12 || (_templateObject12 = lib_taggedTemplateLiteral(["none"]))));
  if (itemBonus === 0) return 0;
  return Math.pow(Math.sqrt(itemBonus + 55 / 4 + 3) - Math.sqrt(55) / 2, 2);
}
var holidayWanderers = new Map([["El Dia De Los Muertos Borrachos", (0,template_string/* $monsters */.fr)(_templateObject13 || (_templateObject13 = lib_taggedTemplateLiteral(["Novia Cad\xE1ver, Novio Cad\xE1ver, Padre Cad\xE1ver, Persona Inocente Cad\xE1ver"])))], ["Feast of Boris", (0,template_string/* $monsters */.fr)(_templateObject14 || (_templateObject14 = lib_taggedTemplateLiteral(["Candied Yam Golem, Malevolent Tofurkey, Possessed Can of Cranberry Sauce, Stuffing Golem"])))], ["Talk Like a Pirate Day", (0,template_string/* $monsters */.fr)(_templateObject15 || (_templateObject15 = lib_taggedTemplateLiteral(["ambulatory pirate, migratory pirate, peripatetic pirate"])))]]);
...
var telescopeStats = new Map([["standing around flexing their muscles and using grip exercisers", (0,template_string/* $stat */.Ri)(_templateObject16 || (_templateObject16 = lib_taggedTemplateLiteral(["Muscle"])))], ["sitting around playing chess and solving complicated-looking logic puzzles", (0,template_string/* $stat */.Ri)(_templateObject17 || (_templateObject17 = lib_taggedTemplateLiteral(["Mysticality"])))], ["all wearing sunglasses and dancing", (0,template_string/* $stat */.Ri)(_templateObject18 || (_templateObject18 = lib_taggedTemplateLiteral(["Moxie"])))]]);
var telescopeElements = new Map([["people, all of whom appear to be on fire", (0,template_string/* $element */.SS)(_templateObject19 || (_templateObject19 = lib_taggedTemplateLiteral(["hot"])))], ["people, surrounded by a cloud of eldritch mist", (0,template_string/* $element */.SS)(_templateObject20 || (_templateObject20 = lib_taggedTemplateLiteral(["spooky"])))], ["greasy-looking people furtively skulking around", (0,template_string/* $element */.SS)(_templateObject21 || (_templateObject21 = lib_taggedTemplateLiteral(["sleaze"])))], ["people, surrounded by garbage and clouds of flies", (0,template_string/* $element */.SS)(_templateObject22 || (_templateObject22 = lib_taggedTemplateLiteral(["stench"])))], ["people, clustered around a group of igloos", (0,template_string/* $element */.SS)(_templateObject23 || (_templateObject23 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap1 = new Map([["smoldering bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject24 || (_templateObject24 = lib_taggedTemplateLiteral(["hot"])))], ["creepy-looking black bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject25 || (_templateObject25 = lib_taggedTemplateLiteral(["spooky"])))], ["purplish, greasy-looking hedges", (0,template_string/* $element */.SS)(_templateObject26 || (_templateObject26 = lib_taggedTemplateLiteral(["sleaze"])))], ["nasty-looking, dripping green bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject27 || (_templateObject27 = lib_taggedTemplateLiteral(["stench"])))], ["frost-rimed bushes on the outskirts of a hedge maze", (0,template_string/* $element */.SS)(_templateObject28 || (_templateObject28 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap2 = new Map([["smoke rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject29 || (_templateObject29 = lib_taggedTemplateLiteral(["hot"])))], ["a miasma of eldritch vapors rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject30 || (_templateObject30 = lib_taggedTemplateLiteral(["spooky"])))], ["a greasy purple cloud hanging over the center of the maze", (0,template_string/* $element */.SS)(_templateObject31 || (_templateObject31 = lib_taggedTemplateLiteral(["sleaze"])))], ["a cloud of green gas hovering over the maze", (0,template_string/* $element */.SS)(_templateObject32 || (_templateObject32 = lib_taggedTemplateLiteral(["stench"])))], ["wintry mists rising from deeper within the maze", (0,template_string/* $element */.SS)(_templateObject33 || (_templateObject33 = lib_taggedTemplateLiteral(["cold"])))]]);
var hedgeTrap3 = new Map([["with lava slowly oozing out of it", (0,template_string/* $element */.SS)(_templateObject34 || (_templateObject34 = lib_taggedTemplateLiteral(["hot"])))], ["surrounded by creepy black mist", (0,template_string/* $element */.SS)(_templateObject35 || (_templateObject35 = lib_taggedTemplateLiteral(["spooky"])))], ["that occasionally vomits out a greasy ball of hair", (0,template_string/* $element */.SS)(_templateObject36 || (_templateObject36 = lib_taggedTemplateLiteral(["sleaze"])))], ["disgorging a really surprising amount of sewage", (0,template_string/* $element */.SS)(_templateObject37 || (_templateObject37 = lib_taggedTemplateLiteral(["stench"])))], ["occasionally disgorging a bunch of ice cubes", (0,template_string/* $element */.SS)(_templateObject38 || (_templateObject38 = lib_taggedTemplateLiteral(["cold"])))]]);
/**
...
var gash_hop_templateObject, gash_hop_templateObject2, gash_hop_templateObject3, gash_hop_templateObject4, gash_hop_templateObject5, gash_hop_templateObject6;
...
function main() {
  ...
  ascend(Paths.CommunityService, (0,template_string/* $class */._$)(gash_hop_templateObject5 || (gash_hop_templateObject5 = gash_hop_taggedTemplateLiteral(["Pastamancer"]))), lifestyle, "knoll", (0,template_string/* $item */.xr)(gash_hop_templateObject6 || (gash_hop_templateObject6 = gash_hop_taggedTemplateLiteral(["astral six-pack"]))), pet);
}
})();
