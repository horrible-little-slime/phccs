    ...
    value: function() {
      ...
      for (var _i3 = 0, _properties = properties; _i3 < _properties.length; _i3++) {
        ...
        if (property in this.properties) {
          ...
          value === PropertiesManager2.EMPTY_PREFERENCE ? (0, import_kolmafia.removeProperty)(property) : value && _set(property, value);
        }
      }
    }
  }, {
...
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    ...
    if (current !== void 0)
      return (0, import_kolmafia3.monsterEval)(current);
...
function ascend(options) {
  ...
  var unownedSkills = _toConsumableArray2((_permOptions$permSkil = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil !== void 0 ? _permOptions$permSkil : []).filter(function(skill2) {
  ...
  var unpermableSkills = _toConsumableArray2((_permOptions$permSkil2 = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil2 !== void 0 ? _permOptions$permSkil2 : []).filter(function(skill2) {
  ...
  if ((0, import_kolmafia5.visitUrl)("afterlife.php?action=pearlygates"), consumable !== $item(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral2(["none"]))) && (0, import_kolmafia5.visitUrl)("afterlife.php?action=buydeli&whichitem=".concat(consumable.id)), pet !== $item(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral2(["none"]))) && (0, import_kolmafia5.visitUrl)("afterlife.php?action=buyarmory&whichitem=".concat(pet.id)), permOptions) {
...
// src/gash/lib.ts
var _templateObject36, _templateObject210, _templateObject37, _templateObject42;
...
function burnSafaris() {
  ...
  for (; $skill(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral3(["Experience Safari"]))).timescast < get("skillLevel180") && safariTargets.length; )
...
var _templateObject38, _templateObject211;
...
function main() {
  burnSafaris(), smokeEmIfYouGotEm(), prepareAscension({
    ...
    path: $path.none,
    playerClass: $class(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral4(["Seal Clubber"]))),
