...
function fightPainting() {
  return (0, import_kolmafia4.visitUrl)("place.php?whichplace=chateau&action=chateau_painting", !1), import_kolmafia4.runCombat.apply(void 0, arguments);
}
...
// node_modules/libram/dist/ascend.js
var _templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5, _templateObject6, _templateObject7, _templateObject8, _templateObject92;
...
function _wrapNativeSuper(Class3) {
  var _cache = typeof Map == "function" ? /* @__PURE__ */ new Map() : void 0;
  return _wrapNativeSuper = function(Class4) {
    if (Class4 === null || !_isNativeFunction(Class4))
      return Class4;
    if (typeof Class4 != "function")
      throw new TypeError("Super expression must either be null or a function");
    if (typeof _cache != "undefined") {
      if (_cache.has(Class4))
        return _cache.get(Class4);
      _cache.set(Class4, Wrapper);
    }
    function Wrapper() {
      return _construct(Class4, arguments, _getPrototypeOf(this).constructor);
    }
    return Wrapper.prototype = Object.create(Class4.prototype, { constructor: { value: Wrapper, enumerable: !1, writable: !0, configurable: !0 } }), _setPrototypeOf(Wrapper, Class4);
  }, _wrapNativeSuper(Class3);
}
function _construct(Parent, args, Class3) {
  return _isNativeReflectConstruct() ? _construct = Reflect.construct.bind() : _construct = function(Parent2, args2, Class4) {
    var a = [null];
    a.push.apply(a, args2);
    var Constructor = Function.bind.apply(Parent2, a), instance = new Constructor();
    return Class4 && _setPrototypeOf(instance, Class4.prototype), instance;
...
function permedSkills() {
  return new Map(Array.from(Object.entries((0, import_kolmafia5.getPermedSkills)())).map(function(_ref) {
    var _ref2 = _slicedToArray2(_ref, 2), skillName = _ref2[0], isHardcore = _ref2[1];
...
var AscendError = /* @__PURE__ */ function(_Error) {
  ...
  function AscendError2() {
    return _classCallCheck2(this, AscendError2), _super.apply(this, arguments);
  }
  return _createClass2(AscendError2);
  ...
  function AscensionPrepError2(cause, original) {
    var _this;
    return _classCallCheck2(this, AscensionPrepError2), isGarden(cause) ? (_this = _super2.call(this, "Unable to swap garden to ".concat(cause, "; garden is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : isEudora(cause) ? (_this = _super2.call(this, "Unable to swap eudora to ".concat(cause, "; eudora is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : isDesk(cause) ? (_this = _super2.call(this, "Unable to swap chateau desk to ".concat(cause, "; desk is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : isNightstand(cause) ? (_this = _super2.call(this, "Unable to swap chateau nightstand to ".concat(cause, "; nightstand is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : isCeiling(cause) ? (_this = _super2.call(this, "Unable to swap chateau ceiling to ".concat(cause, "; ceiling is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : (_this = _super2.call(this, cause), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)), _this.cause = cause, _possibleConstructorReturn(_this);
  }
  return _createClass2(AscensionPrepError2);
...
function ascend(options) {
  var _permOptions$permSkil, _permOptions$permSkil2, DEFAULT_OPTIONS = {
    ...
    consumable: $item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral2(["astral six-pack"]))),
    pet: $item(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral2(["none"])))
  }, prunedOptions = Object.fromEntries(Object.entries(options).filter(function(_ref3) {
    var _ref4 = _slicedToArray2(_ref3, 2), value = _ref4[1];
    return value;
  })), _DEFAULT_OPTIONS$prun = _objectSpread2(_objectSpread2({}, DEFAULT_OPTIONS), prunedOptions), path = _DEFAULT_OPTIONS$prun.path, playerClass = _DEFAULT_OPTIONS$prun.playerClass, lifestyle = _DEFAULT_OPTIONS$prun.lifestyle, kolGender = _DEFAULT_OPTIONS$prun.kolGender, moon = _DEFAULT_OPTIONS$prun.moon, consumable = _DEFAULT_OPTIONS$prun.consumable, pet = _DEFAULT_OPTIONS$prun.pet, permOptions = _DEFAULT_OPTIONS$prun.permOptions;
  ...
  if (!$items(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral2(["none, astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable))
    throw new AscendError("Invalid astral consumable: ".concat(consumable));
  if (!$items(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral2(["none, astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet))
    throw new AscendError("Invalid astral pet: ".concat(pet));
  var unownedSkills = _toConsumableArray((_permOptions$permSkil = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil !== void 0 ? _permOptions$permSkil : []).filter(function(skill2) {
    return !(0, import_kolmafia5.haveSkill)(skill2);
  });
  ...
  var unpermableSkills = _toConsumableArray((_permOptions$permSkil2 = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil2 !== void 0 ? _permOptions$permSkil2 : []).filter(function(skill2) {
  ...
  if ((0, import_kolmafia5.visitUrl)("afterlife.php?action=pearlygates"), consumable !== $item(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral2(["none"]))) && (0, import_kolmafia5.visitUrl)("afterlife.php?action=buydeli&whichitem=".concat(consumable.id)), pet !== $item(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral2(["none"]))) && (0, import_kolmafia5.visitUrl)("afterlife.php?action=buyarmory&whichitem=".concat(pet.id)), permOptions) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var _currentPerms$get, _step$value = _slicedToArray2(_step.value, 2), skill = _step$value[0], prospectivePermLevel = _step$value[1], currentPermLevel = (_currentPerms$get = currentPerms.get(skill)) !== null && _currentPerms$get !== void 0 ? _currentPerms$get : Lifestyle.casual;
  ...
  (0, import_kolmafia5.visitUrl)("afterlife.php?action=ascend&confirmascend=1&whichsign=".concat(moonId, "&gender=").concat(kolGender, "&whichclass=").concat(playerClass.id, "&whichpath=").concat(path.id, "&asctype=").concat(lifestyle, "&nopetok=1&noskillsok=1&lamepathok=1&lamesignok=1&pwd"), !0);
}
...
function getSkillsToPerm() {
  (0, import_kolmafia6.visitUrl)("charsheet.php");
...
function smokeEmIfYouGotEm() {
  ...
  (0, import_kolmafia6.retrieveItem)($item(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral3(["campfire smoke"])))), withChoice(1394, "1&message=".concat((0, import_kolmafia6.urlEncode)(MESSAGE)), function() {
