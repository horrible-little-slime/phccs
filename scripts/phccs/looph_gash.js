...
var AscendError = /* @__PURE__ */ function(_Error) {
  ...
  function AscendError2(cause) {
    var _this;
    if (_classCallCheck2(this, AscendError2), !cause)
      _this = _super.call(this, "Failed to ascend--do you have a pending trade offer?"), _defineProperty2(_assertThisInitialized(_this), "cause", void 0);
      ...
      _this = _super.call(this, "Skill ".concat(cause, " is ").concat(reason, "!")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0);
    } else
      cause instanceof import_kolmafia5.Item ? (_this = _super.call(this, "Invalid astral item: ".concat(cause, "!")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : cause instanceof import_kolmafia5.Class ? (_this = _super.call(this, "Invalid class ".concat(cause, " for this path!")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : cause instanceof import_kolmafia5.Path ? (_this = _super.call(this, "Invalid path ".concat(cause, "!")), _defineProperty2(_assertThisInitialized(_this), "cause", void 0)) : (_this = _super.call(this, cause), _defineProperty2(_assertThisInitialized(_this), "cause", void 0));
  ...
  function AscensionPrepError2(cause, original) {
    var _this2;
    return _classCallCheck2(this, AscensionPrepError2), isGarden(cause) ? (_this2 = _super2.call(this, "Unable to swap garden to ".concat(cause, "; garden is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)) : isEudora(cause) ? (_this2 = _super2.call(this, "Unable to swap eudora to ".concat(cause, "; eudora is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)) : isDesk(cause) ? (_this2 = _super2.call(this, "Unable to swap chateau desk to ".concat(cause, "; desk is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)) : isNightstand(cause) ? (_this2 = _super2.call(this, "Unable to swap chateau nightstand to ".concat(cause, "; nightstand is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)) : isCeiling(cause) ? (_this2 = _super2.call(this, "Unable to swap chateau ceiling to ".concat(cause, "; ceiling is currently ").concat(original, ".")), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)) : (_this2 = _super2.call(this, cause), _defineProperty2(_assertThisInitialized(_this2), "cause", void 0)), _this2.cause = cause, _possibleConstructorReturn(_this2);
  }
...
function ascend(options) {
  ...
  }, _DEFAULT_OPTIONS$opti = _objectSpread2(_objectSpread2({}, DEFAULT_OPTIONS), options), path = _DEFAULT_OPTIONS$opti.path, playerClass = _DEFAULT_OPTIONS$opti.playerClass, lifestyle = _DEFAULT_OPTIONS$opti.lifestyle, kolGender = _DEFAULT_OPTIONS$opti.kolGender, moon = _DEFAULT_OPTIONS$opti.moon, consumable = _DEFAULT_OPTIONS$opti.consumable, pet = _DEFAULT_OPTIONS$opti.pet, permOptions = _DEFAULT_OPTIONS$opti.permOptions;
