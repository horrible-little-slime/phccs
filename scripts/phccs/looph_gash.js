...
function toMoonId(moon, playerClass) {
  ...
  var offset = () => {
    switch (playerClass.primestat) {
      case (0,_template_string__WEBPACK_IMPORTED_MODULE_1__/* .$stat */ .Ri)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Muscle"]))):
        return 0;

      case (0,_template_string__WEBPACK_IMPORTED_MODULE_1__/* .$stat */ .Ri)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Mysticality"]))):
        return 1;

      case (0,_template_string__WEBPACK_IMPORTED_MODULE_1__/* .$stat */ .Ri)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Moxie"]))):
        return 2;
...
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : (0,_template_string__WEBPACK_IMPORTED_MODULE_1__/* .$item */ .xr)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"])));
...
function prepareAscension() {
  ...
  if (workshed && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getWorkshed)() !== kolmafia__WEBPACK_IMPORTED_MODULE_0__.Item.get(workshed)) {
    ...
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getWorkshed)().name !== workshed && throwOnFail) {
      throw new Error("Failed to switch workshed to ".concat(workshed, "; it is currently still ").concat((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getWorkshed)(), "."));
    }
  }
  ...
  if (garden && !Object.getOwnPropertyNames((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getCampground)()).includes(garden)) {
    ...
    if (!Object.getOwnPropertyNames((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getCampground)()).includes(garden) && throwOnFail) {
