...
;// CONCATENATED MODULE: ./src/casual-gash.ts
var casual_gash_templateObject, casual_gash_templateObject2, casual_gash_templateObject3, casual_gash_templateObject4;

function casual_gash_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function main() {
  ...
  while ($skill(casual_gash_templateObject || (casual_gash_templateObject = casual_gash_taggedTemplateLiteral(["Experience Safari"]))).timescast < property_get("skillLevel180") && safariTargets.length) {
    (0,external_kolmafia_namespaceObject.useSkill)($skill(casual_gash_templateObject2 || (casual_gash_templateObject2 = casual_gash_taggedTemplateLiteral(["Experience Safari"]))), 1, safariTargets[0]);
    safariTargets.shift();
  }
  ...
  ascend(Paths.Unrestricted, $class(casual_gash_templateObject3 || (casual_gash_templateObject3 = casual_gash_taggedTemplateLiteral(["Seal Clubber"]))), Lifestyle.casual, "canadia", $item(casual_gash_templateObject4 || (casual_gash_templateObject4 = casual_gash_taggedTemplateLiteral(["astral six-pack"]))));
}
})();
