...
/* harmony export */   "n": () => (/* binding */ Paths)
/* harmony export */ });
/* harmony import */ var _template_string__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(678);
...
function Path(name, id) {
  ...
  var classes = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Seal Clubber, Turtle Tamer, Sauceror, Pastamancer, Disco Bandit, Accordion Thief"])));
...
var Paths = {
  ...
  AvatarOfBoris: new Path("Avatar of Boris", 8, false, true, false, 20, 5, 15, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Avatar of Boris"])))),
  BugbearInvasion: new Path("Bugbear Invasion", 9),
  ZombieSlayer: new Path("Zombie Slayer", 10, false, true, true, 15, 5, 15, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Zombie Master"])))),
  ClassAct: new Path("Class Act", 11, false),
  AvatarofJarlsberg: new Path("Avatar of Jarlsberg", 12, false, true, false, 10, 10, 15, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["Avatar of Jarlsberg"])))),
  Big: new Path("BIG!", 14),
  KolHs: new Path("KOLHS", 15),
  ClassAct2: new Path("Class Act II: A Class For Pigs", 16, false),
  AvatarofSneakyPete: new Path("Avatar of Sneaky Pete", 17, false, true, false, 5, 20, 15, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Avatar of Sneaky Pete"])))),
  ...
  ActuallyEdTheUndying: new Path("Actually Ed the Undying", 23, false, false, false, 0, 0, 5, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["Ed"])))),
  OneCrazyRandomSummer: new Path("One Crazy Random Summer", 24),
  CommunityService: new Path("Community Service", 25),
  AvatarOfWestOfLoathing: new Path("Avatar of West of Loathing", 26, false, true, true, 10, 10, 10, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["Cow Puncher, Snake Oiler, Beanslinger"])))),
  TheSource: new Path("The Source", 27),
  NuclearAutumn: new Path("Nuclear Autumn", 28, false, false, true, 3, 3, 3),
  GelatinousNoob: new Path("Gelatinous Noob", 29, false, true, true, 0, 0, 0, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["Gelatinous Noob"])))),
  ...
  DarkGyffte: new Path("Dark Gyffte", 35, false, true, false, 5, 5, 15, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["Vampyre"])))),
  TwoCrazyRandomSummer: new Path("Two Crazy Random Summer", 36),
  KingdomOfExploathing: new Path("Kingdom of Exploathing", 37),
  PathOfThePlumber: new Path("Path of the Plumber", 38, false, true, true, 20, 0, 5, (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Plumber"])))),
  ...
  (0,_template_string__WEBPACK_IMPORTED_MODULE_0__/* .$classes */ .JT)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Grey Goo"]))))
};
...
/* harmony export */ });
/* unused harmony exports AscendError, AscensionPrepError */
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1664);
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6906);
/* harmony import */ var _resources__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7975);
/* harmony import */ var _template_string__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(678);
...
var AscendError = /*#__PURE__*/function (_Error) {
  ...
  function AscendError(cause) {
    ...
    if (!cause) {
      ...
      _defineProperty(_assertThisInitialized(_this), "cause", void 0);
    } else if (cause instanceof _Path__WEBPACK_IMPORTED_MODULE_1__/* .Path */ .y) {
...
var isWorkshed = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(worksheds);
var isGarden = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(gardens);
var isEudora = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(eudorae);
var isDesk = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(_resources__WEBPACK_IMPORTED_MODULE_3__/* .desks */ .Kb);
var isNightstand = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(_resources__WEBPACK_IMPORTED_MODULE_3__/* .nightstands */ .L4);
var isCeiling = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .createStringUnionTypeGuardFunction */ .S$)(_resources__WEBPACK_IMPORTED_MODULE_3__/* .ceilings */ .bA);
...
function toMoonId(moon, playerClass) {
  ...
  var offset = () => {
    switch (playerClass.primestat) {
      case (0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$stat */ .Ri)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Muscle"]))):
        return 0;

      case (0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$stat */ .Ri)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["Mysticality"]))):
        return 1;

      case (0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$stat */ .Ri)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Moxie"]))):
        return 2;
...
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : (0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$item */ .xr)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"])));
  ...
  if (consumable && !(0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$items */ .vS)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable)) {
    throw new AscendError(consumable);
  }

  if (pet && !(0,_template_string__WEBPACK_IMPORTED_MODULE_4__/* .$items */ .vS)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet)) {
...
function prepareAscension() {
  ...
  if (chateau && _resources__WEBPACK_IMPORTED_MODULE_3__/* .have */ .lf()) {
    var desk = chateau.desk,
        ceiling = chateau.ceiling,
        nightstand = chateau.nightstand;

    if (ceiling && _resources__WEBPACK_IMPORTED_MODULE_3__/* .getCeiling */ .TB() !== ceiling) {
      if (!_resources__WEBPACK_IMPORTED_MODULE_3__/* .changeCeiling */ .L9(ceiling) && throwOnFail) {
        var _ChateauMantegna$getC;

        throw new AscensionPrepError(ceiling, (_ChateauMantegna$getC = _resources__WEBPACK_IMPORTED_MODULE_3__/* .getCeiling */ .TB()) !== null && _ChateauMantegna$getC !== void 0 ? _ChateauMantegna$getC : "unknown");
      }
    }

    if (desk && _resources__WEBPACK_IMPORTED_MODULE_3__/* .getDesk */ ._4() !== desk) {
      if (!_resources__WEBPACK_IMPORTED_MODULE_3__/* .changeDesk */ .GL(desk) && throwOnFail) {
        var _ChateauMantegna$getD;

        throw new AscensionPrepError(desk, (_ChateauMantegna$getD = _resources__WEBPACK_IMPORTED_MODULE_3__/* .getDesk */ ._4()) !== null && _ChateauMantegna$getD !== void 0 ? _ChateauMantegna$getD : "unknown");
      }
    }

    if (nightstand && _resources__WEBPACK_IMPORTED_MODULE_3__/* .getNightstand */ .Ul() !== nightstand) {
      if (!_resources__WEBPACK_IMPORTED_MODULE_3__/* .changeNightstand */ .np(nightstand) && throwOnFail) {
        var _ChateauMantegna$getN;

        throw new AscensionPrepError(nightstand, (_ChateauMantegna$getN = _resources__WEBPACK_IMPORTED_MODULE_3__/* .getNightstand */ .Ul()) !== null && _ChateauMantegna$getN !== void 0 ? _ChateauMantegna$getN : "unknown");
      }
    }
  }
}
...
/* harmony export */ });
/* unused harmony exports $bounty, $bounties, $coinmaster, $coinmasters, $effect, $effects, $element, $elements, $familiar, $familiars, $location, $locations, $monster, $monsters, $phylum, $phyla, $servant, $servants, $skills, $slot, $slots, $stats, $thrall, $thralls */
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1664);
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var libram__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6906);
...
function main() {
  ...
  (0,libram__WEBPACK_IMPORTED_MODULE_3__/* .ascend */ .zU)(libram__WEBPACK_IMPORTED_MODULE_4__/* .Paths.Unrestricted */ .n.Unrestricted, (0,libram__WEBPACK_IMPORTED_MODULE_1__/* .$class */ ._$)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Seal Clubber"]))), libram__WEBPACK_IMPORTED_MODULE_3__/* .Lifestyle.casual */ .VO.casual, "canadia", (0,libram__WEBPACK_IMPORTED_MODULE_1__/* .$item */ .xr)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["astral six-pack"]))));
}
})();
