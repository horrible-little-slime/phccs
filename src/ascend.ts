...
const avatarClasses = {
    8: $class`Avatar of Boris`,
    10: $class`Zombie Master`,
    12: $class`Avatar of Jarlsberg`,
    17: $class`Avatar of Sneaky Pete`,
    23: $class`Ed`,

    29: $class`Gelatinous Noob`,
    35: $class`Vampyre`,
    38: $class`Plumber`,
};
...
export function ascend(
    ...
    const classid = avatarPathIds.includes(pathId) ? toInt() : toInt(playerClass);
